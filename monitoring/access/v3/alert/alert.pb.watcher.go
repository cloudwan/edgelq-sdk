...
func (pw *Watcher) GetFilters() []*WatcherFilterParams {
	...
	for _, query := range pw.filters {
		...
		if query.Parent != nil {
			cQuery.Parent = &alert.ParentReference{}
...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(alert.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Reference) gotenaccess.WatcherFilterParams {
		params := &WatcherFilterParams{}
		if filter != nil {
			params.Filter = filter.(*alert.Filter)
		}
		if parent != nil {
			params.Parent = parent.(*alert.ParentReference)
		}
		return params
	})
}
