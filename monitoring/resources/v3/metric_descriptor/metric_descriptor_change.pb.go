...
func (m *MetricDescriptorChange) Reset() {
	*m = MetricDescriptorChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[0]
...
func (m *MetricDescriptorChange_Added) Reset() {
	*m = MetricDescriptorChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MetricDescriptorChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *MetricDescriptorChange_Modified) Reset() {
	*m = MetricDescriptorChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *MetricDescriptorChange_Current) Reset() {
	*m = MetricDescriptorChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *MetricDescriptorChange_Removed) Reset() {
	*m = MetricDescriptorChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
var edgelq_monitoring_proto_v3_metric_descriptor_change_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDesc = []byte{
	...
	0x2e, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x33, 0x1a, 0x19,
...
var (
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescData = edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDesc
)

func edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDescData
}

var edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_monitoring_proto_v3_metric_descriptor_change_proto_goTypes = []interface{}{
	(*MetricDescriptorChange)(nil),          // 0: ntt.monitoring.v3.MetricDescriptorChange
	(*MetricDescriptorChange_Added)(nil),    // 1: ntt.monitoring.v3.MetricDescriptorChange.Added
	(*MetricDescriptorChange_Modified)(nil), // 2: ntt.monitoring.v3.MetricDescriptorChange.Modified
	(*MetricDescriptorChange_Current)(nil),  // 3: ntt.monitoring.v3.MetricDescriptorChange.Current
	(*MetricDescriptorChange_Removed)(nil),  // 4: ntt.monitoring.v3.MetricDescriptorChange.Removed
	(*MetricDescriptor)(nil),                // 5: ntt.monitoring.v3.MetricDescriptor
	(*MetricDescriptor_FieldMask)(nil),      // 6: ntt.monitoring.v3.MetricDescriptor_FieldMask
}
var edgelq_monitoring_proto_v3_metric_descriptor_change_proto_depIdxs = []int32{
	1, // 0: ntt.monitoring.v3.MetricDescriptorChange.added:type_name -> ntt.monitoring.v3.MetricDescriptorChange.Added
	2, // 1: ntt.monitoring.v3.MetricDescriptorChange.modified:type_name -> ntt.monitoring.v3.MetricDescriptorChange.Modified
	3, // 2: ntt.monitoring.v3.MetricDescriptorChange.current:type_name -> ntt.monitoring.v3.MetricDescriptorChange.Current
	4, // 3: ntt.monitoring.v3.MetricDescriptorChange.removed:type_name -> ntt.monitoring.v3.MetricDescriptorChange.Removed
	5, // 4: ntt.monitoring.v3.MetricDescriptorChange.Added.metric_descriptor:type_name -> ntt.monitoring.v3.MetricDescriptor
	5, // 5: ntt.monitoring.v3.MetricDescriptorChange.Modified.metric_descriptor:type_name -> ntt.monitoring.v3.MetricDescriptor
	6, // 6: ntt.monitoring.v3.MetricDescriptorChange.Modified.field_mask:type_name -> ntt.monitoring.v3.MetricDescriptor_FieldMask
	5, // 7: ntt.monitoring.v3.MetricDescriptorChange.Current.metric_descriptor:type_name -> ntt.monitoring.v3.MetricDescriptor
...
func init() { edgelq_monitoring_proto_v3_metric_descriptor_change_proto_init() }
func edgelq_monitoring_proto_v3_metric_descriptor_change_proto_init() {
	if edgelq_monitoring_proto_v3_metric_descriptor_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_monitoring_proto_v3_metric_descriptor_change_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v3_metric_descriptor_change_proto_depIdxs,
		MessageInfos:      edgelq_monitoring_proto_v3_metric_descriptor_change_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto = out.File
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto_rawDesc = nil
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto_goTypes = nil
	edgelq_monitoring_proto_v3_metric_descriptor_change_proto_depIdxs = nil
}
