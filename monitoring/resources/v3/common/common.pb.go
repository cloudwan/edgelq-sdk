...
type LabelDescriptor struct {
	...
	ValueType LabelDescriptor_ValueType `protobuf:"varint,2,opt,name=value_type,json=valueType,proto3,enum=ntt.monitoring.v3.LabelDescriptor_ValueType" json:"value_type,omitempty"`
...
type Aggregation struct {
	...
	// returned.
	PerSeriesAligner Aggregation_Aligner `protobuf:"varint,2,opt,name=per_series_aligner,json=perSeriesAligner,proto3,enum=ntt.monitoring.v3.Aggregation_Aligner" json:"per_series_aligner,omitempty"`
	...
	// and `alignmentPeriod` must be specified; otherwise, an error is
	// returned.
	CrossSeriesReducer Aggregation_Reducer `protobuf:"varint,4,opt,name=cross_series_reducer,json=crossSeriesReducer,proto3,enum=ntt.monitoring.v3.Aggregation_Reducer" json:"cross_series_reducer,omitempty"`
