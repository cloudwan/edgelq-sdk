...
func (m *NotificationChange) Reset() {
	*m = NotificationChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[0]
...
func (*NotificationChange) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_notification_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *NotificationChange_Added) Reset() {
	*m = NotificationChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotificationChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_notification_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *NotificationChange_Modified) Reset() {
	*m = NotificationChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotificationChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_notification_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *NotificationChange_Current) Reset() {
	*m = NotificationChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotificationChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_notification_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *NotificationChange_Removed) Reset() {
	*m = NotificationChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotificationChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_notification_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_monitoring_proto_v3_notification_change_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v3_notification_change_proto_rawDesc = []byte{
	...
	0x67, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x33, 0x42, 0x17, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
...
var (
	edgelq_monitoring_proto_v3_notification_change_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v3_notification_change_proto_rawDescData = edgelq_monitoring_proto_v3_notification_change_proto_rawDesc
)

func edgelq_monitoring_proto_v3_notification_change_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v3_notification_change_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v3_notification_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v3_notification_change_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v3_notification_change_proto_rawDescData
}

var edgelq_monitoring_proto_v3_notification_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_monitoring_proto_v3_notification_change_proto_goTypes = []interface{}{
	(*NotificationChange)(nil),          // 0: ntt.monitoring.v3.NotificationChange
	(*NotificationChange_Added)(nil),    // 1: ntt.monitoring.v3.NotificationChange.Added
	(*NotificationChange_Modified)(nil), // 2: ntt.monitoring.v3.NotificationChange.Modified
	(*NotificationChange_Current)(nil),  // 3: ntt.monitoring.v3.NotificationChange.Current
	(*NotificationChange_Removed)(nil),  // 4: ntt.monitoring.v3.NotificationChange.Removed
	(*Notification)(nil),                // 5: ntt.monitoring.v3.Notification
	(*Notification_FieldMask)(nil),      // 6: ntt.monitoring.v3.Notification_FieldMask
}
var edgelq_monitoring_proto_v3_notification_change_proto_depIdxs = []int32{
	1, // 0: ntt.monitoring.v3.NotificationChange.added:type_name -> ntt.monitoring.v3.NotificationChange.Added
	2, // 1: ntt.monitoring.v3.NotificationChange.modified:type_name -> ntt.monitoring.v3.NotificationChange.Modified
	3, // 2: ntt.monitoring.v3.NotificationChange.current:type_name -> ntt.monitoring.v3.NotificationChange.Current
	4, // 3: ntt.monitoring.v3.NotificationChange.removed:type_name -> ntt.monitoring.v3.NotificationChange.Removed
	5, // 4: ntt.monitoring.v3.NotificationChange.Added.notification:type_name -> ntt.monitoring.v3.Notification
	5, // 5: ntt.monitoring.v3.NotificationChange.Modified.notification:type_name -> ntt.monitoring.v3.Notification
	6, // 6: ntt.monitoring.v3.NotificationChange.Modified.field_mask:type_name -> ntt.monitoring.v3.Notification_FieldMask
	5, // 7: ntt.monitoring.v3.NotificationChange.Current.notification:type_name -> ntt.monitoring.v3.Notification
...
func init() { edgelq_monitoring_proto_v3_notification_change_proto_init() }
func edgelq_monitoring_proto_v3_notification_change_proto_init() {
	if edgelq_monitoring_proto_v3_notification_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_monitoring_proto_v3_notification_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_monitoring_proto_v3_notification_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_monitoring_proto_v3_notification_change_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v3_notification_change_proto_depIdxs,
		MessageInfos:      edgelq_monitoring_proto_v3_notification_change_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v3_notification_change_proto = out.File
	edgelq_monitoring_proto_v3_notification_change_proto_rawDesc = nil
	edgelq_monitoring_proto_v3_notification_change_proto_goTypes = nil
	edgelq_monitoring_proto_v3_notification_change_proto_depIdxs = nil
}
