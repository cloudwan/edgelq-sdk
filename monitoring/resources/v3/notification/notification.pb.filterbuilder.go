...
func (b *filterCndBuilderMetadataOwnerReferencesBlockOwnerDeletion) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Notification_FieldPathArrayOfValues: NewNotificationFieldPathBuilder().Metadata().OwnerReferences().BlockOwnerDeletion().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesBlockOwnerDeletion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewNotificationFieldPathBuilder().Metadata().OwnerReferences().BlockOwnerDeletion().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesBlockOwnerDeletion) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
		Notification_FieldPathValue: NewNotificationFieldPathBuilder().Metadata().OwnerReferences().BlockOwnerDeletion().WithValue(value),
	})
}
...
func (b *filterCndBuilderStateAlertsLifetime) Eq(value *monitoring_common.TimeRange) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderStateAlertsLifetime) Neq(value *monitoring_common.TimeRange) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderStateAlertsLifetime) Gt(value *monitoring_common.TimeRange) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderStateAlertsLifetime) Gte(value *monitoring_common.TimeRange) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderStateAlertsLifetime) Lt(value *monitoring_common.TimeRange) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderStateAlertsLifetime) Lte(value *monitoring_common.TimeRange) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderStateAlertsLifetime) In(values []*monitoring_common.TimeRange) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Notification_FieldPathArrayOfValues: NewNotificationFieldPathBuilder().State().AlertsLifetime().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderStateAlertsLifetime) NotIn(values []*monitoring_common.TimeRange) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Notification_FieldPathArrayOfValues: NewNotificationFieldPathBuilder().State().AlertsLifetime().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderStateAlertsLifetime) compare(op gotenfilter.CompareOperator, value *monitoring_common.TimeRange) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
...
func (b *filterCndBuilderStateAlertsLifetimeStartTime) Eq(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderStateAlertsLifetimeStartTime) Neq(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderStateAlertsLifetimeStartTime) Gt(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderStateAlertsLifetimeStartTime) Gte(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderStateAlertsLifetimeStartTime) Lt(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderStateAlertsLifetimeStartTime) Lte(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderStateAlertsLifetimeStartTime) In(values []*timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
...
func (b *filterCndBuilderStateAlertsLifetimeStartTime) NotIn(values []*timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Notification_FieldPathArrayOfValues: NewNotificationFieldPathBuilder().State().AlertsLifetime().StartTime().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderStateAlertsLifetimeStartTime) compare(op gotenfilter.CompareOperator, value *timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
...
func (b *filterCndBuilderStateAlertsLifetimeEndTime) Eq(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderStateAlertsLifetimeEndTime) Neq(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderStateAlertsLifetimeEndTime) Gt(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderStateAlertsLifetimeEndTime) Gte(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderStateAlertsLifetimeEndTime) Lt(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderStateAlertsLifetimeEndTime) Lte(value *timestamp.Timestamp) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderStateAlertsLifetimeEndTime) In(values []*timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
...
func (b *filterCndBuilderStateAlertsLifetimeEndTime) NotIn(values []*timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Notification_FieldPathArrayOfValues: NewNotificationFieldPathBuilder().State().AlertsLifetime().EndTime().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderStateAlertsLifetimeEndTime) compare(op gotenfilter.CompareOperator, value *timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
