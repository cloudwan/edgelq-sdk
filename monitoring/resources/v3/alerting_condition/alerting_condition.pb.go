...
func (AlertingCondition_Spec_TimeSeries_Threshold_Compare) Descriptor() preflect.EnumDescriptor {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes[0].Descriptor()
}

func (AlertingCondition_Spec_TimeSeries_Threshold_Compare) Type() preflect.EnumType {
	return &edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes[0]
}
...
func (AlertingCondition_Spec_TimeSeries_CombineThreshold_CombineOperator) Descriptor() preflect.EnumDescriptor {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes[1].Descriptor()
}

func (AlertingCondition_Spec_TimeSeries_CombineThreshold_CombineOperator) Type() preflect.EnumType {
	return &edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes[1]
}
...
func (AlertingCondition_Spec_TimeSeries_CombineThreshold_CombineOperator) EnumDescriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescGZIP(), []int{0, 0, 0, 2, 0}
}
...
func (AlertingCondition_Spec_Trigger_Type) Descriptor() preflect.EnumDescriptor {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes[2].Descriptor()
}

func (AlertingCondition_Spec_Trigger_Type) Type() preflect.EnumType {
	return &edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes[2]
}
...
func (AlertingCondition_Spec_Trigger_Type) EnumDescriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescGZIP(), []int{0, 0, 1, 0}
}
...
func (m *AlertingCondition) Reset() {
	*m = AlertingCondition{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[0]
...
func (*AlertingCondition) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescGZIP(), []int{0}
}
...
func (m *AlertingCondition) GetMetadata() *ntt_meta.Meta {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *AlertingCondition) SetMetadata(fv *ntt_meta.Meta) {
	if m == nil {
...
func (m *AlertingCondition_Spec) Reset() {
	*m = AlertingCondition_Spec{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingCondition_Spec) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *AlertingCondition_State) Reset() {
	*m = AlertingCondition_State{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
type AlertingCondition_Spec_TimeSeries struct {
	...
	Duration *duration.Duration `protobuf:"bytes,4,opt,name=duration,proto3" json:"duration,omitempty" firestore:"duration"`
}

func (m *AlertingCondition_Spec_TimeSeries) Reset() {
	*m = AlertingCondition_Spec_TimeSeries{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingCondition_Spec_TimeSeries) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (m *AlertingCondition_Spec_TimeSeries) GetDuration() *duration.Duration {
	if m != nil {
		return m.Duration
	}
	return nil
...
func (m *AlertingCondition_Spec_TimeSeries) SetDuration(fv *duration.Duration) {
	if m == nil {
...
func (m *AlertingCondition_Spec_Trigger) Reset() {
	*m = AlertingCondition_Spec_Trigger{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
type AlertingCondition_Spec_TimeSeries_Query struct {
	...
	Selector *monitoring_common.TimeSeriesSelector `protobuf:"bytes,2,opt,name=selector,proto3" json:"selector,omitempty" firestore:"selector"`
	// Time Series aggregation
	Aggregation *monitoring_common.Aggregation `protobuf:"bytes,3,opt,name=aggregation,proto3" json:"aggregation,omitempty" firestore:"aggregation"`
}

func (m *AlertingCondition_Spec_TimeSeries_Query) Reset() {
	*m = AlertingCondition_Spec_TimeSeries_Query{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingCondition_Spec_TimeSeries_Query) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescGZIP(), []int{0, 0, 0, 0}
}
...
func (m *AlertingCondition_Spec_TimeSeries_Query) GetSelector() *monitoring_common.TimeSeriesSelector {
	if m != nil {
		return m.Selector
	}
	return nil
...
func (m *AlertingCondition_Spec_TimeSeries_Query) GetAggregation() *monitoring_common.Aggregation {
	if m != nil {
...
func (m *AlertingCondition_Spec_TimeSeries_Query) SetSelector(fv *monitoring_common.TimeSeriesSelector) {
	if m == nil {
...
func (m *AlertingCondition_Spec_TimeSeries_Query) SetAggregation(fv *monitoring_common.Aggregation) {
	if m == nil {
...
func (m *AlertingCondition_Spec_TimeSeries_Threshold) Reset() {
	*m = AlertingCondition_Spec_TimeSeries_Threshold{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *AlertingCondition_Spec_TimeSeries_CombineThreshold) Reset() {
	*m = AlertingCondition_Spec_TimeSeries_CombineThreshold{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
var edgelq_monitoring_proto_v3_alerting_condition_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v3_alerting_condition_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf9, 0x13, 0x0a, 0x11, 0x41,
	...
	0xb2, 0xda, 0x21, 0x15, 0x0a, 0x13, 0x0a, 0x11, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67,
	...
	0x6e, 0x12, 0x47, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x70, 0x65, 0x63, 0x42, 0x08, 0xca, 0xc6, 0x27, 0x04,
	0x62, 0x02, 0x08, 0x01, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x40, 0x0a, 0x05, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	...
	,
	...
	0x65, 0x63, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x42, 0x08, 0xca, 0xc6, 0x27, 0x04,
	0x62, 0x02, 0x08, 0x01, 0x52, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x1a, 0x89, 0x09,
	0x0a, 0x0a, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x69, 0x65, 0x73, 0x12, 0x5a, 0x0a, 0x05,
	0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x6e, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x72,
	0x69, 0x65, 0x73, 0x2e, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x54, 0x68, 0x72, 0x65, 0x73,
	0x68, 0x6f, 0x6c, 0x64, 0x2e, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x4f, 0x70, 0x65, 0x72,
	0x61, 0x74, 0x6f, 0x72, 0x42, 0x08, 0xca, 0xc6, 0x27, 0x04, 0x3a, 0x02, 0x18, 0x00, 0x52, 0x07,
	0x63, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x1a, 0x7c, 0x0a, 0x0e, 0x50, 0x65, 0x72, 0x4d, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6e, 0x67, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x33, 0x42, 0x16, 0x41, 0x6c, 0x65, 0x72, 0x74,
	...
	0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x33, 0x2f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67,
	0x5f, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x3b, 0x61, 0x6c, 0x65, 0x72, 0x74,
	0x69, 0x6e, 0x67, 0x5f, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0xd2, 0x84, 0xd1,
	...
	0x6e, 0x64, 0x6c, 0x65, 0x72, 0x73, 0x2f, 0x76, 0x33, 0xa2, 0x80, 0xd1, 0x02, 0x5f, 0x0a, 0x19,
	0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var (
	edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescData = edgelq_monitoring_proto_v3_alerting_condition_proto_rawDesc
)

func edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v3_alerting_condition_proto_rawDescData
}

var edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var edgelq_monitoring_proto_v3_alerting_condition_proto_goTypes = []interface{}{
	(AlertingCondition_Spec_TimeSeries_Threshold_Compare)(0),                // 0: ntt.monitoring.v3.AlertingCondition_Spec_TimeSeries_Threshold_Compare
	(AlertingCondition_Spec_TimeSeries_CombineThreshold_CombineOperator)(0), // 1: ntt.monitoring.v3.AlertingCondition_Spec_TimeSeries_CombineThreshold_CombineOperator
	(AlertingCondition_Spec_Trigger_Type)(0),                                // 2: ntt.monitoring.v3.AlertingCondition_Spec_Trigger_Type
	(*AlertingCondition)(nil),                                               // 3: ntt.monitoring.v3.AlertingCondition
	(*AlertingCondition_Spec)(nil),                                          // 4: ntt.monitoring.v3.AlertingCondition.Spec
	(*AlertingCondition_State)(nil),                                         // 5: ntt.monitoring.v3.AlertingCondition.State
	(*AlertingCondition_Spec_TimeSeries)(nil),                               // 6: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries
	(*AlertingCondition_Spec_Trigger)(nil),                                  // 7: ntt.monitoring.v3.AlertingCondition.Spec.Trigger
	(*AlertingCondition_Spec_TimeSeries_Query)(nil),                         // 8: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Query
	(*AlertingCondition_Spec_TimeSeries_Threshold)(nil),                     // 9: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Threshold
	(*AlertingCondition_Spec_TimeSeries_CombineThreshold)(nil),              // 10: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.CombineThreshold
	nil,                       // 11: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.CombineThreshold.PerMetricEntry
	(*ntt_meta.Meta)(nil),     // 12: ntt.types.Meta
	(*duration.Duration)(nil), // 13: google.protobuf.Duration
	(*monitoring_common.TimeSeriesSelector)(nil), // 14: ntt.monitoring.v3.TimeSeriesSelector
	(*monitoring_common.Aggregation)(nil),        // 15: ntt.monitoring.v3.Aggregation
}
var edgelq_monitoring_proto_v3_alerting_condition_proto_depIdxs = []int32{
	12, // 0: ntt.monitoring.v3.AlertingCondition.metadata:type_name -> ntt.types.Meta
	4,  // 1: ntt.monitoring.v3.AlertingCondition.spec:type_name -> ntt.monitoring.v3.AlertingCondition.Spec
	5,  // 2: ntt.monitoring.v3.AlertingCondition.state:type_name -> ntt.monitoring.v3.AlertingCondition.State
	6,  // 3: ntt.monitoring.v3.AlertingCondition.Spec.time_series:type_name -> ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries
	7,  // 4: ntt.monitoring.v3.AlertingCondition.Spec.trigger:type_name -> ntt.monitoring.v3.AlertingCondition.Spec.Trigger
	8,  // 5: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.query:type_name -> ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Query
	9,  // 6: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.threshold:type_name -> ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Threshold
	10, // 7: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.combine_threshold:type_name -> ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.CombineThreshold
	13, // 8: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.duration:type_name -> google.protobuf.Duration
	2,  // 9: ntt.monitoring.v3.AlertingCondition.Spec.Trigger.type:type_name -> ntt.monitoring.v3.AlertingCondition_Spec_Trigger_Type
	14, // 10: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Query.selector:type_name -> ntt.monitoring.v3.TimeSeriesSelector
	15, // 11: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Query.aggregation:type_name -> ntt.monitoring.v3.Aggregation
	0,  // 12: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Threshold.compare:type_name -> ntt.monitoring.v3.AlertingCondition_Spec_TimeSeries_Threshold_Compare
	11, // 13: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.CombineThreshold.per_metric:type_name -> ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.CombineThreshold.PerMetricEntry
	1,  // 14: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.CombineThreshold.combine:type_name -> ntt.monitoring.v3.AlertingCondition_Spec_TimeSeries_CombineThreshold_CombineOperator
	9,  // 15: ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.CombineThreshold.PerMetricEntry.value:type_name -> ntt.monitoring.v3.AlertingCondition.Spec.TimeSeries.Threshold
...
func init() { edgelq_monitoring_proto_v3_alerting_condition_proto_init() }
func edgelq_monitoring_proto_v3_alerting_condition_proto_init() {
	if edgelq_monitoring_proto_v3_alerting_condition_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_monitoring_proto_v3_alerting_condition_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_monitoring_proto_v3_alerting_condition_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v3_alerting_condition_proto_depIdxs,
		EnumInfos:         edgelq_monitoring_proto_v3_alerting_condition_proto_enumTypes,
		MessageInfos:      edgelq_monitoring_proto_v3_alerting_condition_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v3_alerting_condition_proto = out.File
	edgelq_monitoring_proto_v3_alerting_condition_proto_rawDesc = nil
	edgelq_monitoring_proto_v3_alerting_condition_proto_goTypes = nil
	edgelq_monitoring_proto_v3_alerting_condition_proto_depIdxs = nil
}
