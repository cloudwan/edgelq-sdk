...
func (orderByFld *OrderByField) CompareWithDirection(left, right *MonitoredResourceDescriptor) int {
...
func (orderBy *OrderBy) Sort(results MonitoredResourceDescriptorList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(MonitoredResourceDescriptorList))
}

func (orderBy *OrderBy) InsertSorted(sorted MonitoredResourceDescriptorList, elem *MonitoredResourceDescriptor) (MonitoredResourceDescriptorList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(MonitoredResourceDescriptorList), elem.(*MonitoredResourceDescriptor))
}

func (orderBy *OrderBy) Compare(left, right *MonitoredResourceDescriptor) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*MonitoredResourceDescriptor), right.(*MonitoredResourceDescriptor))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseMonitoredResourceDescriptor_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *MonitoredResourceDescriptor_FieldMask {
	fieldMask := &MonitoredResourceDescriptor_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == MonitoredResourceDescriptor_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &MonitoredResourceDescriptor_FieldTerminalPath{selector: MonitoredResourceDescriptor_FieldPathSelectorName},
