...
type GetQuery struct {
	Reference *Reference
	Mask      *MonitoredResourceDescriptor_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*MonitoredResourceDescriptor_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	MonitoredResourceDescriptors []*MonitoredResourceDescriptor
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return MonitoredResourceDescriptorList(qr.MonitoredResourceDescriptors)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.MonitoredResourceDescriptors = results.(MonitoredResourceDescriptorList)
	} else {
		qr.MonitoredResourceDescriptors = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*MonitoredResourceDescriptorChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return MonitoredResourceDescriptorChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(MonitoredResourceDescriptorChangeList)
	} else {
		qr.Changes = nil
	}
}
