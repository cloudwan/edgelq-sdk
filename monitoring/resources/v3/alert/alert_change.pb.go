...
// File: edgelq/monitoring/proto/v3/alert_change.proto
// DO NOT EDIT!!!
...
func (m *AlertChange) Reset() {
	*m = AlertChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[0]
...
func (*AlertChange) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alert_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *AlertChange_Added) Reset() {
	*m = AlertChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alert_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *AlertChange_Modified) Reset() {
	*m = AlertChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alert_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *AlertChange_Current) Reset() {
	*m = AlertChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alert_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *AlertChange_Removed) Reset() {
	*m = AlertChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_alert_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_monitoring_proto_v3_alert_change_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v3_alert_change_proto_rawDesc = []byte{
	...
	0x76, 0x33, 0x2e, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x43,
	...
	0x33, 0x2e, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x52, 0x05, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x12, 0x1d,
	...
	0x67, 0x2e, 0x76, 0x33, 0x2e, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x52, 0x05, 0x61, 0x6c, 0x65, 0x72,
	...
	0x72, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x33, 0x42, 0x10, 0x41, 0x6c, 0x65, 0x72,
	...
	0x76, 0x33, 0x2f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x3b, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_monitoring_proto_v3_alert_change_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v3_alert_change_proto_rawDescData = edgelq_monitoring_proto_v3_alert_change_proto_rawDesc
)

func edgelq_monitoring_proto_v3_alert_change_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v3_alert_change_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v3_alert_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v3_alert_change_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v3_alert_change_proto_rawDescData
}

var edgelq_monitoring_proto_v3_alert_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_monitoring_proto_v3_alert_change_proto_goTypes = []interface{}{
	(*AlertChange)(nil),          // 0: ntt.monitoring.v3.AlertChange
	(*AlertChange_Added)(nil),    // 1: ntt.monitoring.v3.AlertChange.Added
	(*AlertChange_Modified)(nil), // 2: ntt.monitoring.v3.AlertChange.Modified
	(*AlertChange_Current)(nil),  // 3: ntt.monitoring.v3.AlertChange.Current
	(*AlertChange_Removed)(nil),  // 4: ntt.monitoring.v3.AlertChange.Removed
	(*Alert)(nil),                // 5: ntt.monitoring.v3.Alert
	(*Alert_FieldMask)(nil),      // 6: ntt.monitoring.v3.Alert_FieldMask
}
var edgelq_monitoring_proto_v3_alert_change_proto_depIdxs = []int32{
	1, // 0: ntt.monitoring.v3.AlertChange.added:type_name -> ntt.monitoring.v3.AlertChange.Added
	2, // 1: ntt.monitoring.v3.AlertChange.modified:type_name -> ntt.monitoring.v3.AlertChange.Modified
	3, // 2: ntt.monitoring.v3.AlertChange.current:type_name -> ntt.monitoring.v3.AlertChange.Current
	4, // 3: ntt.monitoring.v3.AlertChange.removed:type_name -> ntt.monitoring.v3.AlertChange.Removed
	5, // 4: ntt.monitoring.v3.AlertChange.Added.alert:type_name -> ntt.monitoring.v3.Alert
	5, // 5: ntt.monitoring.v3.AlertChange.Modified.alert:type_name -> ntt.monitoring.v3.Alert
	6, // 6: ntt.monitoring.v3.AlertChange.Modified.field_mask:type_name -> ntt.monitoring.v3.Alert_FieldMask
	5, // 7: ntt.monitoring.v3.AlertChange.Current.alert:type_name -> ntt.monitoring.v3.Alert
...
func init() { edgelq_monitoring_proto_v3_alert_change_proto_init() }
func edgelq_monitoring_proto_v3_alert_change_proto_init() {
	if edgelq_monitoring_proto_v3_alert_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_monitoring_proto_v3_alert_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_monitoring_proto_v3_alert_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_monitoring_proto_v3_alert_change_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v3_alert_change_proto_depIdxs,
		MessageInfos:      edgelq_monitoring_proto_v3_alert_change_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v3_alert_change_proto = out.File
	edgelq_monitoring_proto_v3_alert_change_proto_rawDesc = nil
	edgelq_monitoring_proto_v3_alert_change_proto_goTypes = nil
	edgelq_monitoring_proto_v3_alert_change_proto_depIdxs = nil
}
