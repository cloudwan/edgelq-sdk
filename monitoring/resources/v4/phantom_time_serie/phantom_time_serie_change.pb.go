...
func (m *PhantomTimeSerieChange) Reset() {
	*m = PhantomTimeSerieChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[0]
...
func (*PhantomTimeSerieChange) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *PhantomTimeSerieChange_Added) Reset() {
	*m = PhantomTimeSerieChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PhantomTimeSerieChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *PhantomTimeSerieChange_Modified) Reset() {
	*m = PhantomTimeSerieChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PhantomTimeSerieChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *PhantomTimeSerieChange_Current) Reset() {
	*m = PhantomTimeSerieChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PhantomTimeSerieChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *PhantomTimeSerieChange_Removed) Reset() {
	*m = PhantomTimeSerieChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PhantomTimeSerieChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_monitoring_proto_v4_phantom_time_serie_change_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDesc = []byte{
	...
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x34, 0x2f, 0x70, 0x68, 0x61, 0x6e, 0x74, 0x6f,
	...
	0x34, 0x42, 0x1b, 0x50, 0x68, 0x61, 0x6e, 0x74, 0x6f, 0x6d, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x65,
	...
	0x73, 0x2f, 0x76, 0x34, 0x2f, 0x70, 0x68, 0x61, 0x6e, 0x74, 0x6f, 0x6d, 0x5f, 0x74, 0x69, 0x6d,
...
var (
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescData = edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDesc
)

func edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDescData
}

var edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_goTypes = []interface{}{
	(*PhantomTimeSerieChange)(nil),          // 0: ntt.monitoring.v4.PhantomTimeSerieChange
	(*PhantomTimeSerieChange_Added)(nil),    // 1: ntt.monitoring.v4.PhantomTimeSerieChange.Added
	(*PhantomTimeSerieChange_Modified)(nil), // 2: ntt.monitoring.v4.PhantomTimeSerieChange.Modified
	(*PhantomTimeSerieChange_Current)(nil),  // 3: ntt.monitoring.v4.PhantomTimeSerieChange.Current
	(*PhantomTimeSerieChange_Removed)(nil),  // 4: ntt.monitoring.v4.PhantomTimeSerieChange.Removed
	(*PhantomTimeSerie)(nil),                // 5: ntt.monitoring.v4.PhantomTimeSerie
	(*PhantomTimeSerie_FieldMask)(nil),      // 6: ntt.monitoring.v4.PhantomTimeSerie_FieldMask
}
var edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_depIdxs = []int32{
	1, // 0: ntt.monitoring.v4.PhantomTimeSerieChange.added:type_name -> ntt.monitoring.v4.PhantomTimeSerieChange.Added
	2, // 1: ntt.monitoring.v4.PhantomTimeSerieChange.modified:type_name -> ntt.monitoring.v4.PhantomTimeSerieChange.Modified
	3, // 2: ntt.monitoring.v4.PhantomTimeSerieChange.current:type_name -> ntt.monitoring.v4.PhantomTimeSerieChange.Current
	4, // 3: ntt.monitoring.v4.PhantomTimeSerieChange.removed:type_name -> ntt.monitoring.v4.PhantomTimeSerieChange.Removed
	5, // 4: ntt.monitoring.v4.PhantomTimeSerieChange.Added.phantom_time_serie:type_name -> ntt.monitoring.v4.PhantomTimeSerie
	5, // 5: ntt.monitoring.v4.PhantomTimeSerieChange.Modified.phantom_time_serie:type_name -> ntt.monitoring.v4.PhantomTimeSerie
	6, // 6: ntt.monitoring.v4.PhantomTimeSerieChange.Modified.field_mask:type_name -> ntt.monitoring.v4.PhantomTimeSerie_FieldMask
	5, // 7: ntt.monitoring.v4.PhantomTimeSerieChange.Current.phantom_time_serie:type_name -> ntt.monitoring.v4.PhantomTimeSerie
...
func init() { edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_init() }
func edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_init() {
	if edgelq_monitoring_proto_v4_phantom_time_serie_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_depIdxs,
		MessageInfos:      edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto = out.File
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_rawDesc = nil
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_goTypes = nil
	edgelq_monitoring_proto_v4_phantom_time_serie_change_proto_depIdxs = nil
}
