...
const (
	NamePattern_Project_Region = "projects/{project}/regions/{region}/phantomTimeSeries/{phantom_time_serie}"
)
...
func NewNameBuilder() *NameBuilder {
	return &NameBuilder{
		nameObj: Name{
			PhantomTimeSerieId: gotenresource.WildcardId,
...
func (b *NameBuilder) SetId(id string) *NameBuilder {
	b.nameObj.PhantomTimeSerieId = id
	return b
}
