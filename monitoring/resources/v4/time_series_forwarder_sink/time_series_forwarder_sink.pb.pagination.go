...
func (orderByFld *OrderByField) CompareWithDirection(left, right *TimeSeriesForwarderSink) int {
...
func (orderBy *OrderBy) Sort(results TimeSeriesForwarderSinkList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(TimeSeriesForwarderSinkList))
}

func (orderBy *OrderBy) InsertSorted(sorted TimeSeriesForwarderSinkList, elem *TimeSeriesForwarderSink) (TimeSeriesForwarderSinkList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(TimeSeriesForwarderSinkList), elem.(*TimeSeriesForwarderSink))
}

func (orderBy *OrderBy) Compare(left, right *TimeSeriesForwarderSink) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*TimeSeriesForwarderSink), right.(*TimeSeriesForwarderSink))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseTimeSeriesForwarderSink_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *TimeSeriesForwarderSink_FieldMask {
	fieldMask := &TimeSeriesForwarderSink_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == TimeSeriesForwarderSink_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &TimeSeriesForwarderSink_FieldTerminalPath{selector: TimeSeriesForwarderSink_FieldPathSelectorName},
