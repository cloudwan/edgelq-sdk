...
const (
	NamePattern_Project = "projects/{project}/timeSeriesForwarderSinks/{time_series_forwarder_sink}"
)
...
func NewNameBuilder() *NameBuilder {
	return &NameBuilder{
		nameObj: Name{
			TimeSeriesForwarderSinkId: gotenresource.WildcardId,
...
func (b *NameBuilder) SetId(id string) *NameBuilder {
	b.nameObj.TimeSeriesForwarderSinkId = id
	return b
}
