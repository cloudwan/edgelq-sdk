...
type GetQuery struct {
	Reference *Reference
	Mask      *TimeSeriesForwarderSink_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*TimeSeriesForwarderSink_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	TimeSeriesForwarderSinks []*TimeSeriesForwarderSink
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return TimeSeriesForwarderSinkList(qr.TimeSeriesForwarderSinks)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.TimeSeriesForwarderSinks = results.(TimeSeriesForwarderSinkList)
	} else {
		qr.TimeSeriesForwarderSinks = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*TimeSeriesForwarderSinkChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return TimeSeriesForwarderSinkChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(TimeSeriesForwarderSinkChangeList)
	} else {
		qr.Changes = nil
	}
}
