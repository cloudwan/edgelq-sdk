...
type MonitoredResourceDescriptorParentNameList []*ParentName

func (l MonitoredResourceDescriptorParentNameList) Append(name gotenresource.Name) gotenresource.ParentNameList {
	return append(l, name.(*ParentName))
}

func (l MonitoredResourceDescriptorParentNameList) AppendList(list gotenresource.ParentNameList) gotenresource.ParentNameList {
	return append(l, list.(MonitoredResourceDescriptorParentNameList)...)
}

func (l MonitoredResourceDescriptorParentNameList) Slice(first, second int) gotenresource.ParentNameList {
	if first > 0 && second > 0 {
		return l[first:second]
	} else if first > 0 {
		return l[first:]
...
func (l MonitoredResourceDescriptorParentNameList) At(idx int) gotenresource.Name {
	return l[idx]
}

func (l MonitoredResourceDescriptorParentNameList) Set(idx int, name gotenresource.Name) {
	l[idx] = name.(*ParentName)
}

func (l MonitoredResourceDescriptorParentNameList) Length() int {
	return len(l)
}

type MonitoredResourceDescriptorParentReferenceList []*ParentReference

func (l MonitoredResourceDescriptorParentReferenceList) Append(ref gotenresource.Reference) gotenresource.ParentReferenceList {
	return append(l, ref.(*ParentReference))
}

func (l MonitoredResourceDescriptorParentReferenceList) AppendList(list gotenresource.ParentReferenceList) gotenresource.ParentReferenceList {
	return append(l, list.(MonitoredResourceDescriptorParentReferenceList)...)
}

func (l MonitoredResourceDescriptorParentReferenceList) Slice(first, second int) gotenresource.ParentReferenceList {
	if first > 0 && second > 0 {
		return l[first:second]
	} else if first > 0 {
		return l[first:]
...
func (l MonitoredResourceDescriptorParentReferenceList) At(idx int) gotenresource.Reference {
	return l[idx]
}

func (l MonitoredResourceDescriptorParentReferenceList) Set(idx int, ref gotenresource.Reference) {
	l[idx] = ref.(*ParentReference)
}

func (l MonitoredResourceDescriptorParentReferenceList) Length() int {
	return len(l)
}
