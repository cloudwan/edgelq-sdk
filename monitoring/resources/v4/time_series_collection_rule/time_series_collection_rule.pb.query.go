...
type GetQuery struct {
	Reference *Reference
	Mask      *TimeSeriesCollectionRule_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*TimeSeriesCollectionRule_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	TimeSeriesCollectionRules []*TimeSeriesCollectionRule
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return TimeSeriesCollectionRuleList(qr.TimeSeriesCollectionRules)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.TimeSeriesCollectionRules = results.(TimeSeriesCollectionRuleList)
	} else {
		qr.TimeSeriesCollectionRules = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*TimeSeriesCollectionRuleChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return TimeSeriesCollectionRuleChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(TimeSeriesCollectionRuleChangeList)
	} else {
		qr.Changes = nil
	}
}
