...
func (orderByFld *OrderByField) CompareWithDirection(left, right *TimeSeriesCollectionRule) int {
...
func (orderBy *OrderBy) Sort(results TimeSeriesCollectionRuleList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(TimeSeriesCollectionRuleList))
}

func (orderBy *OrderBy) InsertSorted(sorted TimeSeriesCollectionRuleList, elem *TimeSeriesCollectionRule) (TimeSeriesCollectionRuleList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(TimeSeriesCollectionRuleList), elem.(*TimeSeriesCollectionRule))
}

func (orderBy *OrderBy) Compare(left, right *TimeSeriesCollectionRule) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*TimeSeriesCollectionRule), right.(*TimeSeriesCollectionRule))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseTimeSeriesCollectionRule_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *TimeSeriesCollectionRule_FieldMask {
	fieldMask := &TimeSeriesCollectionRule_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == TimeSeriesCollectionRule_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &TimeSeriesCollectionRule_FieldTerminalPath{selector: TimeSeriesCollectionRule_FieldPathSelectorName},
