...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AlertingCondition_FieldPathArrayOfValues: NewAlertingConditionFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAlertingConditionFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		AlertingCondition_FieldPathValue: NewAlertingConditionFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithValue(value),
	})
}
...
func (b *filterCndBuilderSpecTimeSeriesQuery) Filter() *filterCndBuilderSpecTimeSeriesQueryFilter {
...
func (b *filterCndBuilderSpecTimeSeriesQueryFilter) Eq(value *time_serie.Filter) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) Neq(value *time_serie.Filter) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) Gt(value *time_serie.Filter) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) Gte(value *time_serie.Filter) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) Lt(value *time_serie.Filter) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) Lte(value *time_serie.Filter) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) In(values []*time_serie.Filter) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AlertingCondition_FieldPathArrayOfValues: NewAlertingConditionFieldPathBuilder().Spec().TimeSeries().Query().Filter().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) NotIn(values []*time_serie.Filter) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		AlertingCondition_FieldPathArrayOfValues: NewAlertingConditionFieldPathBuilder().Spec().TimeSeries().Query().Filter().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAlertingConditionFieldPathBuilder().Spec().TimeSeries().Query().Filter().FieldPath(),
	})
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewAlertingConditionFieldPathBuilder().Spec().TimeSeries().Query().Filter().FieldPath(),
	})
}

func (b *filterCndBuilderSpecTimeSeriesQueryFilter) compare(op gotenfilter.CompareOperator, value *time_serie.Filter) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
