...
// File: edgelq/monitoring/proto/v4/alerting_condition_change.proto
// DO NOT EDIT!!!
...
func (m *AlertingConditionChange) Reset() {
	*m = AlertingConditionChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[0]
...
func (*AlertingConditionChange) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *AlertingConditionChange_Added) Reset() {
	*m = AlertingConditionChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingConditionChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *AlertingConditionChange_Modified) Reset() {
	*m = AlertingConditionChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingConditionChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *AlertingConditionChange_Current) Reset() {
	*m = AlertingConditionChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingConditionChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *AlertingConditionChange_Removed) Reset() {
	*m = AlertingConditionChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingConditionChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_monitoring_proto_v4_alerting_condition_change_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDesc = []byte{
	...
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x34, 0x2f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69,
...
var (
	edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescData = edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDesc
)

func edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDescData
}

var edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_monitoring_proto_v4_alerting_condition_change_proto_goTypes = []interface{}{
	(*AlertingConditionChange)(nil),          // 0: ntt.monitoring.v4.AlertingConditionChange
	(*AlertingConditionChange_Added)(nil),    // 1: ntt.monitoring.v4.AlertingConditionChange.Added
	(*AlertingConditionChange_Modified)(nil), // 2: ntt.monitoring.v4.AlertingConditionChange.Modified
	(*AlertingConditionChange_Current)(nil),  // 3: ntt.monitoring.v4.AlertingConditionChange.Current
	(*AlertingConditionChange_Removed)(nil),  // 4: ntt.monitoring.v4.AlertingConditionChange.Removed
	(*AlertingCondition)(nil),                // 5: ntt.monitoring.v4.AlertingCondition
	(*AlertingCondition_FieldMask)(nil),      // 6: ntt.monitoring.v4.AlertingCondition_FieldMask
}
var edgelq_monitoring_proto_v4_alerting_condition_change_proto_depIdxs = []int32{
	1, // 0: ntt.monitoring.v4.AlertingConditionChange.added:type_name -> ntt.monitoring.v4.AlertingConditionChange.Added
	2, // 1: ntt.monitoring.v4.AlertingConditionChange.modified:type_name -> ntt.monitoring.v4.AlertingConditionChange.Modified
	3, // 2: ntt.monitoring.v4.AlertingConditionChange.current:type_name -> ntt.monitoring.v4.AlertingConditionChange.Current
	4, // 3: ntt.monitoring.v4.AlertingConditionChange.removed:type_name -> ntt.monitoring.v4.AlertingConditionChange.Removed
	5, // 4: ntt.monitoring.v4.AlertingConditionChange.Added.alerting_condition:type_name -> ntt.monitoring.v4.AlertingCondition
	5, // 5: ntt.monitoring.v4.AlertingConditionChange.Modified.alerting_condition:type_name -> ntt.monitoring.v4.AlertingCondition
	6, // 6: ntt.monitoring.v4.AlertingConditionChange.Modified.field_mask:type_name -> ntt.monitoring.v4.AlertingCondition_FieldMask
	5, // 7: ntt.monitoring.v4.AlertingConditionChange.Current.alerting_condition:type_name -> ntt.monitoring.v4.AlertingCondition
...
func init() { edgelq_monitoring_proto_v4_alerting_condition_change_proto_init() }
func edgelq_monitoring_proto_v4_alerting_condition_change_proto_init() {
	if edgelq_monitoring_proto_v4_alerting_condition_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_monitoring_proto_v4_alerting_condition_change_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v4_alerting_condition_change_proto_depIdxs,
		MessageInfos:      edgelq_monitoring_proto_v4_alerting_condition_change_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v4_alerting_condition_change_proto = out.File
	edgelq_monitoring_proto_v4_alerting_condition_change_proto_rawDesc = nil
	edgelq_monitoring_proto_v4_alerting_condition_change_proto_goTypes = nil
	edgelq_monitoring_proto_v4_alerting_condition_change_proto_depIdxs = nil
}
