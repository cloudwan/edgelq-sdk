...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*RecoveryStoreShardingInfo_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return RecoveryStoreShardingInfoList(qr.RecoveryStoreShardingInfos)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.RecoveryStoreShardingInfos = results.(RecoveryStoreShardingInfoList)
	} else {
		qr.RecoveryStoreShardingInfos = nil
	}
}
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return RecoveryStoreShardingInfoChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(RecoveryStoreShardingInfoChangeList)
	} else {
		qr.Changes = nil
	}
}
