...
func (m *AlertingPolicyChange) Reset() {
	*m = AlertingPolicyChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[0]
...
func (*AlertingPolicyChange) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescGZIP(), []int{0}
}
...
type AlertingPolicyChange_Added_ struct {
	...
	// enters Query view
	Added *AlertingPolicyChange_Added `protobuf:"bytes,1,opt,name=added,proto3,oneof"`
}
type AlertingPolicyChange_Modified_ struct {
	// Modified is returned when watched document is modified
	Modified *AlertingPolicyChange_Modified `protobuf:"bytes,2,opt,name=modified,proto3,oneof"`
}
type AlertingPolicyChange_Current_ struct {
	// Current is returned in stateless watch when document enters query view or
	// is modified within.
	Current *AlertingPolicyChange_Current `protobuf:"bytes,4,opt,name=current,proto3,oneof"`
}
type AlertingPolicyChange_Removed_ struct {
	// Removed is returned when AlertingPolicy is deleted or leaves Query view
	Removed *AlertingPolicyChange_Removed `protobuf:"bytes,3,opt,name=removed,proto3,oneof"`
}
...
type AlertingPolicyChange_Added struct {
	...
	sizeCache      protoimpl.SizeCache
	unknownFields  protoimpl.UnknownFields
	AlertingPolicy *AlertingPolicy `protobuf:"bytes,1,opt,name=alerting_policy,json=alertingPolicy,proto3" json:"alerting_policy,omitempty"`
...
func (m *AlertingPolicyChange_Added) Reset() {
	*m = AlertingPolicyChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingPolicyChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescGZIP(), []int{0, 0}
}
...
type AlertingPolicyChange_Modified struct {
	...
	AlertingPolicy *AlertingPolicy `protobuf:"bytes,2,opt,name=alerting_policy,json=alertingPolicy,proto3" json:"alerting_policy,omitempty"`
	// Used when mask_changes is set, contains field paths of modified
	// properties.
	FieldMask *AlertingPolicy_FieldMask `protobuf:"bytes,3,opt,customtype=AlertingPolicy_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
func (m *AlertingPolicyChange_Modified) Reset() {
	*m = AlertingPolicyChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingPolicyChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *AlertingPolicyChange_Current) Reset() {
	*m = AlertingPolicyChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingPolicyChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *AlertingPolicyChange_Removed) Reset() {
	*m = AlertingPolicyChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlertingPolicyChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_monitoring_proto_v4_alerting_policy_change_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x34, 0x2f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f,
	...
	0x62, 0x2e, 0x76, 0x34, 0x42, 0x19, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x6f,
	...
	0x65, 0x73, 0x2f, 0x76, 0x34, 0x2f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x70,
...
var (
	edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescData = edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDesc
)

func edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDescData
}

var edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_monitoring_proto_v4_alerting_policy_change_proto_goTypes = []interface{}{
	(*AlertingPolicyChange)(nil),          // 0: ntt.monitoring.v4.AlertingPolicyChange
	(*AlertingPolicyChange_Added)(nil),    // 1: ntt.monitoring.v4.AlertingPolicyChange.Added
	(*AlertingPolicyChange_Modified)(nil), // 2: ntt.monitoring.v4.AlertingPolicyChange.Modified
	(*AlertingPolicyChange_Current)(nil),  // 3: ntt.monitoring.v4.AlertingPolicyChange.Current
	(*AlertingPolicyChange_Removed)(nil),  // 4: ntt.monitoring.v4.AlertingPolicyChange.Removed
	(*AlertingPolicy)(nil),                // 5: ntt.monitoring.v4.AlertingPolicy
	(*AlertingPolicy_FieldMask)(nil),      // 6: ntt.monitoring.v4.AlertingPolicy_FieldMask
}
var edgelq_monitoring_proto_v4_alerting_policy_change_proto_depIdxs = []int32{
	1, // 0: ntt.monitoring.v4.AlertingPolicyChange.added:type_name -> ntt.monitoring.v4.AlertingPolicyChange.Added
	2, // 1: ntt.monitoring.v4.AlertingPolicyChange.modified:type_name -> ntt.monitoring.v4.AlertingPolicyChange.Modified
	3, // 2: ntt.monitoring.v4.AlertingPolicyChange.current:type_name -> ntt.monitoring.v4.AlertingPolicyChange.Current
	4, // 3: ntt.monitoring.v4.AlertingPolicyChange.removed:type_name -> ntt.monitoring.v4.AlertingPolicyChange.Removed
	5, // 4: ntt.monitoring.v4.AlertingPolicyChange.Added.alerting_policy:type_name -> ntt.monitoring.v4.AlertingPolicy
	5, // 5: ntt.monitoring.v4.AlertingPolicyChange.Modified.alerting_policy:type_name -> ntt.monitoring.v4.AlertingPolicy
	6, // 6: ntt.monitoring.v4.AlertingPolicyChange.Modified.field_mask:type_name -> ntt.monitoring.v4.AlertingPolicy_FieldMask
	5, // 7: ntt.monitoring.v4.AlertingPolicyChange.Current.alerting_policy:type_name -> ntt.monitoring.v4.AlertingPolicy
...
func init() { edgelq_monitoring_proto_v4_alerting_policy_change_proto_init() }
func edgelq_monitoring_proto_v4_alerting_policy_change_proto_init() {
	if edgelq_monitoring_proto_v4_alerting_policy_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_monitoring_proto_v4_alerting_policy_change_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v4_alerting_policy_change_proto_depIdxs,
		MessageInfos:      edgelq_monitoring_proto_v4_alerting_policy_change_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v4_alerting_policy_change_proto = out.File
	edgelq_monitoring_proto_v4_alerting_policy_change_proto_rawDesc = nil
	edgelq_monitoring_proto_v4_alerting_policy_change_proto_goTypes = nil
	edgelq_monitoring_proto_v4_alerting_policy_change_proto_depIdxs = nil
}
