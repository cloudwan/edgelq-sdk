...
func (c *client) GetAlertingPolicy(ctx context.Context, in *GetAlertingPolicyRequest, opts ...grpc.CallOption) (*alerting_policy.AlertingPolicy, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.AlertingPolicyService/GetAlertingPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetAlertingPolicies(ctx context.Context, in *BatchGetAlertingPoliciesRequest, opts ...grpc.CallOption) (*BatchGetAlertingPoliciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.AlertingPolicyService/BatchGetAlertingPolicies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListAlertingPolicies(ctx context.Context, in *ListAlertingPoliciesRequest, opts ...grpc.CallOption) (*ListAlertingPoliciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.AlertingPolicyService/ListAlertingPolicies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchAlertingPolicy(ctx context.Context, in *WatchAlertingPolicyRequest, opts ...grpc.CallOption) (WatchAlertingPolicyClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.monitoring.v4.AlertingPolicyService/WatchAlertingPolicy", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchAlertingPolicies(ctx context.Context, in *WatchAlertingPoliciesRequest, opts ...grpc.CallOption) (WatchAlertingPoliciesClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.monitoring.v4.AlertingPolicyService/WatchAlertingPolicies", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateAlertingPolicy(ctx context.Context, in *CreateAlertingPolicyRequest, opts ...grpc.CallOption) (*alerting_policy.AlertingPolicy, error) {
	out := new(alerting_policy.AlertingPolicy)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.AlertingPolicyService/CreateAlertingPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateAlertingPolicy(ctx context.Context, in *UpdateAlertingPolicyRequest, opts ...grpc.CallOption) (*alerting_policy.AlertingPolicy, error) {
	out := new(alerting_policy.AlertingPolicy)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.AlertingPolicyService/UpdateAlertingPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteAlertingPolicy(ctx context.Context, in *DeleteAlertingPolicyRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.AlertingPolicyService/DeleteAlertingPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) SearchAlertingPolicies(ctx context.Context, in *SearchAlertingPoliciesRequest, opts ...grpc.CallOption) (*SearchAlertingPoliciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.AlertingPolicyService/SearchAlertingPolicies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
