...
type GetTimeSeriesCollectionRuleRequest struct {
	...
	FieldMask *time_series_collection_rule.TimeSeriesCollectionRule_FieldMask `protobuf:"bytes,3,opt,customtype=TimeSeriesCollectionRule_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
...
type BatchGetTimeSeriesCollectionRulesResponse struct {
	...
	TimeSeriesCollectionRules []*time_series_collection_rule.TimeSeriesCollectionRule `protobuf:"bytes,1,rep,name=time_series_collection_rules,json=timeSeriesCollectionRules,proto3" json:"time_series_collection_rules,omitempty" firestore:"timeSeriesCollectionRules"`
...
type ListTimeSeriesCollectionRulesRequest struct {
	...
	PageToken *time_series_collection_rule.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty" firestore:"pageToken"`
	// Order By -
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *time_series_collection_rule.TimeSeriesCollectionRule_FieldMask `protobuf:"bytes,6,opt,customtype=TimeSeriesCollectionRule_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
type ListTimeSeriesCollectionRulesResponse struct {
	...
	PrevPageToken *time_series_collection_rule.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty" firestore:"prevPageToken"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListTimeSeriesCollectionRulesRequest.page_token.
	NextPageToken *time_series_collection_rule.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty" firestore:"nextPageToken"`
...
type WatchTimeSeriesCollectionRuleRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *time_series_collection_rule.TimeSeriesCollectionRule_FieldMask `protobuf:"bytes,2,opt,customtype=TimeSeriesCollectionRule_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty" firestore:"view"`
}
...
type WatchTimeSeriesCollectionRulesResponse struct {
	...
	TimeSeriesCollectionRuleChanges []*time_series_collection_rule.TimeSeriesCollectionRuleChange `protobuf:"bytes,2,rep,name=time_series_collection_rule_changes,json=timeSeriesCollectionRuleChanges,proto3" json:"time_series_collection_rule_changes,omitempty" firestore:"timeSeriesCollectionRuleChanges"`
	...
	PageTokenChange *WatchTimeSeriesCollectionRulesResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty" firestore:"pageTokenChange"`
...
type CreateTimeSeriesCollectionRuleRequest struct {
	...
	TimeSeriesCollectionRule *time_series_collection_rule.TimeSeriesCollectionRule `protobuf:"bytes,2,opt,name=time_series_collection_rule,json=timeSeriesCollectionRule,proto3" json:"time_series_collection_rule,omitempty" firestore:"timeSeriesCollectionRule"`
...
type UpdateTimeSeriesCollectionRuleRequest struct {
	...
	// the mask
	UpdateMask *time_series_collection_rule.TimeSeriesCollectionRule_FieldMask `protobuf:"bytes,3,opt,customtype=TimeSeriesCollectionRule_FieldMask,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty" firestore:"updateMask"`
...
type WatchTimeSeriesCollectionRulesResponse_PageTokenChange struct {
	...
	PrevPageToken *time_series_collection_rule.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty" firestore:"prevPageToken"`
	// New token to retrieve next page of results.
	NextPageToken *time_series_collection_rule.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty" firestore:"nextPageToken"`
}
...
type CreateTimeSeriesCollectionRuleRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *time_series_collection_rule.TimeSeriesCollectionRule_FieldMask `protobuf:"bytes,2,opt,customtype=TimeSeriesCollectionRule_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
...
type UpdateTimeSeriesCollectionRuleRequest_CAS struct {
	...
	ConditionalState *time_series_collection_rule.TimeSeriesCollectionRule `protobuf:"bytes,1,opt,name=conditional_state,json=conditionalState,proto3" json:"conditional_state,omitempty" firestore:"conditionalState"`
...
type UpdateTimeSeriesCollectionRuleRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *time_series_collection_rule.TimeSeriesCollectionRule_FieldMask `protobuf:"bytes,3,opt,customtype=TimeSeriesCollectionRule_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
