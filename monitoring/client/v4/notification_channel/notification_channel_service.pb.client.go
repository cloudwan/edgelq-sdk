...
func (c *client) GetNotificationChannel(ctx context.Context, in *GetNotificationChannelRequest, opts ...grpc.CallOption) (*notification_channel.NotificationChannel, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.NotificationChannelService/GetNotificationChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetNotificationChannels(ctx context.Context, in *BatchGetNotificationChannelsRequest, opts ...grpc.CallOption) (*BatchGetNotificationChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.NotificationChannelService/BatchGetNotificationChannels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListNotificationChannels(ctx context.Context, in *ListNotificationChannelsRequest, opts ...grpc.CallOption) (*ListNotificationChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.NotificationChannelService/ListNotificationChannels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchNotificationChannel(ctx context.Context, in *WatchNotificationChannelRequest, opts ...grpc.CallOption) (WatchNotificationChannelClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.monitoring.v4.NotificationChannelService/WatchNotificationChannel", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchNotificationChannels(ctx context.Context, in *WatchNotificationChannelsRequest, opts ...grpc.CallOption) (WatchNotificationChannelsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.monitoring.v4.NotificationChannelService/WatchNotificationChannels", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateNotificationChannel(ctx context.Context, in *CreateNotificationChannelRequest, opts ...grpc.CallOption) (*notification_channel.NotificationChannel, error) {
	out := new(notification_channel.NotificationChannel)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.NotificationChannelService/CreateNotificationChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateNotificationChannel(ctx context.Context, in *UpdateNotificationChannelRequest, opts ...grpc.CallOption) (*notification_channel.NotificationChannel, error) {
	out := new(notification_channel.NotificationChannel)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.NotificationChannelService/UpdateNotificationChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteNotificationChannel(ctx context.Context, in *DeleteNotificationChannelRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.NotificationChannelService/DeleteNotificationChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) TestNotificationChannel(ctx context.Context, in *TestNotificationChannelRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.NotificationChannelService/TestNotificationChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
