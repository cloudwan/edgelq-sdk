...
type PhantomTimeSerieServiceClient interface {
	...
	DeletePhantomTimeSerie(ctx context.Context, in *DeletePhantomTimeSerieRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *client) GetPhantomTimeSerie(ctx context.Context, in *GetPhantomTimeSerieRequest, opts ...grpc.CallOption) (*phantom_time_serie.PhantomTimeSerie, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.PhantomTimeSerieService/GetPhantomTimeSerie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetPhantomTimeSeries(ctx context.Context, in *BatchGetPhantomTimeSeriesRequest, opts ...grpc.CallOption) (*BatchGetPhantomTimeSeriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.PhantomTimeSerieService/BatchGetPhantomTimeSeries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListPhantomTimeSeries(ctx context.Context, in *ListPhantomTimeSeriesRequest, opts ...grpc.CallOption) (*ListPhantomTimeSeriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.PhantomTimeSerieService/ListPhantomTimeSeries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchPhantomTimeSerie(ctx context.Context, in *WatchPhantomTimeSerieRequest, opts ...grpc.CallOption) (WatchPhantomTimeSerieClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.monitoring.v4.PhantomTimeSerieService/WatchPhantomTimeSerie", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchPhantomTimeSeries(ctx context.Context, in *WatchPhantomTimeSeriesRequest, opts ...grpc.CallOption) (WatchPhantomTimeSeriesClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.monitoring.v4.PhantomTimeSerieService/WatchPhantomTimeSeries", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreatePhantomTimeSerie(ctx context.Context, in *CreatePhantomTimeSerieRequest, opts ...grpc.CallOption) (*phantom_time_serie.PhantomTimeSerie, error) {
	out := new(phantom_time_serie.PhantomTimeSerie)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.PhantomTimeSerieService/CreatePhantomTimeSerie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdatePhantomTimeSerie(ctx context.Context, in *UpdatePhantomTimeSerieRequest, opts ...grpc.CallOption) (*phantom_time_serie.PhantomTimeSerie, error) {
	out := new(phantom_time_serie.PhantomTimeSerie)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.PhantomTimeSerieService/UpdatePhantomTimeSerie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeletePhantomTimeSerie(ctx context.Context, in *DeletePhantomTimeSerieRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ntt.monitoring.v4.PhantomTimeSerieService/DeletePhantomTimeSerie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
