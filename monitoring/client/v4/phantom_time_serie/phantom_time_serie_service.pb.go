...
type CreatePhantomTimeSerieRequest struct {
	...
	// size.
	ResponseMask *CreatePhantomTimeSerieRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type UpdatePhantomTimeSerieRequest struct {
	...
	ResponseMask *UpdatePhantomTimeSerieRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type CreatePhantomTimeSerieRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *phantom_time_serie.PhantomTimeSerie_FieldMask `protobuf:"bytes,2,opt,customtype=PhantomTimeSerie_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
...
type UpdatePhantomTimeSerieRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *phantom_time_serie.PhantomTimeSerie_FieldMask `protobuf:"bytes,3,opt,customtype=PhantomTimeSerie_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
