...
type GetRecoveryStoreShardingInfoRequest struct {
	...
	Name *recovery_store_sharding_info.Name `protobuf:"bytes,1,opt,customtype=Name,name=name,proto3" json:"name,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,3,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
func (m *GetRecoveryStoreShardingInfoRequest) Reset() {
	*m = GetRecoveryStoreShardingInfoRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[0]
...
func (*GetRecoveryStoreShardingInfoRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{0}
}
...
type BatchGetRecoveryStoreShardingInfosRequest struct {
	...
	Names []*recovery_store_sharding_info.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,3,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
...
func (m *BatchGetRecoveryStoreShardingInfosRequest) Reset() {
	*m = BatchGetRecoveryStoreShardingInfosRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchGetRecoveryStoreShardingInfosRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{1}
}
...
type BatchGetRecoveryStoreShardingInfosResponse struct {
	...
	RecoveryStoreShardingInfos []*recovery_store_sharding_info.RecoveryStoreShardingInfo `protobuf:"bytes,1,rep,name=recovery_store_sharding_infos,json=recoveryStoreShardingInfos,proto3" json:"recovery_store_sharding_infos,omitempty"`
	// list of not found RecoveryStoreShardingInfos
	Missing []*recovery_store_sharding_info.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty"`
}

func (m *BatchGetRecoveryStoreShardingInfosResponse) Reset() {
	*m = BatchGetRecoveryStoreShardingInfosResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchGetRecoveryStoreShardingInfosResponse) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{2}
}
...
type ListRecoveryStoreShardingInfosRequest struct {
	...
	Parent *recovery_store_sharding_info.ParentName `protobuf:"bytes,1,opt,customtype=ParentName,name=parent,proto3" json:"parent,omitempty"`
	...
	PageToken *recovery_store_sharding_info.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *recovery_store_sharding_info.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`
	...
	Filter *recovery_store_sharding_info.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,6,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
func (m *ListRecoveryStoreShardingInfosRequest) Reset() {
	*m = ListRecoveryStoreShardingInfosRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListRecoveryStoreShardingInfosRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{3}
}
...
type ListRecoveryStoreShardingInfosResponse struct {
	...
	PrevPageToken *recovery_store_sharding_info.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListRecoveryStoreShardingInfosRequest.page_token.
	NextPageToken *recovery_store_sharding_info.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
func (m *ListRecoveryStoreShardingInfosResponse) Reset() {
	*m = ListRecoveryStoreShardingInfosResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListRecoveryStoreShardingInfosResponse) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{4}
}
...
type WatchRecoveryStoreShardingInfoRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,2,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty"`
}
...
func (m *WatchRecoveryStoreShardingInfoRequest) Reset() {
	*m = WatchRecoveryStoreShardingInfoRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WatchRecoveryStoreShardingInfoRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{5}
}
...
type WatchRecoveryStoreShardingInfoResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *recovery_store_sharding_info.RecoveryStoreShardingInfoChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty"`
}

func (m *WatchRecoveryStoreShardingInfoResponse) Reset() {
	*m = WatchRecoveryStoreShardingInfoResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WatchRecoveryStoreShardingInfoResponse) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{6}
}
...
func (m *WatchRecoveryStoreShardingInfosRequest) Reset() {
	*m = WatchRecoveryStoreShardingInfosRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WatchRecoveryStoreShardingInfosRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{7}
}
...
type WatchRecoveryStoreShardingInfosResponse struct {
	...
	RecoveryStoreShardingInfoChanges []*recovery_store_sharding_info.RecoveryStoreShardingInfoChange `protobuf:"bytes,2,rep,name=recovery_store_sharding_info_changes,json=recoveryStoreShardingInfoChanges,proto3" json:"recovery_store_sharding_info_changes,omitempty"`
	...
	PageTokenChange *WatchRecoveryStoreShardingInfosResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty"`
...
func (m *WatchRecoveryStoreShardingInfosResponse) Reset() {
	*m = WatchRecoveryStoreShardingInfosResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WatchRecoveryStoreShardingInfosResponse) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{8}
}
...
type CreateRecoveryStoreShardingInfoRequest struct {
	...
	RecoveryStoreShardingInfo *recovery_store_sharding_info.RecoveryStoreShardingInfo `protobuf:"bytes,2,opt,name=recovery_store_sharding_info,json=recoveryStoreShardingInfo,proto3" json:"recovery_store_sharding_info,omitempty"`
	// Optional masking applied to response object to reduce message response
	// size.
	ResponseMask *CreateRecoveryStoreShardingInfoRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}

func (m *CreateRecoveryStoreShardingInfoRequest) Reset() {
	*m = CreateRecoveryStoreShardingInfoRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateRecoveryStoreShardingInfoRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{9}
}
...
func (m *CreateRecoveryStoreShardingInfoRequest) GetResponseMask() *CreateRecoveryStoreShardingInfoRequest_ResponseMask {
	if m != nil {
...
func (m *CreateRecoveryStoreShardingInfoRequest) SetResponseMask(fv *CreateRecoveryStoreShardingInfoRequest_ResponseMask) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResponseMask", "CreateRecoveryStoreShardingInfoRequest"))
	}
	m.ResponseMask = fv
}
...
type UpdateRecoveryStoreShardingInfoRequest struct {
	...
	// the mask
	UpdateMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,3,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"`
	// Conditional update applied to request if update should be executed only for
	// specific resource state. If this field is populated, then server will fetch
	// existing resource, compare with the one stored in the cas field (after
	// applying field mask) and proceed with update only and only if they match.
	// Otherwise RPC error Aborted will be returned.
	Cas *UpdateRecoveryStoreShardingInfoRequest_CAS `protobuf:"bytes,4,opt,name=cas,proto3" json:"cas,omitempty"`
	...
	ResponseMask *UpdateRecoveryStoreShardingInfoRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}

func (m *UpdateRecoveryStoreShardingInfoRequest) Reset() {
	*m = UpdateRecoveryStoreShardingInfoRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateRecoveryStoreShardingInfoRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{10}
}
...
func (m *UpdateRecoveryStoreShardingInfoRequest) GetResponseMask() *UpdateRecoveryStoreShardingInfoRequest_ResponseMask {
	if m != nil {
		return m.ResponseMask
	}
	return nil
...
func (m *UpdateRecoveryStoreShardingInfoRequest) SetResponseMask(fv *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResponseMask", "UpdateRecoveryStoreShardingInfoRequest"))
	}
	m.ResponseMask = fv
}
...
func (m *DeleteRecoveryStoreShardingInfoRequest) Reset() {
	*m = DeleteRecoveryStoreShardingInfoRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteRecoveryStoreShardingInfoRequest) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{11}
}
...
func (m *DeleteRecoveryStoreShardingInfoRequest) GetAllowMissing() bool {
	if m != nil {
		return m.AllowMissing
	}
	return false
...
func (m *DeleteRecoveryStoreShardingInfoRequest) SetAllowMissing(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "AllowMissing", "DeleteRecoveryStoreShardingInfoRequest"))
	}
	m.AllowMissing = fv
}
...
type WatchRecoveryStoreShardingInfosResponse_PageTokenChange struct {
	...
	PrevPageToken *recovery_store_sharding_info.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// New token to retrieve next page of results.
	NextPageToken *recovery_store_sharding_info.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
func (m *WatchRecoveryStoreShardingInfosResponse_PageTokenChange) Reset() {
	*m = WatchRecoveryStoreShardingInfosResponse_PageTokenChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WatchRecoveryStoreShardingInfosResponse_PageTokenChange) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{8, 0}
}
...
type CreateRecoveryStoreShardingInfoRequest_ResponseMask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// Types that are valid to be assigned to Masking:
	//	*CreateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody
	//	*CreateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask
	Masking isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking `protobuf_oneof:"masking"`
}

func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) Reset() {
	*m = CreateRecoveryStoreShardingInfoRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*CreateRecoveryStoreShardingInfoRequest_ResponseMask) ProtoMessage() {}

func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) ProtoReflect() preflect.Message {
	mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*CreateRecoveryStoreShardingInfoRequest_ResponseMask) GotenMessage() {}

// Deprecated, Use CreateRecoveryStoreShardingInfoRequest_ResponseMask.ProtoReflect.Descriptor instead.
func (*CreateRecoveryStoreShardingInfoRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{9, 0}
}

func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

type isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking interface {
	isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking()
}

type CreateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody struct {
...
type CreateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask struct {
	// If this field is populated, then resource in response will contain only
	// specific fields.
	BodyMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,2,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}

func (*CreateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody) isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking() {
}
func (*CreateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask) isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking() {
}
func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) GetMasking() isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking {
	if m != nil {
		return m.Masking
	}
	return nil
}
func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) GetSkipEntireResponseBody() bool {
	if x, ok := m.GetMasking().(*CreateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody); ok {
		return x.SkipEntireResponseBody
	}
	return false
}
func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) GetBodyMask() *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask {
	if x, ok := m.GetMasking().(*CreateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask); ok {
		return x.BodyMask
	}
	return nil
}
func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) SetMasking(ofv isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "isCreateRecoveryStoreShardingInfoRequest_ResponseMask_Masking", "CreateRecoveryStoreShardingInfoRequest_ResponseMask"))
	}
	m.Masking = ofv
}
func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) SetSkipEntireResponseBody(fv bool) {
	m.SetMasking(&CreateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody{SkipEntireResponseBody: fv})
}
func (m *CreateRecoveryStoreShardingInfoRequest_ResponseMask) SetBodyMask(fv *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask) {
	m.SetMasking(&CreateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask{BodyMask: fv})
}
...
type UpdateRecoveryStoreShardingInfoRequest_CAS struct {
	...
	ConditionalState *recovery_store_sharding_info.RecoveryStoreShardingInfo `protobuf:"bytes,1,opt,name=conditional_state,json=conditionalState,proto3" json:"conditional_state,omitempty"`
...
func (m *UpdateRecoveryStoreShardingInfoRequest_CAS) Reset() {
	*m = UpdateRecoveryStoreShardingInfoRequest_CAS{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateRecoveryStoreShardingInfoRequest_CAS) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{10, 0}
}
...
// ResponseMask allows client to reduce response message size.
type UpdateRecoveryStoreShardingInfoRequest_ResponseMask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// Types that are valid to be assigned to Masking:
	//	*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody
	//	*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_UpdatedFieldsOnly
	//	*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask
	Masking isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking `protobuf_oneof:"masking"`
}

func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) Reset() {
	*m = UpdateRecoveryStoreShardingInfoRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*UpdateRecoveryStoreShardingInfoRequest_ResponseMask) ProtoMessage() {}

func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) ProtoReflect() preflect.Message {
	mi := &edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*UpdateRecoveryStoreShardingInfoRequest_ResponseMask) GotenMessage() {}

// Deprecated, Use UpdateRecoveryStoreShardingInfoRequest_ResponseMask.ProtoReflect.Descriptor instead.
func (*UpdateRecoveryStoreShardingInfoRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP(), []int{10, 1}
}

func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

type isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking interface {
	isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking()
}

type UpdateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody struct {
	// If this flag has value true, then response will contain just empty
	// resource without any fields populated. Field body_mask is ignored if
	// set.
	SkipEntireResponseBody bool `protobuf:"varint,1,opt,name=skip_entire_response_body,json=skipEntireResponseBody,proto3,oneof"`
}
type UpdateRecoveryStoreShardingInfoRequest_ResponseMask_UpdatedFieldsOnly struct {
...
type UpdateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask struct {
	// If this field is populated, then resource in response will contain only
	// specific fields. If skip_entire_response_body is true, this field is
	// ignored.
	BodyMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,3,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}

func (*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody) isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking() {
}
func (*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_UpdatedFieldsOnly) isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking() {
}
func (*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask) isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking() {
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) GetMasking() isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking {
	if m != nil {
		return m.Masking
	}
	return nil
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) GetSkipEntireResponseBody() bool {
	if x, ok := m.GetMasking().(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody); ok {
		return x.SkipEntireResponseBody
	}
	return false
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) GetUpdatedFieldsOnly() bool {
	if x, ok := m.GetMasking().(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_UpdatedFieldsOnly); ok {
		return x.UpdatedFieldsOnly
	}
	return false
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) GetBodyMask() *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask {
	if x, ok := m.GetMasking().(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask); ok {
		return x.BodyMask
	}
	return nil
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) SetMasking(ofv isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "isUpdateRecoveryStoreShardingInfoRequest_ResponseMask_Masking", "UpdateRecoveryStoreShardingInfoRequest_ResponseMask"))
	}
	m.Masking = ofv
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) SetSkipEntireResponseBody(fv bool) {
	m.SetMasking(&UpdateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody{SkipEntireResponseBody: fv})
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) SetUpdatedFieldsOnly(fv bool) {
	m.SetMasking(&UpdateRecoveryStoreShardingInfoRequest_ResponseMask_UpdatedFieldsOnly{UpdatedFieldsOnly: fv})
}
func (m *UpdateRecoveryStoreShardingInfoRequest_ResponseMask) SetBodyMask(fv *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask) {
	m.SetMasking(&UpdateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask{BodyMask: fv})
}

var edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto preflect.FileDescriptor

var edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x4d,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x42, 0x21, 0xb2, 0xda, 0x21, 0x1d, 0x3a, 0x1b, 0x0a, 0x19, 0x52, 0x65, 0x63,
	0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69,
	0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x25,
	...
	0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x70, 0x61,
	...
	,
	...
	0x67, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x86, 0x03, 0x0a, 0x26, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64,
	0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x6f, 0x0a, 0x1d, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x6f,
	...
	,
	...
	,
	...
	0x76, 0x69, 0x65, 0x77, 0x22, 0x74, 0x0a, 0x26, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x63,
	0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69,
	0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4a,
	...
	0x67, 0x65, 0x52, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x8e, 0x05, 0x0a, 0x26, 0x57,
	...
	0x09, 0x42, 0x21, 0xb2, 0xda, 0x21, 0x1d, 0x3a, 0x1b, 0x0a, 0x19, 0x52, 0x65, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x25, 0x0a, 0x09,
	...
	,
	...
	0x69, 0x6e, 0x67, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x39, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x21, 0xb2, 0xda, 0x21, 0x1d, 0x1a, 0x1b, 0x0a,
	0x19, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68,
	0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74,
	0x65, 0x72, 0x12, 0x5c, 0x0a, 0x0a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x6d, 0x61, 0x73, 0x6b,
	...
	0x61, 0x78, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xff, 0x04, 0x0a, 0x27,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x82, 0x01, 0x0a, 0x24, 0x72, 0x65, 0x63, 0x6f,
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x6f, 0x6e,
	0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x33, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67,
	0x49, 0x6e, 0x66, 0x6f, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x20, 0x72, 0x65, 0x63, 0x6f,
	0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e,
	0x67, 0x49, 0x6e, 0x66, 0x6f, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x4a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x6f, 0x6e,
	0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x33, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68,
	0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61,
	0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	,
	...
	0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64,
	0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x0c, 0xc8, 0xd5, 0x22, 0x01, 0xca, 0xc6, 0x27,
	0x04, 0x62, 0x02, 0x08, 0x01, 0x52, 0x19, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53,
	0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x6b, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x6d, 0x61, 0x73,
	0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x46, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x6f,
	...
	0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x1a, 0xb4, 0x01,
	...
	,
	...
	0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x5e, 0x0a, 0x0b,
	...
	0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x12, 0x4f, 0x0a, 0x03,
	0x63, 0x61, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3d, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x33, 0x2e, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72,
	...
	0x6e, 0x67, 0x12, 0x6b, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x6d,
	0x61, 0x73, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x46, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x33, 0x2e, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71,
	...
	0xc8, 0x01, 0x0a, 0x03, 0x43, 0x41, 0x53, 0x12, 0x63, 0x0a, 0x11, 0x63, 0x6f, 0x6e, 0x64, 0x69,
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x5c, 0x0a, 0x0a,
	...
	0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	0x09, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x1a, 0xe6, 0x01, 0x0a, 0x0c, 0x52,
	...
	0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x5c, 0x0a, 0x09, 0x62, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x33, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x63,
	0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69,
	0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x81,
	0x01, 0x82, 0xdb, 0x21, 0x34, 0x0a, 0x19, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53,
	0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x39, 0x22, 0x37, 0x2f, 0x76, 0x33, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65,
	0x3d, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x2a, 0x2f, 0x72, 0x65, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67,
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x2f, 0x2a, 0x7d, 0x3a, 0x77, 0x61, 0x74, 0x63, 0x68, 0x8a, 0xcc,
	0x26, 0x00, 0x30, 0x01, 0x12, 0xc2, 0x02, 0x0a, 0x1f, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65,
	0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x68, 0x61, 0x72, 0x64,
	0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x12, 0x39, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d,
	...
	,
	...
	0x71, 0x2e, 0x63, 0x6f, 0x6d, 0x42, 0xa9, 0x03, 0xe8, 0xde, 0x21, 0x00, 0x82, 0xff, 0xd0, 0x02,
	0x73, 0x0a, 0x23, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x4c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x72, 0x76, 0x65, 0x72, 0x2f, 0x76, 0x33, 0x2f, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79,
	0x5f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x5f,
	0x69, 0x6e, 0x66, 0x6f, 0x8a, 0xff, 0xd0, 0x02, 0x73, 0x0a, 0x23, 0x72, 0x65, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x79, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x64, 0x69,
	0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x4c,
	...
	,
	...
	0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x73, 0x68, 0x61,
	0x72, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e,
	0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescOnce sync.Once
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescData = edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDesc
)

func edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescGZIP() []byte {
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescOnce.Do(func() {
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescData)
	})
	return edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDescData
}

var edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_goTypes = []interface{}{
	(*GetRecoveryStoreShardingInfoRequest)(nil),                              // 0: ntt.monitoring.v3.GetRecoveryStoreShardingInfoRequest
	(*BatchGetRecoveryStoreShardingInfosRequest)(nil),                        // 1: ntt.monitoring.v3.BatchGetRecoveryStoreShardingInfosRequest
	(*BatchGetRecoveryStoreShardingInfosResponse)(nil),                       // 2: ntt.monitoring.v3.BatchGetRecoveryStoreShardingInfosResponse
	(*ListRecoveryStoreShardingInfosRequest)(nil),                            // 3: ntt.monitoring.v3.ListRecoveryStoreShardingInfosRequest
	(*ListRecoveryStoreShardingInfosResponse)(nil),                           // 4: ntt.monitoring.v3.ListRecoveryStoreShardingInfosResponse
	(*WatchRecoveryStoreShardingInfoRequest)(nil),                            // 5: ntt.monitoring.v3.WatchRecoveryStoreShardingInfoRequest
	(*WatchRecoveryStoreShardingInfoResponse)(nil),                           // 6: ntt.monitoring.v3.WatchRecoveryStoreShardingInfoResponse
	(*WatchRecoveryStoreShardingInfosRequest)(nil),                           // 7: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosRequest
	(*WatchRecoveryStoreShardingInfosResponse)(nil),                          // 8: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosResponse
	(*CreateRecoveryStoreShardingInfoRequest)(nil),                           // 9: ntt.monitoring.v3.CreateRecoveryStoreShardingInfoRequest
	(*UpdateRecoveryStoreShardingInfoRequest)(nil),                           // 10: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest
	(*DeleteRecoveryStoreShardingInfoRequest)(nil),                           // 11: ntt.monitoring.v3.DeleteRecoveryStoreShardingInfoRequest
	(*WatchRecoveryStoreShardingInfosResponse_PageTokenChange)(nil),          // 12: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosResponse.PageTokenChange
	(*CreateRecoveryStoreShardingInfoRequest_ResponseMask)(nil),              // 13: ntt.monitoring.v3.CreateRecoveryStoreShardingInfoRequest.ResponseMask
	(*UpdateRecoveryStoreShardingInfoRequest_CAS)(nil),                       // 14: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.CAS
	(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask)(nil),              // 15: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.ResponseMask
	(*recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask)(nil), // 16: ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	(view.View)(0), // 17: goten.types.View
	(*recovery_store_sharding_info.RecoveryStoreShardingInfo)(nil),       // 18: ntt.monitoring.v3.RecoveryStoreShardingInfo
	(*recovery_store_sharding_info.RecoveryStoreShardingInfoChange)(nil), // 19: ntt.monitoring.v3.RecoveryStoreShardingInfoChange
	(watch_type.WatchType)(0),     // 20: goten.types.WatchType
	(*timestamppb.Timestamp)(nil), // 21: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 22: google.protobuf.Empty
}
var edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_depIdxs = []int32{
	16, // 0: ntt.monitoring.v3.GetRecoveryStoreShardingInfoRequest.field_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	17, // 1: ntt.monitoring.v3.GetRecoveryStoreShardingInfoRequest.view:type_name -> goten.types.View
	16, // 2: ntt.monitoring.v3.BatchGetRecoveryStoreShardingInfosRequest.field_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	17, // 3: ntt.monitoring.v3.BatchGetRecoveryStoreShardingInfosRequest.view:type_name -> goten.types.View
	18, // 4: ntt.monitoring.v3.BatchGetRecoveryStoreShardingInfosResponse.recovery_store_sharding_infos:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	16, // 5: ntt.monitoring.v3.ListRecoveryStoreShardingInfosRequest.field_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	17, // 6: ntt.monitoring.v3.ListRecoveryStoreShardingInfosRequest.view:type_name -> goten.types.View
	18, // 7: ntt.monitoring.v3.ListRecoveryStoreShardingInfosResponse.recovery_store_sharding_infos:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	16, // 8: ntt.monitoring.v3.WatchRecoveryStoreShardingInfoRequest.field_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	17, // 9: ntt.monitoring.v3.WatchRecoveryStoreShardingInfoRequest.view:type_name -> goten.types.View
	19, // 10: ntt.monitoring.v3.WatchRecoveryStoreShardingInfoResponse.change:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfoChange
	20, // 11: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosRequest.type:type_name -> goten.types.WatchType
	21, // 12: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosRequest.starting_time:type_name -> google.protobuf.Timestamp
	16, // 13: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosRequest.field_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	17, // 14: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosRequest.view:type_name -> goten.types.View
	19, // 15: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosResponse.recovery_store_sharding_info_changes:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfoChange
	12, // 16: ntt.monitoring.v3.WatchRecoveryStoreShardingInfosResponse.page_token_change:type_name -> ntt.monitoring.v3.WatchRecoveryStoreShardingInfosResponse.PageTokenChange
	18, // 17: ntt.monitoring.v3.CreateRecoveryStoreShardingInfoRequest.recovery_store_sharding_info:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	13, // 18: ntt.monitoring.v3.CreateRecoveryStoreShardingInfoRequest.response_mask:type_name -> ntt.monitoring.v3.CreateRecoveryStoreShardingInfoRequest.ResponseMask
	18, // 19: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.recovery_store_sharding_info:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	16, // 20: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.update_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	14, // 21: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.cas:type_name -> ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.CAS
	15, // 22: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.response_mask:type_name -> ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.ResponseMask
	16, // 23: ntt.monitoring.v3.CreateRecoveryStoreShardingInfoRequest.ResponseMask.body_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	18, // 24: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.CAS.conditional_state:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	16, // 25: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.CAS.field_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	16, // 26: ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest.ResponseMask.body_mask:type_name -> ntt.monitoring.v3.RecoveryStoreShardingInfo_FieldMask
	0,  // 27: ntt.monitoring.v3.RecoveryStoreShardingInfoService.GetRecoveryStoreShardingInfo:input_type -> ntt.monitoring.v3.GetRecoveryStoreShardingInfoRequest
	1,  // 28: ntt.monitoring.v3.RecoveryStoreShardingInfoService.BatchGetRecoveryStoreShardingInfos:input_type -> ntt.monitoring.v3.BatchGetRecoveryStoreShardingInfosRequest
	3,  // 29: ntt.monitoring.v3.RecoveryStoreShardingInfoService.ListRecoveryStoreShardingInfos:input_type -> ntt.monitoring.v3.ListRecoveryStoreShardingInfosRequest
	5,  // 30: ntt.monitoring.v3.RecoveryStoreShardingInfoService.WatchRecoveryStoreShardingInfo:input_type -> ntt.monitoring.v3.WatchRecoveryStoreShardingInfoRequest
	7,  // 31: ntt.monitoring.v3.RecoveryStoreShardingInfoService.WatchRecoveryStoreShardingInfos:input_type -> ntt.monitoring.v3.WatchRecoveryStoreShardingInfosRequest
	9,  // 32: ntt.monitoring.v3.RecoveryStoreShardingInfoService.CreateRecoveryStoreShardingInfo:input_type -> ntt.monitoring.v3.CreateRecoveryStoreShardingInfoRequest
	10, // 33: ntt.monitoring.v3.RecoveryStoreShardingInfoService.UpdateRecoveryStoreShardingInfo:input_type -> ntt.monitoring.v3.UpdateRecoveryStoreShardingInfoRequest
	11, // 34: ntt.monitoring.v3.RecoveryStoreShardingInfoService.DeleteRecoveryStoreShardingInfo:input_type -> ntt.monitoring.v3.DeleteRecoveryStoreShardingInfoRequest
	18, // 35: ntt.monitoring.v3.RecoveryStoreShardingInfoService.GetRecoveryStoreShardingInfo:output_type -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	2,  // 36: ntt.monitoring.v3.RecoveryStoreShardingInfoService.BatchGetRecoveryStoreShardingInfos:output_type -> ntt.monitoring.v3.BatchGetRecoveryStoreShardingInfosResponse
	4,  // 37: ntt.monitoring.v3.RecoveryStoreShardingInfoService.ListRecoveryStoreShardingInfos:output_type -> ntt.monitoring.v3.ListRecoveryStoreShardingInfosResponse
	6,  // 38: ntt.monitoring.v3.RecoveryStoreShardingInfoService.WatchRecoveryStoreShardingInfo:output_type -> ntt.monitoring.v3.WatchRecoveryStoreShardingInfoResponse
	8,  // 39: ntt.monitoring.v3.RecoveryStoreShardingInfoService.WatchRecoveryStoreShardingInfos:output_type -> ntt.monitoring.v3.WatchRecoveryStoreShardingInfosResponse
	18, // 40: ntt.monitoring.v3.RecoveryStoreShardingInfoService.CreateRecoveryStoreShardingInfo:output_type -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	18, // 41: ntt.monitoring.v3.RecoveryStoreShardingInfoService.UpdateRecoveryStoreShardingInfo:output_type -> ntt.monitoring.v3.RecoveryStoreShardingInfo
	22, // 42: ntt.monitoring.v3.RecoveryStoreShardingInfoService.DeleteRecoveryStoreShardingInfo:output_type -> google.protobuf.Empty
...
func init() { edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_init() }
func edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_init() {
	if edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateRecoveryStoreShardingInfoRequest_ResponseMask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*CreateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody)(nil),
		(*CreateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask)(nil),
	}
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes[15].OneofWrappers = []interface{}{
		(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_SkipEntireResponseBody)(nil),
		(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_UpdatedFieldsOnly)(nil),
		(*UpdateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_goTypes,
		DependencyIndexes: edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_depIdxs,
		MessageInfos:      edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_msgTypes,
	}.Build()
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto = out.File
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_rawDesc = nil
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_goTypes = nil
	edgelq_monitoring_proto_v3_recovery_store_sharding_info_service_proto_depIdxs = nil
}
