...
type CreateRecoveryStoreShardingInfoRequest struct {
	...
	// size.
	ResponseMask *CreateRecoveryStoreShardingInfoRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type UpdateRecoveryStoreShardingInfoRequest struct {
	...
	ResponseMask *UpdateRecoveryStoreShardingInfoRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type CreateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,2,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
...
type UpdateRecoveryStoreShardingInfoRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *recovery_store_sharding_info.RecoveryStoreShardingInfo_FieldMask `protobuf:"bytes,3,opt,customtype=RecoveryStoreShardingInfo_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
