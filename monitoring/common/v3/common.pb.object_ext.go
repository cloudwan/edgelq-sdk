...
func (o *Aggregation) Clone() *Aggregation {
	...
	result := &Aggregation{}
	result.AlignmentPeriod = proto.Clone(o.AlignmentPeriod).(*duration.Duration)
...
func (o *Aggregation) Merge(source *Aggregation) {
	if source.GetAlignmentPeriod() != nil {
		if o.AlignmentPeriod == nil {
			o.AlignmentPeriod = new(duration.Duration)
		}
...
func (o *MonitoredResourceMetadata) MakeFullFieldMask() *MonitoredResourceMetadata_FieldMask {
	return FullMonitoredResourceMetadata_FieldMask()
}
...
func (o *MonitoredResourceMetadata) MakeDiffFieldMask(other *MonitoredResourceMetadata) *MonitoredResourceMetadata_FieldMask {
	if o == nil && other == nil {
		return &MonitoredResourceMetadata_FieldMask{}
	}
	if o == nil || other == nil {
		return FullMonitoredResourceMetadata_FieldMask()
	}
	...
	if len(o.GetUserLabels()) == len(other.GetUserLabels()) {
		for i, lValue := range o.GetUserLabels() {
			rValue := other.GetUserLabels()[i]
			if lValue != rValue {
...
func (o *MonitoredResourceMetadata) MakeRawDiffFieldMask(other gotenobject.GotenObjectExt) gotenobject.FieldMask {
	return o.MakeDiffFieldMask(other.(*MonitoredResourceMetadata))
}

func (o *MonitoredResourceMetadata) Clone() *MonitoredResourceMetadata {
	if o == nil {
		return nil
	}
	result := &MonitoredResourceMetadata{}
	result.UserLabels = map[string]string{}
	for key, sourceValue := range o.UserLabels {
		result.UserLabels[key] = sourceValue
	}
	return result
}

func (o *MonitoredResourceMetadata) CloneRaw() gotenobject.GotenObjectExt {
	return o.Clone()
}

func (o *MonitoredResourceMetadata) Merge(source *MonitoredResourceMetadata) {
	if source.GetUserLabels() != nil {
		if o.UserLabels == nil {
			o.UserLabels = make(map[string]string, len(source.GetUserLabels()))
		}
		for key, sourceValue := range source.GetUserLabels() {
			o.UserLabels[key] = sourceValue
		}
	}
}

func (o *MonitoredResourceMetadata) MergeRaw(source gotenobject.GotenObjectExt) {
	o.Merge(source.(*MonitoredResourceMetadata))
}
