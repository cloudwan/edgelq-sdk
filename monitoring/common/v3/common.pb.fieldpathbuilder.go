...
func (s TimeRangePathSelectorStartTime) WithValue(value *timestamp.Timestamp) *TimeRange_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*TimeRange_FieldTerminalPathValue)
}

func (s TimeRangePathSelectorStartTime) WithArrayOfValues(values []*timestamp.Timestamp) *TimeRange_FieldTerminalPathArrayOfValues {
...
func (s TimeRangePathSelectorEndTime) WithValue(value *timestamp.Timestamp) *TimeRange_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*TimeRange_FieldTerminalPathValue)
}

func (s TimeRangePathSelectorEndTime) WithArrayOfValues(values []*timestamp.Timestamp) *TimeRange_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*TimeRange_FieldTerminalPathArrayOfValues)
}
...
func (s AggregationPathSelectorAlignmentPeriod) WithValue(value *duration.Duration) *Aggregation_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Aggregation_FieldTerminalPathValue)
}

func (s AggregationPathSelectorAlignmentPeriod) WithArrayOfValues(values []*duration.Duration) *Aggregation_FieldTerminalPathArrayOfValues {
...
func NewMonitoredResourceMetadataFieldPathBuilder() MonitoredResourceMetadataFieldPathBuilder {
	return MonitoredResourceMetadataFieldPathBuilder{}
}
func (MonitoredResourceMetadataFieldPathBuilder) UserLabels() MonitoredResourceMetadataPathSelectorUserLabels {
	return MonitoredResourceMetadataPathSelectorUserLabels{}
}

type MonitoredResourceMetadataPathSelectorUserLabels struct{}

func (MonitoredResourceMetadataPathSelectorUserLabels) FieldPath() *MonitoredResourceMetadata_FieldTerminalPath {
	return &MonitoredResourceMetadata_FieldTerminalPath{selector: MonitoredResourceMetadata_FieldPathSelectorUserLabels}
}

func (s MonitoredResourceMetadataPathSelectorUserLabels) WithValue(value map[string]string) *MonitoredResourceMetadata_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*MonitoredResourceMetadata_FieldTerminalPathValue)
}

func (s MonitoredResourceMetadataPathSelectorUserLabels) WithArrayOfValues(values []map[string]string) *MonitoredResourceMetadata_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*MonitoredResourceMetadata_FieldTerminalPathArrayOfValues)
}

func (MonitoredResourceMetadataPathSelectorUserLabels) WithKey(key string) MonitoredResourceMetadataMapPathSelectorUserLabels {
	return MonitoredResourceMetadataMapPathSelectorUserLabels{key: key}
}
...
func (s MonitoredResourceMetadataMapPathSelectorUserLabels) FieldPath() *MonitoredResourceMetadata_FieldPathMap {
	return &MonitoredResourceMetadata_FieldPathMap{selector: MonitoredResourceMetadata_FieldPathSelectorUserLabels, key: s.key}
}

func (s MonitoredResourceMetadataMapPathSelectorUserLabels) WithValue(value string) *MonitoredResourceMetadata_FieldPathMapValue {
	return s.FieldPath().WithIValue(value).(*MonitoredResourceMetadata_FieldPathMapValue)
}

func (s MonitoredResourceMetadataMapPathSelectorUserLabels) WithArrayOfValues(values []string) *MonitoredResourceMetadata_FieldPathMapArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*MonitoredResourceMetadata_FieldPathMapArrayOfValues)
}
