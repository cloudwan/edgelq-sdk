...
type GetSimCardStockRequest struct {
	...
	FieldMask *sim_card_stock.SimCardStock_FieldMask `protobuf:"bytes,3,opt,customtype=SimCardStock_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
...
type BatchGetSimCardStocksRequest struct {
	...
	Names []*sim_card_stock.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty" firestore:"names"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *sim_card_stock.SimCardStock_FieldMask `protobuf:"bytes,3,opt,customtype=SimCardStock_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
	// View defines list of standard response fields present in response items.
...
type BatchGetSimCardStocksResponse struct {
	...
	unknownFields protoimpl.UnknownFields
	// found SimCardStocks
	SimCardStocks []*sim_card_stock.SimCardStock `protobuf:"bytes,1,rep,name=sim_card_stocks,json=simCardStocks,proto3" json:"sim_card_stocks,omitempty" firestore:"simCardStocks"`
	// list of not found SimCardStocks
	Missing []*sim_card_stock.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty" firestore:"missing"`
}
...
type ListSimCardStocksRequest struct {
	...
	PageToken *sim_card_stock.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty" firestore:"pageToken"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *sim_card_stock.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty" firestore:"orderBy"`
	...
	Filter *sim_card_stock.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty" firestore:"filter"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *sim_card_stock.SimCardStock_FieldMask `protobuf:"bytes,6,opt,customtype=SimCardStock_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
type ListSimCardStocksResponse struct {
	...
	PrevPageToken *sim_card_stock.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty" firestore:"prevPageToken"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListSimCardStocksRequest.page_token.
	NextPageToken *sim_card_stock.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty" firestore:"nextPageToken"`
...
type WatchSimCardStockRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *sim_card_stock.SimCardStock_FieldMask `protobuf:"bytes,2,opt,customtype=SimCardStock_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty" firestore:"view"`
}
...
type WatchSimCardStockResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *sim_card_stock.SimCardStockChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty" firestore:"change"`
}
...
type WatchSimCardStocksResponse struct {
	...
	SimCardStockChanges []*sim_card_stock.SimCardStockChange `protobuf:"bytes,2,rep,name=sim_card_stock_changes,json=simCardStockChanges,proto3" json:"sim_card_stock_changes,omitempty" firestore:"simCardStockChanges"`
	...
	PageTokenChange *WatchSimCardStocksResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty" firestore:"pageTokenChange"`
...
type CreateSimCardStockRequest struct {
	...
	SimCardStock *sim_card_stock.SimCardStock `protobuf:"bytes,2,opt,name=sim_card_stock,json=simCardStock,proto3" json:"sim_card_stock,omitempty" firestore:"simCardStock"`
	// Optional masking applied to response object to reduce message response
	// size.
	ResponseMask *CreateSimCardStockRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type UpdateSimCardStockRequest struct {
	...
	// the mask
	UpdateMask *sim_card_stock.SimCardStock_FieldMask `protobuf:"bytes,3,opt,customtype=SimCardStock_FieldMask,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty" firestore:"updateMask"`
	// Conditional update applied to request if update should be executed only for
	// specific resource state. If this field is populated, then server will fetch
	// existing resource, compare with the one stored in the cas field (after
	// applying field mask) and proceed with update only and only if they match.
	// Otherwise RPC error Aborted will be returned.
	Cas *UpdateSimCardStockRequest_CAS `protobuf:"bytes,4,opt,name=cas,proto3" json:"cas,omitempty" firestore:"cas"`
	...
	ResponseMask *UpdateSimCardStockRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type WatchSimCardStocksResponse_PageTokenChange struct {
	...
	PrevPageToken *sim_card_stock.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty" firestore:"prevPageToken"`
	// New token to retrieve next page of results.
	NextPageToken *sim_card_stock.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty" firestore:"nextPageToken"`
}
...
type CreateSimCardStockRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *sim_card_stock.SimCardStock_FieldMask `protobuf:"bytes,2,opt,customtype=SimCardStock_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
...
type UpdateSimCardStockRequest_CAS struct {
	...
	ConditionalState *sim_card_stock.SimCardStock `protobuf:"bytes,1,opt,name=conditional_state,json=conditionalState,proto3" json:"conditional_state,omitempty" firestore:"conditionalState"`
...
type UpdateSimCardStockRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *sim_card_stock.SimCardStock_FieldMask `protobuf:"bytes,3,opt,customtype=SimCardStock_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
...
var edgelq_cellular_api_proto_v1_sim_card_stock_service_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x5f, 0x82, 0xdb, 0x21, 0x22, 0x0a, 0x0c,
	0x53, 0x69, 0x6d, 0x43, 0x61, 0x72, 0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x0a, 0x64, 0x65,
	0x61, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x65, 0x2a, 0x06, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0xa2, 0xdc, 0x21, 0x02, 0x10, 0x02, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x27, 0x22, 0x25, 0x2f, 0x76,
	0x31, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x3d, 0x73, 0x69, 0x6d, 0x43, 0x61, 0x72, 0x64, 0x53,
	0x74, 0x6f, 0x63, 0x6b, 0x73, 0x2f, 0x2a, 0x7d, 0x3a, 0x64, 0x65, 0x61, 0x6c, 0x6c, 0x6f, 0x63,
	0x61, 0x74, 0x65, 0x8a, 0xcc, 0x26, 0x02, 0x10, 0x01, 0x1a, 0x34, 0xca, 0x41, 0x17, 0x63, 0x65,
	...
	,
	...
	0x63, 0x6b, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x63, 0x65, 0x6c, 0x6c,
	0x75, 0x6c, 0x61, 0x72, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x42, 0x18,
	0x53, 0x69, 0x6d, 0x43, 0x61, 0x72, 0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x53, 0x65, 0x72, 0x76,
	...
	0x61, 0x70, 0x69, 0x2f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x69,
	0x6d, 0x5f, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x3b, 0x73, 0x69, 0x6d,
	0x5f, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x5f, 0x63, 0x6c, 0x69, 0x65,
