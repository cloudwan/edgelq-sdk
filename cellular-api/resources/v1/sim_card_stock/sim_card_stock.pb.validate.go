...
func (obj *SimCardStock) GotenValidate() error {
	if obj == nil {
		return nil
	}
	if subobj, ok := interface{}(obj.Metadata).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("SimCardStock", "metadata", obj.Metadata, "nested object validation failed", err)
		}
	}
