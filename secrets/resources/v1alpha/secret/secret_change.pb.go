...
// File: edgelq/secrets/proto/v1alpha/secret_change.proto
// DO NOT EDIT!!!
...
func (m *SecretChange) Reset() {
	*m = SecretChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[0]
...
func (m *SecretChange_Added) Reset() {
	*m = SecretChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *SecretChange_Modified) Reset() {
	*m = SecretChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *SecretChange_Current) Reset() {
	*m = SecretChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *SecretChange_Removed) Reset() {
	*m = SecretChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
var edgelq_secrets_proto_v1alpha_secret_change_proto preflect.FileDescriptor

var edgelq_secrets_proto_v1alpha_secret_change_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x13, 0x6e, 0x74, 0x74, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x2e,
	...
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc1, 0x06, 0x0a, 0x0c, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x43,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x3f, 0x0a, 0x05, 0x61, 0x64, 0x64, 0x65, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65,
	...
	0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x73,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x53,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x4d, 0x6f, 0x64, 0x69,
	...
	0x0b, 0x32, 0x29, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x43, 0x68,
	...
	,
	...
	0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x33, 0x0a, 0x06,
	...
	0x68, 0x61, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65,
	0x74, 0x12, 0x49, 0x0a, 0x0a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x18,
	...
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x33, 0x0a, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74,
	...
	0x72, 0x65, 0x74, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x1a, 0x4c, 0x0a, 0x07, 0x52,
	...
	0x63, 0x72, 0x65, 0x74, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x76, 0x69,
	...
	0x06, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0xfa, 0xde, 0x21, 0x0e, 0x0a, 0x0c, 0x53, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x63, 0x68, 0x61,
	...
	0x61, 0x42, 0x11, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50,
	...
	0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x73, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x3b, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	edgelq_secrets_proto_v1alpha_secret_change_proto_rawDescOnce sync.Once
	edgelq_secrets_proto_v1alpha_secret_change_proto_rawDescData = edgelq_secrets_proto_v1alpha_secret_change_proto_rawDesc
)

func edgelq_secrets_proto_v1alpha_secret_change_proto_rawDescGZIP() []byte {
	edgelq_secrets_proto_v1alpha_secret_change_proto_rawDescOnce.Do(func() {
		edgelq_secrets_proto_v1alpha_secret_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_secrets_proto_v1alpha_secret_change_proto_rawDescData)
	})
	return edgelq_secrets_proto_v1alpha_secret_change_proto_rawDescData
}

var edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_secrets_proto_v1alpha_secret_change_proto_goTypes = []interface{}{
	(*SecretChange)(nil),          // 0: ntt.secrets.v1alpha.SecretChange
	(*SecretChange_Added)(nil),    // 1: ntt.secrets.v1alpha.SecretChange.Added
	(*SecretChange_Modified)(nil), // 2: ntt.secrets.v1alpha.SecretChange.Modified
	(*SecretChange_Current)(nil),  // 3: ntt.secrets.v1alpha.SecretChange.Current
	(*SecretChange_Removed)(nil),  // 4: ntt.secrets.v1alpha.SecretChange.Removed
	(*Secret)(nil),                // 5: ntt.secrets.v1alpha.Secret
	(*Secret_FieldMask)(nil),      // 6: ntt.secrets.v1alpha.Secret_FieldMask
}
var edgelq_secrets_proto_v1alpha_secret_change_proto_depIdxs = []int32{
	1, // 0: ntt.secrets.v1alpha.SecretChange.added:type_name -> ntt.secrets.v1alpha.SecretChange.Added
	2, // 1: ntt.secrets.v1alpha.SecretChange.modified:type_name -> ntt.secrets.v1alpha.SecretChange.Modified
	3, // 2: ntt.secrets.v1alpha.SecretChange.current:type_name -> ntt.secrets.v1alpha.SecretChange.Current
	4, // 3: ntt.secrets.v1alpha.SecretChange.removed:type_name -> ntt.secrets.v1alpha.SecretChange.Removed
	5, // 4: ntt.secrets.v1alpha.SecretChange.Added.secret:type_name -> ntt.secrets.v1alpha.Secret
	5, // 5: ntt.secrets.v1alpha.SecretChange.Modified.secret:type_name -> ntt.secrets.v1alpha.Secret
	6, // 6: ntt.secrets.v1alpha.SecretChange.Modified.field_mask:type_name -> ntt.secrets.v1alpha.Secret_FieldMask
	5, // 7: ntt.secrets.v1alpha.SecretChange.Current.secret:type_name -> ntt.secrets.v1alpha.Secret
...
func init() { edgelq_secrets_proto_v1alpha_secret_change_proto_init() }
func edgelq_secrets_proto_v1alpha_secret_change_proto_init() {
	if edgelq_secrets_proto_v1alpha_secret_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_secrets_proto_v1alpha_secret_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_secrets_proto_v1alpha_secret_change_proto_goTypes,
		DependencyIndexes: edgelq_secrets_proto_v1alpha_secret_change_proto_depIdxs,
		MessageInfos:      edgelq_secrets_proto_v1alpha_secret_change_proto_msgTypes,
	}.Build()
	edgelq_secrets_proto_v1alpha_secret_change_proto = out.File
	edgelq_secrets_proto_v1alpha_secret_change_proto_rawDesc = nil
	edgelq_secrets_proto_v1alpha_secret_change_proto_goTypes = nil
	edgelq_secrets_proto_v1alpha_secret_change_proto_depIdxs = nil
}
