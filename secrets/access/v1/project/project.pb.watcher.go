...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(project.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Name) gotenaccess.WatcherFilterParams {
