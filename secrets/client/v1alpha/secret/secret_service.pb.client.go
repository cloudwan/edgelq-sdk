...
func (c *client) GetSecret(ctx context.Context, in *GetSecretRequest, opts ...grpc.CallOption) (*secret.Secret, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.secrets.v1alpha.SecretService/GetSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetSecrets(ctx context.Context, in *BatchGetSecretsRequest, opts ...grpc.CallOption) (*BatchGetSecretsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.secrets.v1alpha.SecretService/BatchGetSecrets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListSecrets(ctx context.Context, in *ListSecretsRequest, opts ...grpc.CallOption) (*ListSecretsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.secrets.v1alpha.SecretService/ListSecrets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchSecret(ctx context.Context, in *WatchSecretRequest, opts ...grpc.CallOption) (WatchSecretClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.secrets.v1alpha.SecretService/WatchSecret", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchSecrets(ctx context.Context, in *WatchSecretsRequest, opts ...grpc.CallOption) (WatchSecretsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.secrets.v1alpha.SecretService/WatchSecrets", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateSecret(ctx context.Context, in *CreateSecretRequest, opts ...grpc.CallOption) (*secret.Secret, error) {
	out := new(secret.Secret)
	err := c.cc.Invoke(ctx, "/ntt.secrets.v1alpha.SecretService/CreateSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateSecret(ctx context.Context, in *UpdateSecretRequest, opts ...grpc.CallOption) (*secret.Secret, error) {
	out := new(secret.Secret)
	err := c.cc.Invoke(ctx, "/ntt.secrets.v1alpha.SecretService/UpdateSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteSecret(ctx context.Context, in *DeleteSecretRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.secrets.v1alpha.SecretService/DeleteSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
