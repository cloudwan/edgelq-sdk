...
type ConnectorAuthErrorCode int32

const (
	ConnectorAuthErrorCode_CONNECTOR_AUTH_ERROR_CODE_UNSPECIFIED ConnectorAuthErrorCode = 0
	// No connector OAuth token is available for this user.
	ConnectorAuthErrorCode_CONNECTOR_AUTH_ERROR_CODE_REQUIRED ConnectorAuthErrorCode = 1
	// Token exists but is expired and cannot be automatically refreshed.
	ConnectorAuthErrorCode_CONNECTOR_AUTH_ERROR_CODE_EXPIRED ConnectorAuthErrorCode = 2
	// Refresh attempt failed (e.g. provider returned invalid_grant/401).
	ConnectorAuthErrorCode_CONNECTOR_AUTH_ERROR_CODE_REFRESH_FAILED ConnectorAuthErrorCode = 3
	...
	ConnectorAuthErrorCode_CONNECTOR_AUTH_ERROR_CODE_DOWNSTREAM_CONSENT_REQUIRED ConnectorAuthErrorCode = 4
)

var (
	ConnectorAuthErrorCode_name = map[int32]string{
		0: "CONNECTOR_AUTH_ERROR_CODE_UNSPECIFIED",
		1: "CONNECTOR_AUTH_ERROR_CODE_REQUIRED",
		2: "CONNECTOR_AUTH_ERROR_CODE_EXPIRED",
		3: "CONNECTOR_AUTH_ERROR_CODE_REFRESH_FAILED",
		4: "CONNECTOR_AUTH_ERROR_CODE_DOWNSTREAM_CONSENT_REQUIRED",
	}

	ConnectorAuthErrorCode_value = map[string]int32{
...
func (x ConnectorAuthErrorCode) Enum() *ConnectorAuthErrorCode {
	p := new(ConnectorAuthErrorCode)
	*p = x
	return p
}

func (x ConnectorAuthErrorCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), preflect.EnumNumber(x))
}

func (ConnectorAuthErrorCode) Descriptor() preflect.EnumDescriptor {
	return edgelq_ai_proto_v1_common_proto_enumTypes[4].Descriptor()
}

func (ConnectorAuthErrorCode) Type() preflect.EnumType {
	return &edgelq_ai_proto_v1_common_proto_enumTypes[4]
}

func (x ConnectorAuthErrorCode) Number() preflect.EnumNumber {
	return preflect.EnumNumber(x)
}

// Deprecated, Use ConnectorAuthErrorCode.ProtoReflect.Descriptor instead.
func (ConnectorAuthErrorCode) EnumDescriptor() ([]byte, []int) {
...
func (InternalToolSource_Type) Descriptor() preflect.EnumDescriptor {
	return edgelq_ai_proto_v1_common_proto_enumTypes[5].Descriptor()
}

func (InternalToolSource_Type) Type() preflect.EnumType {
	return &edgelq_ai_proto_v1_common_proto_enumTypes[5]
}
...
type ConnectorAuthError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Code      ConnectorAuthErrorCode `protobuf:"varint,2,opt,name=code,proto3,enum=ntt.ai.v1.ConnectorAuthErrorCode" json:"code,omitempty"`
}

func (m *ConnectorAuthError) Reset() {
	*m = ConnectorAuthError{}
	if protoimpl.UnsafeEnabled {
...
func (m *ConnectorAuthError) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*ConnectorAuthError) ProtoMessage() {}

func (m *ConnectorAuthError) ProtoReflect() preflect.Message {
	mi := &edgelq_ai_proto_v1_common_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*ConnectorAuthError) GotenMessage() {}

// Deprecated, Use ConnectorAuthError.ProtoReflect.Descriptor instead.
func (*ConnectorAuthError) Descriptor() ([]byte, []int) {
	return edgelq_ai_proto_v1_common_proto_rawDescGZIP(), []int{24}
}

func (m *ConnectorAuthError) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *ConnectorAuthError) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *ConnectorAuthError) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *ConnectorAuthError) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

func (m *ConnectorAuthError) GetConnector() string {
	if m != nil {
		return m.Connector
	}
	return ""
...
func (m *ConnectorAuthError) GetCode() ConnectorAuthErrorCode {
	if m != nil {
		return m.Code
	}
	return ConnectorAuthErrorCode_CONNECTOR_AUTH_ERROR_CODE_UNSPECIFIED
}

func (m *ConnectorAuthError) SetConnector(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Connector", "ConnectorAuthError"))
	}
	m.Connector = fv
}

func (m *ConnectorAuthError) SetCode(fv ConnectorAuthErrorCode) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Code", "ConnectorAuthError"))
	}
	m.Code = fv
}
...
var edgelq_ai_proto_v1_common_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
...
var edgelq_ai_proto_v1_common_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var edgelq_ai_proto_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var edgelq_ai_proto_v1_common_proto_goTypes = []interface{}{
	...
	(ConnectorAuthErrorCode)(0),  // 4: ntt.ai.v1.ConnectorAuthErrorCode
	(InternalToolSource_Type)(0), // 5: ntt.ai.v1.InternalToolSource_Type
	(*Message)(nil),              // 6: ntt.ai.v1.Message
	(*ContentPart)(nil),          // 7: ntt.ai.v1.ContentPart
	(*TextContent)(nil),          // 8: ntt.ai.v1.TextContent
	(*ImageContent)(nil),         // 9: ntt.ai.v1.ImageContent
	(*AudioContent)(nil),         // 10: ntt.ai.v1.AudioContent
	(*FileContent)(nil),          // 11: ntt.ai.v1.FileContent
	(*ThinkingContent)(nil),      // 12: ntt.ai.v1.ThinkingContent
	(*TokenUsage)(nil),           // 13: ntt.ai.v1.TokenUsage
	(*InputTokenBreakdown)(nil),  // 14: ntt.ai.v1.InputTokenBreakdown
	(*OutputTokenBreakdown)(nil), // 15: ntt.ai.v1.OutputTokenBreakdown
	(*TokenUsageMetadata)(nil),   // 16: ntt.ai.v1.TokenUsageMetadata
	(*Payload)(nil),              // 17: ntt.ai.v1.Payload
	(*ToolDefinition)(nil),       // 18: ntt.ai.v1.ToolDefinition
	(*ToolCall)(nil),             // 19: ntt.ai.v1.ToolCall
	(*ToolResponse)(nil),         // 20: ntt.ai.v1.ToolResponse
	(*ToolCalls)(nil),            // 21: ntt.ai.v1.ToolCalls
	(*ClientToolSource)(nil),     // 22: ntt.ai.v1.ClientToolSource
	(*ConnectorToolSource)(nil),  // 23: ntt.ai.v1.ConnectorToolSource
	(*InternalToolSource)(nil),   // 24: ntt.ai.v1.InternalToolSource
	(*Citation)(nil),             // 25: ntt.ai.v1.Citation
	(*CitationSource)(nil),       // 26: ntt.ai.v1.CitationSource
	(*CharacterRange)(nil),       // 27: ntt.ai.v1.CharacterRange
	(*PageReference)(nil),        // 28: ntt.ai.v1.PageReference
	(*URLReference)(nil),         // 29: ntt.ai.v1.URLReference
	(*ConnectorAuthError)(nil),   // 30: ntt.ai.v1.ConnectorAuthError
	(*ConnectorsList)(nil),       // 31: ntt.ai.v1.ConnectorsList
	(*ToolInfo)(nil),             // 32: ntt.ai.v1.ToolInfo
	(*ModelCapabilities)(nil),    // 33: ntt.ai.v1.ModelCapabilities
	(*ResumeConfig)(nil),         // 34: ntt.ai.v1.ResumeConfig
	nil,                          // 35: ntt.ai.v1.CitationSource.MetadataEntry
	(*money.Money)(nil),          // 36: google.type.Money
}
var edgelq_ai_proto_v1_common_proto_depIdxs = []int32{
	7,  // 0: ntt.ai.v1.Message.parts:type_name -> ntt.ai.v1.ContentPart
	8,  // 1: ntt.ai.v1.ContentPart.text:type_name -> ntt.ai.v1.TextContent
	9,  // 2: ntt.ai.v1.ContentPart.image:type_name -> ntt.ai.v1.ImageContent
	10, // 3: ntt.ai.v1.ContentPart.audio:type_name -> ntt.ai.v1.AudioContent
	11, // 4: ntt.ai.v1.ContentPart.file:type_name -> ntt.ai.v1.FileContent
	19, // 5: ntt.ai.v1.ContentPart.tool_call:type_name -> ntt.ai.v1.ToolCall
	20, // 6: ntt.ai.v1.ContentPart.tool_result:type_name -> ntt.ai.v1.ToolResponse
	12, // 7: ntt.ai.v1.ContentPart.thinking:type_name -> ntt.ai.v1.ThinkingContent
	14, // 8: ntt.ai.v1.TokenUsage.input_breakdown:type_name -> ntt.ai.v1.InputTokenBreakdown
	15, // 9: ntt.ai.v1.TokenUsage.output_breakdown:type_name -> ntt.ai.v1.OutputTokenBreakdown
	16, // 10: ntt.ai.v1.TokenUsage.metadata:type_name -> ntt.ai.v1.TokenUsageMetadata
	36, // 11: ntt.ai.v1.TokenUsage.input_cost:type_name -> google.type.Money
	36, // 12: ntt.ai.v1.TokenUsage.cached_input_cost:type_name -> google.type.Money
	36, // 13: ntt.ai.v1.TokenUsage.cache_write_five_min_cost:type_name -> google.type.Money
	36, // 14: ntt.ai.v1.TokenUsage.cache_write_one_hour_cost:type_name -> google.type.Money
	36, // 15: ntt.ai.v1.TokenUsage.output_cost:type_name -> google.type.Money
	36, // 16: ntt.ai.v1.TokenUsage.total_cost:type_name -> google.type.Money
	17, // 17: ntt.ai.v1.ToolResponse.output:type_name -> ntt.ai.v1.Payload
	19, // 18: ntt.ai.v1.ToolCalls.calls:type_name -> ntt.ai.v1.ToolCall
	5,  // 19: ntt.ai.v1.InternalToolSource.type:type_name -> ntt.ai.v1.InternalToolSource_Type
	26, // 20: ntt.ai.v1.Citation.source:type_name -> ntt.ai.v1.CitationSource
	27, // 21: ntt.ai.v1.CitationSource.char_range:type_name -> ntt.ai.v1.CharacterRange
	28, // 22: ntt.ai.v1.CitationSource.page:type_name -> ntt.ai.v1.PageReference
	29, // 23: ntt.ai.v1.CitationSource.url:type_name -> ntt.ai.v1.URLReference
	35, // 24: ntt.ai.v1.CitationSource.metadata:type_name -> ntt.ai.v1.CitationSource.MetadataEntry
	4,  // 25: ntt.ai.v1.ConnectorAuthError.code:type_name -> ntt.ai.v1.ConnectorAuthErrorCode
	22, // 26: ntt.ai.v1.ToolInfo.client:type_name -> ntt.ai.v1.ClientToolSource
	23, // 27: ntt.ai.v1.ToolInfo.connector:type_name -> ntt.ai.v1.ConnectorToolSource
	24, // 28: ntt.ai.v1.ToolInfo.internal:type_name -> ntt.ai.v1.InternalToolSource
	6,  // 29: ntt.ai.v1.ResumeConfig.replace_message:type_name -> ntt.ai.v1.Message
...
func edgelq_ai_proto_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		edgelq_ai_proto_v1_common_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConnectorAuthError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	edgelq_ai_proto_v1_common_proto_msgTypes[26].OneofWrappers = []interface{}{
		(*ToolInfo_Client)(nil),
