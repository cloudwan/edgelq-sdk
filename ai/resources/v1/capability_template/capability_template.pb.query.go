...
type GetQuery struct {
	Reference *Reference
	Mask      *CapabilityTemplate_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*CapabilityTemplate_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return CapabilityTemplateList(qr.CapabilityTemplates)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.CapabilityTemplates = results.(CapabilityTemplateList)
	} else {
		qr.CapabilityTemplates = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*CapabilityTemplateChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return CapabilityTemplateChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(CapabilityTemplateChangeList)
	} else {
		qr.Changes = nil
	}
}
