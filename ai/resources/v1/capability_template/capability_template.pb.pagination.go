...
func (orderByFld *OrderByField) CompareWithDirection(left, right *CapabilityTemplate) int {
...
func (orderBy *OrderBy) Sort(results CapabilityTemplateList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(CapabilityTemplateList))
}

func (orderBy *OrderBy) InsertSorted(sorted CapabilityTemplateList, elem *CapabilityTemplate) (CapabilityTemplateList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(CapabilityTemplateList), elem.(*CapabilityTemplate))
}

func (orderBy *OrderBy) Compare(left, right *CapabilityTemplate) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*CapabilityTemplate), right.(*CapabilityTemplate))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseCapabilityTemplate_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *CapabilityTemplate_FieldMask {
	fieldMask := &CapabilityTemplate_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == CapabilityTemplate_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &CapabilityTemplate_FieldTerminalPath{selector: CapabilityTemplate_FieldPathSelectorName},
