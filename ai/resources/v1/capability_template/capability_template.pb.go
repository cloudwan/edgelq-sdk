...
const (
	...
	// Rendered text is injected into the system prompt
	// Variables looked up from CreateRequest.prompt_variables map
...
const (
	...
	InputType_TEXT                   InputType = 1
	InputType_LONG_TEXT              InputType = 2
	InputType_SELECT                 InputType = 3
	InputType_DATETIME               InputType = 4
	InputType_DATE_RANGE             InputType = 5
	InputType_DURATION               InputType = 6
	InputType_DURATION_OR_DATE_RANGE InputType = 7
	InputType_NUMBER                 InputType = 8
	InputType_RESOURCE               InputType = 9
	InputType_FILE                   InputType = 10
	InputType_BOOL                   InputType = 11
	InputType_URL                    InputType = 12
	InputType_EMAIL                  InputType = 13
)
...
func (InputType) Descriptor() preflect.EnumDescriptor {
	return edgelq_ai_proto_v1_capability_template_proto_enumTypes[2].Descriptor()
}

func (InputType) Type() preflect.EnumType {
	return &edgelq_ai_proto_v1_capability_template_proto_enumTypes[2]
}

func (x InputType) Number() preflect.EnumNumber {
	return preflect.EnumNumber(x)
}
...
type CapabilityTemplate struct {
	...
	// User prompt template library for this capability
	// Client-side only: server stores, client renders and executes
	UserPromptTemplates []*UserPromptTemplate `protobuf:"bytes,17,rep,name=user_prompt_templates,json=userPromptTemplates,proto3" json:"user_prompt_templates,omitempty"`
}
...
func (m *CapabilityTemplate) GetUserPromptTemplates() []*UserPromptTemplate {
	if m != nil {
		return m.UserPromptTemplates
	}
	return nil
}
...
func (m *CapabilityTemplate) SetUserPromptTemplates(fv []*UserPromptTemplate) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "UserPromptTemplates", "CapabilityTemplate"))
	}
	m.UserPromptTemplates = fv
}
...
// Prompt template for user-selectable prompt snippets
// These are client-side only - server stores metadata, client renders/executes
type UserPromptTemplate struct {
	...
	// Short explanation shown alongside the template picker entry
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// Tags for filtering/categorization (e.g., ["rca", "historical",
	...
	// Template variables keyed by placeholder name
	Variables map[string]*TemplateVariable `protobuf:"bytes,5,rep,name=variables,proto3" json:"variables,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *UserPromptTemplate) Reset() {
	*m = UserPromptTemplate{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_ai_proto_v1_capability_template_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *UserPromptTemplate) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*UserPromptTemplate) ProtoMessage() {}

func (m *UserPromptTemplate) ProtoReflect() preflect.Message {
	mi := &edgelq_ai_proto_v1_capability_template_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*UserPromptTemplate) GotenMessage() {}

// Deprecated, Use UserPromptTemplate.ProtoReflect.Descriptor instead.
func (*UserPromptTemplate) Descriptor() ([]byte, []int) {
	return edgelq_ai_proto_v1_capability_template_proto_rawDescGZIP(), []int{7}
}

func (m *UserPromptTemplate) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *UserPromptTemplate) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *UserPromptTemplate) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *UserPromptTemplate) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

func (m *UserPromptTemplate) GetDisplayName() string {
	if m != nil {
		return m.DisplayName
	}
	return ""
...
func (m *UserPromptTemplate) GetDescription() string {
	if m != nil {
		return m.Description
	}
	return ""
...
func (m *UserPromptTemplate) GetTags() []string {
	if m != nil {
		return m.Tags
	}
	return nil
...
func (m *UserPromptTemplate) GetTemplateText() string {
	if m != nil {
...
func (m *UserPromptTemplate) GetVariables() map[string]*TemplateVariable {
	if m != nil {
		return m.Variables
	}
	return nil
...
func (m *UserPromptTemplate) SetDisplayName(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "DisplayName", "UserPromptTemplate"))
	}
	m.DisplayName = fv
}

func (m *UserPromptTemplate) SetDescription(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Description", "UserPromptTemplate"))
	}
	m.Description = fv
}

func (m *UserPromptTemplate) SetTags(fv []string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Tags", "UserPromptTemplate"))
	}
	m.Tags = fv
}

func (m *UserPromptTemplate) SetTemplateText(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "TemplateText", "UserPromptTemplate"))
	}
	m.TemplateText = fv
}

func (m *UserPromptTemplate) SetVariables(fv map[string]*TemplateVariable) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Variables", "UserPromptTemplate"))
	}
	m.Variables = fv
}
...
type TemplateVariable struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// Form label (e.g., "Time range")
	Label string `protobuf:"bytes,1,opt,name=label,proto3" json:"label,omitempty"`
	// Placeholder/help text
	HelpText  string    `protobuf:"bytes,2,opt,name=help_text,json=helpText,proto3" json:"help_text,omitempty"`
	InputType InputType `protobuf:"varint,3,opt,name=input_type,json=inputType,proto3,enum=ntt.ai.v1.InputType" json:"input_type,omitempty"`
	// Suggested values for SELECT or DURATION inputs
	Suggestions []string `protobuf:"bytes,4,rep,name=suggestions,proto3" json:"suggestions,omitempty"`
	// Optional client-side default value
	DefaultValue string `protobuf:"bytes,5,opt,name=default_value,json=defaultValue,proto3" json:"default_value,omitempty"`
	// when input_type == RESOURCE
	ResourceType string `protobuf:"bytes,6,opt,name=resource_type,json=resourceType,proto3" json:"resource_type,omitempty"`
}

func (m *TemplateVariable) Reset() {
	*m = TemplateVariable{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_ai_proto_v1_capability_template_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *TemplateVariable) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*TemplateVariable) ProtoMessage() {}

func (m *TemplateVariable) ProtoReflect() preflect.Message {
	mi := &edgelq_ai_proto_v1_capability_template_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*TemplateVariable) GotenMessage() {}

// Deprecated, Use TemplateVariable.ProtoReflect.Descriptor instead.
func (*TemplateVariable) Descriptor() ([]byte, []int) {
	return edgelq_ai_proto_v1_capability_template_proto_rawDescGZIP(), []int{8}
}

func (m *TemplateVariable) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *TemplateVariable) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *TemplateVariable) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *TemplateVariable) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

func (m *TemplateVariable) GetLabel() string {
	if m != nil {
		return m.Label
	}
	return ""
...
func (m *TemplateVariable) GetHelpText() string {
	if m != nil {
		return m.HelpText
	}
	return ""
...
func (m *TemplateVariable) GetInputType() InputType {
	if m != nil {
		return m.InputType
	}
...
func (m *TemplateVariable) GetSuggestions() []string {
	if m != nil {
...
func (m *TemplateVariable) GetDefaultValue() string {
	if m != nil {
...
func (m *TemplateVariable) GetResourceType() string {
	if m != nil {
...
func (m *TemplateVariable) SetLabel(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Label", "TemplateVariable"))
	}
	m.Label = fv
}

func (m *TemplateVariable) SetHelpText(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "HelpText", "TemplateVariable"))
	}
	m.HelpText = fv
}

func (m *TemplateVariable) SetInputType(fv InputType) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "InputType", "TemplateVariable"))
	}
	m.InputType = fv
}

func (m *TemplateVariable) SetSuggestions(fv []string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Suggestions", "TemplateVariable"))
	}
	m.Suggestions = fv
}

func (m *TemplateVariable) SetDefaultValue(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "DefaultValue", "TemplateVariable"))
	}
	m.DefaultValue = fv
}

func (m *TemplateVariable) SetResourceType(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResourceType", "TemplateVariable"))
	}
	m.ResourceType = fv
}
...
var edgelq_ai_proto_v1_capability_template_proto_rawDesc = []byte{
	...
	0x1a, 0x2a, 0x67, 0x6f, 0x74, 0x65, 0x6e, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2d, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1f, 0x65, 0x64,
	0x67, 0x65, 0x6c, 0x71, 0x2f, 0x61, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31,
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x22, 0x65,
	...
	0x6f, 0x22, 0xd5, 0x08, 0x0a, 0x12, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x2e, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x74, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2d, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x65, 0xa2, 0x80, 0xd1, 0x02, 0x59, 0x0a, 0x1a, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x79, 0x5f, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x63,
	...
	,
...
var edgelq_ai_proto_v1_capability_template_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var edgelq_ai_proto_v1_capability_template_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var edgelq_ai_proto_v1_capability_template_proto_goTypes = []interface{}{
	...
	(InputType)(0),                    // 2: ntt.ai.v1.InputType
	(*CapabilityTemplate)(nil),        // 3: ntt.ai.v1.CapabilityTemplate
	(*PromptAppendTemplate)(nil),      // 4: ntt.ai.v1.PromptAppendTemplate
	(*RAGConfig)(nil),                 // 5: ntt.ai.v1.RAGConfig
	(*IndexingPolicy)(nil),            // 6: ntt.ai.v1.IndexingPolicy
	(*RetrievalLimits)(nil),           // 7: ntt.ai.v1.RetrievalLimits
	(*ReasoningConfig)(nil),           // 8: ntt.ai.v1.ReasoningConfig
	(*ToolSafetyConfig)(nil),          // 9: ntt.ai.v1.ToolSafetyConfig
	(*UserPromptTemplate)(nil),        // 10: ntt.ai.v1.UserPromptTemplate
	(*TemplateVariable)(nil),          // 11: ntt.ai.v1.TemplateVariable
	nil,                               // 12: ntt.ai.v1.UserPromptTemplate.VariablesEntry
	(*meta.Meta)(nil),                 // 13: goten.types.Meta
	(common_client.ReasoningLevel)(0), // 14: ntt.ai.v1.ReasoningLevel
}
var edgelq_ai_proto_v1_capability_template_proto_depIdxs = []int32{
	13, // 0: ntt.ai.v1.CapabilityTemplate.metadata:type_name -> goten.types.Meta
	5,  // 1: ntt.ai.v1.CapabilityTemplate.rag_config:type_name -> ntt.ai.v1.RAGConfig
	8,  // 2: ntt.ai.v1.CapabilityTemplate.reasoning:type_name -> ntt.ai.v1.ReasoningConfig
	4,  // 3: ntt.ai.v1.CapabilityTemplate.system_prompt_append:type_name -> ntt.ai.v1.PromptAppendTemplate
	9,  // 4: ntt.ai.v1.CapabilityTemplate.tool_safety:type_name -> ntt.ai.v1.ToolSafetyConfig
	10, // 5: ntt.ai.v1.CapabilityTemplate.user_prompt_templates:type_name -> ntt.ai.v1.UserPromptTemplate
	1,  // 6: ntt.ai.v1.PromptAppendTemplate.mode:type_name -> ntt.ai.v1.PromptVariableMode
	0,  // 7: ntt.ai.v1.PromptAppendTemplate.on_missing:type_name -> ntt.ai.v1.PromptMissingVarPolicy
	6,  // 8: ntt.ai.v1.RAGConfig.indexing_policy:type_name -> ntt.ai.v1.IndexingPolicy
	7,  // 9: ntt.ai.v1.RAGConfig.retrieval_limits:type_name -> ntt.ai.v1.RetrievalLimits
	14, // 10: ntt.ai.v1.ReasoningConfig.max_level:type_name -> ntt.ai.v1.ReasoningLevel
	14, // 11: ntt.ai.v1.ReasoningConfig.default_level:type_name -> ntt.ai.v1.ReasoningLevel
	12, // 12: ntt.ai.v1.UserPromptTemplate.variables:type_name -> ntt.ai.v1.UserPromptTemplate.VariablesEntry
	2,  // 13: ntt.ai.v1.TemplateVariable.input_type:type_name -> ntt.ai.v1.InputType
	11, // 14: ntt.ai.v1.UserPromptTemplate.VariablesEntry.value:type_name -> ntt.ai.v1.TemplateVariable
...
func edgelq_ai_proto_v1_capability_template_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		edgelq_ai_proto_v1_capability_template_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserPromptTemplate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		edgelq_ai_proto_v1_capability_template_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
