...
const (
	NamePattern_Nil     = "capabilityTemplates/{capability_template}"
	NamePattern_Project = "projects/{project}/capabilityTemplates/{capability_template}"
)
...
func NewNameBuilder() *NameBuilder {
	return &NameBuilder{
		nameObj: Name{
			CapabilityTemplateId: gotenresource.WildcardId,
...
func (b *NameBuilder) SetId(id string) *NameBuilder {
	b.nameObj.CapabilityTemplateId = id
	return b
}
