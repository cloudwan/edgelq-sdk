...
const (
	ChatModel_Anthropic_THINKING_MODE_UNSPECIFIED ChatModel_Anthropic_ThinkingMode = 0
	ChatModel_Anthropic_THINKING_MODE_EXTENDED    ChatModel_Anthropic_ThinkingMode = 1
	ChatModel_Anthropic_THINKING_MODE_ADAPTIVE    ChatModel_Anthropic_ThinkingMode = 2
)

var (
	ChatModel_Anthropic_ThinkingMode_name = map[int32]string{
		0: "THINKING_MODE_UNSPECIFIED",
		1: "THINKING_MODE_EXTENDED",
		2: "THINKING_MODE_ADAPTIVE",
	}

	ChatModel_Anthropic_ThinkingMode_value = map[string]int32{
		"THINKING_MODE_UNSPECIFIED": 0,
		"THINKING_MODE_EXTENDED":    1,
		"THINKING_MODE_ADAPTIVE":    2,
	}
)

func (x ChatModel_Anthropic_ThinkingMode) Enum() *ChatModel_Anthropic_ThinkingMode {
	p := new(ChatModel_Anthropic_ThinkingMode)
	*p = x
	return p
}

func (x ChatModel_Anthropic_ThinkingMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), preflect.EnumNumber(x))
}

func (ChatModel_Anthropic_ThinkingMode) Descriptor() preflect.EnumDescriptor {
	return edgelq_ai_proto_v1_chat_model_proto_enumTypes[0].Descriptor()
}

func (ChatModel_Anthropic_ThinkingMode) Type() preflect.EnumType {
	return &edgelq_ai_proto_v1_chat_model_proto_enumTypes[0]
}

func (x ChatModel_Anthropic_ThinkingMode) Number() preflect.EnumNumber {
	return preflect.EnumNumber(x)
}

// Deprecated, Use ChatModel_Anthropic_ThinkingMode.ProtoReflect.Descriptor instead.
func (ChatModel_Anthropic_ThinkingMode) EnumDescriptor() ([]byte, []int) {
	return edgelq_ai_proto_v1_chat_model_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
type ChatModel struct {
	...
	// When true, this model is retired: hidden from ChatModel listings by default
	// and blocked for new chats/responses. Existing conversations stay readable
	// and can be continued by selecting a non-retired model.
	Retired bool `protobuf:"varint,10,opt,name=retired,proto3" json:"retired,omitempty"`
...
func (m *ChatModel) GetRetired() bool {
	if m != nil {
		return m.Retired
	}
	return false
...
func (m *ChatModel) SetRetired(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Retired", "ChatModel"))
	}
	m.Retired = fv
}
...
type ChatModel_OpenAICompatible struct {
	...
	// Optional: route requests through proxies to an OpenAI-compatible endpoint
	// reachable from this device.
	Device *devices_device.Reference `protobuf:"bytes,8,opt,customtype=Reference,name=device,proto3" json:"device,omitempty"`
}
...
func (m *ChatModel_OpenAICompatible) GetDevice() *devices_device.Reference {
	if m != nil {
		return m.Device
	}
	return nil
...
func (m *ChatModel_OpenAICompatible) SetDevice(fv *devices_device.Reference) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Device", "ChatModel_OpenAICompatible"))
	}
	m.Device = fv
}
...
type ChatModel_Anthropic struct {
	...
	ThinkingMode    ChatModel_Anthropic_ThinkingMode `protobuf:"varint,5,opt,name=thinking_mode,json=thinkingMode,proto3,enum=ntt.ai.v1.ChatModel_Anthropic_ThinkingMode" json:"thinking_mode,omitempty"`
}
...
func (m *ChatModel_Anthropic) GetThinkingMode() ChatModel_Anthropic_ThinkingMode {
	if m != nil {
...
func (m *ChatModel_Anthropic) SetThinkingMode(fv ChatModel_Anthropic_ThinkingMode) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ThinkingMode", "ChatModel_Anthropic"))
	}
	m.ThinkingMode = fv
}
...
var edgelq_ai_proto_v1_chat_model_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa7, 0x11, 0x0a, 0x09, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x6f,
	...
	0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x43, 0x6f, 0x73, 0x74, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x12,
	0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x69, 0x72, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x72, 0x65, 0x74, 0x69, 0x72, 0x65, 0x64, 0x1a, 0xe1, 0x02, 0x0a, 0x10, 0x4f, 0x70,
	0x65, 0x6e, 0x41, 0x49, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x12, 0x3c,
	...
	0x65, 0x74, 0x10, 0x01, 0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x62, 0x61, 0x73, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x22, 0x0a,
	...
	0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x5f, 0x65, 0x6e, 0x64, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x61, 0x7a, 0x75, 0x72, 0x65,
	0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x2a, 0x0a, 0x11, 0x61, 0x7a, 0x75, 0x72,
	0x65, 0x5f, 0x61, 0x70, 0x69, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x41, 0x70, 0x69, 0x56, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x11, 0x6d, 0x61, 0x78, 0x5f, 0x6f, 0x75, 0x74, 0x70,
	...
	0x12, 0x3b, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
	...
	0x69, 0x63, 0x65, 0x10, 0x01, 0x52, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x1a, 0xdf, 0x02,
	0x0a, 0x09, 0x41, 0x6e, 0x74, 0x68, 0x72, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x3c, 0x0a, 0x07, 0x61,
	0x70, 0x69, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x23, 0xb2, 0xda,
	0x21, 0x1f, 0x12, 0x1d, 0x0a, 0x19, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x2e, 0x65, 0x64,
	0x67, 0x65, 0x6c, 0x71, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x10,
	0x01, 0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x64,
	...
	,
	...
	0x72, 0x4d, 0x69, 0x6c, 0x6c, 0x69, 0x6f, 0x6e, 0x3a, 0xe2, 0x01, 0xea, 0x41, 0x5e, 0x0a, 0x17,
	...
	0x7b, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x7d, 0x92, 0xd9, 0x21, 0x5b,
	...
	0x6a, 0x65, 0x63, 0x74, 0x38, 0x05, 0x72, 0x13, 0x0a, 0x11, 0x63, 0x68, 0x61, 0x74, 0x4d, 0x6f,
	0x64, 0x65, 0x6c, 0x73, 0x21, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0xb2, 0xdf, 0x21, 0x12, 0x12,
	0x10, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x69, 0x72, 0x65, 0x64, 0x22, 0x05, 0x6d, 0x6f, 0x6e, 0x67,
	0x6f, 0xda, 0x94, 0x23, 0x08, 0x12, 0x06, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x0a, 0x0a,
	0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x42,
	0x80, 0x02, 0xe8, 0xde, 0x21, 0x01, 0xd2, 0xff, 0xd0, 0x02, 0x45, 0x0a, 0x10, 0x63, 0x68, 0x61,
	0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x31, 0x67,
	...
	,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x68, 0x61,
	0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x3b, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x6d, 0x6f, 0x64,
...
var edgelq_ai_proto_v1_chat_model_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var edgelq_ai_proto_v1_chat_model_proto_goTypes = []interface{}{
	(ChatModel_Anthropic_ThinkingMode)(0), // 0: ntt.ai.v1.ChatModel_Anthropic_ThinkingMode
	(*ChatModel)(nil),                     // 1: ntt.ai.v1.ChatModel
	(*ChatModel_OpenAICompatible)(nil),    // 2: ntt.ai.v1.ChatModel.OpenAICompatible
	(*ChatModel_Anthropic)(nil),           // 3: ntt.ai.v1.ChatModel.Anthropic
	(*ChatModel_Gemini)(nil),              // 4: ntt.ai.v1.ChatModel.Gemini
	(*ChatModel_AzureOpenAi)(nil),         // 5: ntt.ai.v1.ChatModel.AzureOpenAi
	(*ChatModel_Cost)(nil),                // 6: ntt.ai.v1.ChatModel.Cost
	(*meta.Meta)(nil),                     // 7: goten.types.Meta
	(*money.Money)(nil),                   // 8: google.type.Money
}
var edgelq_ai_proto_v1_chat_model_proto_depIdxs = []int32{
	7,  // 0: ntt.ai.v1.ChatModel.metadata:type_name -> goten.types.Meta
	5,  // 1: ntt.ai.v1.ChatModel.azure_open_ai:type_name -> ntt.ai.v1.ChatModel.AzureOpenAi
	2,  // 2: ntt.ai.v1.ChatModel.openai_compatible:type_name -> ntt.ai.v1.ChatModel.OpenAICompatible
	3,  // 3: ntt.ai.v1.ChatModel.anthropic:type_name -> ntt.ai.v1.ChatModel.Anthropic
	4,  // 4: ntt.ai.v1.ChatModel.gemini:type_name -> ntt.ai.v1.ChatModel.Gemini
	6,  // 5: ntt.ai.v1.ChatModel.cost:type_name -> ntt.ai.v1.ChatModel.Cost
	0,  // 6: ntt.ai.v1.ChatModel.Anthropic.thinking_mode:type_name -> ntt.ai.v1.ChatModel_Anthropic_ThinkingMode
	8,  // 7: ntt.ai.v1.ChatModel.Cost.input_per_million:type_name -> google.type.Money
	8,  // 8: ntt.ai.v1.ChatModel.Cost.cached_input_per_million:type_name -> google.type.Money
	8,  // 9: ntt.ai.v1.ChatModel.Cost.cache_write_five_min_per_million:type_name -> google.type.Money
	8,  // 10: ntt.ai.v1.ChatModel.Cost.cache_write_one_hour_per_million:type_name -> google.type.Money
	8,  // 11: ntt.ai.v1.ChatModel.Cost.output_per_million:type_name -> google.type.Money
...
func edgelq_ai_proto_v1_chat_model_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         edgelq_ai_proto_v1_chat_model_proto_enumTypes,
