...
type GetQuery struct {
	Reference *Reference
	Mask      *ConnectorUserToken_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*ConnectorUserToken_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	ConnectorUserTokens []*ConnectorUserToken
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return ConnectorUserTokenList(qr.ConnectorUserTokens)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.ConnectorUserTokens = results.(ConnectorUserTokenList)
	} else {
		qr.ConnectorUserTokens = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*ConnectorUserTokenChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return ConnectorUserTokenChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(ConnectorUserTokenChangeList)
	} else {
		qr.Changes = nil
	}
}
