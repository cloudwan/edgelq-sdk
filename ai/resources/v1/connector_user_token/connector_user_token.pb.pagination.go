...
func (orderByFld *OrderByField) CompareWithDirection(left, right *ConnectorUserToken) int {
...
func (orderBy *OrderBy) Sort(results ConnectorUserTokenList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(ConnectorUserTokenList))
}

func (orderBy *OrderBy) InsertSorted(sorted ConnectorUserTokenList, elem *ConnectorUserToken) (ConnectorUserTokenList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(ConnectorUserTokenList), elem.(*ConnectorUserToken))
}

func (orderBy *OrderBy) Compare(left, right *ConnectorUserToken) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*ConnectorUserToken), right.(*ConnectorUserToken))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseConnectorUserToken_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *ConnectorUserToken_FieldMask {
	fieldMask := &ConnectorUserToken_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == ConnectorUserToken_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &ConnectorUserToken_FieldTerminalPath{selector: ConnectorUserToken_FieldPathSelectorName},
