...
func (orderByFld *OrderByField) CompareWithDirection(left, right *ConversationFeedback) int {
...
func (orderBy *OrderBy) Sort(results ConversationFeedbackList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(ConversationFeedbackList))
}

func (orderBy *OrderBy) InsertSorted(sorted ConversationFeedbackList, elem *ConversationFeedback) (ConversationFeedbackList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(ConversationFeedbackList), elem.(*ConversationFeedback))
}

func (orderBy *OrderBy) Compare(left, right *ConversationFeedback) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*ConversationFeedback), right.(*ConversationFeedback))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseConversationFeedback_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *ConversationFeedback_FieldMask {
	fieldMask := &ConversationFeedback_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == ConversationFeedback_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &ConversationFeedback_FieldTerminalPath{selector: ConversationFeedback_FieldPathSelectorName},
