...
type GetQuery struct {
	Reference *Reference
	Mask      *ConversationFeedback_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*ConversationFeedback_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return ConversationFeedbackList(qr.ConversationFeedbacks)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.ConversationFeedbacks = results.(ConversationFeedbackList)
	} else {
		qr.ConversationFeedbacks = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*ConversationFeedbackChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return ConversationFeedbackChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(ConversationFeedbackChangeList)
	} else {
		qr.Changes = nil
	}
}
