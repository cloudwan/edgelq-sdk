...
type GetQuery struct {
	Reference *Reference
	Mask      *AuditedResourceDescriptor_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*AuditedResourceDescriptor_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	AuditedResourceDescriptors []*AuditedResourceDescriptor
	PrevPageCursor             *PagerCursor
	NextPageCursor             *PagerCursor
}

func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return AuditedResourceDescriptorList(qr.AuditedResourceDescriptors)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.AuditedResourceDescriptors = results.(AuditedResourceDescriptorList)
	} else {
		qr.AuditedResourceDescriptors = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*AuditedResourceDescriptorChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return AuditedResourceDescriptorChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(AuditedResourceDescriptorChangeList)
	} else {
		qr.Changes = nil
	}
}
