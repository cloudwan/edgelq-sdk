...
func (orderByFld *OrderByField) CompareWithDirection(left, right *AuditedResourceDescriptor) int {
...
func (orderBy *OrderBy) Sort(results AuditedResourceDescriptorList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(AuditedResourceDescriptorList))
}

func (orderBy *OrderBy) InsertSorted(sorted AuditedResourceDescriptorList, elem *AuditedResourceDescriptor) (AuditedResourceDescriptorList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(AuditedResourceDescriptorList), elem.(*AuditedResourceDescriptor))
}

func (orderBy *OrderBy) Compare(left, right *AuditedResourceDescriptor) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*AuditedResourceDescriptor), right.(*AuditedResourceDescriptor))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseAuditedResourceDescriptor_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *AuditedResourceDescriptor_FieldMask {
	fieldMask := &AuditedResourceDescriptor_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == AuditedResourceDescriptor_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &AuditedResourceDescriptor_FieldTerminalPath{selector: AuditedResourceDescriptor_FieldPathSelectorName},
