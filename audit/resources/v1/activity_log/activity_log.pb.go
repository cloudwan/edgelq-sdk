...
type ActivityLog struct {
	...
	Category ActivityLog_Category `protobuf:"varint,12,opt,name=category,proto3,enum=ntt.audit.v1.ActivityLog_Category" json:"category,omitempty"`
...
type ActivityLog_Event_ClientMsgEvent struct {
	...
	// Set when "data" was dropped to keep the record within the audit
	// message-size limit. It records the original payload size; "data" keeps
	// its type but carries no body.
	OmittedPayload *common.OmittedPayload `protobuf:"bytes,3,opt,name=omitted_payload,json=omittedPayload,proto3" json:"omitted_payload,omitempty"`
}
...
func (m *ActivityLog_Event_ClientMsgEvent) GetOmittedPayload() *common.OmittedPayload {
	if m != nil {
		return m.OmittedPayload
	}
	return nil
}
...
func (m *ActivityLog_Event_ClientMsgEvent) SetOmittedPayload(fv *common.OmittedPayload) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "OmittedPayload", "ActivityLog_Event_ClientMsgEvent"))
	}
	m.OmittedPayload = fv
}
...
func (m *ActivityLog_Event_ServerMsgEvent) GetOmittedPayload() *common.OmittedPayload {
	if m != nil {
		return m.OmittedPayload
	}
	return nil
...
func (m *ActivityLog_Event_ServerMsgEvent) SetOmittedPayload(fv *common.OmittedPayload) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "OmittedPayload", "ActivityLog_Event_ServerMsgEvent"))
	}
	m.OmittedPayload = fv
}
...
type ActivityLog_Resource_Difference struct {
	...
	// Set when "before" was dropped to keep the record within the audit
	// message-size limit. "before" keeps its type but carries no body.
	BeforeOmittedPayload *common.OmittedPayload `protobuf:"bytes,4,opt,name=before_omitted_payload,json=beforeOmittedPayload,proto3" json:"before_omitted_payload,omitempty"`
	// Set when "after" was dropped to keep the record within the audit
	// message-size limit. "after" keeps its type but carries no body.
	AfterOmittedPayload *common.OmittedPayload `protobuf:"bytes,5,opt,name=after_omitted_payload,json=afterOmittedPayload,proto3" json:"after_omitted_payload,omitempty"`
}
...
func (m *ActivityLog_Resource_Difference) GetBeforeOmittedPayload() *common.OmittedPayload {
	if m != nil {
		return m.BeforeOmittedPayload
	}
	return nil
}

func (m *ActivityLog_Resource_Difference) GetAfterOmittedPayload() *common.OmittedPayload {
	if m != nil {
		return m.AfterOmittedPayload
	}
	return nil
}
...
func (m *ActivityLog_Resource_Difference) SetBeforeOmittedPayload(fv *common.OmittedPayload) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "BeforeOmittedPayload", "ActivityLog_Resource_Difference"))
	}
	m.BeforeOmittedPayload = fv
}

func (m *ActivityLog_Resource_Difference) SetAfterOmittedPayload(fv *common.OmittedPayload) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "AfterOmittedPayload", "ActivityLog_Resource_Difference"))
	}
	m.AfterOmittedPayload = fv
}
...
var edgelq_audit_proto_v1_activity_log_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x97, 0x19, 0x0a, 0x0b, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74,
	...
	0x65, 0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x1a, 0xbe, 0x09, 0x0a, 0x05,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0xb0, 0x03, 0x0a, 0x08, 0x52, 0x65,
	...
	0x69, 0x66, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x1a, 0xc0, 0x02, 0x0a, 0x0a, 0x44, 0x69,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x63, 0x74,
	0x69, 0x76, 0x69, 0x74, 0x79, 0x5f, 0x6c, 0x6f, 0x67, 0x3b, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69,
...
var edgelq_audit_proto_v1_activity_log_proto_goTypes = []interface{}{
	...
	(*common.OmittedPayload)(nil),                    // 19: ntt.audit.v1.OmittedPayload
	(*rpc.Status)(nil),                               // 20: ntt.rpc.Status
...
var edgelq_audit_proto_v1_activity_log_proto_depIdxs = []int32{
	...
	19, // 18: ntt.audit.v1.ActivityLog.Event.ClientMsgEvent.omitted_payload:type_name -> ntt.audit.v1.OmittedPayload
	17, // 19: ntt.audit.v1.ActivityLog.Event.RegionalServerMsgEvent.data:type_name -> google.protobuf.Any
	18, // 20: ntt.audit.v1.ActivityLog.Event.RegionalServerMsgEvent.time:type_name -> google.protobuf.Timestamp
	17, // 21: ntt.audit.v1.ActivityLog.Event.ServerMsgEvent.data:type_name -> google.protobuf.Any
	18, // 22: ntt.audit.v1.ActivityLog.Event.ServerMsgEvent.time:type_name -> google.protobuf.Timestamp
	19, // 23: ntt.audit.v1.ActivityLog.Event.ServerMsgEvent.omitted_payload:type_name -> ntt.audit.v1.OmittedPayload
	20, // 24: ntt.audit.v1.ActivityLog.Event.RegionalExitEvent.status:type_name -> ntt.rpc.Status
	18, // 25: ntt.audit.v1.ActivityLog.Event.RegionalExitEvent.time:type_name -> google.protobuf.Timestamp
	20, // 26: ntt.audit.v1.ActivityLog.Event.ExitEvent.status:type_name -> ntt.rpc.Status
	18, // 27: ntt.audit.v1.ActivityLog.Event.ExitEvent.time:type_name -> google.protobuf.Timestamp
	21, // 28: ntt.audit.v1.ActivityLog.Resource.Difference.fields:type_name -> google.protobuf.FieldMask
	17, // 29: ntt.audit.v1.ActivityLog.Resource.Difference.before:type_name -> google.protobuf.Any
	17, // 30: ntt.audit.v1.ActivityLog.Resource.Difference.after:type_name -> google.protobuf.Any
	19, // 31: ntt.audit.v1.ActivityLog.Resource.Difference.before_omitted_payload:type_name -> ntt.audit.v1.OmittedPayload
	19, // 32: ntt.audit.v1.ActivityLog.Resource.Difference.after_omitted_payload:type_name -> ntt.audit.v1.OmittedPayload
