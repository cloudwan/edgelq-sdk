...
func (ResourceChangeLog_ResourceChange_Action) Descriptor() preflect.EnumDescriptor {
	return edgelq_audit_proto_v1_resource_change_log_proto_enumTypes[0].Descriptor()
}

func (ResourceChangeLog_ResourceChange_Action) Type() preflect.EnumType {
	return &edgelq_audit_proto_v1_resource_change_log_proto_enumTypes[0]
}
...
func (ResourceChangeLog_ResourceChange_Action) EnumDescriptor() ([]byte, []int) {
	return edgelq_audit_proto_v1_resource_change_log_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (ResourceChangeLog_TransactionInfo_State) Descriptor() preflect.EnumDescriptor {
	return edgelq_audit_proto_v1_resource_change_log_proto_enumTypes[1].Descriptor()
}

func (ResourceChangeLog_TransactionInfo_State) Type() preflect.EnumType {
	return &edgelq_audit_proto_v1_resource_change_log_proto_enumTypes[1]
}
...
func (ResourceChangeLog_TransactionInfo_State) EnumDescriptor() ([]byte, []int) {
	return edgelq_audit_proto_v1_resource_change_log_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
func (m *ResourceChangeLog) Reset() {
	*m = ResourceChangeLog{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_audit_proto_v1_resource_change_log_proto_msgTypes[0]
...
func (*ResourceChangeLog) Descriptor() ([]byte, []int) {
	return edgelq_audit_proto_v1_resource_change_log_proto_rawDescGZIP(), []int{0}
}
...
type ResourceChangeLog_ResourceChange struct {
	...
	Action ResourceChangeLog_ResourceChange_Action `protobuf:"varint,3,opt,name=action,proto3,enum=ntt.audit.v1.ResourceChangeLog_ResourceChange_Action" json:"action,omitempty"`
	...
	// Set when "previous" was dropped to keep the record within the audit
	// message-size limit. "previous" keeps its type but carries no body.
	PreviousOmittedPayload *common.OmittedPayload `protobuf:"bytes,10,opt,name=previous_omitted_payload,json=previousOmittedPayload,proto3" json:"previous_omitted_payload,omitempty"`
	// Set when "current" was dropped to keep the record within the audit
	// message-size limit. "current" keeps its type but carries no body.
	CurrentOmittedPayload *common.OmittedPayload `protobuf:"bytes,11,opt,name=current_omitted_payload,json=currentOmittedPayload,proto3" json:"current_omitted_payload,omitempty"`
...
func (m *ResourceChangeLog_ResourceChange) Reset() {
	*m = ResourceChangeLog_ResourceChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_audit_proto_v1_resource_change_log_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResourceChangeLog_ResourceChange) Descriptor() ([]byte, []int) {
	return edgelq_audit_proto_v1_resource_change_log_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *ResourceChangeLog_ResourceChange) GetPreviousOmittedPayload() *common.OmittedPayload {
	if m != nil {
		return m.PreviousOmittedPayload
	}
	return nil
}

func (m *ResourceChangeLog_ResourceChange) GetCurrentOmittedPayload() *common.OmittedPayload {
	if m != nil {
		return m.CurrentOmittedPayload
	}
	return nil
}
...
func (m *ResourceChangeLog_ResourceChange) SetPreviousOmittedPayload(fv *common.OmittedPayload) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "PreviousOmittedPayload", "ResourceChangeLog_ResourceChange"))
	}
	m.PreviousOmittedPayload = fv
}

func (m *ResourceChangeLog_ResourceChange) SetCurrentOmittedPayload(fv *common.OmittedPayload) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "CurrentOmittedPayload", "ResourceChangeLog_ResourceChange"))
	}
	m.CurrentOmittedPayload = fv
}
...
type ResourceChangeLog_TransactionInfo struct {
	...
	// State of the transaction.
	State ResourceChangeLog_TransactionInfo_State `protobuf:"varint,3,opt,name=state,proto3,enum=ntt.audit.v1.ResourceChangeLog_TransactionInfo_State" json:"state,omitempty"`
}

func (m *ResourceChangeLog_TransactionInfo) Reset() {
	*m = ResourceChangeLog_TransactionInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_audit_proto_v1_resource_change_log_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResourceChangeLog_TransactionInfo) Descriptor() ([]byte, []int) {
	return edgelq_audit_proto_v1_resource_change_log_proto_rawDescGZIP(), []int{0, 1}
}
...
var edgelq_audit_proto_v1_resource_change_log_proto preflect.FileDescriptor

var edgelq_audit_proto_v1_resource_change_log_proto_rawDesc = []byte{
	...
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf1, 0x0e,
	0x0a, 0x11, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	0x4c, 0x6f, 0x67, 0x12, 0x2d, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x19, 0xb2, 0xda, 0x21, 0x15, 0x0a, 0x13, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x4c, 0x6f, 0x67, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x71, 0x75,
	...
	,
	...
	,
	...
	0x54, 0x45, 0x10, 0x03, 0x12, 0x0f, 0x0a, 0x0b, 0x53, 0x50, 0x45, 0x43, 0x5f, 0x55, 0x50, 0x44,
	0x41, 0x54, 0x45, 0x10, 0x04, 0x12, 0x10, 0x0a, 0x0c, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x55,
	0x50, 0x44, 0x41, 0x54, 0x45, 0x10, 0x05, 0x12, 0x0f, 0x0a, 0x0b, 0x4d, 0x45, 0x54, 0x41, 0x5f,
	0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x10, 0x06, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x50, 0x44, 0x41,
	0x54, 0x45, 0x10, 0x02, 0x1a, 0xea, 0x01, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x72, 0x79, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74,
	0x72, 0x79, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x4b, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x35, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x61,
	0x75, 0x64, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	,
	...
	,
	...
	0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x6c, 0x6f, 0x67, 0x3b, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x6c, 0x6f, 0x67, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_audit_proto_v1_resource_change_log_proto_rawDescOnce sync.Once
	edgelq_audit_proto_v1_resource_change_log_proto_rawDescData = edgelq_audit_proto_v1_resource_change_log_proto_rawDesc
)

func edgelq_audit_proto_v1_resource_change_log_proto_rawDescGZIP() []byte {
	edgelq_audit_proto_v1_resource_change_log_proto_rawDescOnce.Do(func() {
		edgelq_audit_proto_v1_resource_change_log_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_audit_proto_v1_resource_change_log_proto_rawDescData)
	})
	return edgelq_audit_proto_v1_resource_change_log_proto_rawDescData
}

var edgelq_audit_proto_v1_resource_change_log_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var edgelq_audit_proto_v1_resource_change_log_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var edgelq_audit_proto_v1_resource_change_log_proto_goTypes = []interface{}{
	(ResourceChangeLog_ResourceChange_Action)(0), // 0: ntt.audit.v1.ResourceChangeLog_ResourceChange_Action
	(ResourceChangeLog_TransactionInfo_State)(0), // 1: ntt.audit.v1.ResourceChangeLog_TransactionInfo_State
	(*ResourceChangeLog)(nil),                    // 2: ntt.audit.v1.ResourceChangeLog
	(*ResourceChangeLog_ResourceChange)(nil),     // 3: ntt.audit.v1.ResourceChangeLog.ResourceChange
	(*ResourceChangeLog_TransactionInfo)(nil),    // 4: ntt.audit.v1.ResourceChangeLog.TransactionInfo
	nil,                           // 5: ntt.audit.v1.ResourceChangeLog.ResourceChange.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
	(*common.Authentication)(nil), // 7: ntt.audit.v1.Authentication
	(*common.ServiceData)(nil),    // 8: ntt.audit.v1.ServiceData
	(*fieldmaskpb.FieldMask)(nil), // 9: google.protobuf.FieldMask
	(*anypb.Any)(nil),             // 10: google.protobuf.Any
	(*common.OmittedPayload)(nil), // 11: ntt.audit.v1.OmittedPayload
	(*common.ObjectState)(nil),    // 12: ntt.audit.v1.ObjectState
}
var edgelq_audit_proto_v1_resource_change_log_proto_depIdxs = []int32{
	6,  // 0: ntt.audit.v1.ResourceChangeLog.timestamp:type_name -> google.protobuf.Timestamp
	7,  // 1: ntt.audit.v1.ResourceChangeLog.authentication:type_name -> ntt.audit.v1.Authentication
	8,  // 2: ntt.audit.v1.ResourceChangeLog.service:type_name -> ntt.audit.v1.ServiceData
	3,  // 3: ntt.audit.v1.ResourceChangeLog.resource:type_name -> ntt.audit.v1.ResourceChangeLog.ResourceChange
	4,  // 4: ntt.audit.v1.ResourceChangeLog.transaction:type_name -> ntt.audit.v1.ResourceChangeLog.TransactionInfo
	0,  // 5: ntt.audit.v1.ResourceChangeLog.ResourceChange.action:type_name -> ntt.audit.v1.ResourceChangeLog_ResourceChange_Action
	9,  // 6: ntt.audit.v1.ResourceChangeLog.ResourceChange.updated_fields:type_name -> google.protobuf.FieldMask
	10, // 7: ntt.audit.v1.ResourceChangeLog.ResourceChange.previous:type_name -> google.protobuf.Any
	10, // 8: ntt.audit.v1.ResourceChangeLog.ResourceChange.current:type_name -> google.protobuf.Any
	11, // 9: ntt.audit.v1.ResourceChangeLog.ResourceChange.previous_omitted_payload:type_name -> ntt.audit.v1.OmittedPayload
	11, // 10: ntt.audit.v1.ResourceChangeLog.ResourceChange.current_omitted_payload:type_name -> ntt.audit.v1.OmittedPayload
	5,  // 11: ntt.audit.v1.ResourceChangeLog.ResourceChange.labels:type_name -> ntt.audit.v1.ResourceChangeLog.ResourceChange.LabelsEntry
	12, // 12: ntt.audit.v1.ResourceChangeLog.ResourceChange.pre:type_name -> ntt.audit.v1.ObjectState
	12, // 13: ntt.audit.v1.ResourceChangeLog.ResourceChange.post:type_name -> ntt.audit.v1.ObjectState
	1,  // 14: ntt.audit.v1.ResourceChangeLog.TransactionInfo.state:type_name -> ntt.audit.v1.ResourceChangeLog_TransactionInfo_State
...
func init() { edgelq_audit_proto_v1_resource_change_log_proto_init() }
func edgelq_audit_proto_v1_resource_change_log_proto_init() {
	if edgelq_audit_proto_v1_resource_change_log_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_audit_proto_v1_resource_change_log_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_audit_proto_v1_resource_change_log_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_audit_proto_v1_resource_change_log_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_audit_proto_v1_resource_change_log_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_audit_proto_v1_resource_change_log_proto_goTypes,
		DependencyIndexes: edgelq_audit_proto_v1_resource_change_log_proto_depIdxs,
		EnumInfos:         edgelq_audit_proto_v1_resource_change_log_proto_enumTypes,
		MessageInfos:      edgelq_audit_proto_v1_resource_change_log_proto_msgTypes,
	}.Build()
	edgelq_audit_proto_v1_resource_change_log_proto = out.File
	edgelq_audit_proto_v1_resource_change_log_proto_rawDesc = nil
	edgelq_audit_proto_v1_resource_change_log_proto_goTypes = nil
	edgelq_audit_proto_v1_resource_change_log_proto_depIdxs = nil
}
