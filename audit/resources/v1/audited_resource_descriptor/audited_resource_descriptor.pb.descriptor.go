...
func (r *AuditedResourceDescriptor) EnsureMetadata() *meta.Meta {
	if r.Metadata == nil {
...
func (d *Descriptor) NewParentNameList(size, reserved int) gotenresource.ParentNameList {
	return make(AuditedResourceDescriptorParentNameList, size, reserved)
}

func (d *Descriptor) NewParentReferenceList(size, reserved int) gotenresource.ParentReferenceList {
	return make(AuditedResourceDescriptorParentReferenceList, size, reserved)
}
...
func initAuditedResourceDescriptorDescriptor() {
	descriptor = &Descriptor{
		typeName: gotenresource.NewTypeName(
			"AuditedResourceDescriptor", "AuditedResourceDescriptors", "audit.edgelq.com", "v1"),
