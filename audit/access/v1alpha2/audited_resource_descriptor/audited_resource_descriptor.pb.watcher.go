...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(audited_resource_descriptor.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Reference) gotenaccess.WatcherFilterParams {
