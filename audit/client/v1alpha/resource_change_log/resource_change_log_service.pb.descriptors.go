...
func (d *ListResourceChangeLogsDescriptor) GetFullMethodName() string {
	return "/ntt.audit.v1alpha.ResourceChangeLogService/ListResourceChangeLogs"
}
...
func (d *CreatePreCommittedResourceChangeLogsDescriptor) GetFullMethodName() string {
	return "/ntt.audit.v1alpha.ResourceChangeLogService/CreatePreCommittedResourceChangeLogs"
}
...
func (d *SetResourceChangeLogsCommitStateDescriptor) GetFullMethodName() string {
	return "/ntt.audit.v1alpha.ResourceChangeLogService/SetResourceChangeLogsCommitState"
}
...
func (d *ResourceChangeLogServiceDescriptor) GetFullAPIName() string {
	return "/ntt.audit.v1alpha.ResourceChangeLogService"
}
