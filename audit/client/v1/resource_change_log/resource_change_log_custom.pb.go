...
type SetResourceChangeLogsCommitStateRequest struct {
	...
	TxResult resource_change_log.ResourceChangeLog_TransactionInfo_State `protobuf:"varint,3,opt,name=tx_result,json=txResult,proto3,enum=ntt.audit.v1.ResourceChangeLog_TransactionInfo_State" json:"tx_result,omitempty" firestore:"txResult"`
}
