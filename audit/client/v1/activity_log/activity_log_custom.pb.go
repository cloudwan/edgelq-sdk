...
type ListActivityLogsRequest struct {
	...
	Parents []*activity_log.ParentName `protobuf:"bytes,1,rep,customtype=ParentName,name=parents,proto3" json:"parents,omitempty"`
	// A audit filter that specifies which activity logs should be returned
	Filter *activity_log.Filter `protobuf:"bytes,2,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
...
type ListActivityLogsResponse struct {
	...
	ActivityLogs []*activity_log.ActivityLog `protobuf:"bytes,1,rep,name=activity_logs,json=activityLogs,proto3" json:"activity_logs,omitempty"`
...
type CreateActivityLogsRequest struct {
	...
	ActivityLogs []*activity_log.ActivityLog `protobuf:"bytes,1,rep,name=activity_logs,json=activityLogs,proto3" json:"activity_logs,omitempty"`
	// When set, the response returns per-entry results (created_log_names +
	// failed) and the server drops only failing entries instead of failing the
	// whole batch. Opt-in for new exporters; unset preserves the legacy
	// all-or-nothing behavior.
	ReturnPerEntryResults bool `protobuf:"varint,2,opt,name=return_per_entry_results,json=returnPerEntryResults,proto3" json:"return_per_entry_results,omitempty"`
}
...
func (m *CreateActivityLogsRequest) GetReturnPerEntryResults() bool {
	if m != nil {
		return m.ReturnPerEntryResults
	}
	return false
}
...
func (m *CreateActivityLogsRequest) SetReturnPerEntryResults(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ReturnPerEntryResults", "CreateActivityLogsRequest"))
	}
	m.ReturnPerEntryResults = fv
}
...
type CreateActivityLogsResponse struct {
	...
	// as in the request. Populated only in all-or-nothing mode
	// (return_per_entry_results unset).
	LogNames []*activity_log.Name `protobuf:"bytes,1,rep,customtype=Name,name=log_names,json=logNames,proto3" json:"log_names,omitempty"`
	// Server-assigned name per successfully created log, keyed by its position in
	// the request. Populated only when return_per_entry_results is set.
	CreatedLogNames map[uint32]string `protobuf:"bytes,2,rep,name=created_log_names,json=createdLogNames,proto3" json:"created_log_names,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Per-entry failure status, keyed by the failing log's position in the
	// request. Populated only when return_per_entry_results is set.
	Failed map[uint32]*rpc.Status `protobuf:"bytes,3,rep,name=failed,proto3" json:"failed,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *CreateActivityLogsResponse) GetCreatedLogNames() map[uint32]string {
	if m != nil {
		return m.CreatedLogNames
	}
	return nil
}

func (m *CreateActivityLogsResponse) GetFailed() map[uint32]*rpc.Status {
	if m != nil {
		return m.Failed
	}
	return nil
...
func (m *CreateActivityLogsResponse) SetCreatedLogNames(fv map[uint32]string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "CreatedLogNames", "CreateActivityLogsResponse"))
	}
	m.CreatedLogNames = fv
}

func (m *CreateActivityLogsResponse) SetFailed(fv map[uint32]*rpc.Status) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Failed", "CreateActivityLogsResponse"))
	}
	m.Failed = fv
}
...
var edgelq_audit_proto_v1_activity_log_custom_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4a, 0x0a, 0x0b, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x45, 0x6e,
	...
	0x42, 0x80, 0x01, 0xe8, 0xde, 0x21, 0x00, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74,
	0x2e, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x42, 0x16, 0x41, 0x63,
	0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x4c, 0x6f, 0x67, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x50,
	...
	0x76, 0x31, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x5f, 0x6c, 0x6f, 0x67, 0x3b,
	0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x63, 0x6c, 0x69,
...
var edgelq_audit_proto_v1_activity_log_custom_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var edgelq_audit_proto_v1_activity_log_custom_proto_goTypes = []interface{}{
	...
	nil,                              // 5: ntt.audit.v1.CreateActivityLogsResponse.CreatedLogNamesEntry
	nil,                              // 6: ntt.audit.v1.CreateActivityLogsResponse.FailedEntry
	(*common.TimeInterval)(nil),      // 7: ntt.audit.v1.TimeInterval
	(*activity_log.ActivityLog)(nil), // 8: ntt.audit.v1.ActivityLog
	(*rpc.Status)(nil),               // 9: ntt.rpc.Status
}
var edgelq_audit_proto_v1_activity_log_custom_proto_depIdxs = []int32{
	7, // 0: ntt.audit.v1.ListActivityLogsRequest.interval:type_name -> ntt.audit.v1.TimeInterval
	8, // 1: ntt.audit.v1.ListActivityLogsResponse.activity_logs:type_name -> ntt.audit.v1.ActivityLog
	9, // 2: ntt.audit.v1.ListActivityLogsResponse.execution_errors:type_name -> ntt.rpc.Status
	8, // 3: ntt.audit.v1.CreateActivityLogsRequest.activity_logs:type_name -> ntt.audit.v1.ActivityLog
	5, // 4: ntt.audit.v1.CreateActivityLogsResponse.created_log_names:type_name -> ntt.audit.v1.CreateActivityLogsResponse.CreatedLogNamesEntry
	6, // 5: ntt.audit.v1.CreateActivityLogsResponse.failed:type_name -> ntt.audit.v1.CreateActivityLogsResponse.FailedEntry
	9, // 6: ntt.audit.v1.CreateActivityLogsResponse.FailedEntry.value:type_name -> ntt.rpc.Status
