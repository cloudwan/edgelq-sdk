...
func (d *Descriptor) NewResourceList(size, reserved int) gotenresource.ResourceList {
	return make(EdgelqInstanceList, size, reserved)
}

func (d *Descriptor) NewResourceChangeList(size, reserved int) gotenresource.ResourceChangeList {
	return make(EdgelqInstanceChangeList, size, reserved)
}

func (d *Descriptor) NewNameList(size, reserved int) gotenresource.NameList {
	return make(EdgelqInstanceNameList, size, reserved)
}

func (d *Descriptor) NewReferenceList(size, reserved int) gotenresource.ReferenceList {
	return make(EdgelqInstanceReferenceList, size, reserved)
}

func (d *Descriptor) NewParentNameList(size, reserved int) gotenresource.ParentNameList {
	return make(EdgelqInstanceParentNameList, size, reserved)
}

func (d *Descriptor) NewParentReferenceList(size, reserved int) gotenresource.ParentReferenceList {
	return make(EdgelqInstanceParentReferenceList, size, reserved)
}

func (d *Descriptor) NewResourceMap(reserved int) gotenresource.ResourceMap {
	return make(EdgelqInstanceMap, reserved)
}

func (d *Descriptor) NewResourceChangeMap(reserved int) gotenresource.ResourceChangeMap {
	return make(EdgelqInstanceChangeMap, reserved)
}
...
func initEdgelqInstanceDescriptor() {
	descriptor = &Descriptor{
		typeName: gotenresource.NewTypeName(
			"EdgelqInstance", "EdgelqInstances", "ztp.edgelq.com", "v1"),
		nameDescriptor: gotenresource.NewNameDescriptor(
			&EdgelqInstance_FieldTerminalPath{selector: EdgelqInstance_FieldPathSelectorName},
			"pattern", "edgelqInstanceId",
			[]string{"projectId"},
