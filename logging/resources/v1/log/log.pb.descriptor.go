...
func initLogDescriptor() {
	descriptor = &Descriptor{
		typeName: gotenresource.NewTypeName(
			"Log", "Logs", "logging.edgelq.com", "v1"),
		nameDescriptor: gotenresource.NewNameDescriptor(
			&Log_FieldTerminalPath{selector: Log_FieldPathSelectorName},
			"pattern", "logId",
			[]string{"projectId", "organizationId", "serviceId", "regionId", "bucketId"},
			[]gotenresource.NamePattern{NamePattern_Project, NamePattern_Organization, NamePattern_Service, NamePattern_Project_Region_Bucket, NamePattern_Organization_Region_Bucket, NamePattern_Service_Region_Bucket}),
	}
