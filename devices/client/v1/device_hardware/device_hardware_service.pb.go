...
type CreateDeviceHardwareRequest struct {
	...
	// size.
	ResponseMask *CreateDeviceHardwareRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type UpdateDeviceHardwareRequest struct {
	...
	ResponseMask *UpdateDeviceHardwareRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type CreateDeviceHardwareRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,2,opt,customtype=DeviceHardware_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
...
type UpdateDeviceHardwareRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardware_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
