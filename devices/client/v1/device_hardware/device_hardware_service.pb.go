...
type GetDeviceHardwareRequest struct {
	...
	FieldMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardware_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
type BatchGetDeviceHardwaresRequest struct {
	...
	Names []*device_hardware.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardware_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
...
type BatchGetDeviceHardwaresResponse struct {
	...
	Missing []*device_hardware.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty"`
}
...
type ListDeviceHardwaresRequest struct {
	...
	Parent *device_hardware.ParentName `protobuf:"bytes,1,opt,customtype=ParentName,name=parent,proto3" json:"parent,omitempty"`
	...
	PageToken *device_hardware.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *device_hardware.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`
	...
	Filter *device_hardware.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,6,opt,customtype=DeviceHardware_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
type ListDeviceHardwaresResponse struct {
	...
	PrevPageToken *device_hardware.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListDeviceHardwaresRequest.page_token.
	NextPageToken *device_hardware.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
type WatchDeviceHardwareRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,2,opt,customtype=DeviceHardware_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty"`
}
...
type WatchDeviceHardwareResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *device_hardware.DeviceHardwareChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty"`
}
...
type WatchDeviceHardwaresResponse struct {
	...
	DeviceHardwareChanges []*device_hardware.DeviceHardwareChange `protobuf:"bytes,2,rep,name=device_hardware_changes,json=deviceHardwareChanges,proto3" json:"device_hardware_changes,omitempty"`
	...
	PageTokenChange *WatchDeviceHardwaresResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty"`
...
type CreateDeviceHardwareRequest struct {
	...
	DeviceHardware *device_hardware.DeviceHardware `protobuf:"bytes,2,opt,name=device_hardware,json=deviceHardware,proto3" json:"device_hardware,omitempty"`
	// Optional masking applied to response object to reduce message response
	// size.
	ResponseMask *CreateDeviceHardwareRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}
...
func (m *CreateDeviceHardwareRequest) GetResponseMask() *CreateDeviceHardwareRequest_ResponseMask {
	if m != nil {
...
func (m *CreateDeviceHardwareRequest) SetResponseMask(fv *CreateDeviceHardwareRequest_ResponseMask) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResponseMask", "CreateDeviceHardwareRequest"))
	}
	m.ResponseMask = fv
}
...
type UpdateDeviceHardwareRequest struct {
	...
	// the mask
	UpdateMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardware_FieldMask,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"`
	// Conditional update applied to request if update should be executed only for
	// specific resource state. If this field is populated, then server will fetch
	// existing resource, compare with the one stored in the cas field (after
	// applying field mask) and proceed with update only and only if they match.
	// Otherwise RPC error Aborted will be returned.
	Cas *UpdateDeviceHardwareRequest_CAS `protobuf:"bytes,4,opt,name=cas,proto3" json:"cas,omitempty"`
	...
	ResponseMask *UpdateDeviceHardwareRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}
...
func (m *UpdateDeviceHardwareRequest) GetResponseMask() *UpdateDeviceHardwareRequest_ResponseMask {
	if m != nil {
		return m.ResponseMask
	}
	return nil
...
func (m *UpdateDeviceHardwareRequest) SetResponseMask(fv *UpdateDeviceHardwareRequest_ResponseMask) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResponseMask", "UpdateDeviceHardwareRequest"))
	}
	m.ResponseMask = fv
}
...
func (m *DeleteDeviceHardwareRequest) GetAllowMissing() bool {
	if m != nil {
		return m.AllowMissing
	}
	return false
...
func (m *DeleteDeviceHardwareRequest) SetAllowMissing(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "AllowMissing", "DeleteDeviceHardwareRequest"))
	}
	m.AllowMissing = fv
}
...
type WatchDeviceHardwaresResponse_PageTokenChange struct {
	...
	PrevPageToken *device_hardware.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// New token to retrieve next page of results.
	NextPageToken *device_hardware.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
type CreateDeviceHardwareRequest_ResponseMask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// Types that are valid to be assigned to Masking:
	//	*CreateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody
	//	*CreateDeviceHardwareRequest_ResponseMask_BodyMask
	Masking isCreateDeviceHardwareRequest_ResponseMask_Masking `protobuf_oneof:"masking"`
}

func (m *CreateDeviceHardwareRequest_ResponseMask) Reset() {
	*m = CreateDeviceHardwareRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
...
func (m *CreateDeviceHardwareRequest_ResponseMask) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*CreateDeviceHardwareRequest_ResponseMask) ProtoMessage() {}

func (m *CreateDeviceHardwareRequest_ResponseMask) ProtoReflect() preflect.Message {
	mi := &edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*CreateDeviceHardwareRequest_ResponseMask) GotenMessage() {}

// Deprecated, Use CreateDeviceHardwareRequest_ResponseMask.ProtoReflect.Descriptor instead.
func (*CreateDeviceHardwareRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_device_hardware_service_proto_rawDescGZIP(), []int{9, 0}
}

func (m *CreateDeviceHardwareRequest_ResponseMask) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *CreateDeviceHardwareRequest_ResponseMask) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *CreateDeviceHardwareRequest_ResponseMask) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *CreateDeviceHardwareRequest_ResponseMask) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

type isCreateDeviceHardwareRequest_ResponseMask_Masking interface {
	isCreateDeviceHardwareRequest_ResponseMask_Masking()
}

type CreateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody struct {
...
type CreateDeviceHardwareRequest_ResponseMask_BodyMask struct {
	// If this field is populated, then resource in response will contain only
	// specific fields.
	BodyMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,2,opt,customtype=DeviceHardware_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}

func (*CreateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody) isCreateDeviceHardwareRequest_ResponseMask_Masking() {
}
func (*CreateDeviceHardwareRequest_ResponseMask_BodyMask) isCreateDeviceHardwareRequest_ResponseMask_Masking() {
}
func (m *CreateDeviceHardwareRequest_ResponseMask) GetMasking() isCreateDeviceHardwareRequest_ResponseMask_Masking {
	if m != nil {
		return m.Masking
	}
	return nil
}
func (m *CreateDeviceHardwareRequest_ResponseMask) GetSkipEntireResponseBody() bool {
	if x, ok := m.GetMasking().(*CreateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody); ok {
		return x.SkipEntireResponseBody
	}
	return false
}
func (m *CreateDeviceHardwareRequest_ResponseMask) GetBodyMask() *device_hardware.DeviceHardware_FieldMask {
	if x, ok := m.GetMasking().(*CreateDeviceHardwareRequest_ResponseMask_BodyMask); ok {
		return x.BodyMask
	}
	return nil
}
func (m *CreateDeviceHardwareRequest_ResponseMask) SetMasking(ofv isCreateDeviceHardwareRequest_ResponseMask_Masking) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "isCreateDeviceHardwareRequest_ResponseMask_Masking", "CreateDeviceHardwareRequest_ResponseMask"))
	}
	m.Masking = ofv
}
func (m *CreateDeviceHardwareRequest_ResponseMask) SetSkipEntireResponseBody(fv bool) {
	m.SetMasking(&CreateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody{SkipEntireResponseBody: fv})
}
func (m *CreateDeviceHardwareRequest_ResponseMask) SetBodyMask(fv *device_hardware.DeviceHardware_FieldMask) {
	m.SetMasking(&CreateDeviceHardwareRequest_ResponseMask_BodyMask{BodyMask: fv})
}
...
type UpdateDeviceHardwareRequest_CAS struct {
	...
	ConditionalState *device_hardware.DeviceHardware `protobuf:"bytes,1,opt,name=conditional_state,json=conditionalState,proto3" json:"conditional_state,omitempty"`
...
func (m *UpdateDeviceHardwareRequest_CAS) Reset() {
	*m = UpdateDeviceHardwareRequest_CAS{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
// ResponseMask allows client to reduce response message size.
type UpdateDeviceHardwareRequest_ResponseMask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// Types that are valid to be assigned to Masking:
	//	*UpdateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody
	//	*UpdateDeviceHardwareRequest_ResponseMask_UpdatedFieldsOnly
	//	*UpdateDeviceHardwareRequest_ResponseMask_BodyMask
	Masking isUpdateDeviceHardwareRequest_ResponseMask_Masking `protobuf_oneof:"masking"`
}

func (m *UpdateDeviceHardwareRequest_ResponseMask) Reset() {
	*m = UpdateDeviceHardwareRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *UpdateDeviceHardwareRequest_ResponseMask) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*UpdateDeviceHardwareRequest_ResponseMask) ProtoMessage() {}

func (m *UpdateDeviceHardwareRequest_ResponseMask) ProtoReflect() preflect.Message {
	mi := &edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*UpdateDeviceHardwareRequest_ResponseMask) GotenMessage() {}

// Deprecated, Use UpdateDeviceHardwareRequest_ResponseMask.ProtoReflect.Descriptor instead.
func (*UpdateDeviceHardwareRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_device_hardware_service_proto_rawDescGZIP(), []int{10, 1}
}

func (m *UpdateDeviceHardwareRequest_ResponseMask) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *UpdateDeviceHardwareRequest_ResponseMask) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *UpdateDeviceHardwareRequest_ResponseMask) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *UpdateDeviceHardwareRequest_ResponseMask) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

type isUpdateDeviceHardwareRequest_ResponseMask_Masking interface {
	isUpdateDeviceHardwareRequest_ResponseMask_Masking()
}

type UpdateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody struct {
	// If this flag has value true, then response will contain just empty
	// resource without any fields populated. Field body_mask is ignored if
	// set.
	SkipEntireResponseBody bool `protobuf:"varint,1,opt,name=skip_entire_response_body,json=skipEntireResponseBody,proto3,oneof"`
}
type UpdateDeviceHardwareRequest_ResponseMask_UpdatedFieldsOnly struct {
...
type UpdateDeviceHardwareRequest_ResponseMask_BodyMask struct {
	// If this field is populated, then resource in response will contain only
	// specific fields. If skip_entire_response_body is true, this field is
	// ignored.
	BodyMask *device_hardware.DeviceHardware_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardware_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}

func (*UpdateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody) isUpdateDeviceHardwareRequest_ResponseMask_Masking() {
}
func (*UpdateDeviceHardwareRequest_ResponseMask_UpdatedFieldsOnly) isUpdateDeviceHardwareRequest_ResponseMask_Masking() {
}
func (*UpdateDeviceHardwareRequest_ResponseMask_BodyMask) isUpdateDeviceHardwareRequest_ResponseMask_Masking() {
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) GetMasking() isUpdateDeviceHardwareRequest_ResponseMask_Masking {
	if m != nil {
		return m.Masking
	}
	return nil
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) GetSkipEntireResponseBody() bool {
	if x, ok := m.GetMasking().(*UpdateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody); ok {
		return x.SkipEntireResponseBody
	}
	return false
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) GetUpdatedFieldsOnly() bool {
	if x, ok := m.GetMasking().(*UpdateDeviceHardwareRequest_ResponseMask_UpdatedFieldsOnly); ok {
		return x.UpdatedFieldsOnly
	}
	return false
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) GetBodyMask() *device_hardware.DeviceHardware_FieldMask {
	if x, ok := m.GetMasking().(*UpdateDeviceHardwareRequest_ResponseMask_BodyMask); ok {
		return x.BodyMask
	}
	return nil
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) SetMasking(ofv isUpdateDeviceHardwareRequest_ResponseMask_Masking) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "isUpdateDeviceHardwareRequest_ResponseMask_Masking", "UpdateDeviceHardwareRequest_ResponseMask"))
	}
	m.Masking = ofv
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) SetSkipEntireResponseBody(fv bool) {
	m.SetMasking(&UpdateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody{SkipEntireResponseBody: fv})
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) SetUpdatedFieldsOnly(fv bool) {
	m.SetMasking(&UpdateDeviceHardwareRequest_ResponseMask_UpdatedFieldsOnly{UpdatedFieldsOnly: fv})
}
func (m *UpdateDeviceHardwareRequest_ResponseMask) SetBodyMask(fv *device_hardware.DeviceHardware_FieldMask) {
	m.SetMasking(&UpdateDeviceHardwareRequest_ResponseMask_BodyMask{BodyMask: fv})
}
...
var edgelq_devices_proto_v1_device_hardware_service_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x6e, 0x22, 0xaf, 0x03, 0x0a, 0x1b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65,
	...
	0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x12, 0x5d, 0x0a, 0x0d, 0x72, 0x65,
	...
	0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x52,
	...
	,
	...
	0xda, 0x21, 0x12, 0x32, 0x10, 0x0a, 0x0e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72,
	0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x73,
	0x6b, 0x12, 0x41, 0x0a, 0x03, 0x63, 0x61, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f,
	0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64,
	0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x43, 0x41, 0x53, 0x52,
	...
	0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61,
	0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x1a, 0xaf, 0x01, 0x0a, 0x03, 0x43, 0x41, 0x53,
	...
	0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x42, 0x08, 0xca, 0xc6, 0x27,
	...
	0x0e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x16, 0xb2, 0xda, 0x21, 0x12, 0x0a, 0x10, 0x0a, 0x0e, 0x44,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x04, 0x6e,
	...
	0x77, 0x4d, 0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x32, 0x82, 0x11, 0x0a, 0x15, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0xcb, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x12, 0x28, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64,
	...
	0x72, 0x65, 0x22, 0x6c, 0x82, 0xdb, 0x21, 0x25, 0x0a, 0x0e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	...
	,
	...
	0x67, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x2a, 0x7d, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48,
	0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x73, 0x8a, 0xcc, 0x26, 0x00, 0x12, 0xe8, 0x01, 0x0a,
	0x13, 0x57, 0x61, 0x74, 0x63, 0x68, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64,
	0x77, 0x61, 0x72, 0x65, 0x12, 0x2a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63,
	...
	0x31, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72,
	0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x76, 0x82,
	0xdb, 0x21, 0x29, 0x0a, 0x0e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77,
	0x61, 0x72, 0x65, 0x12, 0x05, 0x77, 0x61, 0x74, 0x63, 0x68, 0x2a, 0x06, 0x0a, 0x04, 0x6e, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x8a, 0xcc, 0x26, 0x02, 0x10, 0x01, 0x12, 0xcd, 0x01, 0x0a,
	0x0a, 0x44, 0x65, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x21, 0x2e, 0x6e, 0x74,
	0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x72,
	...
	,
	...
	0xe8, 0xde, 0x21, 0x00, 0x82, 0xff, 0xd0, 0x02, 0x56, 0x0a, 0x16, 0x64, 0x65, 0x76, 0x69, 0x63,
	...
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x2f,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x8a,
	0xff, 0xd0, 0x02, 0x56, 0x0a, 0x16, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x68, 0x61, 0x72,
	0x64, 0x77, 0x61, 0x72, 0x65, 0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x3c, 0x67, 0x69,
	...
	0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e,
	0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x2e, 0x76,
	0x31, 0x42, 0x1a, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72,
	...
	0x76, 0x69, 0x63, 0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x3b, 0x64, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x5f, 0x63, 0x6c,
...
var edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var edgelq_devices_proto_v1_device_hardware_service_proto_goTypes = []interface{}{
	...
	(*CreateDeviceHardwareRequest_ResponseMask)(nil),     // 13: ntt.devices.v1.CreateDeviceHardwareRequest.ResponseMask
	(*UpdateDeviceHardwareRequest_CAS)(nil),              // 14: ntt.devices.v1.UpdateDeviceHardwareRequest.CAS
	(*UpdateDeviceHardwareRequest_ResponseMask)(nil),     // 15: ntt.devices.v1.UpdateDeviceHardwareRequest.ResponseMask
	(*device_hardware.DeviceHardware_FieldMask)(nil),     // 16: ntt.devices.v1.DeviceHardware_FieldMask
	(view.View)(0),                               // 17: goten.types.View
	(*device_hardware.DeviceHardware)(nil),       // 18: ntt.devices.v1.DeviceHardware
	(*device_hardware.DeviceHardwareChange)(nil), // 19: ntt.devices.v1.DeviceHardwareChange
	(watch_type.WatchType)(0),                    // 20: goten.types.WatchType
	(*timestamppb.Timestamp)(nil),                // 21: google.protobuf.Timestamp
	(*DeregisterRequest)(nil),                    // 22: ntt.devices.v1.DeregisterRequest
	(*emptypb.Empty)(nil),                        // 23: google.protobuf.Empty
	(*DeregisterResponse)(nil),                   // 24: ntt.devices.v1.DeregisterResponse
}
var edgelq_devices_proto_v1_device_hardware_service_proto_depIdxs = []int32{
	16, // 0: ntt.devices.v1.GetDeviceHardwareRequest.field_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	17, // 1: ntt.devices.v1.GetDeviceHardwareRequest.view:type_name -> goten.types.View
	16, // 2: ntt.devices.v1.BatchGetDeviceHardwaresRequest.field_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	17, // 3: ntt.devices.v1.BatchGetDeviceHardwaresRequest.view:type_name -> goten.types.View
	18, // 4: ntt.devices.v1.BatchGetDeviceHardwaresResponse.device_hardwares:type_name -> ntt.devices.v1.DeviceHardware
	16, // 5: ntt.devices.v1.ListDeviceHardwaresRequest.field_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	17, // 6: ntt.devices.v1.ListDeviceHardwaresRequest.view:type_name -> goten.types.View
	18, // 7: ntt.devices.v1.ListDeviceHardwaresResponse.device_hardwares:type_name -> ntt.devices.v1.DeviceHardware
	16, // 8: ntt.devices.v1.WatchDeviceHardwareRequest.field_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	17, // 9: ntt.devices.v1.WatchDeviceHardwareRequest.view:type_name -> goten.types.View
	19, // 10: ntt.devices.v1.WatchDeviceHardwareResponse.change:type_name -> ntt.devices.v1.DeviceHardwareChange
	20, // 11: ntt.devices.v1.WatchDeviceHardwaresRequest.type:type_name -> goten.types.WatchType
	21, // 12: ntt.devices.v1.WatchDeviceHardwaresRequest.starting_time:type_name -> google.protobuf.Timestamp
	16, // 13: ntt.devices.v1.WatchDeviceHardwaresRequest.field_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	17, // 14: ntt.devices.v1.WatchDeviceHardwaresRequest.view:type_name -> goten.types.View
	19, // 15: ntt.devices.v1.WatchDeviceHardwaresResponse.device_hardware_changes:type_name -> ntt.devices.v1.DeviceHardwareChange
	...
	18, // 17: ntt.devices.v1.CreateDeviceHardwareRequest.device_hardware:type_name -> ntt.devices.v1.DeviceHardware
	13, // 18: ntt.devices.v1.CreateDeviceHardwareRequest.response_mask:type_name -> ntt.devices.v1.CreateDeviceHardwareRequest.ResponseMask
	18, // 19: ntt.devices.v1.UpdateDeviceHardwareRequest.device_hardware:type_name -> ntt.devices.v1.DeviceHardware
	16, // 20: ntt.devices.v1.UpdateDeviceHardwareRequest.update_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	14, // 21: ntt.devices.v1.UpdateDeviceHardwareRequest.cas:type_name -> ntt.devices.v1.UpdateDeviceHardwareRequest.CAS
	15, // 22: ntt.devices.v1.UpdateDeviceHardwareRequest.response_mask:type_name -> ntt.devices.v1.UpdateDeviceHardwareRequest.ResponseMask
	16, // 23: ntt.devices.v1.CreateDeviceHardwareRequest.ResponseMask.body_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	18, // 24: ntt.devices.v1.UpdateDeviceHardwareRequest.CAS.conditional_state:type_name -> ntt.devices.v1.DeviceHardware
	16, // 25: ntt.devices.v1.UpdateDeviceHardwareRequest.CAS.field_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	16, // 26: ntt.devices.v1.UpdateDeviceHardwareRequest.ResponseMask.body_mask:type_name -> ntt.devices.v1.DeviceHardware_FieldMask
	0,  // 27: ntt.devices.v1.DeviceHardwareService.GetDeviceHardware:input_type -> ntt.devices.v1.GetDeviceHardwareRequest
	1,  // 28: ntt.devices.v1.DeviceHardwareService.BatchGetDeviceHardwares:input_type -> ntt.devices.v1.BatchGetDeviceHardwaresRequest
	3,  // 29: ntt.devices.v1.DeviceHardwareService.ListDeviceHardwares:input_type -> ntt.devices.v1.ListDeviceHardwaresRequest
	5,  // 30: ntt.devices.v1.DeviceHardwareService.WatchDeviceHardware:input_type -> ntt.devices.v1.WatchDeviceHardwareRequest
	7,  // 31: ntt.devices.v1.DeviceHardwareService.WatchDeviceHardwares:input_type -> ntt.devices.v1.WatchDeviceHardwaresRequest
	9,  // 32: ntt.devices.v1.DeviceHardwareService.CreateDeviceHardware:input_type -> ntt.devices.v1.CreateDeviceHardwareRequest
	10, // 33: ntt.devices.v1.DeviceHardwareService.UpdateDeviceHardware:input_type -> ntt.devices.v1.UpdateDeviceHardwareRequest
	11, // 34: ntt.devices.v1.DeviceHardwareService.DeleteDeviceHardware:input_type -> ntt.devices.v1.DeleteDeviceHardwareRequest
	22, // 35: ntt.devices.v1.DeviceHardwareService.Deregister:input_type -> ntt.devices.v1.DeregisterRequest
	18, // 36: ntt.devices.v1.DeviceHardwareService.GetDeviceHardware:output_type -> ntt.devices.v1.DeviceHardware
	2,  // 37: ntt.devices.v1.DeviceHardwareService.BatchGetDeviceHardwares:output_type -> ntt.devices.v1.BatchGetDeviceHardwaresResponse
	4,  // 38: ntt.devices.v1.DeviceHardwareService.ListDeviceHardwares:output_type -> ntt.devices.v1.ListDeviceHardwaresResponse
	6,  // 39: ntt.devices.v1.DeviceHardwareService.WatchDeviceHardware:output_type -> ntt.devices.v1.WatchDeviceHardwareResponse
	8,  // 40: ntt.devices.v1.DeviceHardwareService.WatchDeviceHardwares:output_type -> ntt.devices.v1.WatchDeviceHardwaresResponse
	18, // 41: ntt.devices.v1.DeviceHardwareService.CreateDeviceHardware:output_type -> ntt.devices.v1.DeviceHardware
	18, // 42: ntt.devices.v1.DeviceHardwareService.UpdateDeviceHardware:output_type -> ntt.devices.v1.DeviceHardware
	23, // 43: ntt.devices.v1.DeviceHardwareService.DeleteDeviceHardware:output_type -> google.protobuf.Empty
	24, // 44: ntt.devices.v1.DeviceHardwareService.Deregister:output_type -> ntt.devices.v1.DeregisterResponse
...
func edgelq_devices_proto_v1_device_hardware_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateDeviceHardwareRequest_ResponseMask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateDeviceHardwareRequest_ResponseMask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*CreateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody)(nil),
		(*CreateDeviceHardwareRequest_ResponseMask_BodyMask)(nil),
	}
	edgelq_devices_proto_v1_device_hardware_service_proto_msgTypes[15].OneofWrappers = []interface{}{
		(*UpdateDeviceHardwareRequest_ResponseMask_SkipEntireResponseBody)(nil),
		(*UpdateDeviceHardwareRequest_ResponseMask_UpdatedFieldsOnly)(nil),
		(*UpdateDeviceHardwareRequest_ResponseMask_BodyMask)(nil),
	}
	type x struct{}
