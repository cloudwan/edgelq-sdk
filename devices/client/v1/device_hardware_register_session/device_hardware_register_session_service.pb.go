...
type GetDeviceHardwareRegisterSessionRequest struct {
	...
	Name *device_hardware_register_session.Name `protobuf:"bytes,1,opt,customtype=Name,name=name,proto3" json:"name,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_hardware_register_session.DeviceHardwareRegisterSession_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardwareRegisterSession_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
type BatchGetDeviceHardwareRegisterSessionsRequest struct {
	...
	Names []*device_hardware_register_session.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_hardware_register_session.DeviceHardwareRegisterSession_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardwareRegisterSession_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
...
type BatchGetDeviceHardwareRegisterSessionsResponse struct {
	...
	DeviceHardwareRegisterSessions []*device_hardware_register_session.DeviceHardwareRegisterSession `protobuf:"bytes,1,rep,name=device_hardware_register_sessions,json=deviceHardwareRegisterSessions,proto3" json:"device_hardware_register_sessions,omitempty"`
	// list of not found DeviceHardwareRegisterSessions
	Missing []*device_hardware_register_session.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty"`
}
...
type ListDeviceHardwareRegisterSessionsRequest struct {
	...
	Parent *device_hardware_register_session.ParentName `protobuf:"bytes,1,opt,customtype=ParentName,name=parent,proto3" json:"parent,omitempty"`
	...
	PageToken *device_hardware_register_session.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *device_hardware_register_session.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`
	...
	Filter *device_hardware_register_session.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_hardware_register_session.DeviceHardwareRegisterSession_FieldMask `protobuf:"bytes,6,opt,customtype=DeviceHardwareRegisterSession_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
type ListDeviceHardwareRegisterSessionsResponse struct {
	...
	PrevPageToken *device_hardware_register_session.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the
	// ListDeviceHardwareRegisterSessionsRequest.page_token.
	NextPageToken *device_hardware_register_session.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
type WatchDeviceHardwareRegisterSessionRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_hardware_register_session.DeviceHardwareRegisterSession_FieldMask `protobuf:"bytes,2,opt,customtype=DeviceHardwareRegisterSession_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty"`
}
...
type WatchDeviceHardwareRegisterSessionResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *device_hardware_register_session.DeviceHardwareRegisterSessionChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty"`
}
...
type WatchDeviceHardwareRegisterSessionsResponse struct {
	...
	DeviceHardwareRegisterSessionChanges []*device_hardware_register_session.DeviceHardwareRegisterSessionChange `protobuf:"bytes,2,rep,name=device_hardware_register_session_changes,json=deviceHardwareRegisterSessionChanges,proto3" json:"device_hardware_register_session_changes,omitempty"`
	...
	PageTokenChange *WatchDeviceHardwareRegisterSessionsResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty"`
...
type CreateDeviceHardwareRegisterSessionRequest struct {
	...
	DeviceHardwareRegisterSession *device_hardware_register_session.DeviceHardwareRegisterSession `protobuf:"bytes,2,opt,name=device_hardware_register_session,json=deviceHardwareRegisterSession,proto3" json:"device_hardware_register_session,omitempty"`
	// Optional masking applied to response object to reduce message response
	// size.
	ResponseMask *CreateDeviceHardwareRegisterSessionRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}
...
type UpdateDeviceHardwareRegisterSessionRequest struct {
	...
	// the mask
	UpdateMask *device_hardware_register_session.DeviceHardwareRegisterSession_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardwareRegisterSession_FieldMask,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"`
	// Conditional update applied to request if update should be executed only for
	// specific resource state. If this field is populated, then server will fetch
	// existing resource, compare with the one stored in the cas field (after
	// applying field mask) and proceed with update only and only if they match.
	// Otherwise RPC error Aborted will be returned.
	Cas *UpdateDeviceHardwareRegisterSessionRequest_CAS `protobuf:"bytes,4,opt,name=cas,proto3" json:"cas,omitempty"`
	...
	ResponseMask *UpdateDeviceHardwareRegisterSessionRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}
...
func (m *DeleteDeviceHardwareRegisterSessionRequest) GetAllowMissing() bool {
	if m != nil {
		return m.AllowMissing
	}
	return false
...
func (m *DeleteDeviceHardwareRegisterSessionRequest) SetAllowMissing(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "AllowMissing", "DeleteDeviceHardwareRegisterSessionRequest"))
	}
	m.AllowMissing = fv
}
...
type WatchDeviceHardwareRegisterSessionsResponse_PageTokenChange struct {
	...
	PrevPageToken *device_hardware_register_session.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// New token to retrieve next page of results.
	NextPageToken *device_hardware_register_session.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
type CreateDeviceHardwareRegisterSessionRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *device_hardware_register_session.DeviceHardwareRegisterSession_FieldMask `protobuf:"bytes,2,opt,customtype=DeviceHardwareRegisterSession_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}
...
type UpdateDeviceHardwareRegisterSessionRequest_CAS struct {
	...
	ConditionalState *device_hardware_register_session.DeviceHardwareRegisterSession `protobuf:"bytes,1,opt,name=conditional_state,json=conditionalState,proto3" json:"conditional_state,omitempty"`
...
type UpdateDeviceHardwareRegisterSessionRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *device_hardware_register_session.DeviceHardwareRegisterSession_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceHardwareRegisterSession_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}
...
var edgelq_devices_proto_v1_device_hardware_register_session_service_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72,
	0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x22, 0x8a, 0x01, 0x82, 0xdb, 0x21, 0x34, 0x0a, 0x1d, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x03, 0x67, 0x65, 0x74, 0x2a,
	...
	,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xae, 0x01, 0x82, 0xdb, 0x21, 0x58, 0x0a, 0x1d, 0x44,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x04, 0x6c, 0x69,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x94, 0x01, 0x82, 0xdb, 0x21, 0x38, 0x0a, 0x1d, 0x44, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69,
	...
	0x61, 0x6e, 0x67, 0x65, 0xa2, 0xdc, 0x21, 0x02, 0x08, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x48,
	...
	0x2a, 0x7d, 0x3a, 0x77, 0x61, 0x74, 0x63, 0x68, 0x8a, 0xcc, 0x26, 0x00, 0x30, 0x01, 0x12, 0xdf,
	0x02, 0x0a, 0x23, 0x57, 0x61, 0x74, 0x63, 0x68, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61,
	0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x3a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	,
	...
	0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x8a, 0xcc, 0x26, 0x02, 0x10, 0x01, 0x12, 0x82, 0x03,
	0x0a, 0x23, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61,
	0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69,
	...
	,
	...
	0x10, 0x01, 0x12, 0x83, 0x02, 0x0a, 0x23, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3a, 0x2e, 0x6e, 0x74, 0x74,
	...
	0x01, 0x82, 0xdb, 0x21, 0x2f, 0x0a, 0x1d, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72,
	0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x71, 0x2e, 0x63, 0x6f, 0x6d, 0x42, 0xb9, 0x03, 0xe8, 0xde, 0x21, 0x00, 0x82, 0xff, 0xd0, 0x02,
	...
	0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x4d, 0x67, 0x69, 0x74, 0x68,
	...
	0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x8a, 0xff, 0xd0, 0x02, 0x78, 0x0a, 0x27,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x5f,
	0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x42, 0x29, 0x44,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x52, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x00, 0x5a, 0x75, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x77, 0x61, 0x6e, 0x2f,
