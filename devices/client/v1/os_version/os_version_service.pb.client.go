...
func (c *client) GetOsVersion(ctx context.Context, in *GetOsVersionRequest, opts ...grpc.CallOption) (*os_version.OsVersion, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.devices.v1.OsVersionService/GetOsVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetOsVersions(ctx context.Context, in *BatchGetOsVersionsRequest, opts ...grpc.CallOption) (*BatchGetOsVersionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.devices.v1.OsVersionService/BatchGetOsVersions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListOsVersions(ctx context.Context, in *ListOsVersionsRequest, opts ...grpc.CallOption) (*ListOsVersionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.devices.v1.OsVersionService/ListOsVersions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchOsVersion(ctx context.Context, in *WatchOsVersionRequest, opts ...grpc.CallOption) (WatchOsVersionClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.devices.v1.OsVersionService/WatchOsVersion", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchOsVersions(ctx context.Context, in *WatchOsVersionsRequest, opts ...grpc.CallOption) (WatchOsVersionsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.devices.v1.OsVersionService/WatchOsVersions", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateOsVersion(ctx context.Context, in *CreateOsVersionRequest, opts ...grpc.CallOption) (*os_version.OsVersion, error) {
	out := new(os_version.OsVersion)
	err := c.cc.Invoke(ctx, "/ntt.devices.v1.OsVersionService/CreateOsVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateOsVersion(ctx context.Context, in *UpdateOsVersionRequest, opts ...grpc.CallOption) (*os_version.OsVersion, error) {
	out := new(os_version.OsVersion)
	err := c.cc.Invoke(ctx, "/ntt.devices.v1.OsVersionService/UpdateOsVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteOsVersion(ctx context.Context, in *DeleteOsVersionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.devices.v1.OsVersionService/DeleteOsVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
