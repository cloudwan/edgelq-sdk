...
type GetDeviceDistributionCounterRequest struct {
	...
	FieldMask *device_distribution_counter.DeviceDistributionCounter_FieldMask `protobuf:"bytes,3,opt,customtype=DeviceDistributionCounter_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
...
type BatchGetDeviceDistributionCountersResponse struct {
	...
	DeviceDistributionCounters []*device_distribution_counter.DeviceDistributionCounter `protobuf:"bytes,1,rep,name=device_distribution_counters,json=deviceDistributionCounters,proto3" json:"device_distribution_counters,omitempty" firestore:"deviceDistributionCounters"`
...
type ListDeviceDistributionCountersRequest struct {
	...
	PageToken *device_distribution_counter.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty" firestore:"pageToken"`
	// Order By -
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_distribution_counter.DeviceDistributionCounter_FieldMask `protobuf:"bytes,6,opt,customtype=DeviceDistributionCounter_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
type ListDeviceDistributionCountersResponse struct {
	...
	PrevPageToken *device_distribution_counter.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty" firestore:"prevPageToken"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListDeviceDistributionCountersRequest.page_token.
	NextPageToken *device_distribution_counter.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty" firestore:"nextPageToken"`
...
type WatchDeviceDistributionCounterRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *device_distribution_counter.DeviceDistributionCounter_FieldMask `protobuf:"bytes,2,opt,customtype=DeviceDistributionCounter_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty" firestore:"fieldMask"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty" firestore:"view"`
}
...
type WatchDeviceDistributionCountersResponse struct {
	...
	DeviceDistributionCounterChanges []*device_distribution_counter.DeviceDistributionCounterChange `protobuf:"bytes,2,rep,name=device_distribution_counter_changes,json=deviceDistributionCounterChanges,proto3" json:"device_distribution_counter_changes,omitempty" firestore:"deviceDistributionCounterChanges"`
	...
	PageTokenChange *WatchDeviceDistributionCountersResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty" firestore:"pageTokenChange"`
...
type WatchDeviceDistributionCountersResponse_PageTokenChange struct {
	...
	PrevPageToken *device_distribution_counter.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty" firestore:"prevPageToken"`
	// New token to retrieve next page of results.
	NextPageToken *device_distribution_counter.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty" firestore:"nextPageToken"`
}
