...
type GetQuery struct {
	Reference *Reference
	Mask      *ProvisioningApprovalRequest_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*ProvisioningApprovalRequest_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	ProvisioningApprovalRequests []*ProvisioningApprovalRequest
	PrevPageCursor               *PagerCursor
	NextPageCursor               *PagerCursor
}

func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return ProvisioningApprovalRequestList(qr.ProvisioningApprovalRequests)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.ProvisioningApprovalRequests = results.(ProvisioningApprovalRequestList)
	} else {
		qr.ProvisioningApprovalRequests = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*ProvisioningApprovalRequestChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return ProvisioningApprovalRequestChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(ProvisioningApprovalRequestChangeList)
	} else {
		qr.Changes = nil
	}
}
