...
type DeviceTypeParentNameList []*ParentName

func (l DeviceTypeParentNameList) Append(name gotenresource.Name) gotenresource.ParentNameList {
	return append(l, name.(*ParentName))
}

func (l DeviceTypeParentNameList) AppendList(list gotenresource.ParentNameList) gotenresource.ParentNameList {
	return append(l, list.(DeviceTypeParentNameList)...)
}

func (l DeviceTypeParentNameList) Slice(first, second int) gotenresource.ParentNameList {
	if first > 0 && second > 0 {
		return l[first:second]
	} else if first > 0 {
		return l[first:]
...
func (l DeviceTypeParentNameList) At(idx int) gotenresource.Name {
	return l[idx]
}

func (l DeviceTypeParentNameList) Set(idx int, name gotenresource.Name) {
	l[idx] = name.(*ParentName)
}

func (l DeviceTypeParentNameList) Length() int {
	return len(l)
}

type DeviceTypeParentReferenceList []*ParentReference

func (l DeviceTypeParentReferenceList) Append(ref gotenresource.Reference) gotenresource.ParentReferenceList {
	return append(l, ref.(*ParentReference))
}

func (l DeviceTypeParentReferenceList) AppendList(list gotenresource.ParentReferenceList) gotenresource.ParentReferenceList {
	return append(l, list.(DeviceTypeParentReferenceList)...)
}

func (l DeviceTypeParentReferenceList) Slice(first, second int) gotenresource.ParentReferenceList {
	if first > 0 && second > 0 {
		return l[first:second]
	} else if first > 0 {
		return l[first:]
...
func (l DeviceTypeParentReferenceList) At(idx int) gotenresource.Reference {
	return l[idx]
}

func (l DeviceTypeParentReferenceList) Set(idx int, ref gotenresource.Reference) {
	l[idx] = ref.(*ParentReference)
}

func (l DeviceTypeParentReferenceList) Length() int {
	return len(l)
}
