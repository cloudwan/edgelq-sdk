...
type OsVersionParentNameList []*ParentName

func (l OsVersionParentNameList) Append(name gotenresource.Name) gotenresource.ParentNameList {
	return append(l, name.(*ParentName))
}

func (l OsVersionParentNameList) AppendList(list gotenresource.ParentNameList) gotenresource.ParentNameList {
	return append(l, list.(OsVersionParentNameList)...)
}

func (l OsVersionParentNameList) Slice(first, second int) gotenresource.ParentNameList {
	if first > 0 && second > 0 {
		return l[first:second]
	} else if first > 0 {
		return l[first:]
...
func (l OsVersionParentNameList) At(idx int) gotenresource.Name {
	return l[idx]
}

func (l OsVersionParentNameList) Set(idx int, name gotenresource.Name) {
	l[idx] = name.(*ParentName)
}

func (l OsVersionParentNameList) Length() int {
	return len(l)
}

type OsVersionParentReferenceList []*ParentReference

func (l OsVersionParentReferenceList) Append(ref gotenresource.Reference) gotenresource.ParentReferenceList {
	return append(l, ref.(*ParentReference))
}

func (l OsVersionParentReferenceList) AppendList(list gotenresource.ParentReferenceList) gotenresource.ParentReferenceList {
	return append(l, list.(OsVersionParentReferenceList)...)
}

func (l OsVersionParentReferenceList) Slice(first, second int) gotenresource.ParentReferenceList {
	if first > 0 && second > 0 {
		return l[first:second]
	} else if first > 0 {
		return l[first:]
...
func (l OsVersionParentReferenceList) At(idx int) gotenresource.Reference {
	return l[idx]
}

func (l OsVersionParentReferenceList) Set(idx int, ref gotenresource.Reference) {
	l[idx] = ref.(*ParentReference)
}

func (l OsVersionParentReferenceList) Length() int {
	return len(l)
}
