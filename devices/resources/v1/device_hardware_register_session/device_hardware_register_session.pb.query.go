...
type GetQuery struct {
	Reference *Reference
	Mask      *DeviceHardwareRegisterSession_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*DeviceHardwareRegisterSession_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	DeviceHardwareRegisterSessions []*DeviceHardwareRegisterSession
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return DeviceHardwareRegisterSessionList(qr.DeviceHardwareRegisterSessions)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.DeviceHardwareRegisterSessions = results.(DeviceHardwareRegisterSessionList)
	} else {
		qr.DeviceHardwareRegisterSessions = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*DeviceHardwareRegisterSessionChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return DeviceHardwareRegisterSessionChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(DeviceHardwareRegisterSessionChangeList)
	} else {
		qr.Changes = nil
	}
}
