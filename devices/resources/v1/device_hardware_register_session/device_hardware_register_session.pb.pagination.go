...
func (orderByFld *OrderByField) CompareWithDirection(left, right *DeviceHardwareRegisterSession) int {
...
func (orderBy *OrderBy) Sort(results DeviceHardwareRegisterSessionList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(DeviceHardwareRegisterSessionList))
}

func (orderBy *OrderBy) InsertSorted(sorted DeviceHardwareRegisterSessionList, elem *DeviceHardwareRegisterSession) (DeviceHardwareRegisterSessionList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(DeviceHardwareRegisterSessionList), elem.(*DeviceHardwareRegisterSession))
}

func (orderBy *OrderBy) Compare(left, right *DeviceHardwareRegisterSession) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*DeviceHardwareRegisterSession), right.(*DeviceHardwareRegisterSession))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseDeviceHardwareRegisterSession_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *DeviceHardwareRegisterSession_FieldMask {
	fieldMask := &DeviceHardwareRegisterSession_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == DeviceHardwareRegisterSession_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &DeviceHardwareRegisterSession_FieldTerminalPath{selector: DeviceHardwareRegisterSession_FieldPathSelectorName},
