...
// File: edgelq/devices/proto/v1/os_version_change.proto
// DO NOT EDIT!!!
...
func (m *OsVersionChange) Reset() {
	*m = OsVersionChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_os_version_change_proto_msgTypes[0]
...
func (*OsVersionChange) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_os_version_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *OsVersionChange_Added) Reset() {
	*m = OsVersionChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_os_version_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OsVersionChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_os_version_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *OsVersionChange_Modified) Reset() {
	*m = OsVersionChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_os_version_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OsVersionChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_os_version_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *OsVersionChange_Current) Reset() {
	*m = OsVersionChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_os_version_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OsVersionChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_os_version_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *OsVersionChange_Removed) Reset() {
	*m = OsVersionChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_os_version_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OsVersionChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_os_version_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_devices_proto_v1_os_version_change_proto preflect.FileDescriptor

var edgelq_devices_proto_v1_os_version_change_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x0e, 0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x76,
	...
	0x28, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x06, 0x0a, 0x0f, 0x4f, 0x73,
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x3d, 0x0a,
	...
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x41, 0x64,
	...
	0x4f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e,
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x52, 0x65, 0x6d, 0x6f,
	0x76, 0x65, 0x64, 0x48, 0x00, 0x52, 0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x1a, 0x60,
	0x0a, 0x05, 0x41, 0x64, 0x64, 0x65, 0x64, 0x12, 0x38, 0x0a, 0x0a, 0x6f, 0x73, 0x5f, 0x76, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6e, 0x74,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x38, 0x0a, 0x0a, 0x6f, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x73, 0x56, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x52, 0x09, 0x6f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x4c,
	...
	0xb2, 0xda, 0x21, 0x0d, 0x32, 0x0b, 0x0a, 0x09, 0x4f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	...
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x38, 0x0a, 0x0a, 0x6f, 0x73, 0x5f, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6e, 0x74, 0x74,
	0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x73, 0x56, 0x65,
	...
	0x78, 0x3a, 0x0f, 0x9a, 0xd9, 0x21, 0x0b, 0x0a, 0x09, 0x4f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x42, 0x0d, 0x0a, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70,
	...
	0x4f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50,
	...
	0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x3b, 0x6f, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_devices_proto_v1_os_version_change_proto_rawDescOnce sync.Once
	edgelq_devices_proto_v1_os_version_change_proto_rawDescData = edgelq_devices_proto_v1_os_version_change_proto_rawDesc
)

func edgelq_devices_proto_v1_os_version_change_proto_rawDescGZIP() []byte {
	edgelq_devices_proto_v1_os_version_change_proto_rawDescOnce.Do(func() {
		edgelq_devices_proto_v1_os_version_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_devices_proto_v1_os_version_change_proto_rawDescData)
	})
	return edgelq_devices_proto_v1_os_version_change_proto_rawDescData
}

var edgelq_devices_proto_v1_os_version_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_devices_proto_v1_os_version_change_proto_goTypes = []interface{}{
	(*OsVersionChange)(nil),          // 0: ntt.devices.v1.OsVersionChange
	(*OsVersionChange_Added)(nil),    // 1: ntt.devices.v1.OsVersionChange.Added
	(*OsVersionChange_Modified)(nil), // 2: ntt.devices.v1.OsVersionChange.Modified
	(*OsVersionChange_Current)(nil),  // 3: ntt.devices.v1.OsVersionChange.Current
	(*OsVersionChange_Removed)(nil),  // 4: ntt.devices.v1.OsVersionChange.Removed
	(*OsVersion)(nil),                // 5: ntt.devices.v1.OsVersion
	(*OsVersion_FieldMask)(nil),      // 6: ntt.devices.v1.OsVersion_FieldMask
}
var edgelq_devices_proto_v1_os_version_change_proto_depIdxs = []int32{
	1, // 0: ntt.devices.v1.OsVersionChange.added:type_name -> ntt.devices.v1.OsVersionChange.Added
	2, // 1: ntt.devices.v1.OsVersionChange.modified:type_name -> ntt.devices.v1.OsVersionChange.Modified
	3, // 2: ntt.devices.v1.OsVersionChange.current:type_name -> ntt.devices.v1.OsVersionChange.Current
	4, // 3: ntt.devices.v1.OsVersionChange.removed:type_name -> ntt.devices.v1.OsVersionChange.Removed
	5, // 4: ntt.devices.v1.OsVersionChange.Added.os_version:type_name -> ntt.devices.v1.OsVersion
	5, // 5: ntt.devices.v1.OsVersionChange.Modified.os_version:type_name -> ntt.devices.v1.OsVersion
	6, // 6: ntt.devices.v1.OsVersionChange.Modified.field_mask:type_name -> ntt.devices.v1.OsVersion_FieldMask
	5, // 7: ntt.devices.v1.OsVersionChange.Current.os_version:type_name -> ntt.devices.v1.OsVersion
...
func init() { edgelq_devices_proto_v1_os_version_change_proto_init() }
func edgelq_devices_proto_v1_os_version_change_proto_init() {
	if edgelq_devices_proto_v1_os_version_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_devices_proto_v1_os_version_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_os_version_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_os_version_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_os_version_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_os_version_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_devices_proto_v1_os_version_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_devices_proto_v1_os_version_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_devices_proto_v1_os_version_change_proto_goTypes,
		DependencyIndexes: edgelq_devices_proto_v1_os_version_change_proto_depIdxs,
		MessageInfos:      edgelq_devices_proto_v1_os_version_change_proto_msgTypes,
	}.Build()
	edgelq_devices_proto_v1_os_version_change_proto = out.File
	edgelq_devices_proto_v1_os_version_change_proto_rawDesc = nil
	edgelq_devices_proto_v1_os_version_change_proto_goTypes = nil
	edgelq_devices_proto_v1_os_version_change_proto_depIdxs = nil
}
