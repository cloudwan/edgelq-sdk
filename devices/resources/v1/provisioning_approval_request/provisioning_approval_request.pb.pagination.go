...
func (orderByFld *OrderByField) CompareWithDirection(left, right *ProvisioningApprovalRequest) int {
...
func (orderBy *OrderBy) Sort(results ProvisioningApprovalRequestList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(ProvisioningApprovalRequestList))
}

func (orderBy *OrderBy) InsertSorted(sorted ProvisioningApprovalRequestList, elem *ProvisioningApprovalRequest) (ProvisioningApprovalRequestList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(ProvisioningApprovalRequestList), elem.(*ProvisioningApprovalRequest))
}

func (orderBy *OrderBy) Compare(left, right *ProvisioningApprovalRequest) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*ProvisioningApprovalRequest), right.(*ProvisioningApprovalRequest))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseProvisioningApprovalRequest_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *ProvisioningApprovalRequest_FieldMask {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == ProvisioningApprovalRequest_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &ProvisioningApprovalRequest_FieldTerminalPath{selector: ProvisioningApprovalRequest_FieldPathSelectorName},
