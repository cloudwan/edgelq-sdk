...
type GetQuery struct {
	Reference *Reference
	Mask      *DeviceDistributionCounter_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*DeviceDistributionCounter_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	DeviceDistributionCounters []*DeviceDistributionCounter
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return DeviceDistributionCounterList(qr.DeviceDistributionCounters)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.DeviceDistributionCounters = results.(DeviceDistributionCounterList)
	} else {
		qr.DeviceDistributionCounters = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*DeviceDistributionCounterChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return DeviceDistributionCounterChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(DeviceDistributionCounterChangeList)
	} else {
		qr.Changes = nil
	}
}
