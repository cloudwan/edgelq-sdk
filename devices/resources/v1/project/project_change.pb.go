...
// File: edgelq/devices/proto/v1/project_change.proto
// DO NOT EDIT!!!
...
func (m *ProjectChange) Reset() {
	*m = ProjectChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_project_change_proto_msgTypes[0]
...
func (*ProjectChange) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_project_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *ProjectChange_Added) Reset() {
	*m = ProjectChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_project_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_project_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *ProjectChange_Modified) Reset() {
	*m = ProjectChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_project_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_project_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *ProjectChange_Current) Reset() {
	*m = ProjectChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_project_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_project_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *ProjectChange_Removed) Reset() {
	*m = ProjectChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_devices_proto_v1_project_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_devices_proto_v1_project_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_devices_proto_v1_project_change_proto preflect.FileDescriptor

var edgelq_devices_proto_v1_project_change_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x19,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x68, 0x61,
	...
	0x63, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x64,
	...
	0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x07,
...
var (
	edgelq_devices_proto_v1_project_change_proto_rawDescOnce sync.Once
	edgelq_devices_proto_v1_project_change_proto_rawDescData = edgelq_devices_proto_v1_project_change_proto_rawDesc
)

func edgelq_devices_proto_v1_project_change_proto_rawDescGZIP() []byte {
	edgelq_devices_proto_v1_project_change_proto_rawDescOnce.Do(func() {
		edgelq_devices_proto_v1_project_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_devices_proto_v1_project_change_proto_rawDescData)
	})
	return edgelq_devices_proto_v1_project_change_proto_rawDescData
}

var edgelq_devices_proto_v1_project_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_devices_proto_v1_project_change_proto_goTypes = []interface{}{
	(*ProjectChange)(nil),          // 0: ntt.devices.v1.ProjectChange
	(*ProjectChange_Added)(nil),    // 1: ntt.devices.v1.ProjectChange.Added
	(*ProjectChange_Modified)(nil), // 2: ntt.devices.v1.ProjectChange.Modified
	(*ProjectChange_Current)(nil),  // 3: ntt.devices.v1.ProjectChange.Current
	(*ProjectChange_Removed)(nil),  // 4: ntt.devices.v1.ProjectChange.Removed
	(*Project)(nil),                // 5: ntt.devices.v1.Project
	(*Project_FieldMask)(nil),      // 6: ntt.devices.v1.Project_FieldMask
}
var edgelq_devices_proto_v1_project_change_proto_depIdxs = []int32{
	1, // 0: ntt.devices.v1.ProjectChange.added:type_name -> ntt.devices.v1.ProjectChange.Added
	2, // 1: ntt.devices.v1.ProjectChange.modified:type_name -> ntt.devices.v1.ProjectChange.Modified
	3, // 2: ntt.devices.v1.ProjectChange.current:type_name -> ntt.devices.v1.ProjectChange.Current
	4, // 3: ntt.devices.v1.ProjectChange.removed:type_name -> ntt.devices.v1.ProjectChange.Removed
	5, // 4: ntt.devices.v1.ProjectChange.Added.project:type_name -> ntt.devices.v1.Project
	5, // 5: ntt.devices.v1.ProjectChange.Modified.project:type_name -> ntt.devices.v1.Project
	6, // 6: ntt.devices.v1.ProjectChange.Modified.field_mask:type_name -> ntt.devices.v1.Project_FieldMask
	5, // 7: ntt.devices.v1.ProjectChange.Current.project:type_name -> ntt.devices.v1.Project
...
func init() { edgelq_devices_proto_v1_project_change_proto_init() }
func edgelq_devices_proto_v1_project_change_proto_init() {
	if edgelq_devices_proto_v1_project_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_devices_proto_v1_project_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_project_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_project_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_project_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_devices_proto_v1_project_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_devices_proto_v1_project_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_devices_proto_v1_project_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_devices_proto_v1_project_change_proto_goTypes,
		DependencyIndexes: edgelq_devices_proto_v1_project_change_proto_depIdxs,
		MessageInfos:      edgelq_devices_proto_v1_project_change_proto_msgTypes,
	}.Build()
	edgelq_devices_proto_v1_project_change_proto = out.File
	edgelq_devices_proto_v1_project_change_proto_rawDesc = nil
	edgelq_devices_proto_v1_project_change_proto_goTypes = nil
	edgelq_devices_proto_v1_project_change_proto_depIdxs = nil
}
