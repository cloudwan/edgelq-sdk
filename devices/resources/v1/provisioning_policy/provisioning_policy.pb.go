...
type ProvisioningPolicy_Spec struct {
	...
	ExtraConditions []*iam_condition.ExecutableCondition `protobuf:"bytes,12,rep,name=extra_conditions,json=extraConditions,proto3" json:"extra_conditions,omitempty" firestore:"extraConditions"`
}
