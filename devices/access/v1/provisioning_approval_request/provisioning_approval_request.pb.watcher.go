...
type WatcherFilterParams struct {
	Parent *provisioning_approval_request.ParentName
...
func (pw *Watcher) GetFilters() []*WatcherFilterParams {
	...
	for _, query := range pw.filters {
		...
		if query.Parent != nil {
			cQuery.Parent = &provisioning_approval_request.ParentName{}
...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(provisioning_approval_request.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Name) gotenaccess.WatcherFilterParams {
		params := &WatcherFilterParams{}
		if filter != nil {
			params.Filter = filter.(*provisioning_approval_request.Filter)
		}
		if parent != nil {
			params.Parent = parent.(*provisioning_approval_request.ParentName)
		}
		return params
	})
}
