...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(device_type.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Name) gotenaccess.WatcherFilterParams {
