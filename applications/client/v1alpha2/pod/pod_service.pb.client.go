...
func (c *client) GetPod(ctx context.Context, in *GetPodRequest, opts ...grpc.CallOption) (*pod.Pod, error) {
	out := new(pod.Pod)
	err := c.cc.Invoke(ctx, "/ntt.applications.v1alpha2.PodService/GetPod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetPods(ctx context.Context, in *BatchGetPodsRequest, opts ...grpc.CallOption) (*BatchGetPodsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.applications.v1alpha2.PodService/BatchGetPods", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListPods(ctx context.Context, in *ListPodsRequest, opts ...grpc.CallOption) (*ListPodsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.applications.v1alpha2.PodService/ListPods", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchPod(ctx context.Context, in *WatchPodRequest, opts ...grpc.CallOption) (WatchPodClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.applications.v1alpha2.PodService/WatchPod", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchPods(ctx context.Context, in *WatchPodsRequest, opts ...grpc.CallOption) (WatchPodsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.applications.v1alpha2.PodService/WatchPods", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreatePod(ctx context.Context, in *CreatePodRequest, opts ...grpc.CallOption) (*pod.Pod, error) {
	out := new(pod.Pod)
	err := c.cc.Invoke(ctx, "/ntt.applications.v1alpha2.PodService/CreatePod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdatePod(ctx context.Context, in *UpdatePodRequest, opts ...grpc.CallOption) (*pod.Pod, error) {
	out := new(pod.Pod)
	err := c.cc.Invoke(ctx, "/ntt.applications.v1alpha2.PodService/UpdatePod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
