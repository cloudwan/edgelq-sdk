...
func (pw *Watcher) GetFilters() []*WatcherFilterParams {
	...
	for _, query := range pw.filters {
		...
		if query.Parent != nil {
			cQuery.Parent = &pod.ParentReference{}
...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(pod.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Reference) gotenaccess.WatcherFilterParams {
		params := &WatcherFilterParams{}
		if filter != nil {
			params.Filter = filter.(*pod.Filter)
		}
		if parent != nil {
			params.Parent = parent.(*pod.ParentReference)
		}
		return params
	})
}
