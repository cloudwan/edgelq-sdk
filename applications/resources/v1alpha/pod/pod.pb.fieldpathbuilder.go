...
func NewLocalObjectReferenceFieldPathBuilder() LocalObjectReferenceFieldPathBuilder {
	return LocalObjectReferenceFieldPathBuilder{}
}
func (LocalObjectReferenceFieldPathBuilder) Name() LocalObjectReferencePathSelectorName {
	return LocalObjectReferencePathSelectorName{}
}

type LocalObjectReferencePathSelectorName struct{}

func (LocalObjectReferencePathSelectorName) FieldPath() *LocalObjectReference_FieldTerminalPath {
	return &LocalObjectReference_FieldTerminalPath{selector: LocalObjectReference_FieldPathSelectorName}
}

func (s LocalObjectReferencePathSelectorName) WithValue(value string) *LocalObjectReference_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*LocalObjectReference_FieldTerminalPathValue)
}

func (s LocalObjectReferencePathSelectorName) WithArrayOfValues(values []string) *LocalObjectReference_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*LocalObjectReference_FieldTerminalPathArrayOfValues)
}
