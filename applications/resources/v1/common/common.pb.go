...
type PodSpec struct {
	...
	RestartPolicy PodSpec_RestartPolicy `protobuf:"varint,4,opt,name=restart_policy,json=restartPolicy,proto3,enum=ntt.applications.v1.PodSpec_RestartPolicy" json:"restart_policy,omitempty"`
	...
	ComposeHealthChecks map[string]*PodSpec_ContainerHealthChecks `protobuf:"bytes,9,rep,name=compose_health_checks,json=composeHealthChecks,proto3" json:"compose_health_checks,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type HostPathVolumeSource struct {
	...
	Type HostPathVolumeSource_Type `protobuf:"varint,2,opt,name=type,proto3,enum=ntt.applications.v1.HostPathVolumeSource_Type" json:"type,omitempty"`
}
...
type PodSpec_Container struct {
	...
	HealthCheck []*api.HealthCheckSpec `protobuf:"bytes,20,rep,name=health_check,json=healthCheck,proto3" json:"health_check,omitempty"`
}
...
type PodSpec_ContainerHealthChecks struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	HealthChecks  []*api.HealthCheckSpec `protobuf:"bytes,1,rep,name=health_checks,json=healthChecks,proto3" json:"health_checks,omitempty"`
}
