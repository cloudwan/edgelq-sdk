...
type Pod_Status struct {
	...
	HealthStatus Pod_Status_HealthStatus `protobuf:"varint,5,opt,name=health_status,json=healthStatus,proto3,enum=ntt.applications.v1.Pod_Status_HealthStatus" json:"health_status,omitempty" firestore:"healthStatus"`
}
...
type Pod_Status_Container struct {
	...
	HealthStatus Pod_Status_HealthStatus               `protobuf:"varint,7,opt,name=health_status,json=healthStatus,proto3,enum=ntt.applications.v1.Pod_Status_HealthStatus" json:"health_status,omitempty" firestore:"healthStatus"`
	// service name in case of compose pod
	ServiceName string `protobuf:"bytes,8,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty" firestore:"serviceName"`
	ContainerIp string `protobuf:"bytes,9,opt,name=container_ip,json=containerIp,proto3" json:"container_ip,omitempty" firestore:"containerIp"`
	ContainerId string `protobuf:"bytes,10,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty" firestore:"containerId"`
}
...
var edgelq_applications_proto_v1_pod_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaa, 0x13, 0x0a, 0x03,
	...
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0xb8, 0x0c, 0x0a, 0x06, 0x53, 0x74,
	...
	0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x9b, 0x08, 0x0a, 0x09, 0x43, 0x6f,
	...
	0x64, 0x12, 0x51, 0x0a, 0x0d, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x61,
	0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x50,
	0x6f, 0x64, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	...
	0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x61,
	0x69, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x70, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63,
	0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x70, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x1a, 0x40, 0x0a,
	...
	0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x04, 0x22, 0xa3, 0x01, 0x0a, 0x05, 0x50, 0x68, 0x61, 0x73,
	...
	0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x05, 0x12, 0x19, 0x0a, 0x15, 0x49, 0x4d,
	0x41, 0x47, 0x45, 0x5f, 0x44, 0x4f, 0x57, 0x4e, 0x4c, 0x4f, 0x41, 0x44, 0x5f, 0x46, 0x41, 0x49,
	0x4c, 0x45, 0x44, 0x10, 0x06, 0x12, 0x0f, 0x0a, 0x0b, 0x49, 0x4e, 0x49, 0x54, 0x5f, 0x46, 0x41,
	0x49, 0x4c, 0x45, 0x44, 0x10, 0x07, 0x12, 0x15, 0x0a, 0x11, 0x50, 0x4f, 0x44, 0x5f, 0x43, 0x52,
	0x45, 0x41, 0x54, 0x45, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x08, 0x22, 0x45, 0x0a,
	...
	0x48, 0x59, 0x10, 0x02, 0x3a, 0x91, 0x04, 0xea, 0x41, 0x4d, 0x0a, 0x1b, 0x61, 0x70, 0x70, 0x6c,
	...
	0x73, 0x2f, 0x7b, 0x70, 0x6f, 0x64, 0x7d, 0x92, 0xd9, 0x21, 0x9e, 0x01, 0x0a, 0x04, 0x70, 0x6f,
	...
	,
	...
	,
	...
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x76,
	0x31, 0x2f, 0x70, 0x6f, 0x64, 0xa2, 0x80, 0xd1, 0x02, 0x43, 0x0a, 0x0a, 0x70, 0x6f, 0x64, 0x5f,
	...
	0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x6f, 0x64, 0x0a, 0x1a, 0x63,
	0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x50, 0x6f, 0x64, 0x50, 0x72,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x6f, 0x64, 0x3b,
...
var edgelq_applications_proto_v1_pod_proto_goTypes = []interface{}{
	...
	(*common.PodSpec)(nil),                       // 10: ntt.applications.v1.PodSpec
	(*timestamppb.Timestamp)(nil),                // 11: google.protobuf.Timestamp
}
var edgelq_applications_proto_v1_pod_proto_depIdxs = []int32{
	9,  // 0: ntt.applications.v1.Pod.metadata:type_name -> goten.types.Meta
	10, // 1: ntt.applications.v1.Pod.spec:type_name -> ntt.applications.v1.PodSpec
	...
	1,  // 10: ntt.applications.v1.Pod.Status.Container.health_status:type_name -> ntt.applications.v1.Pod_Status_HealthStatus
	11, // 11: ntt.applications.v1.Pod.Status.Container.StateRunning.started_at:type_name -> google.protobuf.Timestamp
	11, // 12: ntt.applications.v1.Pod.Status.Container.StateTerminated.started_at:type_name -> google.protobuf.Timestamp
	11, // 13: ntt.applications.v1.Pod.Status.Container.StateTerminated.finished_at:type_name -> google.protobuf.Timestamp
