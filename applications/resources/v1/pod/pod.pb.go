...
type Pod_Status_HealthStatus int32

const (
	Pod_Status_HEALTH_STATUS_UNKNOWN Pod_Status_HealthStatus = 0
	Pod_Status_HEALTHY               Pod_Status_HealthStatus = 1
	Pod_Status_UNHEALTHY             Pod_Status_HealthStatus = 2
)

var (
	Pod_Status_HealthStatus_name = map[int32]string{
		0: "HEALTH_STATUS_UNKNOWN",
		1: "HEALTHY",
		2: "UNHEALTHY",
	}

	Pod_Status_HealthStatus_value = map[string]int32{
...
func (x Pod_Status_HealthStatus) Enum() *Pod_Status_HealthStatus {
	p := new(Pod_Status_HealthStatus)
	*p = x
	return p
}

func (x Pod_Status_HealthStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), preflect.EnumNumber(x))
}

func (Pod_Status_HealthStatus) Descriptor() preflect.EnumDescriptor {
	return edgelq_applications_proto_v1_pod_proto_enumTypes[1].Descriptor()
}

func (Pod_Status_HealthStatus) Type() preflect.EnumType {
	return &edgelq_applications_proto_v1_pod_proto_enumTypes[1]
}

func (x Pod_Status_HealthStatus) Number() preflect.EnumNumber {
	return preflect.EnumNumber(x)
}

// Deprecated, Use Pod_Status_HealthStatus.ProtoReflect.Descriptor instead.
func (Pod_Status_HealthStatus) EnumDescriptor() ([]byte, []int) {
	return edgelq_applications_proto_v1_pod_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
const (
	...
	Pod_Status_Container_RESTARTING        Pod_Status_Container_State = 5
)
...
func (Pod_Status_Container_State) Descriptor() preflect.EnumDescriptor {
	return edgelq_applications_proto_v1_pod_proto_enumTypes[2].Descriptor()
}

func (Pod_Status_Container_State) Type() preflect.EnumType {
	return &edgelq_applications_proto_v1_pod_proto_enumTypes[2]
}
...
type Pod_Status struct {
	...
	Phase Pod_Status_Phase `protobuf:"varint,1,opt,name=phase,proto3,enum=ntt.applications.v1.Pod_Status_Phase" json:"phase,omitempty"`
	...
	HealthStatus Pod_Status_HealthStatus `protobuf:"varint,5,opt,name=health_status,json=healthStatus,proto3,enum=ntt.applications.v1.Pod_Status_HealthStatus" json:"health_status,omitempty"`
}
...
func (m *Pod_Status) GetHealthStatus() Pod_Status_HealthStatus {
	if m != nil {
...
func (m *Pod_Status) SetHealthStatus(fv Pod_Status_HealthStatus) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "HealthStatus", "Pod_Status"))
	}
	m.HealthStatus = fv
}
...
type Pod_Status_Container struct {
	...
	State        Pod_Status_Container_State            `protobuf:"varint,3,opt,name=state,proto3,enum=ntt.applications.v1.Pod_Status_Container_State" json:"state,omitempty"`
	...
	Restarting   *Pod_Status_Container_StateRestarting `protobuf:"bytes,11,opt,name=restarting,proto3" json:"restarting,omitempty"`
	HealthStatus Pod_Status_HealthStatus               `protobuf:"varint,7,opt,name=health_status,json=healthStatus,proto3,enum=ntt.applications.v1.Pod_Status_HealthStatus" json:"health_status,omitempty"`
...
func (m *Pod_Status_Container) GetRestarting() *Pod_Status_Container_StateRestarting {
	if m != nil {
		return m.Restarting
	}
	return nil
...
func (m *Pod_Status_Container) GetHealthStatus() Pod_Status_HealthStatus {
	if m != nil {
		return m.HealthStatus
	}
	return Pod_Status_HEALTH_STATUS_UNKNOWN
...
func (m *Pod_Status_Container) GetServiceName() string {
	if m != nil {
...
func (m *Pod_Status_Container) GetContainerIp() string {
	if m != nil {
...
func (m *Pod_Status_Container) GetContainerId() string {
	if m != nil {
...
func (m *Pod_Status_Container) SetRestarting(fv *Pod_Status_Container_StateRestarting) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Restarting", "Pod_Status_Container"))
	}
	m.Restarting = fv
}

func (m *Pod_Status_Container) SetHealthStatus(fv Pod_Status_HealthStatus) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "HealthStatus", "Pod_Status_Container"))
	}
	m.HealthStatus = fv
}

func (m *Pod_Status_Container) SetServiceName(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ServiceName", "Pod_Status_Container"))
	}
	m.ServiceName = fv
}

func (m *Pod_Status_Container) SetContainerIp(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ContainerIp", "Pod_Status_Container"))
	}
	m.ContainerIp = fv
}

func (m *Pod_Status_Container) SetContainerId(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ContainerId", "Pod_Status_Container"))
	}
	m.ContainerId = fv
}
...
type Pod_Status_Container_StateRestarting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// exit_code is the exist code that the process returns at the end.
...
func (m *Pod_Status_Container_StateRestarting) Reset() {
	*m = Pod_Status_Container_StateRestarting{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_applications_proto_v1_pod_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *Pod_Status_Container_StateRestarting) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*Pod_Status_Container_StateRestarting) ProtoMessage() {}

func (m *Pod_Status_Container_StateRestarting) ProtoReflect() preflect.Message {
	mi := &edgelq_applications_proto_v1_pod_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*Pod_Status_Container_StateRestarting) GotenMessage() {}

// Deprecated, Use Pod_Status_Container_StateRestarting.ProtoReflect.Descriptor instead.
func (*Pod_Status_Container_StateRestarting) Descriptor() ([]byte, []int) {
	return edgelq_applications_proto_v1_pod_proto_rawDescGZIP(), []int{0, 0, 0, 3}
}

func (m *Pod_Status_Container_StateRestarting) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *Pod_Status_Container_StateRestarting) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *Pod_Status_Container_StateRestarting) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *Pod_Status_Container_StateRestarting) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

func (m *Pod_Status_Container_StateRestarting) GetExitCode() int32 {
	if m != nil {
		return m.ExitCode
	}
	return int32(0)
...
func (m *Pod_Status_Container_StateRestarting) GetContainerId() string {
	if m != nil {
		return m.ContainerId
	}
	return ""
...
func (m *Pod_Status_Container_StateRestarting) SetExitCode(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ExitCode", "Pod_Status_Container_StateRestarting"))
	}
	m.ExitCode = fv
}

func (m *Pod_Status_Container_StateRestarting) SetContainerId(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ContainerId", "Pod_Status_Container_StateRestarting"))
	}
	m.ContainerId = fv
}
...
var edgelq_applications_proto_v1_pod_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x16, 0x0a, 0x03,
	...
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0xf6, 0x0d, 0x0a, 0x06, 0x53, 0x74,
	...
	,
	...
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x12, 0x50, 0x0a, 0x07, 0x77, 0x61, 0x69, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x04, 0x20,
	...
	,
	...
	0x69, 0x70, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	0x6e, 0x65, 0x72, 0x49, 0x70, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6f, 0x6e,
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x1a, 0x40, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74,
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x49, 0x0a, 0x0c, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x52, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x12, 0x39, 0x0a, 0x0a, 0x73, 0x74,
	0x61, 0x72, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x09, 0x73, 0x74, 0x61, 0x72,
	0x74, 0x65, 0x64, 0x41, 0x74, 0x1a, 0x93, 0x02, 0x0a, 0x0f, 0x53, 0x74, 0x61, 0x74, 0x65, 0x54,
	...
	,
	...
	0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x05, 0x12, 0x19, 0x0a, 0x15, 0x49, 0x4d, 0x41, 0x47,
	0x45, 0x5f, 0x44, 0x4f, 0x57, 0x4e, 0x4c, 0x4f, 0x41, 0x44, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45,
	0x44, 0x10, 0x06, 0x12, 0x0f, 0x0a, 0x0b, 0x49, 0x4e, 0x49, 0x54, 0x5f, 0x46, 0x41, 0x49, 0x4c,
	0x45, 0x44, 0x10, 0x07, 0x12, 0x15, 0x0a, 0x11, 0x50, 0x4f, 0x44, 0x5f, 0x43, 0x52, 0x45, 0x41,
	0x54, 0x45, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x08, 0x22, 0x45, 0x0a, 0x0c, 0x48,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x15, 0x48,
	0x45, 0x41, 0x4c, 0x54, 0x48, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x55, 0x4e, 0x4b,
	...
	,
	...
	0x74, 0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x6f, 0x64, 0xa2, 0x80, 0xd1, 0x02, 0x43,
	0x0a, 0x0a, 0x70, 0x6f, 0x64, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x35, 0x67, 0x69,
	...
	0x08, 0x50, 0x6f, 0x64, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3c, 0x67, 0x69, 0x74,
	...
	0x31, 0x2f, 0x70, 0x6f, 0x64, 0x3b, 0x70, 0x6f, 0x64, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var edgelq_applications_proto_v1_pod_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var edgelq_applications_proto_v1_pod_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var edgelq_applications_proto_v1_pod_proto_goTypes = []interface{}{
	(Pod_Status_Phase)(0),                        // 0: ntt.applications.v1.Pod_Status_Phase
	(Pod_Status_HealthStatus)(0),                 // 1: ntt.applications.v1.Pod_Status_HealthStatus
	(Pod_Status_Container_State)(0),              // 2: ntt.applications.v1.Pod_Status_Container_State
	(*Pod)(nil),                                  // 3: ntt.applications.v1.Pod
	(*Pod_Status)(nil),                           // 4: ntt.applications.v1.Pod.Status
	(*Pod_Status_Container)(nil),                 // 5: ntt.applications.v1.Pod.Status.Container
	(*Pod_Status_Container_StateWaiting)(nil),    // 6: ntt.applications.v1.Pod.Status.Container.StateWaiting
	(*Pod_Status_Container_StateRunning)(nil),    // 7: ntt.applications.v1.Pod.Status.Container.StateRunning
	(*Pod_Status_Container_StateTerminated)(nil), // 8: ntt.applications.v1.Pod.Status.Container.StateTerminated
	(*Pod_Status_Container_StateRestarting)(nil), // 9: ntt.applications.v1.Pod.Status.Container.StateRestarting
	(*meta.Meta)(nil),                            // 10: goten.types.Meta
	(*common.PodSpec)(nil),                       // 11: ntt.applications.v1.PodSpec
	(*timestamppb.Timestamp)(nil),                // 12: google.protobuf.Timestamp
}
var edgelq_applications_proto_v1_pod_proto_depIdxs = []int32{
	10, // 0: ntt.applications.v1.Pod.metadata:type_name -> goten.types.Meta
	11, // 1: ntt.applications.v1.Pod.spec:type_name -> ntt.applications.v1.PodSpec
	4,  // 2: ntt.applications.v1.Pod.status:type_name -> ntt.applications.v1.Pod.Status
	0,  // 3: ntt.applications.v1.Pod.Status.phase:type_name -> ntt.applications.v1.Pod_Status_Phase
	5,  // 4: ntt.applications.v1.Pod.Status.container_statuses:type_name -> ntt.applications.v1.Pod.Status.Container
	1,  // 5: ntt.applications.v1.Pod.Status.health_status:type_name -> ntt.applications.v1.Pod_Status_HealthStatus
	2,  // 6: ntt.applications.v1.Pod.Status.Container.state:type_name -> ntt.applications.v1.Pod_Status_Container_State
	6,  // 7: ntt.applications.v1.Pod.Status.Container.waiting:type_name -> ntt.applications.v1.Pod.Status.Container.StateWaiting
	7,  // 8: ntt.applications.v1.Pod.Status.Container.running:type_name -> ntt.applications.v1.Pod.Status.Container.StateRunning
	8,  // 9: ntt.applications.v1.Pod.Status.Container.terminated:type_name -> ntt.applications.v1.Pod.Status.Container.StateTerminated
	9,  // 10: ntt.applications.v1.Pod.Status.Container.restarting:type_name -> ntt.applications.v1.Pod.Status.Container.StateRestarting
	1,  // 11: ntt.applications.v1.Pod.Status.Container.health_status:type_name -> ntt.applications.v1.Pod_Status_HealthStatus
	12, // 12: ntt.applications.v1.Pod.Status.Container.StateRunning.started_at:type_name -> google.protobuf.Timestamp
	12, // 13: ntt.applications.v1.Pod.Status.Container.StateTerminated.started_at:type_name -> google.protobuf.Timestamp
	12, // 14: ntt.applications.v1.Pod.Status.Container.StateTerminated.finished_at:type_name -> google.protobuf.Timestamp
...
func edgelq_applications_proto_v1_pod_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		edgelq_applications_proto_v1_pod_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pod_Status_Container_StateRestarting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
