...
type GetServiceRequest struct {
	...
	Name *service.Name `protobuf:"bytes,1,opt,customtype=Name,name=name,proto3" json:"name,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *service.Service_FieldMask `protobuf:"bytes,3,opt,customtype=Service_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
type BatchGetServicesRequest struct {
	...
	unknownFields protoimpl.UnknownFields
	// Names of Services
	Names []*service.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *service.Service_FieldMask `protobuf:"bytes,3,opt,customtype=Service_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
...
type BatchGetServicesResponse struct {
	...
	Missing []*service.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty"`
}
...
type ListServicesRequest struct {
	...
	PageToken *service.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *service.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`
	...
	Filter *service.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *service.Service_FieldMask `protobuf:"bytes,6,opt,customtype=Service_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
func (m *ListServicesRequest) SetIncludePagingInfo(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "IncludePagingInfo", "ListServicesRequest"))
	}
...
type ListServicesResponse struct {
	...
	PrevPageToken *service.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListServicesRequest.page_token.
	NextPageToken *service.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
func (m *ListServicesResponse) SetCurrentOffset(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "CurrentOffset", "ListServicesResponse"))
	}
	m.CurrentOffset = fv
}
...
func (m *ListServicesResponse) SetTotalResultsCount(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "TotalResultsCount", "ListServicesResponse"))
	}
...
type WatchServiceRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *service.Service_FieldMask `protobuf:"bytes,2,opt,customtype=Service_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty"`
}
...
type WatchServiceResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *service.ServiceChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty"`
}
...
type WatchServicesResponse struct {
	...
	unknownFields protoimpl.UnknownFields
	// Changes of Services
	ServiceChanges []*service.ServiceChange `protobuf:"bytes,2,rep,name=service_changes,json=serviceChanges,proto3" json:"service_changes,omitempty"`
	...
	PageTokenChange *WatchServicesResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty"`
...
type WatchServicesResponse_PageTokenChange struct {
	...
	PrevPageToken *service.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// New token to retrieve next page of results.
	NextPageToken *service.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
var edgelq_meta_proto_v1alpha2_service_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x2f, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0xab, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0f, 0xb2, 0xda, 0x21, 0x0b, 0x0a, 0x09, 0x0a,
	0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x4a,
	...
	0x77, 0x22, 0xb9, 0x01, 0x0a, 0x17, 0x42, 0x61, 0x74, 0x63, 0x68, 0x47, 0x65, 0x74, 0x53, 0x65,
	...
	0x21, 0x0b, 0x0a, 0x09, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x05, 0x6e,
	...
	0x4d, 0x61, 0x73, 0x6b, 0x42, 0x0f, 0xb2, 0xda, 0x21, 0x0b, 0x32, 0x09, 0x0a, 0x07, 0x53, 0x65,
	...
	0x18, 0x42, 0x61, 0x74, 0x63, 0x68, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x08, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6e, 0x74,
	...
	0x28, 0x09, 0x42, 0x0f, 0xb2, 0xda, 0x21, 0x0b, 0x0a, 0x09, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x52, 0x07, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x22, 0xe4, 0x02, 0x0a,
	...
	0xda, 0x21, 0x0b, 0x2a, 0x09, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x07,
	...
	0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72,
	0x12, 0x4a, 0x0a, 0x0a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b,
	0x42, 0x0f, 0xb2, 0xda, 0x21, 0x0b, 0x32, 0x09, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6e, 0x66, 0x6f, 0x22, 0x97, 0x02, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x08,
	...
	0x61, 0x32, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x08, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x12, 0x37, 0x0a, 0x0f, 0x70, 0x72, 0x65, 0x76, 0x5f, 0x70, 0x61, 0x67,
	...
	0x76, 0x69, 0x63, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x4a, 0x0a, 0x0a, 0x66, 0x69,
	...
	0x14, 0x57, 0x61, 0x74, 0x63, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x65, 0x74, 0x61,
	...
	0xf9, 0x03, 0x0a, 0x14, 0x57, 0x61, 0x74, 0x63, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x0b, 0x1a, 0x09, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x06, 0x66, 0x69,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x49, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x52, 0x0e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73,
	...
	,
	...
	0x3d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x8a, 0xcc, 0x26, 0x00,
	0x12, 0xc8, 0x01, 0x0a, 0x10, 0x42, 0x61, 0x74, 0x63, 0x68, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x2a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x65, 0x74, 0x61,
	...
	,
	...
	0x76, 0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x49, 0x82,
	0xdb, 0x21, 0x21, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x04, 0x6c, 0x69,
	0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x2a, 0x00, 0x32, 0x0a, 0x12, 0x08, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0xa2, 0xdc, 0x21, 0x02, 0x08, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x14,
	0x12, 0x12, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x8a, 0xcc, 0x26, 0x00, 0x12, 0xbc, 0x01, 0x0a, 0x0c, 0x57, 0x61, 0x74,
	0x63, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x26, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	...
	,
	...
	0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x57, 0x82, 0xdb,
	...
	0x68, 0x8a, 0xcc, 0x26, 0x00, 0x30, 0x01, 0x1a, 0x2c, 0xca, 0x41, 0x0f, 0x6d, 0x65, 0x74, 0x61,
	...
	0x49, 0x0a, 0x0e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65,
	...
	0x61, 0x32, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x8a, 0xff, 0xd0, 0x02, 0x49, 0x0a,
	0x0e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12,
	...
	0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x0a, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74,
	0x74, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68,
	0x61, 0x32, 0x42, 0x13, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x63, 0x65, 0x3b, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e,
...
var edgelq_meta_proto_v1alpha2_service_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var edgelq_meta_proto_v1alpha2_service_service_proto_goTypes = []interface{}{
	...
	(*WatchServicesResponse_PageTokenChange)(nil), // 9: ntt.meta.v1alpha2.WatchServicesResponse.PageTokenChange
	(*service.Service_FieldMask)(nil),             // 10: ntt.meta.v1alpha2.Service_FieldMask
	(view.View)(0),                                // 11: goten.types.View
	(*service.Service)(nil),                       // 12: ntt.meta.v1alpha2.Service
	(*service.ServiceChange)(nil),                 // 13: ntt.meta.v1alpha2.ServiceChange
...
var edgelq_meta_proto_v1alpha2_service_service_proto_depIdxs = []int32{
	10, // 0: ntt.meta.v1alpha2.GetServiceRequest.field_mask:type_name -> ntt.meta.v1alpha2.Service_FieldMask
	11, // 1: ntt.meta.v1alpha2.GetServiceRequest.view:type_name -> goten.types.View
	10, // 2: ntt.meta.v1alpha2.BatchGetServicesRequest.field_mask:type_name -> ntt.meta.v1alpha2.Service_FieldMask
	11, // 3: ntt.meta.v1alpha2.BatchGetServicesRequest.view:type_name -> goten.types.View
	12, // 4: ntt.meta.v1alpha2.BatchGetServicesResponse.services:type_name -> ntt.meta.v1alpha2.Service
	10, // 5: ntt.meta.v1alpha2.ListServicesRequest.field_mask:type_name -> ntt.meta.v1alpha2.Service_FieldMask
	11, // 6: ntt.meta.v1alpha2.ListServicesRequest.view:type_name -> goten.types.View
	12, // 7: ntt.meta.v1alpha2.ListServicesResponse.services:type_name -> ntt.meta.v1alpha2.Service
	10, // 8: ntt.meta.v1alpha2.WatchServiceRequest.field_mask:type_name -> ntt.meta.v1alpha2.Service_FieldMask
	11, // 9: ntt.meta.v1alpha2.WatchServiceRequest.view:type_name -> goten.types.View
	13, // 10: ntt.meta.v1alpha2.WatchServiceResponse.change:type_name -> ntt.meta.v1alpha2.ServiceChange
	14, // 11: ntt.meta.v1alpha2.WatchServicesRequest.type:type_name -> goten.types.WatchType
	15, // 12: ntt.meta.v1alpha2.WatchServicesRequest.starting_time:type_name -> google.protobuf.Timestamp
	10, // 13: ntt.meta.v1alpha2.WatchServicesRequest.field_mask:type_name -> ntt.meta.v1alpha2.Service_FieldMask
	11, // 14: ntt.meta.v1alpha2.WatchServicesRequest.view:type_name -> goten.types.View
	13, // 15: ntt.meta.v1alpha2.WatchServicesResponse.service_changes:type_name -> ntt.meta.v1alpha2.ServiceChange
	9,  // 16: ntt.meta.v1alpha2.WatchServicesResponse.page_token_change:type_name -> ntt.meta.v1alpha2.WatchServicesResponse.PageTokenChange
	0,  // 17: ntt.meta.v1alpha2.ServiceService.GetService:input_type -> ntt.meta.v1alpha2.GetServiceRequest
	1,  // 18: ntt.meta.v1alpha2.ServiceService.BatchGetServices:input_type -> ntt.meta.v1alpha2.BatchGetServicesRequest
	3,  // 19: ntt.meta.v1alpha2.ServiceService.ListServices:input_type -> ntt.meta.v1alpha2.ListServicesRequest
	5,  // 20: ntt.meta.v1alpha2.ServiceService.WatchService:input_type -> ntt.meta.v1alpha2.WatchServiceRequest
	7,  // 21: ntt.meta.v1alpha2.ServiceService.WatchServices:input_type -> ntt.meta.v1alpha2.WatchServicesRequest
	12, // 22: ntt.meta.v1alpha2.ServiceService.GetService:output_type -> ntt.meta.v1alpha2.Service
	2,  // 23: ntt.meta.v1alpha2.ServiceService.BatchGetServices:output_type -> ntt.meta.v1alpha2.BatchGetServicesResponse
	4,  // 24: ntt.meta.v1alpha2.ServiceService.ListServices:output_type -> ntt.meta.v1alpha2.ListServicesResponse
	6,  // 25: ntt.meta.v1alpha2.ServiceService.WatchService:output_type -> ntt.meta.v1alpha2.WatchServiceResponse
	8,  // 26: ntt.meta.v1alpha2.ServiceService.WatchServices:output_type -> ntt.meta.v1alpha2.WatchServicesResponse
