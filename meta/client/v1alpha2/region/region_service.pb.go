...
type GetRegionRequest struct {
	...
	Name *region.Name `protobuf:"bytes,1,opt,customtype=Name,name=name,proto3" json:"name,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *region.Region_FieldMask `protobuf:"bytes,3,opt,customtype=Region_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
type BatchGetRegionsRequest struct {
	...
	unknownFields protoimpl.UnknownFields
	// Names of Regions
	Names []*region.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *region.Region_FieldMask `protobuf:"bytes,3,opt,customtype=Region_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
...
type BatchGetRegionsResponse struct {
	...
	unknownFields protoimpl.UnknownFields
	// found Regions
	Regions []*region.Region `protobuf:"bytes,1,rep,name=regions,proto3" json:"regions,omitempty"`
	// list of not found Regions
	Missing []*region.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty"`
}
...
type ListRegionsRequest struct {
	...
	PageToken *region.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *region.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`
	...
	Filter *region.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *region.Region_FieldMask `protobuf:"bytes,6,opt,customtype=Region_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
type ListRegionsResponse struct {
	...
	PrevPageToken *region.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListRegionsRequest.page_token.
	NextPageToken *region.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
type WatchRegionRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *region.Region_FieldMask `protobuf:"bytes,2,opt,customtype=Region_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty"`
}
...
type WatchRegionResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *region.RegionChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty"`
}
...
type WatchRegionsResponse struct {
	...
	unknownFields protoimpl.UnknownFields
	// Changes of Regions
	RegionChanges []*region.RegionChange `protobuf:"bytes,2,rep,name=region_changes,json=regionChanges,proto3" json:"region_changes,omitempty"`
	...
	PageTokenChange *WatchRegionsResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty"`
...
type WatchRegionsResponse_PageTokenChange struct {
	...
	PrevPageToken *region.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// New token to retrieve next page of results.
	NextPageToken *region.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
var edgelq_meta_proto_v1alpha2_region_service_proto_rawDesc = []byte{
	...
	,
	...
	0x08, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x09, 0x66, 0x69, 0x65, 0x6c, 0x64,
	...
	0x02, 0x20, 0x03, 0x28, 0x09, 0x42, 0x0e, 0xb2, 0xda, 0x21, 0x0a, 0x0a, 0x08, 0x0a, 0x06, 0x52,
	0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x12, 0x49, 0x0a, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x28, 0x0a, 0x07, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x09, 0x42, 0x0e, 0xb2, 0xda, 0x21, 0x0a, 0x0a, 0x08, 0x0a, 0x06, 0x52,
	0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x22, 0xdf,
	...
	0xda, 0x21, 0x0a, 0x2a, 0x08, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x6f,
	...
	0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x49,
	...
	0x22, 0x91, 0x02, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x72, 0x65, 0x67, 0x69,
	0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	0x6d, 0x65, 0x74, 0x61, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x52, 0x65,
	0x67, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x36, 0x0a,
	...
	0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x70, 0x72, 0x65, 0x76, 0x50, 0x61, 0x67, 0x65,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0xaa, 0x01, 0x0a, 0x12, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65,
	0x67, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x22, 0x0a, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0e, 0xb2, 0xda, 0x21, 0x0a, 0x0a,
	0x08, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	...
	0x77, 0x22, 0x4e, 0x0a, 0x13, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x06, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d,
	...
	0x65, 0x22, 0xf4, 0x03, 0x0a, 0x13, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x67, 0x69, 0x6f,
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x25, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69,
	0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x42, 0x08, 0xca, 0xc6, 0x27, 0x04, 0x12, 0x02,
	0x2a, 0x00, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x2d, 0x0a, 0x0a,
	0x70, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x0e, 0xb2, 0xda, 0x21, 0x0a, 0x22, 0x08, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e,
	...
	0x1a, 0x08, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74,
	...
	0x63, 0x68, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x46, 0x0a, 0x0e, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	0x6d, 0x65, 0x74, 0x61, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x52, 0x65,
	0x67, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x0d, 0x72, 0x65, 0x67, 0x69,
	...
	0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x67,
	...
	0x22, 0x08, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x70, 0x72, 0x65, 0x76,
	...
	0x6e, 0x32, 0xba, 0x07, 0x0a, 0x0d, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x9a, 0x01, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x52, 0x65, 0x67, 0x69, 0x6f,
	...
	0x6e, 0x22, 0x4d, 0x82, 0xdb, 0x21, 0x1d, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x65, 0x3d, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x2a, 0x7d, 0x8a, 0xcc, 0x26, 0x00,
	0x12, 0xc2, 0x01, 0x0a, 0x0f, 0x42, 0x61, 0x74, 0x63, 0x68, 0x47, 0x65, 0x74, 0x52, 0x65, 0x67,
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x29, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x69, 0x73, 0x2e, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2e, 0x63, 0x6f, 0x6d, 0x42, 0x92,
	0x02, 0xe8, 0xde, 0x21, 0x00, 0x82, 0xff, 0xd0, 0x02, 0x47, 0x0a, 0x0d, 0x72, 0x65, 0x67, 0x69,
	0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x72, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x6f,
	0x6e, 0x8a, 0xff, 0xd0, 0x02, 0x47, 0x0a, 0x0d, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x5f, 0x63,
	...
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x0a, 0x18, 0x63,
	0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x70, 0x62, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x42, 0x12, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x53,
	...
	0x65, 0x67, 0x69, 0x6f, 0x6e, 0x3b, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6c, 0x69,
...
var edgelq_meta_proto_v1alpha2_region_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var edgelq_meta_proto_v1alpha2_region_service_proto_goTypes = []interface{}{
	...
	(*WatchRegionsResponse_PageTokenChange)(nil), // 9: ntt.meta.v1alpha2.WatchRegionsResponse.PageTokenChange
	(*region.Region_FieldMask)(nil),              // 10: ntt.meta.v1alpha2.Region_FieldMask
	(view.View)(0),                               // 11: goten.types.View
	(*region.Region)(nil),                        // 12: ntt.meta.v1alpha2.Region
	(*region.RegionChange)(nil),                  // 13: ntt.meta.v1alpha2.RegionChange
...
var edgelq_meta_proto_v1alpha2_region_service_proto_depIdxs = []int32{
	10, // 0: ntt.meta.v1alpha2.GetRegionRequest.field_mask:type_name -> ntt.meta.v1alpha2.Region_FieldMask
	11, // 1: ntt.meta.v1alpha2.GetRegionRequest.view:type_name -> goten.types.View
	10, // 2: ntt.meta.v1alpha2.BatchGetRegionsRequest.field_mask:type_name -> ntt.meta.v1alpha2.Region_FieldMask
	11, // 3: ntt.meta.v1alpha2.BatchGetRegionsRequest.view:type_name -> goten.types.View
	12, // 4: ntt.meta.v1alpha2.BatchGetRegionsResponse.regions:type_name -> ntt.meta.v1alpha2.Region
	10, // 5: ntt.meta.v1alpha2.ListRegionsRequest.field_mask:type_name -> ntt.meta.v1alpha2.Region_FieldMask
	11, // 6: ntt.meta.v1alpha2.ListRegionsRequest.view:type_name -> goten.types.View
	12, // 7: ntt.meta.v1alpha2.ListRegionsResponse.regions:type_name -> ntt.meta.v1alpha2.Region
	10, // 8: ntt.meta.v1alpha2.WatchRegionRequest.field_mask:type_name -> ntt.meta.v1alpha2.Region_FieldMask
	11, // 9: ntt.meta.v1alpha2.WatchRegionRequest.view:type_name -> goten.types.View
	13, // 10: ntt.meta.v1alpha2.WatchRegionResponse.change:type_name -> ntt.meta.v1alpha2.RegionChange
	14, // 11: ntt.meta.v1alpha2.WatchRegionsRequest.type:type_name -> goten.types.WatchType
	15, // 12: ntt.meta.v1alpha2.WatchRegionsRequest.starting_time:type_name -> google.protobuf.Timestamp
	10, // 13: ntt.meta.v1alpha2.WatchRegionsRequest.field_mask:type_name -> ntt.meta.v1alpha2.Region_FieldMask
	11, // 14: ntt.meta.v1alpha2.WatchRegionsRequest.view:type_name -> goten.types.View
	13, // 15: ntt.meta.v1alpha2.WatchRegionsResponse.region_changes:type_name -> ntt.meta.v1alpha2.RegionChange
	9,  // 16: ntt.meta.v1alpha2.WatchRegionsResponse.page_token_change:type_name -> ntt.meta.v1alpha2.WatchRegionsResponse.PageTokenChange
	0,  // 17: ntt.meta.v1alpha2.RegionService.GetRegion:input_type -> ntt.meta.v1alpha2.GetRegionRequest
	1,  // 18: ntt.meta.v1alpha2.RegionService.BatchGetRegions:input_type -> ntt.meta.v1alpha2.BatchGetRegionsRequest
	3,  // 19: ntt.meta.v1alpha2.RegionService.ListRegions:input_type -> ntt.meta.v1alpha2.ListRegionsRequest
	5,  // 20: ntt.meta.v1alpha2.RegionService.WatchRegion:input_type -> ntt.meta.v1alpha2.WatchRegionRequest
	7,  // 21: ntt.meta.v1alpha2.RegionService.WatchRegions:input_type -> ntt.meta.v1alpha2.WatchRegionsRequest
	12, // 22: ntt.meta.v1alpha2.RegionService.GetRegion:output_type -> ntt.meta.v1alpha2.Region
	2,  // 23: ntt.meta.v1alpha2.RegionService.BatchGetRegions:output_type -> ntt.meta.v1alpha2.BatchGetRegionsResponse
	4,  // 24: ntt.meta.v1alpha2.RegionService.ListRegions:output_type -> ntt.meta.v1alpha2.ListRegionsResponse
	6,  // 25: ntt.meta.v1alpha2.RegionService.WatchRegion:output_type -> ntt.meta.v1alpha2.WatchRegionResponse
	8,  // 26: ntt.meta.v1alpha2.RegionService.WatchRegions:output_type -> ntt.meta.v1alpha2.WatchRegionsResponse
