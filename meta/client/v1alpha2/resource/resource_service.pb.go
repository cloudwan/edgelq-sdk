...
type GetResourceRequest struct {
	...
	Name *resource.Name `protobuf:"bytes,1,opt,customtype=Name,name=name,proto3" json:"name,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *resource.Resource_FieldMask `protobuf:"bytes,3,opt,customtype=Resource_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
type BatchGetResourcesRequest struct {
	...
	unknownFields protoimpl.UnknownFields
	// Names of Resources
	Names []*resource.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *resource.Resource_FieldMask `protobuf:"bytes,3,opt,customtype=Resource_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
...
type BatchGetResourcesResponse struct {
	...
	Missing []*resource.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty"`
}
...
type ListResourcesRequest struct {
	...
	Parent *resource.ParentName `protobuf:"bytes,1,opt,customtype=ParentName,name=parent,proto3" json:"parent,omitempty"`
	...
	PageToken *resource.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *resource.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`
	...
	Filter *resource.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *resource.Resource_FieldMask `protobuf:"bytes,6,opt,customtype=Resource_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
type ListResourcesResponse struct {
	...
	PrevPageToken *resource.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListResourcesRequest.page_token.
	NextPageToken *resource.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
type WatchResourceRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *resource.Resource_FieldMask `protobuf:"bytes,2,opt,customtype=Resource_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty"`
}
...
type WatchResourceResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *resource.ResourceChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty"`
}
...
type WatchResourcesResponse struct {
	...
	ResourceChanges []*resource.ResourceChange `protobuf:"bytes,2,rep,name=resource_changes,json=resourceChanges,proto3" json:"resource_changes,omitempty"`
	...
	PageTokenChange *WatchResourcesResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty"`
...
type WatchResourcesResponse_PageTokenChange struct {
	...
	PrevPageToken *resource.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// New token to retrieve next page of results.
	NextPageToken *resource.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
