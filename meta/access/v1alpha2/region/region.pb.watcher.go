...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(region.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Name) gotenaccess.WatcherFilterParams {
