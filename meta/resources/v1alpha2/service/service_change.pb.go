...
type ServiceChange_Added_ struct {
	...
	// enters Query view
	Added *ServiceChange_Added `protobuf:"bytes,1,opt,name=added,proto3,oneof"`
}
type ServiceChange_Modified_ struct {
	// Modified is returned when watched document is modified
	Modified *ServiceChange_Modified `protobuf:"bytes,2,opt,name=modified,proto3,oneof"`
}
type ServiceChange_Current_ struct {
	// Current is returned in stateless watch when document enters query view or
	// is modified within.
	Current *ServiceChange_Current `protobuf:"bytes,4,opt,name=current,proto3,oneof"`
}
type ServiceChange_Removed_ struct {
	// Removed is returned when Service is deleted or leaves Query view
	Removed *ServiceChange_Removed `protobuf:"bytes,3,opt,name=removed,proto3,oneof"`
}
...
type ServiceChange_Modified struct {
	...
	// properties.
	FieldMask *Service_FieldMask `protobuf:"bytes,3,opt,customtype=Service_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
