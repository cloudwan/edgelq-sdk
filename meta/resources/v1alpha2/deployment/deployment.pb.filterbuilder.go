...
func (b *filterCndBuilderMetadataOwnerReferencesApiVersion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Deployment_FieldPathArrayOfValues: NewDeploymentFieldPathBuilder().Metadata().OwnerReferences().ApiVersion().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesApiVersion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewDeploymentFieldPathBuilder().Metadata().OwnerReferences().ApiVersion().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesApiVersion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                  op,
		Deployment_FieldPathValue: NewDeploymentFieldPathBuilder().Metadata().OwnerReferences().ApiVersion().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUid) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Deployment_FieldPathArrayOfValues: NewDeploymentFieldPathBuilder().Metadata().OwnerReferences().Uid().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUid) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewDeploymentFieldPathBuilder().Metadata().OwnerReferences().Uid().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUid) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                  op,
		Deployment_FieldPathValue: NewDeploymentFieldPathBuilder().Metadata().OwnerReferences().Uid().WithValue(value),
	})
}
