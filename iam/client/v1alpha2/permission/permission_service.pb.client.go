...
func (c *client) GetPermission(ctx context.Context, in *GetPermissionRequest, opts ...grpc.CallOption) (*permission.Permission, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.iam.v1alpha2.PermissionService/GetPermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetPermissions(ctx context.Context, in *BatchGetPermissionsRequest, opts ...grpc.CallOption) (*BatchGetPermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.iam.v1alpha2.PermissionService/BatchGetPermissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListPermissions(ctx context.Context, in *ListPermissionsRequest, opts ...grpc.CallOption) (*ListPermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.iam.v1alpha2.PermissionService/ListPermissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchPermission(ctx context.Context, in *WatchPermissionRequest, opts ...grpc.CallOption) (WatchPermissionClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.iam.v1alpha2.PermissionService/WatchPermission", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchPermissions(ctx context.Context, in *WatchPermissionsRequest, opts ...grpc.CallOption) (WatchPermissionsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.iam.v1alpha2.PermissionService/WatchPermissions", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreatePermission(ctx context.Context, in *CreatePermissionRequest, opts ...grpc.CallOption) (*permission.Permission, error) {
	out := new(permission.Permission)
	err := c.cc.Invoke(ctx, "/ntt.iam.v1alpha2.PermissionService/CreatePermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, opts ...grpc.CallOption) (*permission.Permission, error) {
	out := new(permission.Permission)
	err := c.cc.Invoke(ctx, "/ntt.iam.v1alpha2.PermissionService/UpdatePermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeletePermission(ctx context.Context, in *DeletePermissionRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.iam.v1alpha2.PermissionService/DeletePermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
