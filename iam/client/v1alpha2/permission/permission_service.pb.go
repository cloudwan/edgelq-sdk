...
type GetPermissionRequest struct {
	...
	// Name of ntt.iam.v1alpha2.Permission
	Name *permission.Name `protobuf:"bytes,1,opt,customtype=Name,name=name,proto3" json:"name,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *permission.Permission_FieldMask `protobuf:"bytes,3,opt,customtype=Permission_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
func (m *GetPermissionRequest) Reset() {
	*m = GetPermissionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[0]
...
type BatchGetPermissionsRequest struct {
	...
	Names []*permission.Name `protobuf:"bytes,2,rep,customtype=Name,name=names,proto3" json:"names,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *permission.Permission_FieldMask `protobuf:"bytes,3,opt,customtype=Permission_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
...
func (m *BatchGetPermissionsRequest) Reset() {
	*m = BatchGetPermissionsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchGetPermissionsRequest) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{1}
}
...
type BatchGetPermissionsResponse struct {
	...
	Missing []*permission.Name `protobuf:"bytes,2,rep,customtype=Name,name=missing,proto3" json:"missing,omitempty"`
}

func (m *BatchGetPermissionsResponse) Reset() {
	*m = BatchGetPermissionsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchGetPermissionsResponse) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{2}
}
...
type ListPermissionsRequest struct {
	...
	PageToken *permission.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Order By -
	// https://cloud.google.com/apis/design/design_patterns#list_pagination list
	// of field path with order directive, either 'asc' or 'desc'. If direction is
	// not provided, 'asc' is assumed. e.g. "state.nested_field asc,
	// state.something.else desc, theme"
	OrderBy *permission.OrderBy `protobuf:"bytes,4,opt,customtype=OrderBy,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`
	...
	Filter *permission.Filter `protobuf:"bytes,5,opt,customtype=Filter,name=filter,proto3" json:"filter,omitempty"`
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *permission.Permission_FieldMask `protobuf:"bytes,6,opt,customtype=Permission_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
...
func (m *ListPermissionsRequest) Reset() {
	*m = ListPermissionsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListPermissionsRequest) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{3}
}
...
type ListPermissionsResponse struct {
	...
	PrevPageToken *permission.PagerCursor `protobuf:"bytes,3,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// A token to retrieve next page of results.
	//
	// Pass this value in the ListPermissionsRequest.page_token.
	NextPageToken *permission.PagerCursor `protobuf:"bytes,4,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
func (m *ListPermissionsResponse) Reset() {
	*m = ListPermissionsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListPermissionsResponse) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{4}
}
...
type WatchPermissionRequest struct {
	...
	// A list of extra fields to be obtained for each response item on top of
	// fields defined by request field view
	FieldMask *permission.Permission_FieldMask `protobuf:"bytes,2,opt,customtype=Permission_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	// View defines list of standard response fields present in response items.
	// Additional fields can be amended by request field field_mask
	View view.View `protobuf:"varint,4,opt,name=view,proto3,enum=goten.types.View" json:"view,omitempty"`
}
...
func (m *WatchPermissionRequest) Reset() {
	*m = WatchPermissionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
type WatchPermissionResponse struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Change        *permission.PermissionChange `protobuf:"bytes,1,opt,name=change,proto3" json:"change,omitempty"`
}

func (m *WatchPermissionResponse) Reset() {
	*m = WatchPermissionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *WatchPermissionsRequest) Reset() {
	*m = WatchPermissionsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WatchPermissionsRequest) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{7}
}
...
type WatchPermissionsResponse struct {
	...
	PermissionChanges []*permission.PermissionChange `protobuf:"bytes,2,rep,name=permission_changes,json=permissionChanges,proto3" json:"permission_changes,omitempty"`
	...
	PageTokenChange *WatchPermissionsResponse_PageTokenChange `protobuf:"bytes,3,opt,name=page_token_change,json=pageTokenChange,proto3" json:"page_token_change,omitempty"`
...
func (m *WatchPermissionsResponse) Reset() {
	*m = WatchPermissionsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WatchPermissionsResponse) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{8}
}
...
type CreatePermissionRequest struct {
	...
	Permission *permission.Permission `protobuf:"bytes,2,opt,name=permission,proto3" json:"permission,omitempty"`
	// Optional masking applied to response object to reduce message response
	// size.
	ResponseMask *CreatePermissionRequest_ResponseMask `protobuf:"bytes,3,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}

func (m *CreatePermissionRequest) Reset() {
	*m = CreatePermissionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreatePermissionRequest) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{9}
}
...
type UpdatePermissionRequest struct {
	...
	// the mask
	UpdateMask *permission.Permission_FieldMask `protobuf:"bytes,3,opt,customtype=Permission_FieldMask,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"`
	// Conditional update applied to request if update should be executed only for
	// specific resource state. If this field is populated, then server will fetch
	// existing resource, compare with the one stored in the cas field (after
	// applying field mask) and proceed with update only and only if they match.
	// Otherwise RPC error Aborted will be returned.
	Cas *UpdatePermissionRequest_CAS `protobuf:"bytes,4,opt,name=cas,proto3" json:"cas,omitempty"`
	...
	ResponseMask *UpdatePermissionRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty"`
}

func (m *UpdatePermissionRequest) Reset() {
	*m = UpdatePermissionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *DeletePermissionRequest) Reset() {
	*m = DeletePermissionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeletePermissionRequest) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{11}
}
...
func (m *DeletePermissionRequest) GetAllowMissing() bool {
	if m != nil {
		return m.AllowMissing
	}
	return false
...
func (m *DeletePermissionRequest) SetAllowMissing(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "AllowMissing", "DeletePermissionRequest"))
	}
	m.AllowMissing = fv
}
...
type WatchPermissionsResponse_PageTokenChange struct {
	...
	PrevPageToken *permission.PagerCursor `protobuf:"bytes,1,opt,customtype=PagerCursor,name=prev_page_token,json=prevPageToken,proto3" json:"prev_page_token,omitempty"`
	// New token to retrieve next page of results.
	NextPageToken *permission.PagerCursor `protobuf:"bytes,2,opt,customtype=PagerCursor,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}

func (m *WatchPermissionsResponse_PageTokenChange) Reset() {
	*m = WatchPermissionsResponse_PageTokenChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *CreatePermissionRequest_ResponseMask) Reset() {
	*m = CreatePermissionRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreatePermissionRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{9, 0}
}
...
type CreatePermissionRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *permission.Permission_FieldMask `protobuf:"bytes,2,opt,customtype=Permission_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}
...
type UpdatePermissionRequest_CAS struct {
	...
	ConditionalState *permission.Permission `protobuf:"bytes,1,opt,name=conditional_state,json=conditionalState,proto3" json:"conditional_state,omitempty"`
...
func (m *UpdatePermissionRequest_CAS) Reset() {
	*m = UpdatePermissionRequest_CAS{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdatePermissionRequest_CAS) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{10, 0}
}
...
func (m *UpdatePermissionRequest_ResponseMask) Reset() {
	*m = UpdatePermissionRequest_ResponseMask{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdatePermissionRequest_ResponseMask) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP(), []int{10, 1}
}
...
type UpdatePermissionRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *permission.Permission_FieldMask `protobuf:"bytes,3,opt,customtype=Permission_FieldMask,name=body_mask,json=bodyMask,proto3,oneof"`
}
...
var edgelq_iam_proto_v1alpha2_permission_service_proto preflect.FileDescriptor

var edgelq_iam_proto_v1alpha2_permission_service_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2a, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x31, 0x65, 0x64, 0x67, 0x65, 0x6c,
	...
	0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x4d, 0x0a,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x12, 0x4d, 0x0a, 0x0a,
	...
	0x65, 0x77, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x22, 0x8b, 0x01, 0x0a, 0x1b, 0x42, 0x61, 0x74,
	...
	0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x42, 0x12, 0xb2, 0xda, 0x21, 0x0e, 0x0a,
	0x0c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x22, 0xf3, 0x02, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x50,
	...
	,
	...
	,
	...
	0x74, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xb6, 0x01, 0x0a, 0x16, 0x57, 0x61, 0x74, 0x63,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x4d, 0x0a, 0x0a, 0x66, 0x69,
	...
	0x22, 0x55, 0x0a, 0x17, 0x57, 0x61, 0x74, 0x63, 0x68, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x06, 0x63,
	...
	0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x88, 0x04, 0x0a, 0x17, 0x57, 0x61, 0x74, 0x63,
	...
	0x22, 0x0c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x09,
	...
	0x0e, 0x2a, 0x0c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x21, 0x0e, 0x1a, 0x0c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x7a, 0x65, 0x22, 0x90, 0x04, 0x0a, 0x18, 0x57, 0x61, 0x74, 0x63, 0x68, 0x50, 0x65, 0x72, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x51, 0x0a, 0x12, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x6e, 0x74,
	0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x50,
	0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xea, 0x02, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x42, 0x0c, 0xc8, 0xd5, 0x22, 0x01, 0xca, 0xc6, 0x27, 0x04, 0x62, 0x02, 0x08,
	0x01, 0x52, 0x0a, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x5b, 0x0a,
	...
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x1a, 0xa5, 0x01, 0x0a, 0x0c, 0x52,
	...
	,
	...
	0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x61, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69,
	...
	0x73, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69,
	0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	0x70, 0x68, 0x61, 0x32, 0x2e, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x42,
	...
	0x66, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x42, 0x12, 0xb2, 0xda, 0x21,
	0x0e, 0x32, 0x0c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52,
	0x09, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x1a, 0xd7, 0x01, 0x0a, 0x0c, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x12, 0x3b, 0x0a, 0x19, 0x73,
	0x6b, 0x69, 0x70, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x5f, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00,
	0x52, 0x16, 0x73, 0x6b, 0x69, 0x70, 0x45, 0x6e, 0x74, 0x69, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x4d, 0x0a, 0x09, 0x62, 0x6f,
	...
	0x0c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52,
	0x08, 0x62, 0x6f, 0x64, 0x79, 0x4d, 0x61, 0x73, 0x6b, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x61, 0x73,
	0x6b, 0x69, 0x6e, 0x67, 0x22, 0x66, 0x0a, 0x17, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x65,
	...
	0xda, 0x21, 0x0e, 0x0a, 0x0c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f,
	...
	,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x64, 0x82, 0xdb, 0x21, 0x30, 0x0a, 0x0a, 0x50, 0x65,
	...
	0x0b, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0xa2, 0xdc, 0x21, 0x02,
	0x08, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x20, 0x12, 0x1e, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x32, 0x2f, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x3a,
	0x62, 0x61, 0x74, 0x63, 0x68, 0x47, 0x65, 0x74, 0x8a, 0xcc, 0x26, 0x00, 0x12, 0xba, 0x01, 0x0a,
	...
	0x68, 0x61, 0x32, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x6e, 0x74, 0x74,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x52, 0x82, 0xdb, 0x21, 0x27, 0x0a, 0x0a, 0x50, 0x65, 0x72,
	...
	0x6e, 0x73, 0xa2, 0xdc, 0x21, 0x02, 0x08, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x17, 0x12, 0x15,
	0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x8a, 0xcc, 0x26, 0x00, 0x12, 0xc9, 0x01, 0x0a, 0x0f, 0x57, 0x61,
	0x74, 0x63, 0x68, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x28, 0x2e,
	0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32,
	0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x22, 0x65, 0x82, 0xdb, 0x21, 0x2c, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69,
	...
	0x23, 0x3a, 0x0a, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x15, 0x2f,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x73, 0x8a, 0xcc, 0x26, 0x02, 0x10, 0x01, 0x12, 0xd4, 0x01, 0x0a, 0x10, 0x55,
	...
	0x61, 0x32, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x6e, 0x74, 0x74,
	0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x50, 0x65,
	0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x77, 0x82, 0xdb, 0x21, 0x2a, 0x0a, 0x0a,
	...
	,
	...
	0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2e, 0x63, 0x6f, 0x6d, 0x42, 0xaa, 0x02, 0xe8, 0xde, 0x21,
	0x00, 0x82, 0xff, 0xd0, 0x02, 0x4e, 0x0a, 0x11, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x8a, 0xff, 0xd0, 0x02, 0x4e, 0x0a, 0x11, 0x70, 0x65, 0x72, 0x6d, 0x69,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x39, 0x67, 0x69,
	...
	0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x70, 0x65, 0x72,
	0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74,
	0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32,
	0x42, 0x16, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76,
	...
	0x74, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x70, 0x65, 0x72, 0x6d, 0x69,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x3b, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescData = edgelq_iam_proto_v1alpha2_permission_service_proto_rawDesc
)

func edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescData)
	})
	return edgelq_iam_proto_v1alpha2_permission_service_proto_rawDescData
}

var edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var edgelq_iam_proto_v1alpha2_permission_service_proto_goTypes = []interface{}{
	(*GetPermissionRequest)(nil),                     // 0: ntt.iam.v1alpha2.GetPermissionRequest
	(*BatchGetPermissionsRequest)(nil),               // 1: ntt.iam.v1alpha2.BatchGetPermissionsRequest
	(*BatchGetPermissionsResponse)(nil),              // 2: ntt.iam.v1alpha2.BatchGetPermissionsResponse
	(*ListPermissionsRequest)(nil),                   // 3: ntt.iam.v1alpha2.ListPermissionsRequest
	(*ListPermissionsResponse)(nil),                  // 4: ntt.iam.v1alpha2.ListPermissionsResponse
	(*WatchPermissionRequest)(nil),                   // 5: ntt.iam.v1alpha2.WatchPermissionRequest
	(*WatchPermissionResponse)(nil),                  // 6: ntt.iam.v1alpha2.WatchPermissionResponse
	(*WatchPermissionsRequest)(nil),                  // 7: ntt.iam.v1alpha2.WatchPermissionsRequest
	(*WatchPermissionsResponse)(nil),                 // 8: ntt.iam.v1alpha2.WatchPermissionsResponse
	(*CreatePermissionRequest)(nil),                  // 9: ntt.iam.v1alpha2.CreatePermissionRequest
	(*UpdatePermissionRequest)(nil),                  // 10: ntt.iam.v1alpha2.UpdatePermissionRequest
	(*DeletePermissionRequest)(nil),                  // 11: ntt.iam.v1alpha2.DeletePermissionRequest
	(*WatchPermissionsResponse_PageTokenChange)(nil), // 12: ntt.iam.v1alpha2.WatchPermissionsResponse.PageTokenChange
	(*CreatePermissionRequest_ResponseMask)(nil),     // 13: ntt.iam.v1alpha2.CreatePermissionRequest.ResponseMask
	(*UpdatePermissionRequest_CAS)(nil),              // 14: ntt.iam.v1alpha2.UpdatePermissionRequest.CAS
	(*UpdatePermissionRequest_ResponseMask)(nil),     // 15: ntt.iam.v1alpha2.UpdatePermissionRequest.ResponseMask
	(*permission.Permission_FieldMask)(nil),          // 16: ntt.iam.v1alpha2.Permission_FieldMask
	(view.View)(0),                                   // 17: goten.types.View
	(*permission.Permission)(nil),                    // 18: ntt.iam.v1alpha2.Permission
	(*permission.PermissionChange)(nil),              // 19: ntt.iam.v1alpha2.PermissionChange
	(watch_type.WatchType)(0),                        // 20: goten.types.WatchType
	(*timestamppb.Timestamp)(nil),                    // 21: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                            // 22: google.protobuf.Empty
}
var edgelq_iam_proto_v1alpha2_permission_service_proto_depIdxs = []int32{
	16, // 0: ntt.iam.v1alpha2.GetPermissionRequest.field_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	17, // 1: ntt.iam.v1alpha2.GetPermissionRequest.view:type_name -> goten.types.View
	16, // 2: ntt.iam.v1alpha2.BatchGetPermissionsRequest.field_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	17, // 3: ntt.iam.v1alpha2.BatchGetPermissionsRequest.view:type_name -> goten.types.View
	18, // 4: ntt.iam.v1alpha2.BatchGetPermissionsResponse.permissions:type_name -> ntt.iam.v1alpha2.Permission
	16, // 5: ntt.iam.v1alpha2.ListPermissionsRequest.field_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	17, // 6: ntt.iam.v1alpha2.ListPermissionsRequest.view:type_name -> goten.types.View
	18, // 7: ntt.iam.v1alpha2.ListPermissionsResponse.permissions:type_name -> ntt.iam.v1alpha2.Permission
	16, // 8: ntt.iam.v1alpha2.WatchPermissionRequest.field_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	17, // 9: ntt.iam.v1alpha2.WatchPermissionRequest.view:type_name -> goten.types.View
	19, // 10: ntt.iam.v1alpha2.WatchPermissionResponse.change:type_name -> ntt.iam.v1alpha2.PermissionChange
	20, // 11: ntt.iam.v1alpha2.WatchPermissionsRequest.type:type_name -> goten.types.WatchType
	21, // 12: ntt.iam.v1alpha2.WatchPermissionsRequest.starting_time:type_name -> google.protobuf.Timestamp
	16, // 13: ntt.iam.v1alpha2.WatchPermissionsRequest.field_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	17, // 14: ntt.iam.v1alpha2.WatchPermissionsRequest.view:type_name -> goten.types.View
	19, // 15: ntt.iam.v1alpha2.WatchPermissionsResponse.permission_changes:type_name -> ntt.iam.v1alpha2.PermissionChange
	12, // 16: ntt.iam.v1alpha2.WatchPermissionsResponse.page_token_change:type_name -> ntt.iam.v1alpha2.WatchPermissionsResponse.PageTokenChange
	18, // 17: ntt.iam.v1alpha2.CreatePermissionRequest.permission:type_name -> ntt.iam.v1alpha2.Permission
	13, // 18: ntt.iam.v1alpha2.CreatePermissionRequest.response_mask:type_name -> ntt.iam.v1alpha2.CreatePermissionRequest.ResponseMask
	18, // 19: ntt.iam.v1alpha2.UpdatePermissionRequest.permission:type_name -> ntt.iam.v1alpha2.Permission
	16, // 20: ntt.iam.v1alpha2.UpdatePermissionRequest.update_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	14, // 21: ntt.iam.v1alpha2.UpdatePermissionRequest.cas:type_name -> ntt.iam.v1alpha2.UpdatePermissionRequest.CAS
	15, // 22: ntt.iam.v1alpha2.UpdatePermissionRequest.response_mask:type_name -> ntt.iam.v1alpha2.UpdatePermissionRequest.ResponseMask
	16, // 23: ntt.iam.v1alpha2.CreatePermissionRequest.ResponseMask.body_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	18, // 24: ntt.iam.v1alpha2.UpdatePermissionRequest.CAS.conditional_state:type_name -> ntt.iam.v1alpha2.Permission
	16, // 25: ntt.iam.v1alpha2.UpdatePermissionRequest.CAS.field_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	16, // 26: ntt.iam.v1alpha2.UpdatePermissionRequest.ResponseMask.body_mask:type_name -> ntt.iam.v1alpha2.Permission_FieldMask
	0,  // 27: ntt.iam.v1alpha2.PermissionService.GetPermission:input_type -> ntt.iam.v1alpha2.GetPermissionRequest
	1,  // 28: ntt.iam.v1alpha2.PermissionService.BatchGetPermissions:input_type -> ntt.iam.v1alpha2.BatchGetPermissionsRequest
	3,  // 29: ntt.iam.v1alpha2.PermissionService.ListPermissions:input_type -> ntt.iam.v1alpha2.ListPermissionsRequest
	5,  // 30: ntt.iam.v1alpha2.PermissionService.WatchPermission:input_type -> ntt.iam.v1alpha2.WatchPermissionRequest
	7,  // 31: ntt.iam.v1alpha2.PermissionService.WatchPermissions:input_type -> ntt.iam.v1alpha2.WatchPermissionsRequest
	9,  // 32: ntt.iam.v1alpha2.PermissionService.CreatePermission:input_type -> ntt.iam.v1alpha2.CreatePermissionRequest
	10, // 33: ntt.iam.v1alpha2.PermissionService.UpdatePermission:input_type -> ntt.iam.v1alpha2.UpdatePermissionRequest
	11, // 34: ntt.iam.v1alpha2.PermissionService.DeletePermission:input_type -> ntt.iam.v1alpha2.DeletePermissionRequest
	18, // 35: ntt.iam.v1alpha2.PermissionService.GetPermission:output_type -> ntt.iam.v1alpha2.Permission
	2,  // 36: ntt.iam.v1alpha2.PermissionService.BatchGetPermissions:output_type -> ntt.iam.v1alpha2.BatchGetPermissionsResponse
	4,  // 37: ntt.iam.v1alpha2.PermissionService.ListPermissions:output_type -> ntt.iam.v1alpha2.ListPermissionsResponse
	6,  // 38: ntt.iam.v1alpha2.PermissionService.WatchPermission:output_type -> ntt.iam.v1alpha2.WatchPermissionResponse
	8,  // 39: ntt.iam.v1alpha2.PermissionService.WatchPermissions:output_type -> ntt.iam.v1alpha2.WatchPermissionsResponse
	18, // 40: ntt.iam.v1alpha2.PermissionService.CreatePermission:output_type -> ntt.iam.v1alpha2.Permission
	18, // 41: ntt.iam.v1alpha2.PermissionService.UpdatePermission:output_type -> ntt.iam.v1alpha2.Permission
	22, // 42: ntt.iam.v1alpha2.PermissionService.DeletePermission:output_type -> google.protobuf.Empty
...
func init() { edgelq_iam_proto_v1alpha2_permission_service_proto_init() }
func edgelq_iam_proto_v1alpha2_permission_service_proto_init() {
	if edgelq_iam_proto_v1alpha2_permission_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*CreatePermissionRequest_ResponseMask_SkipEntireResponseBody)(nil),
		(*CreatePermissionRequest_ResponseMask_BodyMask)(nil),
	}
	edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes[15].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1alpha2_permission_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           edgelq_iam_proto_v1alpha2_permission_service_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1alpha2_permission_service_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1alpha2_permission_service_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1alpha2_permission_service_proto = out.File
	edgelq_iam_proto_v1alpha2_permission_service_proto_rawDesc = nil
	edgelq_iam_proto_v1alpha2_permission_service_proto_goTypes = nil
	edgelq_iam_proto_v1alpha2_permission_service_proto_depIdxs = nil
}
