...
func (m *ListMyProjectsRequest) Reset() {
	*m = ListMyProjectsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_project_custom_proto_msgTypes[0]
...
func (*ListMyProjectsRequest) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_project_custom_proto_rawDescGZIP(), []int{0}
}
...
func (m *ListMyProjectsResponse) Reset() {
	*m = ListMyProjectsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_project_custom_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListMyProjectsResponse) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_project_custom_proto_rawDescGZIP(), []int{1}
}
...
var edgelq_iam_proto_v1alpha_project_custom_proto preflect.FileDescriptor

var edgelq_iam_proto_v1alpha_project_custom_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x5f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x26, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2f,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x4d,
	...
	0x64, 0x4d, 0x61, 0x73, 0x6b, 0x3a, 0x1f, 0xfa, 0xde, 0x21, 0x1b, 0x0a, 0x15, 0x4c, 0x69, 0x73,
	0x74, 0x4d, 0x79, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x10, 0x01, 0x18, 0x02, 0x22, 0x70, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x79,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x3a, 0x20, 0xfa, 0xde, 0x21, 0x1c, 0x0a, 0x16, 0x4c, 0x69,
	0x73, 0x74, 0x4d, 0x79, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x10, 0x01, 0x18, 0x01, 0x42, 0x96, 0x02, 0xe8, 0xde, 0x21, 0x01, 0x92,
	...
	0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x42, 0x12, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var (
	edgelq_iam_proto_v1alpha_project_custom_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1alpha_project_custom_proto_rawDescData = edgelq_iam_proto_v1alpha_project_custom_proto_rawDesc
)

func edgelq_iam_proto_v1alpha_project_custom_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1alpha_project_custom_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1alpha_project_custom_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1alpha_project_custom_proto_rawDescData)
	})
	return edgelq_iam_proto_v1alpha_project_custom_proto_rawDescData
}

var edgelq_iam_proto_v1alpha_project_custom_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var edgelq_iam_proto_v1alpha_project_custom_proto_goTypes = []interface{}{
	(*ListMyProjectsRequest)(nil),     // 0: ntt.iam.v1alpha.ListMyProjectsRequest
	(*ListMyProjectsResponse)(nil),    // 1: ntt.iam.v1alpha.ListMyProjectsResponse
	(*project.Project_FieldMask)(nil), // 2: ntt.iam.v1alpha.Project_FieldMask
	(*project.Project)(nil),           // 3: ntt.iam.v1alpha.Project
}
var edgelq_iam_proto_v1alpha_project_custom_proto_depIdxs = []int32{
	2, // 0: ntt.iam.v1alpha.ListMyProjectsRequest.field_mask:type_name -> ntt.iam.v1alpha.Project_FieldMask
	3, // 1: ntt.iam.v1alpha.ListMyProjectsResponse.projects:type_name -> ntt.iam.v1alpha.Project
...
func init() { edgelq_iam_proto_v1alpha_project_custom_proto_init() }
func edgelq_iam_proto_v1alpha_project_custom_proto_init() {
	if edgelq_iam_proto_v1alpha_project_custom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1alpha_project_custom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_project_custom_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1alpha_project_custom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1alpha_project_custom_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1alpha_project_custom_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1alpha_project_custom_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1alpha_project_custom_proto = out.File
	edgelq_iam_proto_v1alpha_project_custom_proto_rawDesc = nil
	edgelq_iam_proto_v1alpha_project_custom_proto_goTypes = nil
	edgelq_iam_proto_v1alpha_project_custom_proto_depIdxs = nil
}
