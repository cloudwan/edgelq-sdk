...
func (m *RoleChange) Reset() {
	*m = RoleChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[0]
...
func (*RoleChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_role_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *RoleChange_Added) Reset() {
	*m = RoleChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_role_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *RoleChange_Modified) Reset() {
	*m = RoleChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_role_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *RoleChange_Current) Reset() {
	*m = RoleChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_role_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *RoleChange_Removed) Reset() {
	*m = RoleChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_role_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1alpha_role_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1alpha_role_change_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x1a, 0x19, 0x67,
	...
	0x6f, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x72, 0x6f, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xff, 0x05, 0x0a, 0x0a, 0x52, 0x6f, 0x6c, 0x65, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x12, 0x39, 0x0a, 0x05, 0x61, 0x64, 0x64, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e,
	0x41, 0x64, 0x64, 0x65, 0x64, 0x48, 0x00, 0x52, 0x05, 0x61, 0x64, 0x64, 0x65, 0x64, 0x12, 0x42,
	...
	0x68, 0x61, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x4d, 0x6f,
	0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x48, 0x00, 0x52, 0x08, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69,
	0x65, 0x64, 0x12, 0x3f, 0x0a, 0x07, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20,
	...
	0x65, 0x6e, 0x74, 0x12, 0x3f, 0x0a, 0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x18, 0x03,
	...
	0x6f, 0x76, 0x65, 0x64, 0x1a, 0x51, 0x0a, 0x05, 0x41, 0x64, 0x64, 0x65, 0x64, 0x12, 0x29, 0x0a,
	0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6e, 0x74,
	0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x52, 0x6f,
	0x6c, 0x65, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x76, 0x69, 0x65, 0x77,
	...
	0x66, 0x69, 0x65, 0x64, 0x12, 0x20, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x0c, 0xb2, 0xda, 0x21, 0x08, 0x0a, 0x06, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x29, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x02,
	...
	,
	...
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x72, 0x6f, 0x6c, 0x65, 0x0a, 0x16, 0x63, 0x6f, 0x6d,
	0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x42, 0x0f, 0x52, 0x6f, 0x6c, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50,
	...
	0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x72, 0x6f, 0x6c, 0x65, 0x3b, 0x72, 0x6f,
	0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_iam_proto_v1alpha_role_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1alpha_role_change_proto_rawDescData = edgelq_iam_proto_v1alpha_role_change_proto_rawDesc
)

func edgelq_iam_proto_v1alpha_role_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1alpha_role_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1alpha_role_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1alpha_role_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1alpha_role_change_proto_rawDescData
}

var edgelq_iam_proto_v1alpha_role_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1alpha_role_change_proto_goTypes = []interface{}{
	(*RoleChange)(nil),          // 0: ntt.iam.v1alpha.RoleChange
	(*RoleChange_Added)(nil),    // 1: ntt.iam.v1alpha.RoleChange.Added
	(*RoleChange_Modified)(nil), // 2: ntt.iam.v1alpha.RoleChange.Modified
	(*RoleChange_Current)(nil),  // 3: ntt.iam.v1alpha.RoleChange.Current
	(*RoleChange_Removed)(nil),  // 4: ntt.iam.v1alpha.RoleChange.Removed
	(*Role)(nil),                // 5: ntt.iam.v1alpha.Role
	(*Role_FieldMask)(nil),      // 6: ntt.iam.v1alpha.Role_FieldMask
}
var edgelq_iam_proto_v1alpha_role_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1alpha.RoleChange.added:type_name -> ntt.iam.v1alpha.RoleChange.Added
	2, // 1: ntt.iam.v1alpha.RoleChange.modified:type_name -> ntt.iam.v1alpha.RoleChange.Modified
	3, // 2: ntt.iam.v1alpha.RoleChange.current:type_name -> ntt.iam.v1alpha.RoleChange.Current
	4, // 3: ntt.iam.v1alpha.RoleChange.removed:type_name -> ntt.iam.v1alpha.RoleChange.Removed
	5, // 4: ntt.iam.v1alpha.RoleChange.Added.role:type_name -> ntt.iam.v1alpha.Role
	5, // 5: ntt.iam.v1alpha.RoleChange.Modified.role:type_name -> ntt.iam.v1alpha.Role
	6, // 6: ntt.iam.v1alpha.RoleChange.Modified.field_mask:type_name -> ntt.iam.v1alpha.Role_FieldMask
	5, // 7: ntt.iam.v1alpha.RoleChange.Current.role:type_name -> ntt.iam.v1alpha.Role
...
func init() { edgelq_iam_proto_v1alpha_role_change_proto_init() }
func edgelq_iam_proto_v1alpha_role_change_proto_init() {
	if edgelq_iam_proto_v1alpha_role_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1alpha_role_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1alpha_role_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1alpha_role_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1alpha_role_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1alpha_role_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1alpha_role_change_proto = out.File
	edgelq_iam_proto_v1alpha_role_change_proto_rawDesc = nil
	edgelq_iam_proto_v1alpha_role_change_proto_goTypes = nil
	edgelq_iam_proto_v1alpha_role_change_proto_depIdxs = nil
}
