		...
		nameObj: Name{
			...
			ParentName: ParentName{
				NamePattern: NamePattern{
					...
					Pattern: NamePattern_Project_ServiceAccount,
				},
			},
		},
	}
...
func (b *NameBuilder) SetServiceAccount(parent *service_account.Name) *NameBuilder {
	...
	case service_account.NamePattern_Project:
		parentName.Pattern = NamePattern_Project_ServiceAccount
	}
...
func (b *NameBuilder) SetProjectId(id string) *NameBuilder {
	...
	if parentName.ProjectId != "" && parentName.ServiceAccountId != "" {
		parentName.Pattern = NamePattern_Project_ServiceAccount
	}
	return b
}
