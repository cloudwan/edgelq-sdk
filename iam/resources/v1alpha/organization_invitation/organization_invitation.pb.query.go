...
type GetQuery struct {
	Reference *Reference
	Mask      *OrganizationInvitation_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*OrganizationInvitation_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return OrganizationInvitationList(qr.OrganizationInvitations)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.OrganizationInvitations = results.(OrganizationInvitationList)
	} else {
		qr.OrganizationInvitations = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*OrganizationInvitationChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return OrganizationInvitationChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(OrganizationInvitationChangeList)
	} else {
		qr.Changes = nil
	}
}
