...
// File: edgelq/iam/proto/v1alpha/project_change.proto
// DO NOT EDIT!!!
...
func (m *ProjectChange) Reset() {
	*m = ProjectChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[0]
...
func (*ProjectChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_project_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *ProjectChange_Added) Reset() {
	*m = ProjectChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_project_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *ProjectChange_Modified) Reset() {
	*m = ProjectChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_project_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *ProjectChange_Current) Reset() {
	*m = ProjectChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_project_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *ProjectChange_Removed) Reset() {
	*m = ProjectChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha_project_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1alpha_project_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1alpha_project_change_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x74, 0x6f, 0x1a, 0x26, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2f, 0x69, 0x61, 0x6d, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x70, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x06, 0x0a, 0x0d, 0x50,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x3c, 0x0a, 0x05,
	0x61, 0x64, 0x64, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x6e, 0x74,
	...
	0x64, 0x48, 0x00, 0x52, 0x05, 0x61, 0x64, 0x64, 0x65, 0x64, 0x12, 0x45, 0x0a, 0x08, 0x6d, 0x6f,
	0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6e,
	...
	0x64, 0x12, 0x42, 0x0a, 0x07, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01,
	...
	0x72, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x42, 0x0a, 0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d,
	...
	0x65, 0x64, 0x12, 0x32, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x01, 0x20,
	...
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x1a, 0xfe, 0x01, 0x0a, 0x08, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x69,
	...
	0x74, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x32, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69,
	...
	0x77, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x1a, 0x3d, 0x0a, 0x07, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x74, 0x12, 0x32, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61,
	...
	0x6e, 0x64, 0x65, 0x78, 0x3a, 0x20, 0x9a, 0xd9, 0x21, 0x09, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0xfa, 0xde, 0x21, 0x0f, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x42, 0xc8, 0x01, 0xe8, 0xde, 0x21, 0x00, 0x92, 0x8c, 0xd1, 0x02,
	0x4f, 0x0a, 0x12, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69,
	...
	0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x00, 0x5a, 0x40,
...
var (
	edgelq_iam_proto_v1alpha_project_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1alpha_project_change_proto_rawDescData = edgelq_iam_proto_v1alpha_project_change_proto_rawDesc
)

func edgelq_iam_proto_v1alpha_project_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1alpha_project_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1alpha_project_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1alpha_project_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1alpha_project_change_proto_rawDescData
}

var edgelq_iam_proto_v1alpha_project_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1alpha_project_change_proto_goTypes = []interface{}{
	(*ProjectChange)(nil),          // 0: ntt.iam.v1alpha.ProjectChange
	(*ProjectChange_Added)(nil),    // 1: ntt.iam.v1alpha.ProjectChange.Added
	(*ProjectChange_Modified)(nil), // 2: ntt.iam.v1alpha.ProjectChange.Modified
	(*ProjectChange_Current)(nil),  // 3: ntt.iam.v1alpha.ProjectChange.Current
	(*ProjectChange_Removed)(nil),  // 4: ntt.iam.v1alpha.ProjectChange.Removed
	(*Project)(nil),                // 5: ntt.iam.v1alpha.Project
	(*Project_FieldMask)(nil),      // 6: ntt.iam.v1alpha.Project_FieldMask
}
var edgelq_iam_proto_v1alpha_project_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1alpha.ProjectChange.added:type_name -> ntt.iam.v1alpha.ProjectChange.Added
	2, // 1: ntt.iam.v1alpha.ProjectChange.modified:type_name -> ntt.iam.v1alpha.ProjectChange.Modified
	3, // 2: ntt.iam.v1alpha.ProjectChange.current:type_name -> ntt.iam.v1alpha.ProjectChange.Current
	4, // 3: ntt.iam.v1alpha.ProjectChange.removed:type_name -> ntt.iam.v1alpha.ProjectChange.Removed
	5, // 4: ntt.iam.v1alpha.ProjectChange.Added.project:type_name -> ntt.iam.v1alpha.Project
	5, // 5: ntt.iam.v1alpha.ProjectChange.Modified.project:type_name -> ntt.iam.v1alpha.Project
	6, // 6: ntt.iam.v1alpha.ProjectChange.Modified.field_mask:type_name -> ntt.iam.v1alpha.Project_FieldMask
	5, // 7: ntt.iam.v1alpha.ProjectChange.Current.project:type_name -> ntt.iam.v1alpha.Project
...
func init() { edgelq_iam_proto_v1alpha_project_change_proto_init() }
func edgelq_iam_proto_v1alpha_project_change_proto_init() {
	if edgelq_iam_proto_v1alpha_project_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1alpha_project_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1alpha_project_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1alpha_project_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1alpha_project_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1alpha_project_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1alpha_project_change_proto = out.File
	edgelq_iam_proto_v1alpha_project_change_proto_rawDesc = nil
	edgelq_iam_proto_v1alpha_project_change_proto_goTypes = nil
	edgelq_iam_proto_v1alpha_project_change_proto_depIdxs = nil
}
