...
// File: edgelq/iam/proto/v1alpha2/role_binding_change.proto
// DO NOT EDIT!!!
...
func (m *RoleBindingChange) Reset() {
	*m = RoleBindingChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[0]
...
func (*RoleBindingChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *RoleBindingChange_Added) Reset() {
	*m = RoleBindingChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleBindingChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *RoleBindingChange_Modified) Reset() {
	*m = RoleBindingChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleBindingChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *RoleBindingChange_Current) Reset() {
	*m = RoleBindingChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleBindingChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *RoleBindingChange_Removed) Reset() {
	*m = RoleBindingChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoleBindingChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1alpha2_role_binding_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xf7, 0x06, 0x0a, 0x11, 0x52, 0x6f, 0x6c, 0x65, 0x42, 0x69, 0x6e, 0x64,
	0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x41, 0x0a, 0x05, 0x61, 0x64, 0x64,
	...
	0x32, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61,
	...
	0x65, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x43,
	...
	0x64, 0x65, 0x64, 0x12, 0x40, 0x0a, 0x0c, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x62, 0x69, 0x6e, 0x64,
	0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x52, 0x6f, 0x6c,
	...
	0x64, 0x69, 0x6e, 0x67, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x40, 0x0a, 0x0c, 0x72, 0x6f,
	...
	0x68, 0x61, 0x32, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x52,
	0x0b, 0x72, 0x6f, 0x6c, 0x65, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x12, 0x4e, 0x0a, 0x0a,
	...
	0x67, 0x52, 0x09, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x12, 0x2e, 0x0a, 0x13,
	...
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x40, 0x0a, 0x0c, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x62,
	0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6e,
	...
	0x65, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x1a, 0x51, 0x0a, 0x07, 0x52, 0x65, 0x6d, 0x6f,
	0x76, 0x65, 0x64, 0x12, 0x27, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x13, 0xb2, 0xda, 0x21, 0x0f, 0x0a, 0x0d, 0x0a, 0x0b, 0x52, 0x6f, 0x6c, 0x65, 0x42,
	0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x0d, 0x0a, 0x0b, 0x52, 0x6f, 0x6c, 0x65, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x42, 0x0d,
	...
	0x6d, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x42, 0x16, 0x52,
	...
	0x73, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x72, 0x6f, 0x6c, 0x65, 0x5f,
	0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x3b, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x62, 0x69, 0x6e,
	0x64, 0x69, 0x6e, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescData = edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDesc
)

func edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDescData
}

var edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1alpha2_role_binding_change_proto_goTypes = []interface{}{
	(*RoleBindingChange)(nil),          // 0: ntt.iam.v1alpha2.RoleBindingChange
	(*RoleBindingChange_Added)(nil),    // 1: ntt.iam.v1alpha2.RoleBindingChange.Added
	(*RoleBindingChange_Modified)(nil), // 2: ntt.iam.v1alpha2.RoleBindingChange.Modified
	(*RoleBindingChange_Current)(nil),  // 3: ntt.iam.v1alpha2.RoleBindingChange.Current
	(*RoleBindingChange_Removed)(nil),  // 4: ntt.iam.v1alpha2.RoleBindingChange.Removed
	(*RoleBinding)(nil),                // 5: ntt.iam.v1alpha2.RoleBinding
	(*RoleBinding_FieldMask)(nil),      // 6: ntt.iam.v1alpha2.RoleBinding_FieldMask
}
var edgelq_iam_proto_v1alpha2_role_binding_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1alpha2.RoleBindingChange.added:type_name -> ntt.iam.v1alpha2.RoleBindingChange.Added
	2, // 1: ntt.iam.v1alpha2.RoleBindingChange.modified:type_name -> ntt.iam.v1alpha2.RoleBindingChange.Modified
	3, // 2: ntt.iam.v1alpha2.RoleBindingChange.current:type_name -> ntt.iam.v1alpha2.RoleBindingChange.Current
	4, // 3: ntt.iam.v1alpha2.RoleBindingChange.removed:type_name -> ntt.iam.v1alpha2.RoleBindingChange.Removed
	5, // 4: ntt.iam.v1alpha2.RoleBindingChange.Added.role_binding:type_name -> ntt.iam.v1alpha2.RoleBinding
	5, // 5: ntt.iam.v1alpha2.RoleBindingChange.Modified.role_binding:type_name -> ntt.iam.v1alpha2.RoleBinding
	6, // 6: ntt.iam.v1alpha2.RoleBindingChange.Modified.field_mask:type_name -> ntt.iam.v1alpha2.RoleBinding_FieldMask
	5, // 7: ntt.iam.v1alpha2.RoleBindingChange.Current.role_binding:type_name -> ntt.iam.v1alpha2.RoleBinding
...
func init() { edgelq_iam_proto_v1alpha2_role_binding_change_proto_init() }
func edgelq_iam_proto_v1alpha2_role_binding_change_proto_init() {
	if edgelq_iam_proto_v1alpha2_role_binding_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1alpha2_role_binding_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1alpha2_role_binding_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1alpha2_role_binding_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1alpha2_role_binding_change_proto = out.File
	edgelq_iam_proto_v1alpha2_role_binding_change_proto_rawDesc = nil
	edgelq_iam_proto_v1alpha2_role_binding_change_proto_goTypes = nil
	edgelq_iam_proto_v1alpha2_role_binding_change_proto_depIdxs = nil
}
