...
func (b *filterCndBuilderRootOrganization) Eq(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderRootOrganization) Neq(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderRootOrganization) Gt(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderRootOrganization) Gte(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderRootOrganization) Lt(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderRootOrganization) Lte(value *Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderRootOrganization) In(values []*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Organization_FieldPathArrayOfValues: NewOrganizationFieldPathBuilder().RootOrganization().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderRootOrganization) NotIn(values []*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Organization_FieldPathArrayOfValues: NewOrganizationFieldPathBuilder().RootOrganization().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderRootOrganization) compare(op gotenfilter.CompareOperator, value *Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
...
func (b *filterCndBuilderAncestryPath) Eq(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderAncestryPath) Neq(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderAncestryPath) Gt(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderAncestryPath) Gte(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderAncestryPath) Lt(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderAncestryPath) Lte(value []*Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderAncestryPath) In(values [][]*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Organization_FieldPathArrayOfValues: NewOrganizationFieldPathBuilder().AncestryPath().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderAncestryPath) NotIn(values [][]*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Organization_FieldPathArrayOfValues: NewOrganizationFieldPathBuilder().AncestryPath().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderAncestryPath) Contains(value *Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewOrganizationFieldPathBuilder().AncestryPath().FieldPath(),
...
func (b *filterCndBuilderAncestryPath) ContainsAnyOf(values []*Reference) *FilterBuilder {
...
func (b *filterCndBuilderAncestryPath) ContainsAll(values []*Reference) *FilterBuilder {
	pathSelector := NewOrganizationFieldPathBuilder().AncestryPath()
	itemValues := make([]Organization_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderAncestryPath) compare(op gotenfilter.CompareOperator, value []*Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
