...
func (b *filterCndBuilderRootOrganization) Eq(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderRootOrganization) Neq(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderRootOrganization) Gt(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderRootOrganization) Gte(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderRootOrganization) Lt(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderRootOrganization) Lte(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderRootOrganization) In(values []*organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().RootOrganization().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderRootOrganization) NotIn(values []*organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().RootOrganization().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderRootOrganization) compare(op gotenfilter.CompareOperator, value *organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
...
func (b *filterCndBuilderAncestryPath) Eq(value []*organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderAncestryPath) Neq(value []*organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderAncestryPath) Gt(value []*organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderAncestryPath) Gte(value []*organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderAncestryPath) Lt(value []*organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderAncestryPath) Lte(value []*organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderAncestryPath) In(values [][]*organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().AncestryPath().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderAncestryPath) NotIn(values [][]*organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().AncestryPath().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderAncestryPath) Contains(value *organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectFieldPathBuilder().AncestryPath().FieldPath(),
...
func (b *filterCndBuilderAncestryPath) ContainsAnyOf(values []*organization.Reference) *FilterBuilder {
...
func (b *filterCndBuilderAncestryPath) ContainsAll(values []*organization.Reference) *FilterBuilder {
	pathSelector := NewProjectFieldPathBuilder().AncestryPath()
	itemValues := make([]Project_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderAncestryPath) compare(op gotenfilter.CompareOperator, value []*organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
