...
type ProjectInvitationAccess interface {
	GetProjectInvitation(context.Context, *GetQuery, ...gotenresource.GetOption) (*ProjectInvitation, error)
	BatchGetProjectInvitations(context.Context, []*Reference, ...gotenresource.BatchGetOption) error
	QueryProjectInvitations(context.Context, *ListQuery, ...gotenresource.QueryOption) (*QueryResultSnapshot, error)
...
func (a *anyCastAccess) Get(ctx context.Context, q gotenresource.GetQuery, opts ...gotenresource.GetOption) (gotenresource.Resource, error) {
	if asProjectInvitationQuery, ok := q.(*GetQuery); ok {
		return a.GetProjectInvitation(ctx, asProjectInvitationQuery, opts...)
	}
...
func (a *anyCastAccess) Query(ctx context.Context, q gotenresource.ListQuery, opts ...gotenresource.QueryOption) (gotenresource.QueryResultSnapshot, error) {
	if asProjectInvitationQuery, ok := q.(*ListQuery); ok {
		return a.QueryProjectInvitations(ctx, asProjectInvitationQuery, opts...)
	}
	return nil, status.Errorf(codes.Internal,
		"Unrecognized descriptor, expected ProjectInvitation, got: %s",
		q.GetResourceDescriptor().GetResourceTypeName().FullyQualifiedTypeName())
