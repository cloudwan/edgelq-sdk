...
// File: edgelq/iam/proto/v1alpha2/project_invitation_change.proto
// DO NOT EDIT!!!
...
func (m *ProjectInvitationChange) Reset() {
	*m = ProjectInvitationChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[0]
...
func (*ProjectInvitationChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescGZIP(), []int{0}
}
...
type ProjectInvitationChange_Added_ struct {
	...
	// enters Query view
	Added *ProjectInvitationChange_Added `protobuf:"bytes,1,opt,name=added,proto3,oneof"`
}
type ProjectInvitationChange_Modified_ struct {
	// Modified is returned when watched document is modified
	Modified *ProjectInvitationChange_Modified `protobuf:"bytes,2,opt,name=modified,proto3,oneof"`
}
type ProjectInvitationChange_Current_ struct {
	// Current is returned in stateless watch when document enters query view or
	// is modified within.
	Current *ProjectInvitationChange_Current `protobuf:"bytes,4,opt,name=current,proto3,oneof"`
}
type ProjectInvitationChange_Removed_ struct {
	// Removed is returned when ProjectInvitation is deleted or leaves Query
	// view
	Removed *ProjectInvitationChange_Removed `protobuf:"bytes,3,opt,name=removed,proto3,oneof"`
}
...
type ProjectInvitationChange_Added struct {
	...
	sizeCache         protoimpl.SizeCache
	unknownFields     protoimpl.UnknownFields
	ProjectInvitation *ProjectInvitation `protobuf:"bytes,1,opt,name=project_invitation,json=projectInvitation,proto3" json:"project_invitation,omitempty"`
...
func (m *ProjectInvitationChange_Added) Reset() {
	*m = ProjectInvitationChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectInvitationChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescGZIP(), []int{0, 0}
}
...
type ProjectInvitationChange_Modified struct {
	...
	ProjectInvitation *ProjectInvitation `protobuf:"bytes,2,opt,name=project_invitation,json=projectInvitation,proto3" json:"project_invitation,omitempty"`
	// Used when mask_changes is set, contains field paths of modified
	// properties.
	FieldMask *ProjectInvitation_FieldMask `protobuf:"bytes,3,opt,customtype=ProjectInvitation_FieldMask,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
...
func (m *ProjectInvitationChange_Modified) Reset() {
	*m = ProjectInvitationChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectInvitationChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *ProjectInvitationChange_Current) Reset() {
	*m = ProjectInvitationChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectInvitationChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *ProjectInvitationChange_Removed) Reset() {
	*m = ProjectInvitationChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectInvitationChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1alpha2_project_invitation_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDesc = []byte{
	...
	0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0xe3, 0x07, 0x0a, 0x17, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x47, 0x0a, 0x05, 0x61,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	...
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x52, 0x0a, 0x12,
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69,
	0x61, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x50, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x11, 0x70,
	...
	0x12, 0x52, 0x0a, 0x12, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x6e, 0x76, 0x69,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6e,
	...
	0x6e, 0x52, 0x11, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x57, 0x0a, 0x07, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x12,
	...
	0xd9, 0x21, 0x13, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x76, 0x69,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x0d, 0x0a, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65,
	...
	0x6c, 0x70, 0x68, 0x61, 0x32, 0x42, 0x1c, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e,
	...
	0x65, 0x63, 0x74, 0x5f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescData = edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDesc
)

func edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDescData
}

var edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1alpha2_project_invitation_change_proto_goTypes = []interface{}{
	(*ProjectInvitationChange)(nil),          // 0: ntt.iam.v1alpha2.ProjectInvitationChange
	(*ProjectInvitationChange_Added)(nil),    // 1: ntt.iam.v1alpha2.ProjectInvitationChange.Added
	(*ProjectInvitationChange_Modified)(nil), // 2: ntt.iam.v1alpha2.ProjectInvitationChange.Modified
	(*ProjectInvitationChange_Current)(nil),  // 3: ntt.iam.v1alpha2.ProjectInvitationChange.Current
	(*ProjectInvitationChange_Removed)(nil),  // 4: ntt.iam.v1alpha2.ProjectInvitationChange.Removed
	(*ProjectInvitation)(nil),                // 5: ntt.iam.v1alpha2.ProjectInvitation
	(*ProjectInvitation_FieldMask)(nil),      // 6: ntt.iam.v1alpha2.ProjectInvitation_FieldMask
}
var edgelq_iam_proto_v1alpha2_project_invitation_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1alpha2.ProjectInvitationChange.added:type_name -> ntt.iam.v1alpha2.ProjectInvitationChange.Added
	2, // 1: ntt.iam.v1alpha2.ProjectInvitationChange.modified:type_name -> ntt.iam.v1alpha2.ProjectInvitationChange.Modified
	3, // 2: ntt.iam.v1alpha2.ProjectInvitationChange.current:type_name -> ntt.iam.v1alpha2.ProjectInvitationChange.Current
	4, // 3: ntt.iam.v1alpha2.ProjectInvitationChange.removed:type_name -> ntt.iam.v1alpha2.ProjectInvitationChange.Removed
	5, // 4: ntt.iam.v1alpha2.ProjectInvitationChange.Added.project_invitation:type_name -> ntt.iam.v1alpha2.ProjectInvitation
	5, // 5: ntt.iam.v1alpha2.ProjectInvitationChange.Modified.project_invitation:type_name -> ntt.iam.v1alpha2.ProjectInvitation
	6, // 6: ntt.iam.v1alpha2.ProjectInvitationChange.Modified.field_mask:type_name -> ntt.iam.v1alpha2.ProjectInvitation_FieldMask
	5, // 7: ntt.iam.v1alpha2.ProjectInvitationChange.Current.project_invitation:type_name -> ntt.iam.v1alpha2.ProjectInvitation
...
func init() { edgelq_iam_proto_v1alpha2_project_invitation_change_proto_init() }
func edgelq_iam_proto_v1alpha2_project_invitation_change_proto_init() {
	if edgelq_iam_proto_v1alpha2_project_invitation_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1alpha2_project_invitation_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1alpha2_project_invitation_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1alpha2_project_invitation_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto = out.File
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto_rawDesc = nil
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto_goTypes = nil
	edgelq_iam_proto_v1alpha2_project_invitation_change_proto_depIdxs = nil
}
