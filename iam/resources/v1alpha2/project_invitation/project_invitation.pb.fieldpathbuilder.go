...
func (s ProjectInvitationPathSelectorMetadataSyncing) WithValue(value *syncing_meta.SyncingMeta) *ProjectInvitation_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*ProjectInvitation_FieldSubPathValue)
}

func (s ProjectInvitationPathSelectorMetadataSyncing) WithArrayOfValues(values []*syncing_meta.SyncingMeta) *ProjectInvitation_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*ProjectInvitation_FieldSubPathArrayOfValues)
}
