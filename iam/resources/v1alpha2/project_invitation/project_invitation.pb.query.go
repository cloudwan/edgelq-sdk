...
type GetQuery struct {
	Reference *Reference
	Mask      *ProjectInvitation_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*ProjectInvitation_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return ProjectInvitationList(qr.ProjectInvitations)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.ProjectInvitations = results.(ProjectInvitationList)
	} else {
		qr.ProjectInvitations = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*ProjectInvitationChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return ProjectInvitationChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(ProjectInvitationChangeList)
	} else {
		qr.Changes = nil
	}
}
