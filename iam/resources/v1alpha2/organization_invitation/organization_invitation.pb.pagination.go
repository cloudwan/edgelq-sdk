...
func (orderByFld *OrderByField) CompareWithDirection(left, right *OrganizationInvitation) int {
...
func (orderBy *OrderBy) Sort(results OrganizationInvitationList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(OrganizationInvitationList))
}

func (orderBy *OrderBy) InsertSorted(sorted OrganizationInvitationList, elem *OrganizationInvitation) (OrganizationInvitationList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(OrganizationInvitationList), elem.(*OrganizationInvitation))
}

func (orderBy *OrderBy) Compare(left, right *OrganizationInvitation) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*OrganizationInvitation), right.(*OrganizationInvitation))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseOrganizationInvitation_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *OrganizationInvitation_FieldMask {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == OrganizationInvitation_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &OrganizationInvitation_FieldTerminalPath{selector: OrganizationInvitation_FieldPathSelectorName},
