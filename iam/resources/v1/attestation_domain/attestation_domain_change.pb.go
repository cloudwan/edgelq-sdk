...
// File: edgelq/iam/proto/v1/attestation_domain_change.proto
// DO NOT EDIT!!!
...
func (m *AttestationDomainChange) Reset() {
	*m = AttestationDomainChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[0]
...
func (*AttestationDomainChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *AttestationDomainChange_Added) Reset() {
	*m = AttestationDomainChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AttestationDomainChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *AttestationDomainChange_Modified) Reset() {
	*m = AttestationDomainChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AttestationDomainChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *AttestationDomainChange_Current) Reset() {
	*m = AttestationDomainChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AttestationDomainChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *AttestationDomainChange_Removed) Reset() {
	*m = AttestationDomainChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AttestationDomainChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1_attestation_domain_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1_attestation_domain_change_proto_rawDesc = []byte{
	...
	0x5f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb9, 0x07,
	0x0a, 0x17, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x6f, 0x6d,
	0x61, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x41, 0x0a, 0x05, 0x61, 0x64, 0x64,
	...
	0x6e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x41, 0x64,
	...
	0x6f, 0x6e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x43,
	...
	0x64, 0x65, 0x64, 0x12, 0x4c, 0x0a, 0x12, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x4c, 0x0a, 0x12,
	0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x6f, 0x6d, 0x61,
	0x69, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69,
	0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x52, 0x11, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x54, 0x0a, 0x0a, 0x66, 0x69,
	...
	0x57, 0x0a, 0x07, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x4c, 0x0a, 0x12, 0x61, 0x74,
	...
	0x6f, 0x6e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x1a, 0x57, 0x0a, 0x07, 0x52, 0x65, 0x6d, 0x6f,
	...
	0x78, 0x3a, 0x17, 0x9a, 0xd9, 0x21, 0x13, 0x0a, 0x11, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x42, 0x0d, 0x0a, 0x0b, 0x63, 0x68,
	...
	0x2e, 0x76, 0x31, 0x42, 0x1c, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74,
...
var (
	edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescData = edgelq_iam_proto_v1_attestation_domain_change_proto_rawDesc
)

func edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1_attestation_domain_change_proto_rawDescData
}

var edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1_attestation_domain_change_proto_goTypes = []interface{}{
	(*AttestationDomainChange)(nil),          // 0: ntt.iam.v1.AttestationDomainChange
	(*AttestationDomainChange_Added)(nil),    // 1: ntt.iam.v1.AttestationDomainChange.Added
	(*AttestationDomainChange_Modified)(nil), // 2: ntt.iam.v1.AttestationDomainChange.Modified
	(*AttestationDomainChange_Current)(nil),  // 3: ntt.iam.v1.AttestationDomainChange.Current
	(*AttestationDomainChange_Removed)(nil),  // 4: ntt.iam.v1.AttestationDomainChange.Removed
	(*AttestationDomain)(nil),                // 5: ntt.iam.v1.AttestationDomain
	(*AttestationDomain_FieldMask)(nil),      // 6: ntt.iam.v1.AttestationDomain_FieldMask
}
var edgelq_iam_proto_v1_attestation_domain_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1.AttestationDomainChange.added:type_name -> ntt.iam.v1.AttestationDomainChange.Added
	2, // 1: ntt.iam.v1.AttestationDomainChange.modified:type_name -> ntt.iam.v1.AttestationDomainChange.Modified
	3, // 2: ntt.iam.v1.AttestationDomainChange.current:type_name -> ntt.iam.v1.AttestationDomainChange.Current
	4, // 3: ntt.iam.v1.AttestationDomainChange.removed:type_name -> ntt.iam.v1.AttestationDomainChange.Removed
	5, // 4: ntt.iam.v1.AttestationDomainChange.Added.attestation_domain:type_name -> ntt.iam.v1.AttestationDomain
	5, // 5: ntt.iam.v1.AttestationDomainChange.Modified.attestation_domain:type_name -> ntt.iam.v1.AttestationDomain
	6, // 6: ntt.iam.v1.AttestationDomainChange.Modified.field_mask:type_name -> ntt.iam.v1.AttestationDomain_FieldMask
	5, // 7: ntt.iam.v1.AttestationDomainChange.Current.attestation_domain:type_name -> ntt.iam.v1.AttestationDomain
...
func init() { edgelq_iam_proto_v1_attestation_domain_change_proto_init() }
func edgelq_iam_proto_v1_attestation_domain_change_proto_init() {
	if edgelq_iam_proto_v1_attestation_domain_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1_attestation_domain_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1_attestation_domain_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1_attestation_domain_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1_attestation_domain_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1_attestation_domain_change_proto = out.File
	edgelq_iam_proto_v1_attestation_domain_change_proto_rawDesc = nil
	edgelq_iam_proto_v1_attestation_domain_change_proto_goTypes = nil
	edgelq_iam_proto_v1_attestation_domain_change_proto_depIdxs = nil
}
