...
// File: edgelq/iam/proto/v1/user_change.proto
// DO NOT EDIT!!!
...
func (m *UserChange) Reset() {
	*m = UserChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_user_change_proto_msgTypes[0]
...
func (*UserChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_user_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *UserChange_Added) Reset() {
	*m = UserChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_user_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_user_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *UserChange_Modified) Reset() {
	*m = UserChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_user_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_user_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *UserChange_Current) Reset() {
	*m = UserChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_user_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_user_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *UserChange_Removed) Reset() {
	*m = UserChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_user_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_user_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1_user_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1_user_change_proto_rawDesc = []byte{
	0x0a, 0x25, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2f, 0x69, 0x61, 0x6d, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67,
	...
	0x6f, 0x22, 0xcc, 0x05, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	0x12, 0x34, 0x0a, 0x05, 0x61, 0x64, 0x64, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1c, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65,
	...
	0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x43,
	...
	0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76,
	0x65, 0x64, 0x48, 0x00, 0x52, 0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x1a, 0x4c, 0x0a,
	0x05, 0x41, 0x64, 0x64, 0x65, 0x64, 0x12, 0x24, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01,
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x04, 0x75, 0x73,
	...
	0x65, 0x6e, 0x74, 0x12, 0x24, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x1a, 0x4a, 0x0a, 0x07, 0x52, 0x65, 0x6d,
	...
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x3a, 0x0a, 0x9a, 0xd9, 0x21, 0x06, 0x0a, 0x04, 0x55, 0x73, 0x65,
	0x72, 0x42, 0x0d, 0x0a, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x42, 0x61, 0xe8, 0xde, 0x21, 0x00, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74, 0x2e,
	0x69, 0x61, 0x6d, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x42, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x43,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x3b, 0x75,
	0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	edgelq_iam_proto_v1_user_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1_user_change_proto_rawDescData = edgelq_iam_proto_v1_user_change_proto_rawDesc
)

func edgelq_iam_proto_v1_user_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1_user_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1_user_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1_user_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1_user_change_proto_rawDescData
}

var edgelq_iam_proto_v1_user_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1_user_change_proto_goTypes = []interface{}{
	(*UserChange)(nil),          // 0: ntt.iam.v1.UserChange
	(*UserChange_Added)(nil),    // 1: ntt.iam.v1.UserChange.Added
	(*UserChange_Modified)(nil), // 2: ntt.iam.v1.UserChange.Modified
	(*UserChange_Current)(nil),  // 3: ntt.iam.v1.UserChange.Current
	(*UserChange_Removed)(nil),  // 4: ntt.iam.v1.UserChange.Removed
	(*User)(nil),                // 5: ntt.iam.v1.User
	(*User_FieldMask)(nil),      // 6: ntt.iam.v1.User_FieldMask
}
var edgelq_iam_proto_v1_user_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1.UserChange.added:type_name -> ntt.iam.v1.UserChange.Added
	2, // 1: ntt.iam.v1.UserChange.modified:type_name -> ntt.iam.v1.UserChange.Modified
	3, // 2: ntt.iam.v1.UserChange.current:type_name -> ntt.iam.v1.UserChange.Current
	4, // 3: ntt.iam.v1.UserChange.removed:type_name -> ntt.iam.v1.UserChange.Removed
	5, // 4: ntt.iam.v1.UserChange.Added.user:type_name -> ntt.iam.v1.User
	5, // 5: ntt.iam.v1.UserChange.Modified.user:type_name -> ntt.iam.v1.User
	6, // 6: ntt.iam.v1.UserChange.Modified.field_mask:type_name -> ntt.iam.v1.User_FieldMask
	5, // 7: ntt.iam.v1.UserChange.Current.user:type_name -> ntt.iam.v1.User
...
func init() { edgelq_iam_proto_v1_user_change_proto_init() }
func edgelq_iam_proto_v1_user_change_proto_init() {
	if edgelq_iam_proto_v1_user_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1_user_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_user_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_user_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_user_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_user_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1_user_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1_user_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1_user_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1_user_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1_user_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1_user_change_proto = out.File
	edgelq_iam_proto_v1_user_change_proto_rawDesc = nil
	edgelq_iam_proto_v1_user_change_proto_goTypes = nil
	edgelq_iam_proto_v1_user_change_proto_depIdxs = nil
}
