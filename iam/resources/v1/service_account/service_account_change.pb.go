...
func (m *ServiceAccountChange) Reset() {
	*m = ServiceAccountChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_service_account_change_proto_msgTypes[0]
...
func (*ServiceAccountChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_service_account_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *ServiceAccountChange_Added) Reset() {
	*m = ServiceAccountChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_service_account_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServiceAccountChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_service_account_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *ServiceAccountChange_Modified) Reset() {
	*m = ServiceAccountChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_service_account_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServiceAccountChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_service_account_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *ServiceAccountChange_Current) Reset() {
	*m = ServiceAccountChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_service_account_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServiceAccountChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_service_account_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *ServiceAccountChange_Removed) Reset() {
	*m = ServiceAccountChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_service_account_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServiceAccountChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_service_account_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1_service_account_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1_service_account_change_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x83, 0x07, 0x0a, 0x14, 0x53, 0x65, 0x72, 0x76,
	...
	0x26, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72,
	...
	0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x43, 0x75, 0x72,
	...
	0x32, 0x28, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65,
	...
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x43, 0x0a, 0x0f, 0x73,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d,
	...
	0x6e, 0x74, 0x1a, 0x54, 0x0a, 0x07, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x12, 0x2a, 0x0a,
	...
	0x75, 0x6e, 0x74, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x76, 0x69, 0x65,
	...
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x0d,
	0x0a, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x42, 0x81, 0x01,
	0xe8, 0xde, 0x21, 0x00, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61,
	0x6d, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x42, 0x19, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f,
...
var (
	edgelq_iam_proto_v1_service_account_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1_service_account_change_proto_rawDescData = edgelq_iam_proto_v1_service_account_change_proto_rawDesc
)

func edgelq_iam_proto_v1_service_account_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1_service_account_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1_service_account_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1_service_account_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1_service_account_change_proto_rawDescData
}

var edgelq_iam_proto_v1_service_account_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1_service_account_change_proto_goTypes = []interface{}{
	(*ServiceAccountChange)(nil),          // 0: ntt.iam.v1.ServiceAccountChange
	(*ServiceAccountChange_Added)(nil),    // 1: ntt.iam.v1.ServiceAccountChange.Added
	(*ServiceAccountChange_Modified)(nil), // 2: ntt.iam.v1.ServiceAccountChange.Modified
	(*ServiceAccountChange_Current)(nil),  // 3: ntt.iam.v1.ServiceAccountChange.Current
	(*ServiceAccountChange_Removed)(nil),  // 4: ntt.iam.v1.ServiceAccountChange.Removed
	(*ServiceAccount)(nil),                // 5: ntt.iam.v1.ServiceAccount
	(*ServiceAccount_FieldMask)(nil),      // 6: ntt.iam.v1.ServiceAccount_FieldMask
}
var edgelq_iam_proto_v1_service_account_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1.ServiceAccountChange.added:type_name -> ntt.iam.v1.ServiceAccountChange.Added
	2, // 1: ntt.iam.v1.ServiceAccountChange.modified:type_name -> ntt.iam.v1.ServiceAccountChange.Modified
	3, // 2: ntt.iam.v1.ServiceAccountChange.current:type_name -> ntt.iam.v1.ServiceAccountChange.Current
	4, // 3: ntt.iam.v1.ServiceAccountChange.removed:type_name -> ntt.iam.v1.ServiceAccountChange.Removed
	5, // 4: ntt.iam.v1.ServiceAccountChange.Added.service_account:type_name -> ntt.iam.v1.ServiceAccount
	5, // 5: ntt.iam.v1.ServiceAccountChange.Modified.service_account:type_name -> ntt.iam.v1.ServiceAccount
	6, // 6: ntt.iam.v1.ServiceAccountChange.Modified.field_mask:type_name -> ntt.iam.v1.ServiceAccount_FieldMask
	5, // 7: ntt.iam.v1.ServiceAccountChange.Current.service_account:type_name -> ntt.iam.v1.ServiceAccount
...
func init() { edgelq_iam_proto_v1_service_account_change_proto_init() }
func edgelq_iam_proto_v1_service_account_change_proto_init() {
	if edgelq_iam_proto_v1_service_account_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1_service_account_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_service_account_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_service_account_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_service_account_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_service_account_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1_service_account_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1_service_account_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1_service_account_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1_service_account_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1_service_account_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1_service_account_change_proto = out.File
	edgelq_iam_proto_v1_service_account_change_proto_rawDesc = nil
	edgelq_iam_proto_v1_service_account_change_proto_goTypes = nil
	edgelq_iam_proto_v1_service_account_change_proto_depIdxs = nil
}
