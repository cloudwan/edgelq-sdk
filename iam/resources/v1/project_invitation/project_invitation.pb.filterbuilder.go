...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServices) In(values []*meta.ServicesInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Metadata().Services().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Metadata().Services().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServices) compare(op gotenfilter.CompareOperator, value *meta.ServicesInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Metadata().Services().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Metadata().Services().OwningService().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Metadata().Services().OwningService().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Metadata().Services().OwningService().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) In(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Metadata().Services().AllowedServices().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Metadata().Services().AllowedServices().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) Contains(value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectInvitationFieldPathBuilder().Metadata().Services().AllowedServices().FieldPath(),
		Value:     NewProjectInvitationFieldPathBuilder().Metadata().Services().AllowedServices().WithItemValue(value),
	})
}

func (b *filterCndBuilderMetadataServicesAllowedServices) ContainsAnyOf(values []string) *FilterBuilder {
	pathSelector := NewProjectInvitationFieldPathBuilder().Metadata().Services().AllowedServices()
	itemValues := make([]ProjectInvitation_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) compare(op gotenfilter.CompareOperator, value []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Metadata().Services().AllowedServices().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRoles) In(values [][]*iam_invitation.Invitation_BindingRole) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRoles) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRoles) Contains(value *iam_invitation.Invitation_BindingRole) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().FieldPath(),
		Value:     NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().WithItemValue(value),
	})
}

func (b *filterCndBuilderInvitationBindingRoles) ContainsAnyOf(values []*iam_invitation.Invitation_BindingRole) *FilterBuilder {
	pathSelector := NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles()
	itemValues := make([]ProjectInvitation_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderInvitationBindingRoles) compare(op gotenfilter.CompareOperator, value []*iam_invitation.Invitation_BindingRole) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesRole) In(values []*role.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().Role().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesRole) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().Role().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesRole) compare(op gotenfilter.CompareOperator, value *role.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().Role().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditions) In(values [][]*condition.ExecutableCondition) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditions) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditions) Contains(value *condition.ExecutableCondition) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().FieldPath(),
		Value:     NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().WithItemValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditions) ContainsAnyOf(values []*condition.ExecutableCondition) *FilterBuilder {
	pathSelector := NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions()
	itemValues := make([]ProjectInvitation_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditions) compare(op gotenfilter.CompareOperator, value []*condition.ExecutableCondition) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditionsCondition) In(values []*condition.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().Condition().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditionsCondition) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().Condition().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditionsCondition) compare(op gotenfilter.CompareOperator, value *condition.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().Condition().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditionsParams) In(values []*structpb.Struct) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().Params().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditionsParams) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().Params().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesExecutableConditionsParams) compare(op gotenfilter.CompareOperator, value *structpb.Struct) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ExecutableConditions().Params().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParams) In(values [][]*role.ScopeParam) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParams) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParams) Contains(value *role.ScopeParam) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().FieldPath(),
		Value:     NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().WithItemValue(value),
	})
}

func (b *filterCndBuilderInvitationBindingRolesScopeParams) ContainsAnyOf(values []*role.ScopeParam) *FilterBuilder {
	pathSelector := NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams()
	itemValues := make([]ProjectInvitation_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParams) compare(op gotenfilter.CompareOperator, value []*role.ScopeParam) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsName) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Name().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsName) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Name().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsName) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Name().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsString) In(values []*role.ScopeParam_StringValue) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().String_().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsString) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().String_().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsString) compare(op gotenfilter.CompareOperator, value *role.ScopeParam_StringValue) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().String_().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringValue) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().String_().Value().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringValue) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().String_().Value().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringValue) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().String_().Value().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStrings) In(values []*role.ScopeParam_ArrayOfStringsValue) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStrings) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStrings) compare(op gotenfilter.CompareOperator, value *role.ScopeParam_ArrayOfStringsValue) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringsValues) In(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().Values().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringsValues) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().Values().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringsValues) Contains(value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().Values().FieldPath(),
		Value:     NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().Values().WithItemValue(value),
	})
}

func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringsValues) ContainsAnyOf(values []string) *FilterBuilder {
	pathSelector := NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().Values()
	itemValues := make([]ProjectInvitation_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsStringsValues) compare(op gotenfilter.CompareOperator, value []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().Strings().Values().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFrom) In(values []*role.ScopeParam_FromValue) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFrom) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFrom) compare(op gotenfilter.CompareOperator, value *role.ScopeParam_FromValue) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFromSource) In(values []role.ScopeParam_FromValue_Source) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().Source().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFromSource) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().Source().FieldPath(),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFromSource) compare(op gotenfilter.CompareOperator, value role.ScopeParam_FromValue_Source) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                         op,
		ProjectInvitation_FieldPathValue: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().Source().WithValue(value),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFromPath) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		ProjectInvitation_FieldPathArrayOfValues: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().Path().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderInvitationBindingRolesScopeParamsValueFromPath) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectInvitationFieldPathBuilder().Invitation().BindingRoles().ScopeParams().ValueFrom().Path().FieldPath(),
	})
}
