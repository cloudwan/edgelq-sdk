...
type GetQuery struct {
	Reference *Reference
	Mask      *MemberAssignment_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*MemberAssignment_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return MemberAssignmentList(qr.MemberAssignments)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.MemberAssignments = results.(MemberAssignmentList)
	} else {
		qr.MemberAssignments = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*MemberAssignmentChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return MemberAssignmentChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(MemberAssignmentChangeList)
	} else {
		qr.Changes = nil
	}
}
