...
type Role struct {
	...
	Description string `protobuf:"bytes,9,opt,name=description,proto3" json:"description,omitempty" firestore:"description"`
	// Category to which Role belongs to. It cannot be changed.
	Category Role_Category `protobuf:"varint,10,opt,name=category,proto3,enum=ntt.iam.v1.Role_Category" json:"category,omitempty" firestore:"category"`
	...
	// role updates.
	RbSpecGeneration int64 `protobuf:"varint,8,opt,name=rb_spec_generation,json=rbSpecGeneration,proto3" json:"rb_spec_generation,omitempty" firestore:"rbSpecGeneration"`
}
...
type ScopeParam_ValueFrom struct {
	ValueFrom *ScopeParam_FromValue `protobuf:"bytes,4,opt,name=value_from,json=valueFrom,proto3,oneof" firestore:"valueFrom"`
}
...
type Role_Grant struct {
	...
	ResourceFieldConditions []*Role_Grant_FieldCondition `protobuf:"bytes,3,rep,name=resource_field_conditions,json=resourceFieldConditions,proto3" json:"resource_field_conditions,omitempty" firestore:"resourceFieldConditions"`
	// List of request field conditions. Values for conditions are extracted
	// from assigned RoleBinding (scope params).
	RequestFieldConditions []*Role_Grant_FieldCondition `protobuf:"bytes,4,rep,name=request_field_conditions,json=requestFieldConditions,proto3" json:"request_field_conditions,omitempty" firestore:"requestFieldConditions"`
	...
	ExecutableConditions []*condition.ExecutableCondition `protobuf:"bytes,5,rep,name=executable_conditions,json=executableConditions,proto3" json:"executable_conditions,omitempty" firestore:"executableConditions"`
}
...
type ScopeParam_FromValue struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Source        ScopeParam_FromValue_Source `protobuf:"varint,1,opt,name=source,proto3,enum=ntt.iam.v1.ScopeParam_FromValue_Source" json:"source,omitempty" firestore:"source"`
...
var edgelq_iam_proto_v1_role_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xf5, 0x0c, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x20, 0x0a, 0x04,
	...
	,
	...
	,
	...
	0x2f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x6f, 0x6c, 0x65, 0xa2, 0x80,
	0xd1, 0x02, 0x3c, 0x0a, 0x0b, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x12, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x77, 0x61, 0x6e, 0x2f, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2f, 0x69, 0x61, 0x6d,
	0x2f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x6f, 0x6c, 0x65, 0x0a,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x6f, 0x6c,
	0x65, 0x3b, 0x72, 0x6f, 0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var edgelq_iam_proto_v1_role_proto_depIdxs = []int32{
	...
	6,  // 3: ntt.iam.v1.Role.grants:type_name -> ntt.iam.v1.Role.Grant
	8,  // 4: ntt.iam.v1.ScopeParam.string:type_name -> ntt.iam.v1.ScopeParam.StringValue
	9,  // 5: ntt.iam.v1.ScopeParam.strings:type_name -> ntt.iam.v1.ScopeParam.ArrayOfStringsValue
	10, // 6: ntt.iam.v1.ScopeParam.value_from:type_name -> ntt.iam.v1.ScopeParam.FromValue
	1,  // 7: ntt.iam.v1.Role.ScopeParamType.type:type_name -> ntt.iam.v1.Role_ScopeParamType_Type
	7,  // 8: ntt.iam.v1.Role.Grant.resource_field_conditions:type_name -> ntt.iam.v1.Role.Grant.FieldCondition
	7,  // 9: ntt.iam.v1.Role.Grant.request_field_conditions:type_name -> ntt.iam.v1.Role.Grant.FieldCondition
	12, // 10: ntt.iam.v1.Role.Grant.executable_conditions:type_name -> ntt.iam.v1.ExecutableCondition
	2,  // 11: ntt.iam.v1.ScopeParam.FromValue.source:type_name -> ntt.iam.v1.ScopeParam_FromValue_Source
