...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServices) In(values []*meta.ServicesInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().Services().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().Services().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServices) compare(op gotenfilter.CompareOperator, value *meta.ServicesInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().Services().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().Services().OwningService().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().Services().OwningService().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().Services().OwningService().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) In(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().Services().AllowedServices().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().Services().AllowedServices().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) Contains(value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectFieldPathBuilder().Metadata().Services().AllowedServices().FieldPath(),
		Value:     NewProjectFieldPathBuilder().Metadata().Services().AllowedServices().WithItemValue(value),
	})
}

func (b *filterCndBuilderMetadataServicesAllowedServices) ContainsAnyOf(values []string) *FilterBuilder {
	pathSelector := NewProjectFieldPathBuilder().Metadata().Services().AllowedServices()
	itemValues := make([]Project_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) compare(op gotenfilter.CompareOperator, value []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().Services().AllowedServices().WithValue(value),
	})
}
...
func (b *filterCndBuilderTitle) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Title().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderTitle) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Title().FieldPath(),
	})
}
...
func (b *filterCndBuilderParentOrganization) Eq(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderParentOrganization) Neq(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderParentOrganization) Gt(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderParentOrganization) Gte(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderParentOrganization) Lt(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderParentOrganization) Lte(value *organization.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderParentOrganization) In(values []*organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ParentOrganization().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderParentOrganization) NotIn(values []*organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ParentOrganization().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderParentOrganization) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ParentOrganization().FieldPath(),
	})
}
...
func (b *filterCndBuilderParentOrganization) compare(op gotenfilter.CompareOperator, value *organization.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ParentOrganization().WithValue(value),
	})
}
...
func (b *filterCndBuilderBusinessTier) In(values []iam_common.BusinessTier) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().BusinessTier().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderBusinessTier) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().BusinessTier().FieldPath(),
	})
}
...
func (b *filterCndBuilderBusinessTier) compare(op gotenfilter.CompareOperator, value iam_common.BusinessTier) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().BusinessTier().WithValue(value),
	})
}
...
func (b *filterCndBuilderServiceTiers) In(values [][]*iam_common.ServiceBusinessTier) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ServiceTiers().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderServiceTiers) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ServiceTiers().FieldPath(),
	})
}
...
func (b *filterCndBuilderServiceTiers) Contains(value *iam_common.ServiceBusinessTier) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectFieldPathBuilder().ServiceTiers().FieldPath(),
		Value:     NewProjectFieldPathBuilder().ServiceTiers().WithItemValue(value),
	})
}

func (b *filterCndBuilderServiceTiers) ContainsAnyOf(values []*iam_common.ServiceBusinessTier) *FilterBuilder {
	pathSelector := NewProjectFieldPathBuilder().ServiceTiers()
	itemValues := make([]Project_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderServiceTiers) compare(op gotenfilter.CompareOperator, value []*iam_common.ServiceBusinessTier) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ServiceTiers().WithValue(value),
	})
}
...
func (b *filterCndBuilderServiceTiersService) In(values []*meta_service.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ServiceTiers().Service().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderServiceTiersService) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ServiceTiers().Service().FieldPath(),
	})
}
...
func (b *filterCndBuilderServiceTiersService) compare(op gotenfilter.CompareOperator, value *meta_service.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ServiceTiers().Service().WithValue(value),
	})
}
...
func (b *filterCndBuilderServiceTiersBusinessTier) In(values []iam_common.BusinessTier) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ServiceTiers().BusinessTier().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderServiceTiersBusinessTier) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ServiceTiers().BusinessTier().FieldPath(),
	})
}
...
func (b *filterCndBuilderServiceTiersBusinessTier) compare(op gotenfilter.CompareOperator, value iam_common.BusinessTier) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ServiceTiers().BusinessTier().WithValue(value),
	})
}
...
func (b *filterCndBuilderRootOrganization) Eq(value *organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderRootOrganization) Neq(value *organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderRootOrganization) Gt(value *organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderRootOrganization) Gte(value *organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderRootOrganization) Lt(value *organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderRootOrganization) Lte(value *organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderRootOrganization) In(values []*organization.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().RootOrganization().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderRootOrganization) NotIn(values []*organization.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().RootOrganization().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderRootOrganization) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().RootOrganization().FieldPath(),
	})
}
...
func (b *filterCndBuilderRootOrganization) compare(op gotenfilter.CompareOperator, value *organization.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().RootOrganization().WithValue(value),
	})
}
...
func (b *filterCndBuilderAncestryPath) Eq(value []*organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderAncestryPath) Neq(value []*organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderAncestryPath) Gt(value []*organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderAncestryPath) Gte(value []*organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderAncestryPath) Lt(value []*organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderAncestryPath) Lte(value []*organization.Name) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderAncestryPath) In(values [][]*organization.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().AncestryPath().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderAncestryPath) NotIn(values [][]*organization.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().AncestryPath().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderAncestryPath) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().AncestryPath().FieldPath(),
	})
}
...
func (b *filterCndBuilderAncestryPath) Contains(value *organization.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectFieldPathBuilder().AncestryPath().FieldPath(),
		Value:     NewProjectFieldPathBuilder().AncestryPath().WithItemValue(value),
	})
}

func (b *filterCndBuilderAncestryPath) ContainsAnyOf(values []*organization.Name) *FilterBuilder {
	pathSelector := NewProjectFieldPathBuilder().AncestryPath()
	itemValues := make([]Project_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderAncestryPath) ContainsAll(values []*organization.Name) *FilterBuilder {
	pathSelector := NewProjectFieldPathBuilder().AncestryPath()
	itemValues := make([]Project_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderAncestryPath) compare(op gotenfilter.CompareOperator, value []*organization.Name) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().AncestryPath().WithValue(value),
	})
}
...
func (b *filterCndBuilderServiceErrors) In(values []map[string]*iam_common.ServiceErrors) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ServiceErrors().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderServiceErrors) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ServiceErrors().FieldPath(),
	})
}
...
func (b *filterCndBuilderServiceErrors) compare(op gotenfilter.CompareOperator, value map[string]*iam_common.ServiceErrors) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ServiceErrors().WithValue(value),
	})
}
...
func (b *mapFilterCndBuilderServiceErrors) In(values []*iam_common.ServiceErrors) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ServiceErrors().WithKey(b.key).WithArrayOfValues(values),
	})
}
...
func (b *mapFilterCndBuilderServiceErrors) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ServiceErrors().WithKey(b.key).FieldPath(),
	})
}
...
func (b *mapFilterCndBuilderServiceErrors) compare(op gotenfilter.CompareOperator, value *iam_common.ServiceErrors) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ServiceErrors().WithKey(b.key).WithValue(value),
	})
}
...
func (b *filterCndBuilderServicesGeneration) In(values []int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ServicesGeneration().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderServicesGeneration) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ServicesGeneration().FieldPath(),
	})
}
...
func (b *filterCndBuilderServicesGeneration) compare(op gotenfilter.CompareOperator, value int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ServicesGeneration().WithValue(value),
	})
}
