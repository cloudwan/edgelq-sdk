...
// File: edgelq/iam/proto/v1/group_change.proto
// DO NOT EDIT!!!
...
func (m *GroupChange) Reset() {
	*m = GroupChange{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_group_change_proto_msgTypes[0]
...
func (*GroupChange) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_group_change_proto_rawDescGZIP(), []int{0}
}
...
func (m *GroupChange_Added) Reset() {
	*m = GroupChange_Added{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_group_change_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GroupChange_Added) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_group_change_proto_rawDescGZIP(), []int{0, 0}
}
...
func (m *GroupChange_Modified) Reset() {
	*m = GroupChange_Modified{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_group_change_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GroupChange_Modified) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_group_change_proto_rawDescGZIP(), []int{0, 1}
}
...
func (m *GroupChange_Current) Reset() {
	*m = GroupChange_Current{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_group_change_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GroupChange_Current) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_group_change_proto_rawDescGZIP(), []int{0, 2}
}
...
func (m *GroupChange_Removed) Reset() {
	*m = GroupChange_Removed{}
	if protoimpl.UnsafeEnabled {
		mi := &edgelq_iam_proto_v1_group_change_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GroupChange_Removed) Descriptor() ([]byte, []int) {
	return edgelq_iam_proto_v1_group_change_proto_rawDescGZIP(), []int{0, 3}
}
...
var edgelq_iam_proto_v1_group_change_proto preflect.FileDescriptor

var edgelq_iam_proto_v1_group_change_proto_rawDesc = []byte{
	0x0a, 0x26, 0x65, 0x64, 0x67, 0x65, 0x6c, 0x71, 0x2f, 0x69, 0x61, 0x6d, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61,
	...
	,
	...
	0x6f, 0x76, 0x65, 0x64, 0x1a, 0x4f, 0x0a, 0x05, 0x41, 0x64, 0x64, 0x65, 0x64, 0x12, 0x27, 0x0a,
	0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6e,
	...
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x1a, 0xef, 0x01, 0x0a, 0x08, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x69,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x27, 0x0a, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76,
	0x31, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x48,
	...
	0x65, 0x77, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x1a, 0x32, 0x0a, 0x07, 0x43, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x74, 0x12, 0x27, 0x0a, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x11, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x1a, 0x4b, 0x0a, 0x07, 0x52,
	...
	0x6f, 0x75, 0x70, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x76, 0x69, 0x65,
	...
	,
}

var (
	edgelq_iam_proto_v1_group_change_proto_rawDescOnce sync.Once
	edgelq_iam_proto_v1_group_change_proto_rawDescData = edgelq_iam_proto_v1_group_change_proto_rawDesc
)

func edgelq_iam_proto_v1_group_change_proto_rawDescGZIP() []byte {
	edgelq_iam_proto_v1_group_change_proto_rawDescOnce.Do(func() {
		edgelq_iam_proto_v1_group_change_proto_rawDescData = protoimpl.X.CompressGZIP(edgelq_iam_proto_v1_group_change_proto_rawDescData)
	})
	return edgelq_iam_proto_v1_group_change_proto_rawDescData
}

var edgelq_iam_proto_v1_group_change_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var edgelq_iam_proto_v1_group_change_proto_goTypes = []interface{}{
	(*GroupChange)(nil),          // 0: ntt.iam.v1.GroupChange
	(*GroupChange_Added)(nil),    // 1: ntt.iam.v1.GroupChange.Added
	(*GroupChange_Modified)(nil), // 2: ntt.iam.v1.GroupChange.Modified
	(*GroupChange_Current)(nil),  // 3: ntt.iam.v1.GroupChange.Current
	(*GroupChange_Removed)(nil),  // 4: ntt.iam.v1.GroupChange.Removed
	(*Group)(nil),                // 5: ntt.iam.v1.Group
	(*Group_FieldMask)(nil),      // 6: ntt.iam.v1.Group_FieldMask
}
var edgelq_iam_proto_v1_group_change_proto_depIdxs = []int32{
	1, // 0: ntt.iam.v1.GroupChange.added:type_name -> ntt.iam.v1.GroupChange.Added
	2, // 1: ntt.iam.v1.GroupChange.modified:type_name -> ntt.iam.v1.GroupChange.Modified
	3, // 2: ntt.iam.v1.GroupChange.current:type_name -> ntt.iam.v1.GroupChange.Current
	4, // 3: ntt.iam.v1.GroupChange.removed:type_name -> ntt.iam.v1.GroupChange.Removed
	5, // 4: ntt.iam.v1.GroupChange.Added.group:type_name -> ntt.iam.v1.Group
	5, // 5: ntt.iam.v1.GroupChange.Modified.group:type_name -> ntt.iam.v1.Group
	6, // 6: ntt.iam.v1.GroupChange.Modified.field_mask:type_name -> ntt.iam.v1.Group_FieldMask
	5, // 7: ntt.iam.v1.GroupChange.Current.group:type_name -> ntt.iam.v1.Group
...
func init() { edgelq_iam_proto_v1_group_change_proto_init() }
func edgelq_iam_proto_v1_group_change_proto_init() {
	if edgelq_iam_proto_v1_group_change_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		edgelq_iam_proto_v1_group_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_group_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_group_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_group_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		edgelq_iam_proto_v1_group_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	edgelq_iam_proto_v1_group_change_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: edgelq_iam_proto_v1_group_change_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           edgelq_iam_proto_v1_group_change_proto_goTypes,
		DependencyIndexes: edgelq_iam_proto_v1_group_change_proto_depIdxs,
		MessageInfos:      edgelq_iam_proto_v1_group_change_proto_msgTypes,
	}.Build()
	edgelq_iam_proto_v1_group_change_proto = out.File
	edgelq_iam_proto_v1_group_change_proto_rawDesc = nil
	edgelq_iam_proto_v1_group_change_proto_goTypes = nil
	edgelq_iam_proto_v1_group_change_proto_depIdxs = nil
}
