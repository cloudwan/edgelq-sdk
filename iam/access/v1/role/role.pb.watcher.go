...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(role.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Name) gotenaccess.WatcherFilterParams {
		params := &WatcherFilterParams{}
		if filter != nil {
			params.Filter = filter.(*role.Filter)
		}
		if parent != nil {
			params.Parent = parent.(*role.ParentName)
		}
		return params
	})
}
