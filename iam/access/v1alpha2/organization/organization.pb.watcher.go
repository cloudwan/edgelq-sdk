...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(organization.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Name) gotenaccess.WatcherFilterParams {
