...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(organization_invitation.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Reference) gotenaccess.WatcherFilterParams {
		params := &WatcherFilterParams{}
		if filter != nil {
			params.Filter = filter.(*organization_invitation.Filter)
		}
		if parent != nil {
			params.Parent = parent.(*organization_invitation.ParentReference)
		}
		return params
	})
}
