...
func (c *client) GetDocument(ctx context.Context, in *GetDocumentRequest, opts ...grpc.CallOption) (*document.Document, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.alerting.v1.DocumentService/GetDocument", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetDocuments(ctx context.Context, in *BatchGetDocumentsRequest, opts ...grpc.CallOption) (*BatchGetDocumentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.alerting.v1.DocumentService/BatchGetDocuments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListDocuments(ctx context.Context, in *ListDocumentsRequest, opts ...grpc.CallOption) (*ListDocumentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.alerting.v1.DocumentService/ListDocuments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchDocument(ctx context.Context, in *WatchDocumentRequest, opts ...grpc.CallOption) (WatchDocumentClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.alerting.v1.DocumentService/WatchDocument", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchDocuments(ctx context.Context, in *WatchDocumentsRequest, opts ...grpc.CallOption) (WatchDocumentsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.alerting.v1.DocumentService/WatchDocuments", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateDocument(ctx context.Context, in *CreateDocumentRequest, opts ...grpc.CallOption) (*document.Document, error) {
	out := new(document.Document)
	err := c.cc.Invoke(ctx, "/ntt.alerting.v1.DocumentService/CreateDocument", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateDocument(ctx context.Context, in *UpdateDocumentRequest, opts ...grpc.CallOption) (*document.Document, error) {
	out := new(document.Document)
	err := c.cc.Invoke(ctx, "/ntt.alerting.v1.DocumentService/UpdateDocument", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteDocument(ctx context.Context, in *DeleteDocumentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.alerting.v1.DocumentService/DeleteDocument", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) SearchDocuments(ctx context.Context, in *SearchDocumentsRequest, opts ...grpc.CallOption) (*SearchDocumentsResponse, error) {
	out := new(SearchDocumentsResponse)
	err := c.cc.Invoke(ctx, "/ntt.alerting.v1.DocumentService/SearchDocuments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
