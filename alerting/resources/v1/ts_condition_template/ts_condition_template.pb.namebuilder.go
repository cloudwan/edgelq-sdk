...
const (
	NamePattern_Project_PolicyTemplate = "projects/{project}/policyTemplates/{policy_template}/tsConditionTemplates/{ts_condition_template}"
)
...
func NewNameBuilder() *NameBuilder {
	return &NameBuilder{
		nameObj: Name{
			TsConditionTemplateId: gotenresource.WildcardId,
...
func (b *NameBuilder) SetId(id string) *NameBuilder {
	b.nameObj.TsConditionTemplateId = id
	return b
}
