...
func (orderByFld *OrderByField) CompareWithDirection(left, right *TsConditionTemplate) int {
...
func (orderBy *OrderBy) Sort(results TsConditionTemplateList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(TsConditionTemplateList))
}

func (orderBy *OrderBy) InsertSorted(sorted TsConditionTemplateList, elem *TsConditionTemplate) (TsConditionTemplateList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(TsConditionTemplateList), elem.(*TsConditionTemplate))
}

func (orderBy *OrderBy) Compare(left, right *TsConditionTemplate) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*TsConditionTemplate), right.(*TsConditionTemplate))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseTsConditionTemplate_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *TsConditionTemplate_FieldMask {
	fieldMask := &TsConditionTemplate_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == TsConditionTemplate_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &TsConditionTemplate_FieldTerminalPath{selector: TsConditionTemplate_FieldPathSelectorName},
