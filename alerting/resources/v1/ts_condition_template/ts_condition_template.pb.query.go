...
type GetQuery struct {
	Reference *Reference
	Mask      *TsConditionTemplate_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*TsConditionTemplate_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	TsConditionTemplates []*TsConditionTemplate
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return TsConditionTemplateList(qr.TsConditionTemplates)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.TsConditionTemplates = results.(TsConditionTemplateList)
	} else {
		qr.TsConditionTemplates = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*TsConditionTemplateChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return TsConditionTemplateChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(TsConditionTemplateChangeList)
	} else {
		qr.Changes = nil
	}
}
