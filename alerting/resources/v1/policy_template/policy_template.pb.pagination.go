...
func (orderByFld *OrderByField) CompareWithDirection(left, right *PolicyTemplate) int {
...
func (orderBy *OrderBy) Sort(results PolicyTemplateList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(PolicyTemplateList))
}

func (orderBy *OrderBy) InsertSorted(sorted PolicyTemplateList, elem *PolicyTemplate) (PolicyTemplateList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(PolicyTemplateList), elem.(*PolicyTemplate))
}

func (orderBy *OrderBy) Compare(left, right *PolicyTemplate) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*PolicyTemplate), right.(*PolicyTemplate))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParsePolicyTemplate_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *PolicyTemplate_FieldMask {
	fieldMask := &PolicyTemplate_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == PolicyTemplate_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &PolicyTemplate_FieldTerminalPath{selector: PolicyTemplate_FieldPathSelectorName},
