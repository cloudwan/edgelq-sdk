...
type PolicySpec_Notification_Kind int32

const (
	// Undefined is not allowed
	PolicySpec_Notification_UNDEFINED PolicySpec_Notification_Kind = 0
	// This kind must be used if we want to generate a notification
	// for a new firing alert.
	PolicySpec_Notification_NEW_FIRING PolicySpec_Notification_Kind = 1
	// This kind must be used if we want to generate a notification
	// for an alert that has been pushed to Operator (escalated by
	// AI Agent).
	PolicySpec_Notification_AI_ESCALATED_TO_OPERATOR PolicySpec_Notification_Kind = 2
	// This kind must be used if we want to generate a notification
	// for an alert which received remediation recommendation by
	// AI Agent, and which requires operator approval.
	PolicySpec_Notification_AI_REMEDIATION_AWAITING_APPROVAL PolicySpec_Notification_Kind = 3
	// This kind must be used if we want to generate a notification
	// for an alert which has been considered as a temporary violation
	// by AI Agent.
	PolicySpec_Notification_AI_IGNORED_AS_TMP PolicySpec_Notification_Kind = 4
	// This kind must be used if we want to generate a notification
	// for an alert which has been considered as a false positive,
	// and for which alerting thresholds should be adjusted.
	PolicySpec_Notification_AI_ADJUSTED_ENTRIES PolicySpec_Notification_Kind = 5
	// This kind must be used if we want to generate a notification
	// for an alert for which AI agent applied recommendation.
	PolicySpec_Notification_AI_REMEDIATION_APPLIED PolicySpec_Notification_Kind = 6
	// This kind must be used if we want to generate a notification
	// for an alert for which operator applied recommendation.
	PolicySpec_Notification_OP_REMEDIATION_APPLIED PolicySpec_Notification_Kind = 7
	// This kind must be used if we want to generate a notification
	// for an alert that stopped firing.
	PolicySpec_Notification_STOPPED_FIRING PolicySpec_Notification_Kind = 8
)

var (
	PolicySpec_Notification_Kind_name = map[int32]string{
		0: "UNDEFINED",
		1: "NEW_FIRING",
	...
	PolicySpec_Notification_Kind_value = map[string]int32{
		"UNDEFINED":                        0,
		"NEW_FIRING":                       1,
...
func (x PolicySpec_Notification_Kind) Enum() *PolicySpec_Notification_Kind {
	p := new(PolicySpec_Notification_Kind)
	*p = x
	return p
}

func (x PolicySpec_Notification_Kind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), preflect.EnumNumber(x))
}

func (PolicySpec_Notification_Kind) Descriptor() preflect.EnumDescriptor {
	return edgelq_alerting_proto_v1_specs_proto_enumTypes[3].Descriptor()
}

func (PolicySpec_Notification_Kind) Type() preflect.EnumType {
	return &edgelq_alerting_proto_v1_specs_proto_enumTypes[3]
}

func (x PolicySpec_Notification_Kind) Number() preflect.EnumNumber {
	return preflect.EnumNumber(x)
}

// Deprecated, Use PolicySpec_Notification_Kind.ProtoReflect.Descriptor instead.
func (PolicySpec_Notification_Kind) EnumDescriptor() ([]byte, []int) {
...
func (PolicySpec_ResourceIdentity_LabelInfo_UsageContext) EnumDescriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 1, 0, 0}
}
...
type PolicySpec struct {
	...
	Notifications []*PolicySpec_Notification `protobuf:"bytes,3,rep,name=notifications,proto3" json:"notifications,omitempty"`
...
func (m *PolicySpec) GetNotifications() []*PolicySpec_Notification {
	if m != nil {
...
func (m *PolicySpec) SetNotifications(fv []*PolicySpec_Notification) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Notifications", "PolicySpec"))
	}
	m.Notifications = fv
}
...
type PolicySpec_Notification struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	// List of alert state change kinds when we want to send a notification.
	EnabledKinds []PolicySpec_Notification_Kind `protobuf:"varint,1,rep,packed,name=enabled_kinds,json=enabledKinds,proto3,enum=ntt.alerting.v1.PolicySpec_Notification_Kind" json:"enabled_kinds,omitempty"`
...
func (m *PolicySpec_Notification) Reset() {
	*m = PolicySpec_Notification{}
	if protoimpl.UnsafeEnabled {
...
func (m *PolicySpec_Notification) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*PolicySpec_Notification) ProtoMessage() {}

func (m *PolicySpec_Notification) ProtoReflect() preflect.Message {
	mi := &edgelq_alerting_proto_v1_specs_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*PolicySpec_Notification) GotenMessage() {}

// Deprecated, Use PolicySpec_Notification.ProtoReflect.Descriptor instead.
func (*PolicySpec_Notification) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 0}
}

func (m *PolicySpec_Notification) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *PolicySpec_Notification) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *PolicySpec_Notification) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *PolicySpec_Notification) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

func (m *PolicySpec_Notification) GetEnabledKinds() []PolicySpec_Notification_Kind {
	if m != nil {
...
func (m *PolicySpec_Notification) GetChannel() *notification_channel.Reference {
	if m != nil {
		return m.Channel
	}
	return nil
...
func (m *PolicySpec_Notification) GetMaxAlertBodiesInMsg() int32 {
	if m != nil {
...
func (m *PolicySpec_Notification) GetPutOnlyAlertsCounterWhenOverflowing() bool {
	if m != nil {
...
func (m *PolicySpec_Notification) SetEnabledKinds(fv []PolicySpec_Notification_Kind) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "EnabledKinds", "PolicySpec_Notification"))
	}
	m.EnabledKinds = fv
}

func (m *PolicySpec_Notification) SetChannel(fv *notification_channel.Reference) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Channel", "PolicySpec_Notification"))
	}
	m.Channel = fv
}

func (m *PolicySpec_Notification) SetMaxAlertBodiesInMsg(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "MaxAlertBodiesInMsg", "PolicySpec_Notification"))
	}
	m.MaxAlertBodiesInMsg = fv
}

func (m *PolicySpec_Notification) SetPutOnlyAlertsCounterWhenOverflowing(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "PutOnlyAlertsCounterWhenOverflowing", "PolicySpec_Notification"))
	}
...
func (*PolicySpec_AIAgentHandling) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3}
}
...
func (*PolicySpec_SupportingAlertQuery_RestGetQuery) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 2, 2}
}
...
func (*PolicySpec_SupportingAlertQuery_RestListQuery) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 2, 3}
}
...
func (*PolicySpec_AIAgentHandling_EdgeConnectivity) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3, 0}
}
...
func (*PolicySpec_AIAgentHandling_Remediation) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3, 1}
}
...
func (*PolicySpec_AIAgentHandling_EdgeConnectivity_DeviceSSH) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3, 0, 0}
}
...
func (*PolicySpec_AIAgentHandling_EdgeConnectivity_ProxiesSSH) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3, 0, 1}
}
...
func (*PolicySpec_AIAgentHandling_EdgeConnectivity_PodSSH) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3, 0, 2}
}
...
func (*PolicySpec_AIAgentHandling_Remediation_FixInSSH) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3, 1, 0}
}
...
func (*PolicySpec_AIAgentHandling_Remediation_Reboot) Descriptor() ([]byte, []int) {
	return edgelq_alerting_proto_v1_specs_proto_rawDescGZIP(), []int{2, 3, 1, 1}
}
...
var edgelq_alerting_proto_v1_specs_proto_rawDesc = []byte{
	...
	0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0xcb, 0x21, 0x0a, 0x0a, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	...
	0x6e, 0x67, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5a, 0x0a, 0x0d, 0x6e, 0x6f,
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x28, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67,
	0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x0a, 0xca, 0xc6, 0x27,
	0x06, 0x42, 0x04, 0x12, 0x02, 0x08, 0x08, 0x52, 0x0d, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x63, 0x0a, 0x11, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	,
	...
	,
	...
	0x6e, 0x67, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x54, 0x73, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x48, 0x00, 0x52, 0x07, 0x74, 0x73, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12,
	0x58, 0x0a, 0x09, 0x6c, 0x6f, 0x67, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x39, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e,
	...
	,
	...
	,
	...
	0x80, 0x04, 0x52, 0x09, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x1a, 0xa1, 0x02,
	0x0a, 0x0d, 0x52, 0x65, 0x73, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x12, 0x72, 0x65, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0xf3, 0x05, 0x0a, 0x10, 0x45, 0x64, 0x67,
	0x65, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x12, 0x67, 0x0a,
	0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x73, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x46, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67,
	0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x41,
	...
	,
	...
	0x79, 0x2e, 0x50, 0x6f, 0x64, 0x53, 0x53, 0x48, 0x48, 0x00, 0x52, 0x06, 0x70, 0x6f, 0x64, 0x53,
	0x73, 0x68, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f, 0x62, 0x69,
	0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65,
	0x64, 0x42, 0x69, 0x6e, 0x73, 0x1a, 0x3a, 0x0a, 0x09, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53,
	...
	,
	...
	0x47, 0x45, 0x10, 0x02, 0x22, 0x4c, 0x0a, 0x11, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67,
	...
	0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x76, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x73, 0x69,
	0x76, 0x65, 0x42, 0x45, 0xe8, 0xde, 0x21, 0x01, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x3b, 0x72, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var edgelq_alerting_proto_v1_specs_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var edgelq_alerting_proto_v1_specs_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var edgelq_alerting_proto_v1_specs_proto_goTypes = []interface{}{
	...
	(PolicySpec_Notification_Kind)(0),                              // 3: ntt.alerting.v1.PolicySpec_Notification_Kind
	(PolicySpec_ResourceIdentity_LabelInfo_UsageContext)(0),        // 4: ntt.alerting.v1.PolicySpec_ResourceIdentity_LabelInfo_UsageContext
	(*LogCndSpec)(nil),                                             // 5: ntt.alerting.v1.LogCndSpec
	(*TsCndSpec)(nil),                                              // 6: ntt.alerting.v1.TsCndSpec
	(*PolicySpec)(nil),                                             // 7: ntt.alerting.v1.PolicySpec
	(*AlertingThreshold)(nil),                                      // 8: ntt.alerting.v1.AlertingThreshold
	(*LogCndSpec_Query)(nil),                                       // 9: ntt.alerting.v1.LogCndSpec.Query
	(*LogCndSpec_Query_LabelTrigger)(nil),                          // 10: ntt.alerting.v1.LogCndSpec.Query.LabelTrigger
	(*LogCndSpec_Query_StringPayloadTrigger)(nil),                  // 11: ntt.alerting.v1.LogCndSpec.Query.StringPayloadTrigger
	(*LogCndSpec_Query_CompositeTrigger)(nil),                      // 12: ntt.alerting.v1.LogCndSpec.Query.CompositeTrigger
	(*LogCndSpec_Query_TriggerCnd)(nil),                            // 13: ntt.alerting.v1.LogCndSpec.Query.TriggerCnd
	(*TsCndSpec_Query)(nil),                                        // 14: ntt.alerting.v1.TsCndSpec.Query
	(*TsCndSpec_ThresholdAlertingCfg)(nil),                         // 15: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg
	(*TsCndSpec_AnomalyAlertingCfg)(nil),                           // 16: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg
	(*TsCndSpec_ThresholdAlertingCfg_AlertingThresholds)(nil),      // 17: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.AlertingThresholds
	(*TsCndSpec_AnomalyAlertingCfg_LstmAutoEncoder)(nil),           // 18: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.LstmAutoEncoder
	(*PolicySpec_Notification)(nil),                                // 19: ntt.alerting.v1.PolicySpec.Notification
	(*PolicySpec_ResourceIdentity)(nil),                            // 20: ntt.alerting.v1.PolicySpec.ResourceIdentity
	(*PolicySpec_SupportingAlertQuery)(nil),                        // 21: ntt.alerting.v1.PolicySpec.SupportingAlertQuery
	(*PolicySpec_AIAgentHandling)(nil),                             // 22: ntt.alerting.v1.PolicySpec.AIAgentHandling
	(*PolicySpec_ResourceIdentity_LabelInfo)(nil),                  // 23: ntt.alerting.v1.PolicySpec.ResourceIdentity.LabelInfo
	(*PolicySpec_SupportingAlertQuery_TsQuery)(nil),                // 24: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.TsQuery
	(*PolicySpec_SupportingAlertQuery_LogQuery)(nil),               // 25: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.LogQuery
	(*PolicySpec_SupportingAlertQuery_RestGetQuery)(nil),           // 26: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.RestGetQuery
	(*PolicySpec_SupportingAlertQuery_RestListQuery)(nil),          // 27: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.RestListQuery
	(*PolicySpec_AIAgentHandling_EdgeConnectivity)(nil),            // 28: ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity
	(*PolicySpec_AIAgentHandling_Remediation)(nil),                 // 29: ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation
	(*PolicySpec_AIAgentHandling_EdgeConnectivity_DeviceSSH)(nil),  // 30: ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.DeviceSSH
	(*PolicySpec_AIAgentHandling_EdgeConnectivity_ProxiesSSH)(nil), // 31: ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.ProxiesSSH
	(*PolicySpec_AIAgentHandling_EdgeConnectivity_PodSSH)(nil),     // 32: ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.PodSSH
	(*PolicySpec_AIAgentHandling_Remediation_FixInSSH)(nil),        // 33: ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation.FixInSSH
	(*PolicySpec_AIAgentHandling_Remediation_Reboot)(nil),          // 34: ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation.Reboot
	(*durationpb.Duration)(nil),                                    // 35: google.protobuf.Duration
	(monitoring_common.Aggregation_Aligner)(0),                     // 36: ntt.monitoring.v4.Aggregation_Aligner
	(monitoring_common.Aggregation_Reducer)(0),                     // 37: ntt.monitoring.v4.Aggregation_Reducer
	(*monitoring_common.Aggregation)(nil),                          // 38: ntt.monitoring.v4.Aggregation
}
var edgelq_alerting_proto_v1_specs_proto_depIdxs = []int32{
	9,  // 0: ntt.alerting.v1.LogCndSpec.query:type_name -> ntt.alerting.v1.LogCndSpec.Query
	14, // 1: ntt.alerting.v1.TsCndSpec.queries:type_name -> ntt.alerting.v1.TsCndSpec.Query
	15, // 2: ntt.alerting.v1.TsCndSpec.threshold_alerting:type_name -> ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg
	16, // 3: ntt.alerting.v1.TsCndSpec.anomaly_alerting:type_name -> ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg
	2,  // 4: ntt.alerting.v1.PolicySpec.processing_location:type_name -> ntt.alerting.v1.PolicySpec_ProcessingLocation
	19, // 5: ntt.alerting.v1.PolicySpec.notifications:type_name -> ntt.alerting.v1.PolicySpec.Notification
	20, // 6: ntt.alerting.v1.PolicySpec.resource_identity:type_name -> ntt.alerting.v1.PolicySpec.ResourceIdentity
	21, // 7: ntt.alerting.v1.PolicySpec.supporting_queries:type_name -> ntt.alerting.v1.PolicySpec.SupportingAlertQuery
	22, // 8: ntt.alerting.v1.PolicySpec.ai_agent:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling
	13, // 9: ntt.alerting.v1.LogCndSpec.Query.trigger:type_name -> ntt.alerting.v1.LogCndSpec.Query.TriggerCnd
	35, // 10: ntt.alerting.v1.LogCndSpec.Query.min_duration:type_name -> google.protobuf.Duration
	13, // 11: ntt.alerting.v1.LogCndSpec.Query.CompositeTrigger.triggers:type_name -> ntt.alerting.v1.LogCndSpec.Query.TriggerCnd
	0,  // 12: ntt.alerting.v1.LogCndSpec.Query.CompositeTrigger.operator:type_name -> ntt.alerting.v1.LogCndSpec_Query_CompositeTrigger_Operator
	10, // 13: ntt.alerting.v1.LogCndSpec.Query.TriggerCnd.label:type_name -> ntt.alerting.v1.LogCndSpec.Query.LabelTrigger
	11, // 14: ntt.alerting.v1.LogCndSpec.Query.TriggerCnd.string_content:type_name -> ntt.alerting.v1.LogCndSpec.Query.StringPayloadTrigger
	12, // 15: ntt.alerting.v1.LogCndSpec.Query.TriggerCnd.composite:type_name -> ntt.alerting.v1.LogCndSpec.Query.CompositeTrigger
	36, // 16: ntt.alerting.v1.TsCndSpec.Query.aligner:type_name -> ntt.monitoring.v4.Aggregation_Aligner
	37, // 17: ntt.alerting.v1.TsCndSpec.Query.reducer:type_name -> ntt.monitoring.v4.Aggregation_Reducer
	1,  // 18: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.operator:type_name -> ntt.alerting.v1.TsCndSpec_ThresholdAlertingCfg_Operator
	35, // 19: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.alignment_period:type_name -> google.protobuf.Duration
	35, // 20: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.raise_after:type_name -> google.protobuf.Duration
	35, // 21: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.silence_after:type_name -> google.protobuf.Duration
	17, // 22: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.per_query_thresholds:type_name -> ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.AlertingThresholds
	35, // 23: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.adaptive_thresholds_detection_period:type_name -> google.protobuf.Duration
	35, // 24: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.analysis_window:type_name -> google.protobuf.Duration
	35, // 25: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.step_interval:type_name -> google.protobuf.Duration
	35, // 26: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.train_step_interval:type_name -> google.protobuf.Duration
	35, // 27: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.alignment_period:type_name -> google.protobuf.Duration
	18, // 28: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.lstm_autoencoder:type_name -> ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.LstmAutoEncoder
	35, // 29: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.raise_after:type_name -> google.protobuf.Duration
	35, // 30: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.silence_after:type_name -> google.protobuf.Duration
	8,  // 31: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.AlertingThresholds.max_upper:type_name -> ntt.alerting.v1.AlertingThreshold
	8,  // 32: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.AlertingThresholds.max_lower:type_name -> ntt.alerting.v1.AlertingThreshold
	8,  // 33: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.AlertingThresholds.min_upper:type_name -> ntt.alerting.v1.AlertingThreshold
	8,  // 34: ntt.alerting.v1.TsCndSpec.ThresholdAlertingCfg.AlertingThresholds.min_lower:type_name -> ntt.alerting.v1.AlertingThreshold
	35, // 35: ntt.alerting.v1.TsCndSpec.AnomalyAlertingCfg.LstmAutoEncoder.training_period:type_name -> google.protobuf.Duration
	3,  // 36: ntt.alerting.v1.PolicySpec.Notification.enabled_kinds:type_name -> ntt.alerting.v1.PolicySpec_Notification_Kind
	23, // 37: ntt.alerting.v1.PolicySpec.ResourceIdentity.labels:type_name -> ntt.alerting.v1.PolicySpec.ResourceIdentity.LabelInfo
	24, // 38: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.ts_query:type_name -> ntt.alerting.v1.PolicySpec.SupportingAlertQuery.TsQuery
	25, // 39: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.log_query:type_name -> ntt.alerting.v1.PolicySpec.SupportingAlertQuery.LogQuery
	26, // 40: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.rest_get_query:type_name -> ntt.alerting.v1.PolicySpec.SupportingAlertQuery.RestGetQuery
	27, // 41: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.rest_list_query:type_name -> ntt.alerting.v1.PolicySpec.SupportingAlertQuery.RestListQuery
	28, // 42: ntt.alerting.v1.PolicySpec.AIAgentHandling.edge_connectivity:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity
	29, // 43: ntt.alerting.v1.PolicySpec.AIAgentHandling.remediation_options:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation
	4,  // 44: ntt.alerting.v1.PolicySpec.ResourceIdentity.LabelInfo.contexts:type_name -> ntt.alerting.v1.PolicySpec_ResourceIdentity_LabelInfo_UsageContext
	38, // 45: ntt.alerting.v1.PolicySpec.SupportingAlertQuery.TsQuery.aggregation:type_name -> ntt.monitoring.v4.Aggregation
	30, // 46: ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.device_ssh:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.DeviceSSH
	31, // 47: ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.proxies_ssh:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.ProxiesSSH
	32, // 48: ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.pod_ssh:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling.EdgeConnectivity.PodSSH
	33, // 49: ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation.fix_in_ssh:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation.FixInSSH
	34, // 50: ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation.reboot:type_name -> ntt.alerting.v1.PolicySpec.AIAgentHandling.Remediation.Reboot
...
func edgelq_alerting_proto_v1_specs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		edgelq_alerting_proto_v1_specs_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PolicySpec_Notification); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	edgelq_alerting_proto_v1_specs_proto_msgTypes[8].OneofWrappers = []interface{}{
	...
	edgelq_alerting_proto_v1_specs_proto_msgTypes[11].OneofWrappers = []interface{}{
