...
func (obj *TsCondition) GotenValidate() error {
	...
	if subobj, ok := interface{}(obj.TemplateSource).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("TsCondition", "templateSource", obj.TemplateSource, "nested object validation failed", err)
		}
	}
...
func (obj *TsCondition_TemplateSource) GotenValidate() error {
	if obj == nil {
		return nil
	}
	if cvobj, ok := interface{}(obj).(gotenvalidate.CustomValidator); ok {
