...
func (b *filterCndBuilderPlan) In(values []*plan.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AcceptedPlan_FieldPathArrayOfValues: NewAcceptedPlanFieldPathBuilder().Plan().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderPlan) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAcceptedPlanFieldPathBuilder().Plan().FieldPath(),
	})
}
...
func (b *filterCndBuilderPlan) compare(op gotenfilter.CompareOperator, value *plan.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
		AcceptedPlan_FieldPathValue: NewAcceptedPlanFieldPathBuilder().Plan().WithValue(value),
	})
}
...
func (b *filterCndBuilderRegionalDistributions) In(values [][]*common.RegionalDistribution) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AcceptedPlan_FieldPathArrayOfValues: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderRegionalDistributions) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().FieldPath(),
	})
}
...
func (b *filterCndBuilderRegionalDistributions) Contains(value *common.RegionalDistribution) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().FieldPath(),
		Value:     NewAcceptedPlanFieldPathBuilder().RegionalDistributions().WithItemValue(value),
	})
}

func (b *filterCndBuilderRegionalDistributions) ContainsAnyOf(values []*common.RegionalDistribution) *FilterBuilder {
	pathSelector := NewAcceptedPlanFieldPathBuilder().RegionalDistributions()
	itemValues := make([]AcceptedPlan_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderRegionalDistributions) compare(op gotenfilter.CompareOperator, value []*common.RegionalDistribution) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
		AcceptedPlan_FieldPathValue: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().WithValue(value),
	})
}
...
func (b *filterCndBuilderRegionalDistributionsResource) In(values []*meta_resource.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AcceptedPlan_FieldPathArrayOfValues: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().Resource().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderRegionalDistributionsResource) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().Resource().FieldPath(),
	})
}
...
func (b *filterCndBuilderRegionalDistributionsResource) compare(op gotenfilter.CompareOperator, value *meta_resource.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
		AcceptedPlan_FieldPathValue: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().Resource().WithValue(value),
	})
}
...
func (b *filterCndBuilderRegionalDistributionsLimitsByRegion) In(values []map[string]int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AcceptedPlan_FieldPathArrayOfValues: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().LimitsByRegion().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderRegionalDistributionsLimitsByRegion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().LimitsByRegion().FieldPath(),
	})
}
...
func (b *filterCndBuilderRegionalDistributionsLimitsByRegion) compare(op gotenfilter.CompareOperator, value map[string]int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
		AcceptedPlan_FieldPathValue: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().LimitsByRegion().WithValue(value),
	})
}
...
func (b *mapFilterCndBuilderRegionalDistributionsLimitsByRegion) In(values []int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AcceptedPlan_FieldPathArrayOfValues: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().LimitsByRegion().WithKey(b.key).WithArrayOfValues(values),
	})
}
...
func (b *mapFilterCndBuilderRegionalDistributionsLimitsByRegion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().LimitsByRegion().WithKey(b.key).FieldPath(),
	})
}
...
func (b *mapFilterCndBuilderRegionalDistributionsLimitsByRegion) compare(op gotenfilter.CompareOperator, value int64) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
		AcceptedPlan_FieldPathValue: NewAcceptedPlanFieldPathBuilder().RegionalDistributions().LimitsByRegion().WithKey(b.key).WithValue(value),
	})
}
...
func (b *filterCndBuilderAssignee) SystemAssignee() *filterCndBuilderAssigneeSystemAssignee {
	return &filterCndBuilderAssigneeSystemAssignee{builder: b.builder}
}
...
type filterCndBuilderAssigneeSystemAssignee struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderAssigneeSystemAssignee) Eq(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderAssigneeSystemAssignee) Neq(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderAssigneeSystemAssignee) Gt(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderAssigneeSystemAssignee) Gte(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderAssigneeSystemAssignee) Lt(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderAssigneeSystemAssignee) Lte(value bool) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderAssigneeSystemAssignee) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		AcceptedPlan_FieldPathArrayOfValues: NewAcceptedPlanFieldPathBuilder().Assignee().SystemAssignee().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderAssigneeSystemAssignee) NotIn(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		AcceptedPlan_FieldPathArrayOfValues: NewAcceptedPlanFieldPathBuilder().Assignee().SystemAssignee().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderAssigneeSystemAssignee) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewAcceptedPlanFieldPathBuilder().Assignee().SystemAssignee().FieldPath(),
	})
}

func (b *filterCndBuilderAssigneeSystemAssignee) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewAcceptedPlanFieldPathBuilder().Assignee().SystemAssignee().FieldPath(),
	})
}

func (b *filterCndBuilderAssigneeSystemAssignee) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:                    op,
		AcceptedPlan_FieldPathValue: NewAcceptedPlanFieldPathBuilder().Assignee().SystemAssignee().WithValue(value),
	})
}
