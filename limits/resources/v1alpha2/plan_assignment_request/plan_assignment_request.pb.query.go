...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*PlanAssignmentRequest_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return PlanAssignmentRequestList(qr.PlanAssignmentRequests)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.PlanAssignmentRequests = results.(PlanAssignmentRequestList)
	} else {
		qr.PlanAssignmentRequests = nil
	}
}
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return PlanAssignmentRequestChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(PlanAssignmentRequestChangeList)
	} else {
		qr.Changes = nil
	}
}
