...
func (b *filterCndBuilderResourceLimits) Eq(value []*common.Allowance) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderResourceLimits) Neq(value []*common.Allowance) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderResourceLimits) Gt(value []*common.Allowance) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderResourceLimits) Gte(value []*common.Allowance) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderResourceLimits) Lt(value []*common.Allowance) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderResourceLimits) Lte(value []*common.Allowance) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderResourceLimits) In(values [][]*common.Allowance) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Plan_FieldPathArrayOfValues: NewPlanFieldPathBuilder().ResourceLimits().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderResourceLimits) NotIn(values [][]*common.Allowance) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Plan_FieldPathArrayOfValues: NewPlanFieldPathBuilder().ResourceLimits().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderResourceLimits) Contains(value *common.Allowance) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewPlanFieldPathBuilder().ResourceLimits().FieldPath(),
...
func (b *filterCndBuilderResourceLimits) ContainsAnyOf(values []*common.Allowance) *FilterBuilder {
...
func (b *filterCndBuilderResourceLimits) ContainsAll(values []*common.Allowance) *FilterBuilder {
	pathSelector := NewPlanFieldPathBuilder().ResourceLimits()
	itemValues := make([]Plan_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderResourceLimits) compare(op gotenfilter.CompareOperator, value []*common.Allowance) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:            op,
