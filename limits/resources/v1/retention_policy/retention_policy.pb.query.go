...
type GetQuery struct {
	Reference *Reference
	Mask      *RetentionPolicy_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*RetentionPolicy_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return RetentionPolicyList(qr.RetentionPolicies)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.RetentionPolicies = results.(RetentionPolicyList)
	} else {
		qr.RetentionPolicies = nil
	}
}
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return RetentionPolicyChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(RetentionPolicyChangeList)
	} else {
		qr.Changes = nil
	}
}
