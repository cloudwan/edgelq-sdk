...
func (orderByFld *OrderByField) CompareWithDirection(left, right *RetentionPolicy) int {
...
func (orderBy *OrderBy) Sort(results RetentionPolicyList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(RetentionPolicyList))
}

func (orderBy *OrderBy) InsertSorted(sorted RetentionPolicyList, elem *RetentionPolicy) (RetentionPolicyList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(RetentionPolicyList), elem.(*RetentionPolicy))
}

func (orderBy *OrderBy) Compare(left, right *RetentionPolicy) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*RetentionPolicy), right.(*RetentionPolicy))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseRetentionPolicy_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *RetentionPolicy_FieldMask {
	fieldMask := &RetentionPolicy_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == RetentionPolicy_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &RetentionPolicy_FieldTerminalPath{selector: RetentionPolicy_FieldPathSelectorName},
