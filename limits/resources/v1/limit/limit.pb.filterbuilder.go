...
func (b *filterCndBuilder) Sources() *filterCndBuilderSources {
	return &filterCndBuilderSources{builder: b.builder}
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Limit_FieldPathArrayOfValues: NewLimitFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewLimitFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesUnsetOnDelete) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:             op,
		Limit_FieldPathValue: NewLimitFieldPathBuilder().Metadata().OwnerReferences().UnsetOnDelete().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServices) In(values []*meta.ServicesInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Limit_FieldPathArrayOfValues: NewLimitFieldPathBuilder().Metadata().Services().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewLimitFieldPathBuilder().Metadata().Services().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServices) compare(op gotenfilter.CompareOperator, value *meta.ServicesInfo) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:             op,
		Limit_FieldPathValue: NewLimitFieldPathBuilder().Metadata().Services().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Limit_FieldPathArrayOfValues: NewLimitFieldPathBuilder().Metadata().Services().OwningService().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewLimitFieldPathBuilder().Metadata().Services().OwningService().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServicesOwningService) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:             op,
		Limit_FieldPathValue: NewLimitFieldPathBuilder().Metadata().Services().OwningService().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) In(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Limit_FieldPathArrayOfValues: NewLimitFieldPathBuilder().Metadata().Services().AllowedServices().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewLimitFieldPathBuilder().Metadata().Services().AllowedServices().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) Contains(value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewLimitFieldPathBuilder().Metadata().Services().AllowedServices().FieldPath(),
		Value:     NewLimitFieldPathBuilder().Metadata().Services().AllowedServices().WithItemValue(value),
	})
}

func (b *filterCndBuilderMetadataServicesAllowedServices) ContainsAnyOf(values []string) *FilterBuilder {
	pathSelector := NewLimitFieldPathBuilder().Metadata().Services().AllowedServices()
	itemValues := make([]Limit_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderMetadataServicesAllowedServices) compare(op gotenfilter.CompareOperator, value []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:             op,
		Limit_FieldPathValue: NewLimitFieldPathBuilder().Metadata().Services().AllowedServices().WithValue(value),
	})
}
...
type filterCndBuilderSources struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderSources) Eq(value []*limit_pool.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderSources) Neq(value []*limit_pool.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderSources) Gt(value []*limit_pool.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderSources) Gte(value []*limit_pool.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderSources) Lt(value []*limit_pool.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderSources) Lte(value []*limit_pool.Reference) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderSources) In(values [][]*limit_pool.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Limit_FieldPathArrayOfValues: NewLimitFieldPathBuilder().Sources().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderSources) NotIn(values [][]*limit_pool.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Limit_FieldPathArrayOfValues: NewLimitFieldPathBuilder().Sources().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderSources) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewLimitFieldPathBuilder().Sources().FieldPath(),
	})
}

func (b *filterCndBuilderSources) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewLimitFieldPathBuilder().Sources().FieldPath(),
	})
}

func (b *filterCndBuilderSources) Contains(value *limit_pool.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewLimitFieldPathBuilder().Sources().FieldPath(),
		Value:     NewLimitFieldPathBuilder().Sources().WithItemValue(value),
	})
}

func (b *filterCndBuilderSources) ContainsAnyOf(values []*limit_pool.Reference) *FilterBuilder {
	pathSelector := NewLimitFieldPathBuilder().Sources()
	itemValues := make([]Limit_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderSources) ContainsAll(values []*limit_pool.Reference) *FilterBuilder {
	pathSelector := NewLimitFieldPathBuilder().Sources()
	itemValues := make([]Limit_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderSources) compare(op gotenfilter.CompareOperator, value []*limit_pool.Reference) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:             op,
		Limit_FieldPathValue: NewLimitFieldPathBuilder().Sources().WithValue(value),
	})
}
