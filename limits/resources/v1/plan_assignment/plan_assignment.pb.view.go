...
func ResourceViewFieldMask(viewName view.View, extraMask *PlanAssignment_FieldMask) *PlanAssignment_FieldMask {
	...
	case view.View_BASIC:
		protoFieldMask.Paths = append(protoFieldMask.Paths, "name", "default_regional_plan", "service")
		break
	case view.View_DETAIL:
		protoFieldMask.Paths = append(protoFieldMask.Paths, "name", "default_regional_plan", "service", "extensions", "regional_plan_overrides")
		break
	case view.View_NAME:
