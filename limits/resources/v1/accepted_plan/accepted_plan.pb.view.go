...
func ResourceViewFieldMask(viewName view.View, extraMask *AcceptedPlan_FieldMask) *AcceptedPlan_FieldMask {
	...
	case view.View_BASIC:
		protoFieldMask.Paths = append(protoFieldMask.Paths, "name", "default_regional_plan", "service", "assignee")
		break
	case view.View_DETAIL:
		protoFieldMask.Paths = append(protoFieldMask.Paths, "name", "default_regional_plan", "service", "assignee", "extensions", "regional_plan_overrides", "allowances")
		break
	case view.View_NAME:
