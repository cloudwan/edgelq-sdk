...
func (AcceptedPlanFieldPathBuilder) DefaultRegionalPlan() AcceptedPlanPathSelectorDefaultRegionalPlan {
	return AcceptedPlanPathSelectorDefaultRegionalPlan{}
}
func (AcceptedPlanFieldPathBuilder) Service() AcceptedPlanPathSelectorService {
	return AcceptedPlanPathSelectorService{}
}
func (AcceptedPlanFieldPathBuilder) RegionalPlanOverrides() AcceptedPlanPathSelectorRegionalPlanOverrides {
	return AcceptedPlanPathSelectorRegionalPlanOverrides{}
}
func (AcceptedPlanFieldPathBuilder) Extensions() AcceptedPlanPathSelectorExtensions {
	return AcceptedPlanPathSelectorExtensions{}
}
func (AcceptedPlanFieldPathBuilder) Allowances() AcceptedPlanPathSelectorAllowances {
	return AcceptedPlanPathSelectorAllowances{}
}
func (AcceptedPlanFieldPathBuilder) AppliedRegions() AcceptedPlanPathSelectorAppliedRegions {
	return AcceptedPlanPathSelectorAppliedRegions{}
}
func (AcceptedPlanFieldPathBuilder) AppliedPlanSpecGeneration() AcceptedPlanPathSelectorAppliedPlanSpecGeneration {
	return AcceptedPlanPathSelectorAppliedPlanSpecGeneration{}
}
...
func (AcceptedPlanPathSelectorDefaultRegionalPlan) FieldPath() *AcceptedPlan_FieldTerminalPath {
	return &AcceptedPlan_FieldTerminalPath{selector: AcceptedPlan_FieldPathSelectorDefaultRegionalPlan}
}

func (s AcceptedPlanPathSelectorDefaultRegionalPlan) WithValue(value *plan.Reference) *AcceptedPlan_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldTerminalPathValue)
}

func (s AcceptedPlanPathSelectorDefaultRegionalPlan) WithArrayOfValues(values []*plan.Reference) *AcceptedPlan_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldTerminalPathArrayOfValues)
}
...
func (AcceptedPlanPathSelectorRegionalPlanOverrides) FieldPath() *AcceptedPlan_FieldTerminalPath {
	return &AcceptedPlan_FieldTerminalPath{selector: AcceptedPlan_FieldPathSelectorRegionalPlanOverrides}
}

func (s AcceptedPlanPathSelectorRegionalPlanOverrides) WithValue(value []*common.RegionalPlanAssignment) *AcceptedPlan_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldTerminalPathValue)
}

func (s AcceptedPlanPathSelectorRegionalPlanOverrides) WithArrayOfValues(values [][]*common.RegionalPlanAssignment) *AcceptedPlan_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldTerminalPathArrayOfValues)
}

func (s AcceptedPlanPathSelectorRegionalPlanOverrides) WithItemValue(value *common.RegionalPlanAssignment) *AcceptedPlan_FieldTerminalPathArrayItemValue {
	return s.FieldPath().WithIArrayItemValue(value).(*AcceptedPlan_FieldTerminalPathArrayItemValue)
}
func (AcceptedPlanPathSelectorRegionalPlanOverrides) WithSubPath(subPath common.RegionalPlanAssignment_FieldPath) *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{selector: AcceptedPlan_FieldPathSelectorRegionalPlanOverrides, subPath: subPath}
}

func (s AcceptedPlanPathSelectorRegionalPlanOverrides) WithSubValue(subPathValue common.RegionalPlanAssignment_FieldPathValue) *AcceptedPlan_FieldSubPathValue {
	return &AcceptedPlan_FieldSubPathValue{AcceptedPlan_FieldPath: s.WithSubPath(subPathValue), subPathValue: subPathValue}
}

func (s AcceptedPlanPathSelectorRegionalPlanOverrides) WithSubArrayOfValues(subPathArrayOfValues common.RegionalPlanAssignment_FieldPathArrayOfValues) *AcceptedPlan_FieldSubPathArrayOfValues {
	return &AcceptedPlan_FieldSubPathArrayOfValues{AcceptedPlan_FieldPath: s.WithSubPath(subPathArrayOfValues), subPathArrayOfValues: subPathArrayOfValues}
}

func (s AcceptedPlanPathSelectorRegionalPlanOverrides) WithSubArrayItemValue(subPathArrayItemValue common.RegionalPlanAssignment_FieldPathArrayItemValue) *AcceptedPlan_FieldSubPathArrayItemValue {
	return &AcceptedPlan_FieldSubPathArrayItemValue{AcceptedPlan_FieldPath: s.WithSubPath(subPathArrayItemValue), subPathItemValue: subPathArrayItemValue}
}

func (AcceptedPlanPathSelectorRegionalPlanOverrides) Plan() AcceptedPlanPathSelectorRegionalPlanOverridesPlan {
	return AcceptedPlanPathSelectorRegionalPlanOverridesPlan{}
}

func (AcceptedPlanPathSelectorRegionalPlanOverrides) Region() AcceptedPlanPathSelectorRegionalPlanOverridesRegion {
	return AcceptedPlanPathSelectorRegionalPlanOverridesRegion{}
}

func (AcceptedPlanPathSelectorRegionalPlanOverrides) PlanGeneration() AcceptedPlanPathSelectorRegionalPlanOverridesPlanGeneration {
	return AcceptedPlanPathSelectorRegionalPlanOverridesPlanGeneration{}
}

type AcceptedPlanPathSelectorRegionalPlanOverridesPlan struct{}

func (AcceptedPlanPathSelectorRegionalPlanOverridesPlan) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
...
func (s AcceptedPlanPathSelectorRegionalPlanOverridesPlan) WithValue(value *plan.Reference) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorRegionalPlanOverridesPlan) WithArrayOfValues(values []*plan.Reference) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}

type AcceptedPlanPathSelectorRegionalPlanOverridesRegion struct{}

func (AcceptedPlanPathSelectorRegionalPlanOverridesRegion) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
		selector: AcceptedPlan_FieldPathSelectorRegionalPlanOverrides,
...
func (s AcceptedPlanPathSelectorRegionalPlanOverridesRegion) WithValue(value string) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorRegionalPlanOverridesRegion) WithArrayOfValues(values []string) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}

type AcceptedPlanPathSelectorRegionalPlanOverridesPlanGeneration struct{}

func (AcceptedPlanPathSelectorRegionalPlanOverridesPlanGeneration) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
		selector: AcceptedPlan_FieldPathSelectorRegionalPlanOverrides,
...
func (s AcceptedPlanPathSelectorRegionalPlanOverridesPlanGeneration) WithValue(value int64) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorRegionalPlanOverridesPlanGeneration) WithArrayOfValues(values []int64) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}
...
func (AcceptedPlanPathSelectorExtensions) Region() AcceptedPlanPathSelectorExtensionsRegion {
	return AcceptedPlanPathSelectorExtensionsRegion{}
}
...
func (AcceptedPlanPathSelectorExtensionsRegion) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
		selector: AcceptedPlan_FieldPathSelectorExtensions,
...
func (s AcceptedPlanPathSelectorExtensionsRegion) WithValue(value string) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorExtensionsRegion) WithArrayOfValues(values []string) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}

type AcceptedPlanPathSelectorAllowances struct{}

func (AcceptedPlanPathSelectorAllowances) FieldPath() *AcceptedPlan_FieldTerminalPath {
	return &AcceptedPlan_FieldTerminalPath{selector: AcceptedPlan_FieldPathSelectorAllowances}
}

func (s AcceptedPlanPathSelectorAllowances) WithValue(value []*common.Allowance) *AcceptedPlan_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldTerminalPathValue)
}

func (s AcceptedPlanPathSelectorAllowances) WithArrayOfValues(values [][]*common.Allowance) *AcceptedPlan_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldTerminalPathArrayOfValues)
}

func (s AcceptedPlanPathSelectorAllowances) WithItemValue(value *common.Allowance) *AcceptedPlan_FieldTerminalPathArrayItemValue {
	return s.FieldPath().WithIArrayItemValue(value).(*AcceptedPlan_FieldTerminalPathArrayItemValue)
}
func (AcceptedPlanPathSelectorAllowances) WithSubPath(subPath common.Allowance_FieldPath) *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{selector: AcceptedPlan_FieldPathSelectorAllowances, subPath: subPath}
}

func (s AcceptedPlanPathSelectorAllowances) WithSubValue(subPathValue common.Allowance_FieldPathValue) *AcceptedPlan_FieldSubPathValue {
	return &AcceptedPlan_FieldSubPathValue{AcceptedPlan_FieldPath: s.WithSubPath(subPathValue), subPathValue: subPathValue}
}

func (s AcceptedPlanPathSelectorAllowances) WithSubArrayOfValues(subPathArrayOfValues common.Allowance_FieldPathArrayOfValues) *AcceptedPlan_FieldSubPathArrayOfValues {
	return &AcceptedPlan_FieldSubPathArrayOfValues{AcceptedPlan_FieldPath: s.WithSubPath(subPathArrayOfValues), subPathArrayOfValues: subPathArrayOfValues}
}

func (s AcceptedPlanPathSelectorAllowances) WithSubArrayItemValue(subPathArrayItemValue common.Allowance_FieldPathArrayItemValue) *AcceptedPlan_FieldSubPathArrayItemValue {
	return &AcceptedPlan_FieldSubPathArrayItemValue{AcceptedPlan_FieldPath: s.WithSubPath(subPathArrayItemValue), subPathItemValue: subPathArrayItemValue}
}

func (AcceptedPlanPathSelectorAllowances) Resource() AcceptedPlanPathSelectorAllowancesResource {
	return AcceptedPlanPathSelectorAllowancesResource{}
}

func (AcceptedPlanPathSelectorAllowances) Value() AcceptedPlanPathSelectorAllowancesValue {
	return AcceptedPlanPathSelectorAllowancesValue{}
}

func (AcceptedPlanPathSelectorAllowances) Region() AcceptedPlanPathSelectorAllowancesRegion {
	return AcceptedPlanPathSelectorAllowancesRegion{}
}

type AcceptedPlanPathSelectorAllowancesResource struct{}

func (AcceptedPlanPathSelectorAllowancesResource) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
		selector: AcceptedPlan_FieldPathSelectorAllowances,
		subPath:  common.NewAllowanceFieldPathBuilder().Resource().FieldPath(),
	}
}

func (s AcceptedPlanPathSelectorAllowancesResource) WithValue(value *meta_resource.Reference) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorAllowancesResource) WithArrayOfValues(values []*meta_resource.Reference) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}

type AcceptedPlanPathSelectorAllowancesValue struct{}

func (AcceptedPlanPathSelectorAllowancesValue) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
		selector: AcceptedPlan_FieldPathSelectorAllowances,
		subPath:  common.NewAllowanceFieldPathBuilder().Value().FieldPath(),
	}
...
func (s AcceptedPlanPathSelectorAllowancesValue) WithValue(value int64) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorAllowancesValue) WithArrayOfValues(values []int64) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}

type AcceptedPlanPathSelectorAllowancesRegion struct{}

func (AcceptedPlanPathSelectorAllowancesRegion) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
		selector: AcceptedPlan_FieldPathSelectorAllowances,
		subPath:  common.NewAllowanceFieldPathBuilder().Region().FieldPath(),
	}
...
func (s AcceptedPlanPathSelectorAllowancesRegion) WithValue(value string) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorAllowancesRegion) WithArrayOfValues(values []string) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}

type AcceptedPlanPathSelectorAppliedRegions struct{}

func (AcceptedPlanPathSelectorAppliedRegions) FieldPath() *AcceptedPlan_FieldTerminalPath {
	return &AcceptedPlan_FieldTerminalPath{selector: AcceptedPlan_FieldPathSelectorAppliedRegions}
}

func (s AcceptedPlanPathSelectorAppliedRegions) WithValue(value []string) *AcceptedPlan_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldTerminalPathValue)
}

func (s AcceptedPlanPathSelectorAppliedRegions) WithArrayOfValues(values [][]string) *AcceptedPlan_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldTerminalPathArrayOfValues)
}

func (s AcceptedPlanPathSelectorAppliedRegions) WithItemValue(value string) *AcceptedPlan_FieldTerminalPathArrayItemValue {
	return s.FieldPath().WithIArrayItemValue(value).(*AcceptedPlan_FieldTerminalPathArrayItemValue)
}

type AcceptedPlanPathSelectorAppliedPlanSpecGeneration struct{}

func (AcceptedPlanPathSelectorAppliedPlanSpecGeneration) FieldPath() *AcceptedPlan_FieldTerminalPath {
	return &AcceptedPlan_FieldTerminalPath{selector: AcceptedPlan_FieldPathSelectorAppliedPlanSpecGeneration}
}

func (s AcceptedPlanPathSelectorAppliedPlanSpecGeneration) WithValue(value int64) *AcceptedPlan_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldTerminalPathValue)
}

func (s AcceptedPlanPathSelectorAppliedPlanSpecGeneration) WithArrayOfValues(values []int64) *AcceptedPlan_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldTerminalPathArrayOfValues)
}
...
func (AcceptedPlanPathSelectorAssignee) ServiceAssignee() AcceptedPlanPathSelectorAssigneeServiceAssignee {
	return AcceptedPlanPathSelectorAssigneeServiceAssignee{}
}
...
func (AcceptedPlanPathSelectorAssigneeServiceAssignee) FieldPath() *AcceptedPlan_FieldSubPath {
	return &AcceptedPlan_FieldSubPath{
		selector: AcceptedPlan_FieldPathSelectorAssignee,
		subPath:  NewAcceptedPlanAssigneeFieldPathBuilder().ServiceAssignee().FieldPath(),
	}
}

func (s AcceptedPlanPathSelectorAssigneeServiceAssignee) WithValue(value *meta_service.Reference) *AcceptedPlan_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlan_FieldSubPathValue)
}

func (s AcceptedPlanPathSelectorAssigneeServiceAssignee) WithArrayOfValues(values []*meta_service.Reference) *AcceptedPlan_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlan_FieldSubPathArrayOfValues)
}
...
func (AcceptedPlanAssigneeFieldPathBuilder) ServiceAssignee() AcceptedPlan_AssigneePathSelectorServiceAssignee {
	return AcceptedPlan_AssigneePathSelectorServiceAssignee{}
}
...
func (AcceptedPlan_AssigneePathSelectorServiceAssignee) FieldPath() *AcceptedPlanAssignee_FieldTerminalPath {
	return &AcceptedPlanAssignee_FieldTerminalPath{selector: AcceptedPlanAssignee_FieldPathSelectorServiceAssignee}
}

func (s AcceptedPlan_AssigneePathSelectorServiceAssignee) WithValue(value *meta_service.Reference) *AcceptedPlanAssignee_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*AcceptedPlanAssignee_FieldTerminalPathValue)
}

func (s AcceptedPlan_AssigneePathSelectorServiceAssignee) WithArrayOfValues(values []*meta_service.Reference) *AcceptedPlanAssignee_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*AcceptedPlanAssignee_FieldTerminalPathArrayOfValues)
}
