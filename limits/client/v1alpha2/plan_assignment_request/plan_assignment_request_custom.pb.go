...
type ListApproverPlanAssignmentRequestsRequest struct {
	...
	Approver *iam_organization.Name `protobuf:"bytes,1,opt,customtype=Name,name=approver,proto3" json:"approver,omitempty"`
...
type AcceptPlanAssignmentRequest struct {
	...
	Approver *iam_organization.Name `protobuf:"bytes,2,opt,customtype=Name,name=approver,proto3" json:"approver,omitempty"`
}
