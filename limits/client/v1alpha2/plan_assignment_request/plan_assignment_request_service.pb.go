...
type CreatePlanAssignmentRequestRequest_ResponseMask_BodyMask struct {
	...
	// specific fields.
	BodyMask *plan_assignment_request.PlanAssignmentRequest_FieldMask `protobuf:"bytes,2,opt,customtype=PlanAssignmentRequest_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
...
type UpdatePlanAssignmentRequestRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *plan_assignment_request.PlanAssignmentRequest_FieldMask `protobuf:"bytes,3,opt,customtype=PlanAssignmentRequest_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
