...
type UpdateLimitPoolRequest struct {
	...
	// size.
	ResponseMask *UpdateLimitPoolRequest_ResponseMask `protobuf:"bytes,6,opt,name=response_mask,json=responseMask,proto3" json:"response_mask,omitempty" firestore:"responseMask"`
}
...
type UpdateLimitPoolRequest_ResponseMask_BodyMask struct {
	...
	// ignored.
	BodyMask *limit_pool.LimitPool_FieldMask `protobuf:"bytes,3,opt,customtype=LimitPool_FieldMask,name=body_mask,json=bodyMask,proto3,oneof" firestore:"bodyMask"`
}
