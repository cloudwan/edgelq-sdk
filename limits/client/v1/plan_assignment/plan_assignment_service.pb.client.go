...
type PlanAssignmentServiceClient interface {
	...
	DeletePlanAssignment(ctx context.Context, in *DeletePlanAssignmentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *client) GetPlanAssignment(ctx context.Context, in *GetPlanAssignmentRequest, opts ...grpc.CallOption) (*plan_assignment.PlanAssignment, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.PlanAssignmentService/GetPlanAssignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetPlanAssignments(ctx context.Context, in *BatchGetPlanAssignmentsRequest, opts ...grpc.CallOption) (*BatchGetPlanAssignmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.PlanAssignmentService/BatchGetPlanAssignments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListPlanAssignments(ctx context.Context, in *ListPlanAssignmentsRequest, opts ...grpc.CallOption) (*ListPlanAssignmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.PlanAssignmentService/ListPlanAssignments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchPlanAssignment(ctx context.Context, in *WatchPlanAssignmentRequest, opts ...grpc.CallOption) (WatchPlanAssignmentClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.limits.v1.PlanAssignmentService/WatchPlanAssignment", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchPlanAssignments(ctx context.Context, in *WatchPlanAssignmentsRequest, opts ...grpc.CallOption) (WatchPlanAssignmentsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.limits.v1.PlanAssignmentService/WatchPlanAssignments", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreatePlanAssignment(ctx context.Context, in *CreatePlanAssignmentRequest, opts ...grpc.CallOption) (*plan_assignment.PlanAssignment, error) {
	out := new(plan_assignment.PlanAssignment)
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.PlanAssignmentService/CreatePlanAssignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdatePlanAssignment(ctx context.Context, in *UpdatePlanAssignmentRequest, opts ...grpc.CallOption) (*plan_assignment.PlanAssignment, error) {
	out := new(plan_assignment.PlanAssignment)
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.PlanAssignmentService/UpdatePlanAssignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeletePlanAssignment(ctx context.Context, in *DeletePlanAssignmentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.PlanAssignmentService/DeletePlanAssignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) MigratePlanAssignment(ctx context.Context, in *MigratePlanAssignmentRequest, opts ...grpc.CallOption) (*plan_assignment.PlanAssignment, error) {
	out := new(plan_assignment.PlanAssignment)
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.PlanAssignmentService/MigratePlanAssignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
