...
type AcceptedPlanServiceClient interface {
	...
	DeleteAcceptedPlan(ctx context.Context, in *DeleteAcceptedPlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *client) GetAcceptedPlan(ctx context.Context, in *GetAcceptedPlanRequest, opts ...grpc.CallOption) (*accepted_plan.AcceptedPlan, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.AcceptedPlanService/GetAcceptedPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetAcceptedPlans(ctx context.Context, in *BatchGetAcceptedPlansRequest, opts ...grpc.CallOption) (*BatchGetAcceptedPlansResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.AcceptedPlanService/BatchGetAcceptedPlans", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListAcceptedPlans(ctx context.Context, in *ListAcceptedPlansRequest, opts ...grpc.CallOption) (*ListAcceptedPlansResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.AcceptedPlanService/ListAcceptedPlans", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchAcceptedPlan(ctx context.Context, in *WatchAcceptedPlanRequest, opts ...grpc.CallOption) (WatchAcceptedPlanClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.limits.v1.AcceptedPlanService/WatchAcceptedPlan", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchAcceptedPlans(ctx context.Context, in *WatchAcceptedPlansRequest, opts ...grpc.CallOption) (WatchAcceptedPlansClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.limits.v1.AcceptedPlanService/WatchAcceptedPlans", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateAcceptedPlan(ctx context.Context, in *CreateAcceptedPlanRequest, opts ...grpc.CallOption) (*accepted_plan.AcceptedPlan, error) {
	out := new(accepted_plan.AcceptedPlan)
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.AcceptedPlanService/CreateAcceptedPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateAcceptedPlan(ctx context.Context, in *UpdateAcceptedPlanRequest, opts ...grpc.CallOption) (*accepted_plan.AcceptedPlan, error) {
	out := new(accepted_plan.AcceptedPlan)
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.AcceptedPlanService/UpdateAcceptedPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteAcceptedPlan(ctx context.Context, in *DeleteAcceptedPlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ntt.limits.v1.AcceptedPlanService/DeleteAcceptedPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
