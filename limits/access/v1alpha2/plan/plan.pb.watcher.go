...
func init() {
	...
	gotenaccess.GetRegistry().RegisterWatcherFilterConstructor(plan.GetDescriptor(), func(filter gotenresource.Filter, parent gotenresource.Reference) gotenaccess.WatcherFilterParams {
